...
assert '#define AD_VERSION "v7.471-pdp-four-adcard-repair"' in T
assert 'AD_PROBE_VERSION=7.471' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.471' in S
assert 'VER=7.471' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.471-probe.arm' in H and 'AmazonDark-v7.471-probe-status.json' in H
assert 'AMAZONDARK v7.471 UNIVERSAL' in INC and 'AmazonDark-v7.471-ui-viewport.arm' in INC
assert 'AmazonDark-v7.471-launch-sb-probe.txt' in SB
