...
assert 'AMAZONDARK v7.471 UNIVERSAL' in INC and 'AmazonDark-v7.471-ui-viewport.arm' in INC and "version:'7.471'" in JS
assert 'in 7.471~*)' in SK and 'Install the v7.471 Actions package first.' in SK
