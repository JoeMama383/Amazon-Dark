...
for h in ['## FULL — v7.470','## VIEWPORT — v7.470','## TRANSITION — v7.470']: assert h in CMD,h
print('PASS: v7.470 uses the probe-proven isolated all-frame lane, pins exact ad paint, and targets the actual PUTB book fade')
