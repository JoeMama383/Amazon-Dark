...
assert 'VER=7.470' in UI and 'AD_PROBE_VERSION=7.470' in SK and 'AD_PROBE_NAME=AmazonDark-v7.470' in SK
assert 'AMAZONDARK v7.470 UNIVERSAL' in INC and 'AmazonDark-v7.470-ui-viewport.arm' in INC and "version:'7.470'" in JS
assert 'in 7.470~*)' in SK and 'Install the v7.470 Actions package first.' in SK
