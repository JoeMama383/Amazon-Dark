...
import os,sys
v=os.environ.get('AD_INSTALLED','7.420~cart-topnav-payment-divider-fix')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.420-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.420-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.420-probe.arm').exists()
