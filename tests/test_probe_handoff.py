...
import os,sys
v=os.environ.get('AD_INSTALLED','7.415~location-text-finalize-fix')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.415-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.415-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.415-probe.arm').exists()
    ...
    assert not launch_arm.exists()
    print('PASS: current v7.415 plus prior proven upgrade receipts discover Amazon with plutil unavailable')
