...
VERSION='7.441~pdp-site-isolated-frames'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.441~pdp-site-isolated-frames')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.441-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.441-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.441-probe.arm').exists()
