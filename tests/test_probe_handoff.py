...
import os,sys
v=os.environ.get('AD_INSTALLED','7.431~pdp-r2-r5-fix')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.431-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.431-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.431-probe.arm').exists()
