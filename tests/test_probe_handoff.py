...
VERSION='7.440~pdp-frame-ownership'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.440~pdp-frame-ownership')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.440-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.440-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.440-probe.arm').exists()
