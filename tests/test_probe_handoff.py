...
VERSION='7.437~pdp-standalone-ad-treatment'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.437~pdp-standalone-ad-treatment')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.437-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.437-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.437-probe.arm').exists()
