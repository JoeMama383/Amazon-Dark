...
VERSION='7.433~universal-crossframe-probe'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.433~universal-crossframe-probe')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.433-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.433-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.433-probe.arm').exists()
