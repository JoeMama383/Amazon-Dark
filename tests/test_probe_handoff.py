...
import os,sys
v=os.environ.get('AD_INSTALLED','7.412~address-location-aux-theme')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.412-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.412-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.412-probe.arm').exists()
