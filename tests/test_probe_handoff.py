...
VERSION='7.371~checkout-residual-ui-fix'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.371~checkout-residual-ui-fix')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.371-probe.arm'
    ...
    log=amazon/'Documents/AmazonDark-v7.371-skeleton-1-77-launch.jsonl'
    log.write_text('{"event":"SESSION_START","label":"launch"}\n')
    receipt=amazon/'Documents/AmazonDark-v7.371-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','reason':'capture-started','version':'v7.371-checkout-residual-ui-fix'}))
    ...
    assert not (other/'Documents/AmazonDark-v7.371-probe.arm').exists()
