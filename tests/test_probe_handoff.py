...
VERSION='7.442~user-style-ad-ownership'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.442~user-style-ad-ownership')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.442-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.442-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.442-probe.arm').exists()
