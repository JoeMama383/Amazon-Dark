...
VERSION='7.439~pdp-ui-completion'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.439~pdp-ui-completion')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.439-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.439-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.439-probe.arm').exists()
