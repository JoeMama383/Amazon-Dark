...
import os,sys
v=os.environ.get('AD_INSTALLED','7.418~payment-giftcard-switch-cleanup')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.418-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.418-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.418-probe.arm').exists()
