...
VERSION='7.432~pdp-safeframe-ad-fix'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.432~pdp-safeframe-ad-fix')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.432-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.432-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.432-probe.arm').exists()
