...
VERSION='7.375~checkout-prepaint-snapshot-hydration'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.375~checkout-prepaint-snapshot-hydration')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.375-probe.arm'
    ...
    log=amazon/'Documents/AmazonDark-v7.375-skeleton-1-77-launch.jsonl'
    log.write_text('{"event":"SESSION_START","label":"launch"}\n')
    receipt=amazon/'Documents/AmazonDark-v7.375-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','reason':'capture-started','version':'v7.375-checkout-prepaint-snapshot-hydration'}))
    ...
    assert not (other/'Documents/AmazonDark-v7.375-probe.arm').exists()
