...
VERSION='7.435~probe-backed-pdp-search-fixes'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.435~probe-backed-pdp-search-fixes')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.435-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.435-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.435-probe.arm').exists()
