...
VERSION='7.376~warm-switcher-noninterference'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.376~warm-switcher-noninterference')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.376-probe.arm'
    ...
    log=amazon/'Documents/AmazonDark-v7.376-skeleton-1-77-launch.jsonl'
    log.write_text('{"event":"SESSION_START","label":"launch"}\n')
    receipt=amazon/'Documents/AmazonDark-v7.376-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','reason':'capture-started','version':'v7.376-warm-switcher-noninterference'}))
    ...
    assert not (other/'Documents/AmazonDark-v7.376-probe.arm').exists()
