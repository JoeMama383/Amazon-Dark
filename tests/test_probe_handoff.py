...
VERSION='7.444~pdp-proven-media'
...
import os,sys
v=os.environ.get('AD_INSTALLED','7.444~pdp-proven-media')
...
''');dpkg.chmod(0o755)
    ...
    arm=amazon/'Documents/AmazonDark-v7.444-probe.arm'
    ...
    sb=mobile/'AmazonDark-v7.444-launch-sb-probe.txt';sb.write_text('snapshot.dark\n')
    ...
    assert not (other/'Documents/AmazonDark-v7.444-probe.arm').exists()
