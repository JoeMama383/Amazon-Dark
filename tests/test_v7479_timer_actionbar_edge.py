...
# v7.479 adds an independent inset-black paint layer so a competing white
...
print('PASS: v7.479 covers the TNF visible white paint and clears only the PDP action-bar container top edge')
