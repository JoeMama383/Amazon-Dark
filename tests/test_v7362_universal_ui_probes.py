...
assert 'Version: 7.448~performance-consolidation' in ctl
...
assert 'AmazonDark-v7.448-ui-viewport.arm' in inc
...
print('PASS: v7.448 retains exactly two universal UI probe categories and no route-specific dispatcher')
