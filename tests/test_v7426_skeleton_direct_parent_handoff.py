...
with tempfile.TemporaryDirectory(prefix='ad-v7426-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.425-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.425-swv-video-taming'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.425 receipt and arms current-version probe paths')
