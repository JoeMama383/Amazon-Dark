...
# PDP v7.453 must launch exactly one finite page-side stream and finish from script messages.
...
print('PASS: v7.453 PDP FULL streams a finite full-document read-only scan without recursive WebKit evaluation')
