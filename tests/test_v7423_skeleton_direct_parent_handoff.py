...
with tempfile.TemporaryDirectory(prefix='ad-v7423-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.422-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.422-person-returns-medical-fix'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.422 receipt and arms current-version probe paths')
