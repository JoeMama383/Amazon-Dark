...
with tempfile.TemporaryDirectory(prefix='ad-v7422-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.421-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.421-byg-carousel-theme-restore'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.421 receipt and arms current-version probe paths')
