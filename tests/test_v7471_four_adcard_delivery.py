...
for t in ('[data-testid=renderer-factory-ad-container]:has(#offsite-buy-box)>div:first-child','[data-testid=brand-name]','[data-testid=product-description]',
          ...
          'data-csa-c-slot-id=sp_hqp_phoneapp_shared','sp_hqp_phoneapp_shared_responsive_box_rem','#sp_hqp_phoneapp_shared_inner{background:transparent!important;box-shadow:none!important}','sp_hqp_phoneapp_shared_display_title','sp_hqp_phoneapp_shared_rating_rem','sp_hqp_phoneapp_shared_price_rem'):
    assert t in g,t
...
for h in ['## FULL — v7.482','## VIEWPORT — v7.482','## TRANSITION — v7.482']: assert h in CMD,h
