...
assert 'VER=7.408' in UI and 'AD_PROBE_VERSION=7.408' in SK
...
assert 'v.layer.borderColor=ADBorderGray706().CGColor' in perm
...
assert 'ADLocationRootActive7202' in loc
...
for tok in ['effect.effect=','effect.hidden=','effect.alpha=','effect.layer.opacity=']:
