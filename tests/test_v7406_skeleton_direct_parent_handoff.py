...
with tempfile.TemporaryDirectory(prefix='ad7406-parent-handoff-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.405-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.405-pdp-completion'}))
...
print('PASS: v7.407 skeleton helper discovers Amazon from exact direct-parent v7.405 receipt')
