...
assert 'VER=7.480' in UI and 'AD_PROBE_VERSION=7.480' in SK
...
for t in ('renderer-factory-ad-container]:has(#offsite-buy-box)>div:first-child','mix-blend-mode:normal!important','[data-testid=brand-name]','[data-testid=product-description]',
          ...
          '[data-testid=dealprice-stack]>img.inline-block{filter:none!important','sp_hqp_phoneapp_shared_responsive_box_rem','#sp_hqp_phoneapp_shared_inner{background:transparent!important;box-shadow:none!important}'):
    assert t in g,t
