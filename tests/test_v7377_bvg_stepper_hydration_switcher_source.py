...
assert 'version=7.384~cold-artwork-no-generic-xib base=v7.338' in SB
...
assert 'AMAZONDARK v7.384 UNIVERSAL' in INC
assert "version:'7.384'" in JS
assert 'AmazonDark-v7.384-ui-viewport.arm' in INC

print('PASS: v7.377-established BYG stepper/switcher/probe contracts remain under v7.384')
