...
assert 'Version: 7.389~checkout-sheet-switcher-fix' in C
assert '#define AD_VERSION "v7.389-checkout-sheet-switcher-fix"' in S
...
assert 'version=7.389~cold-artwork-no-generic-xib base=v7.338' in SB
...
assert 'AMAZONDARK v7.389 UNIVERSAL' in INC
assert "version:'7.389'" in JS
