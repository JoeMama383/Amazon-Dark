...
assert 'version=7.388~cold-artwork-no-generic-xib base=v7.338' in SB
...
assert 'AMAZONDARK v7.388 UNIVERSAL' in INC
assert "version:'7.388'" in JS
assert 'AmazonDark-v7.388-ui-viewport.arm' in INC
