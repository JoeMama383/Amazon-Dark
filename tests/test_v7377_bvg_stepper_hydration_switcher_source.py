...
assert 'version=7.380~cold-artwork-no-generic-xib base=v7.338' in SB
...
assert 'AMAZONDARK v7.380 UNIVERSAL' in INC
assert "version:'7.380'" in JS
assert 'AmazonDark-v7.380-ui-viewport.arm' in INC

print('PASS: v7.377-established BYG stepper/switcher/probe contracts remain under v7.380')
