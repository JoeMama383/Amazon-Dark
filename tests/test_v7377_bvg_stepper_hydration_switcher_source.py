...
assert 'version=7.392~cold-artwork-no-generic-xib base=v7.338' in SB
...
assert 'AMAZONDARK v7.392 UNIVERSAL' in INC
assert "version:'7.391'" in JS
assert 'AmazonDark-v7.392-ui-viewport.arm' in INC
