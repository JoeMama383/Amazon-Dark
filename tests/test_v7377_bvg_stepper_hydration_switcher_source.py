...
for token in [
    '#checkoutDisplayPage .checkout-byg-mobile-container .a-stepper-inner-container',
...
assert 'version=7.411~cold-artwork-no-generic-xib base=v7.338' in SB
...
assert 'AMAZONDARK v7.455 UNIVERSAL' in INC
assert "version:'7.455'" in JS
assert 'AmazonDark-v7.455-ui-viewport.arm' in INC
