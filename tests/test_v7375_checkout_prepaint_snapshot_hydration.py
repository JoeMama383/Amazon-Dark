...
assert 'AmazonDark-v7.384-sponsored-logos-build-fix-source.zip' in CMD
...
print('PASS: checkout/TWB/CI contracts retained under v7.384; BYG recovery remains real-control/no-recurring')
