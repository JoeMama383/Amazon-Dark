...
assert 'AmazonDark-v7.387-runtime-css-optimization-source.zip' in CMD
...
print('PASS: checkout/TWB/CI contracts retained under v7.387; BYG recovery remains real-control/no-recurring')
