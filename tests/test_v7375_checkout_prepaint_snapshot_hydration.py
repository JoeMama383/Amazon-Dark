...
assert 'AmazonDark-v7.382-sponsored-carousel-precision-source.zip' in CMD
...
print('PASS: checkout/TWB/CI contracts retained under v7.382; BYG recovery remains real-control/no-recurring')
