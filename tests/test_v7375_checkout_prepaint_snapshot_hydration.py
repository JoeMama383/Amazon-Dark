...
assert 'AmazonDark-v7.383-sponsored-selector-rules-source.zip' in CMD
...
print('PASS: checkout/TWB/CI contracts retained under v7.383; BYG recovery remains real-control/no-recurring')
