...
assert 'AmazonDark-v7.381-sponsored-slot-collapse-ad-floor-source.zip' in CMD
...
print('PASS: checkout/TWB/CI contracts retained under v7.381; BYG recovery remains real-control/no-recurring')
