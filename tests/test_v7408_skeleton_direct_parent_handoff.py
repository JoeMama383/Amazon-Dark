...
with tempfile.TemporaryDirectory(prefix='ad7408-parent-handoff-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.407-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.407-pdp-transition-skeleton-dark'}))
...
print('PASS: v7.408 skeleton helper discovers Amazon from exact direct-parent v7.407 receipt')
