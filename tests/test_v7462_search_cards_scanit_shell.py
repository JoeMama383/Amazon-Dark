...
assert 'VER=7.465' in U
assert 'AD_PROBE_VERSION=7.465' in K and 'AD_PROBE_NAME=AmazonDark-v7.465' in K
assert 'AmazonDark-v7.465-pdp-ad-book-ci-fix-source.zip' in CMD
for h in ['## FULL — v7.465','## VIEWPORT — v7.465','## TRANSITION — v7.465']:
    assert h in CMD
print('PASS: v7.465 handoff stays below the 856000-byte gate and regenerates all probes')
