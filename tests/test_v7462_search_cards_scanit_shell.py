...
assert 'VER=7.466' in U
assert 'AD_PROBE_VERSION=7.466' in K and 'AD_PROBE_NAME=AmazonDark-v7.466' in K
assert 'AmazonDark-v7.466-pdp-ad-book-ci-compat-source.zip' in CMD
for h in ['## FULL — v7.466','## VIEWPORT — v7.466','## TRANSITION — v7.466']:
    assert h in CMD
print('PASS: v7.466 handoff stays below the 856000-byte gate and regenerates all probes')
