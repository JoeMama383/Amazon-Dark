...
assert 'VER=7.480' in U
assert 'AD_PROBE_VERSION=7.480' in K and 'AD_PROBE_NAME=AmazonDark-v7.480' in K
assert 'AmazonDark-v7.480-camera-permission-build-repair-source.zip' in CMD
