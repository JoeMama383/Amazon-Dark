...
assert 'VER=7.478' in U
assert 'AD_PROBE_VERSION=7.478' in K and 'AD_PROBE_NAME=AmazonDark-v7.478' in K
assert 'AmazonDark-v7.478-home-pdp-six-fix-source.zip' in CMD
for h in ['## FULL — v7.478','## VIEWPORT — v7.478','## TRANSITION — v7.478']:
    assert h in CMD
