...
with tempfile.TemporaryDirectory(prefix='ad7409-parent-handoff-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.408-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.408-permission-location-switcher-hardening'}))
...
print('PASS: v7.409 skeleton helper discovers Amazon from exact direct-parent v7.408 receipt')
