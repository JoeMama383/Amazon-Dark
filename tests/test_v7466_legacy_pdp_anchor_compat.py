...
assert 'ADPDPStandalonePromoteJS7472' in S and '#ad [data-testid=gridContainer]{background:#000!important;border:0!important' in S
print('PASS: v7.472 retains frozen PDP/source anchors while replacing only failed ad delivery')
