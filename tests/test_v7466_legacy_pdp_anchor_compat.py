...
assert 'background:#000!important;background-color:#000!important;background-image:none!important' in f
...
for h in ['## FULL — v7.466','## VIEWPORT — v7.466','## TRANSITION — v7.466']:
    assert h in CMD,h
print('PASS: v7.466 restores frozen PDP/source slicing anchors without changing the v7.464 visual ownership contract')
