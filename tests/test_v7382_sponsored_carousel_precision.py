...
# v7.385 must not reintroduce illegal nested :has() syntax.
...
print('PASS: v7.382 precision contracts survive v7.385 without nested :has or broad carousel promotion')
