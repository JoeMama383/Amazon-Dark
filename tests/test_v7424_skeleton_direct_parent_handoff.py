...
with tempfile.TemporaryDirectory(prefix='ad-v7424-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.423-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.423-cart-message-banner-fix'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.423 receipt and arms current-version probe paths')
