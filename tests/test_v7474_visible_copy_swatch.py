...
for h in ['## FULL — v7.477','## VIEWPORT — v7.477','## TRANSITION — v7.477']:
    assert h in CMD,h
print('PASS: v7.477 restores variant offsite neutral subcopy, PUTB description copy, and selected format cap without flattening dynamic ad colors')
