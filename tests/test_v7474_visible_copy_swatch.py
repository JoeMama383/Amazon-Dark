...
assert 'VER=7.474' in UI and 'AD_PROBE_VERSION=7.474' in SK and 'AD_PROBE_NAME=AmazonDark-v7.474' in SK
...
for h in ['## FULL — v7.474','## VIEWPORT — v7.474','## TRANSITION — v7.474']:
    assert h in CMD,h
print('PASS: v7.474 restores variant offsite neutral subcopy, PUTB description copy, and selected format cap without flattening dynamic ad colors')
