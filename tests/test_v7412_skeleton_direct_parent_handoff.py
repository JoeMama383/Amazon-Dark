...
with tempfile.TemporaryDirectory(prefix='ad7412-parent-handoff-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.411-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.411-permission-firstpaint-owner-fix'}))
...
print('PASS: v7.412 helper accepts exact direct-parent v7.411 receipt')
