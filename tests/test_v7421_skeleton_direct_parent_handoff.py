...
with tempfile.TemporaryDirectory(prefix='ad-v7421-parent-') as td:
    ...
    arm=amazon/'AmazonDark-v7.431-probe.arm'; launch=root/'AmazonDark-launch-probe.arm'
...
print('PASS: v7.431 transition helper accepts the direct-parent v7.420 receipt and arms current-version probe paths')
