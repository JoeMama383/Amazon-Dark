...
with tempfile.TemporaryDirectory(prefix='ad-v7419-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.418-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.418-payment-giftcard-switch-cleanup'}))
...
print('PASS: v7.419 transition helper accepts the direct-parent v7.418 receipt and arms current-version probe paths')
