...
# v7.460 corrects the mistaken no-scroll diagnosis: verify modal unlock first.
...
print('PASS: v7.460 routes Product Detail through manual read-only checkpoints and preserves automatic FULL elsewhere')
