...
# v7.458 corrects the mistaken no-scroll diagnosis: verify modal unlock first.
...
print('PASS: v7.458 routes Product Detail through manual read-only checkpoints and preserves automatic FULL elsewhere')
