...
# v7.457 corrects the mistaken no-scroll diagnosis: verify modal unlock first.
...
print('PASS: v7.457 routes Product Detail through manual read-only checkpoints and preserves automatic FULL elsewhere')
