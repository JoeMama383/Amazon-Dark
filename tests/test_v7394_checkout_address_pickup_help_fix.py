...
assert 'VER=7.420' in UI and 'AD_PROBE_VERSION=7.420' in SK and 'AD_PROBE_NAME=AmazonDark-v7.420' in SK
assert 'AMAZONDARK v7.420 UNIVERSAL' in INC
assert "version:'7.420'" in JSINC
