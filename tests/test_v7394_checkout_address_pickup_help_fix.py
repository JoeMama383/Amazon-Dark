...
assert 'VER=7.408' in UI and 'AD_PROBE_VERSION=7.408' in SK and 'AD_PROBE_NAME=AmazonDark-v7.408' in SK
assert 'AMAZONDARK v7.408 UNIVERSAL' in INC
assert "version:'7.408'" in JSINC
