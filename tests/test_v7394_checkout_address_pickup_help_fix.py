...
assert 'VER=7.405' in UI and 'AD_PROBE_VERSION=7.405' in SK and 'AD_PROBE_NAME=AmazonDark-v7.405' in SK
assert 'AMAZONDARK v7.405 UNIVERSAL' in INC
assert "version:'7.405'" in JSINC
