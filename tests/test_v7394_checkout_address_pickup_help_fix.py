...
assert 'VER=7.406' in UI and 'AD_PROBE_VERSION=7.406' in SK and 'AD_PROBE_NAME=AmazonDark-v7.406' in SK
assert 'AMAZONDARK v7.406 UNIVERSAL' in INC
assert "version:'7.406'" in JSINC
