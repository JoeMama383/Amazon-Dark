...
with tempfile.TemporaryDirectory(prefix='ad-v7420-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.419-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.419-payment-giftcard-art-input-fill'}))
...
print('PASS: v7.420 transition helper accepts the direct-parent v7.419 receipt and arms current-version probe paths')
