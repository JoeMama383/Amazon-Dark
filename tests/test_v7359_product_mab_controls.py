...
assert 'Version: 7.370~checkout-script-reinstall-theme' in ctl
assert '#define AD_VERSION "v7.370-checkout-script-reinstall-theme"' in t
...
assert '#search .mlt-icon-container{background:#303335!important;background-color:#303335!important;background-image:none!important;border:1px solid #747a7c!important' in t
assert '#search .mlt-icon-container img.s-image{background:transparent!important;background-color:transparent!important;filter:brightness(0) invert(1) brightness(.91)!important' in t
