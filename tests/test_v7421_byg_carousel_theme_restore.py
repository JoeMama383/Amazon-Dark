...
assert 'VER=7.437' in UI and 'AD_PROBE_VERSION=7.437' in SK and 'AD_PROBE_NAME=AmazonDark-v7.437' in SK
assert 'AMAZONDARK v7.437 UNIVERSAL' in INC and 'AmazonDark-v7.437-ui-viewport.arm' in INC and "version:'7.437'" in JS
assert 'in 7.437~*)' in SK and 'Install the v7.437 Actions package first.' in SK
