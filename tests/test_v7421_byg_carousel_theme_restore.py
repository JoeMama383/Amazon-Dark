...
assert 'VER=7.454' in UI and 'AD_PROBE_VERSION=7.454' in SK and 'AD_PROBE_NAME=AmazonDark-v7.454' in SK
assert 'AMAZONDARK v7.454 UNIVERSAL' in INC and 'AmazonDark-v7.454-ui-viewport.arm' in INC and "version:'7.454'" in JS
assert 'in 7.454~*)' in SK and 'Install the v7.454 Actions package first.' in SK
