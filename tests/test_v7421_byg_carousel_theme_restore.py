...
assert 'VER=7.440' in UI and 'AD_PROBE_VERSION=7.440' in SK and 'AD_PROBE_NAME=AmazonDark-v7.440' in SK
assert 'AMAZONDARK v7.440 UNIVERSAL' in INC and 'AmazonDark-v7.440-ui-viewport.arm' in INC and "version:'7.440'" in JS
assert 'in 7.440~*)' in SK and 'Install the v7.440 Actions package first.' in SK
