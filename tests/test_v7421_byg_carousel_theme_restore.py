...
assert 'VER=7.442' in UI and 'AD_PROBE_VERSION=7.442' in SK and 'AD_PROBE_NAME=AmazonDark-v7.442' in SK
assert 'AMAZONDARK v7.442 UNIVERSAL' in INC and 'AmazonDark-v7.442-ui-viewport.arm' in INC and "version:'7.442'" in JS
assert 'in 7.442~*)' in SK and 'Install the v7.442 Actions package first.' in SK
