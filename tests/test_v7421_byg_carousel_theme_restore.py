...
assert 'VER=7.424' in UI and 'AD_PROBE_VERSION=7.424' in SK and 'AD_PROBE_NAME=AmazonDark-v7.424' in SK
assert 'AMAZONDARK v7.424 UNIVERSAL' in INC and 'AmazonDark-v7.424-ui-viewport.arm' in INC and "version:'7.424'" in JS
assert 'in 7.424~*)' in SK and 'Install the v7.424 Actions package first.' in SK
print('PASS: v7.424 restores the speed-BYG carousel shell and semantic gray/white add-to-cart controls while retaining the old dense-grid path')
