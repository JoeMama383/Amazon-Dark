...
assert 'VER=7.438' in UI and 'AD_PROBE_VERSION=7.438' in SK and 'AD_PROBE_NAME=AmazonDark-v7.438' in SK
assert 'AMAZONDARK v7.438 UNIVERSAL' in INC and 'AmazonDark-v7.438-ui-viewport.arm' in INC and "version:'7.438'" in JS
assert 'in 7.438~*)' in SK and 'Install the v7.438 Actions package first.' in SK
