...
assert 'VER=7.435' in UI and 'AD_PROBE_VERSION=7.435' in SK and 'AD_PROBE_NAME=AmazonDark-v7.435' in SK
assert 'AMAZONDARK v7.435 UNIVERSAL' in INC and 'AmazonDark-v7.435-ui-viewport.arm' in INC and "version:'7.435'" in JS
assert 'in 7.435~*)' in SK and 'Install the v7.435 Actions package first.' in SK
