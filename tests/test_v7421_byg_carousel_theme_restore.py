...
assert 'AMAZONDARK v7.457 UNIVERSAL' in INC and 'AmazonDark-v7.457-ui-viewport.arm' in INC and "version:'7.457'" in JS
assert 'in 7.457~*)' in SK and 'Install the v7.457 Actions package first.' in SK
