...
assert 'VER=7.460' in UI and 'AD_PROBE_VERSION=7.460' in SK and 'AD_PROBE_NAME=AmazonDark-v7.460' in SK
assert 'AMAZONDARK v7.460 UNIVERSAL' in INC and 'AmazonDark-v7.460-ui-viewport.arm' in INC and "version:'7.460'" in JS
assert 'in 7.460~*)' in SK and 'Install the v7.460 Actions package first.' in SK
