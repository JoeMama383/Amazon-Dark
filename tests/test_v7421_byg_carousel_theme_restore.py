...
assert 'AMAZONDARK v7.444 UNIVERSAL' in INC and 'AmazonDark-v7.444-ui-viewport.arm' in INC and "version:'7.444'" in JS
assert 'in 7.444~*)' in SK and 'Install the v7.444 Actions package first.' in SK
