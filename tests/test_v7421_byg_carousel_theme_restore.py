...
assert 'AMAZONDARK v7.447 UNIVERSAL' in INC and 'AmazonDark-v7.447-ui-viewport.arm' in INC and "version:'7.447'" in JS
assert 'in 7.447~*)' in SK and 'Install the v7.447 Actions package first.' in SK
