...
assert 'VER=7.453' in UI and 'AD_PROBE_VERSION=7.453' in SK and 'AD_PROBE_NAME=AmazonDark-v7.453' in SK
assert 'AMAZONDARK v7.453 UNIVERSAL' in INC and 'AmazonDark-v7.453-ui-viewport.arm' in INC and "version:'7.453'" in JS
assert 'in 7.453~*)' in SK and 'Install the v7.453 Actions package first.' in SK
