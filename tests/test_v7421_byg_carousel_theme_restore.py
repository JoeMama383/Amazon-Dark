...
assert 'VER=7.439' in UI and 'AD_PROBE_VERSION=7.439' in SK and 'AD_PROBE_NAME=AmazonDark-v7.439' in SK
assert 'AMAZONDARK v7.439 UNIVERSAL' in INC and 'AmazonDark-v7.439-ui-viewport.arm' in INC and "version:'7.439'" in JS
assert 'in 7.439~*)' in SK and 'Install the v7.439 Actions package first.' in SK
