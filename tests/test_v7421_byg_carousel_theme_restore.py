...
assert 'VER=7.441' in UI and 'AD_PROBE_VERSION=7.441' in SK and 'AD_PROBE_NAME=AmazonDark-v7.441' in SK
assert 'AMAZONDARK v7.441 UNIVERSAL' in INC and 'AmazonDark-v7.441-ui-viewport.arm' in INC and "version:'7.441'" in JS
assert 'in 7.441~*)' in SK and 'Install the v7.441 Actions package first.' in SK
