...
assert 'VER=7.423' in UI and 'AD_PROBE_VERSION=7.423' in SK and 'AD_PROBE_NAME=AmazonDark-v7.423' in SK
assert 'AMAZONDARK v7.423 UNIVERSAL' in INC and 'AmazonDark-v7.423-ui-viewport.arm' in INC and "version:'7.423'" in JS
assert 'in 7.423~*)' in SK and 'Install the v7.423 Actions package first.' in SK
print('PASS: v7.423 restores the speed-BYG carousel shell and semantic gray/white add-to-cart controls while retaining the old dense-grid path')
