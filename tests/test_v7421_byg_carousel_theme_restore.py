...
assert 'VER=7.429' in UI and 'AD_PROBE_VERSION=7.429' in SK and 'AD_PROBE_NAME=AmazonDark-v7.429' in SK
assert 'AMAZONDARK v7.429 UNIVERSAL' in INC and 'AmazonDark-v7.429-ui-viewport.arm' in INC and "version:'7.429'" in JS
assert 'in 7.429~*)' in SK and 'Install the v7.429 Actions package first.' in SK
print('PASS: v7.429 restores the speed-BYG carousel shell and semantic gray/white add-to-cart controls while retaining the old dense-grid path')
