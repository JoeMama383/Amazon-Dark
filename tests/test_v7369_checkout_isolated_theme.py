...
assert 'Version: 7.439~pdp-ui-completion' in CTRL
...
# v7.417/v7.418 intentionally add only a narrow Search caption fallback and switch-outline cleanup to the shared floor.
