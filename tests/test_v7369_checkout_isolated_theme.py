...
assert 'Version: 7.384~sponsored-logos-build-fix' in CTRL
...
# Critical shared theming programs remain stable; v7.384 changes only the core concatenation to append the tiny Home ad-shell floor.
