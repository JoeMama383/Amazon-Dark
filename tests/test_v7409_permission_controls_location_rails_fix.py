...
assert 'VER=7.409' in UI and 'AD_PROBE_VERSION=7.409' in SK and 'AD_PROBE_NAME=AmazonDark-v7.409' in SK
...
for tok in ['RCTScrollView','0.89','0.94','fabs(xr.size.height-vr.size.height)<=8.0','v.clipsToBounds','v.subviews.count!=1']:
