...
with tempfile.TemporaryDirectory(prefix='ad7410-parent-handoff-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.409-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.409-permission-controls-location-rails-fix'}))
...
print('PASS: v7.410 skeleton helper discovers Amazon from exact direct-parent v7.409 receipt')
