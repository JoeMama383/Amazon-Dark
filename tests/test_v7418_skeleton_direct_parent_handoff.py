...
with tempfile.TemporaryDirectory(prefix='ad-v7418-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.416-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.416-location-canonical-owner'}))
...
print('PASS: v7.418 transition helper accepts the direct-parent v7.416 receipt and arms current-version probe paths')
