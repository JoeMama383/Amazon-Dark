...
for strength in [0,100]:
 ...
 assert 'Version: 7.450~pdp-readonly-full' in (R/'layout/DEBIAN/control').read_text()
print('PASS: v7.450 executes media styles at both strength bounds; wrapper blending releases loaded images and only artwork receives dimming')
