...
for strength in [0,100]:
 ...
 assert 'Version: 7.449~full-probe-nonblocking' in (R/'layout/DEBIAN/control').read_text()
print('PASS: v7.449 executes media styles at both strength bounds; wrapper blending releases loaded images and only artwork receives dimming')
