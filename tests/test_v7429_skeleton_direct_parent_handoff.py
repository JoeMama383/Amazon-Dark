...
with tempfile.TemporaryDirectory(prefix='ad-v7429-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.428-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.428-pdp-media-native-icon-fix'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.428 receipt and arms current-version probe paths')
