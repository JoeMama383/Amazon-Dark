...
with tempfile.TemporaryDirectory(prefix='ad7401-parent-handoff-') as td:
    ...
    arm=amazon/'AmazonDark-v7.401-probe.arm'; launch=root/'AmazonDark-launch-probe.arm'
...
print('PASS: v7.401 skeleton helper discovers Amazon from exact direct-parent v7.400 receipt with metadata/plutil unavailable')
