...
def main():
    ...
    assert 'AmazonDark-v7.373-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.373' in control
    print("PASS: native capture uses app Documents; v7.366 helper identity agrees")
