...
def main():
    ...
    assert 'AmazonDark-v7.363-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.363' in control
    print("PASS: native capture uses app Documents; v7.362 helper identity agrees")
