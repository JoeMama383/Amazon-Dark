...
def main():
    ...
    assert 'AmazonDark-v7.355-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.355' in control
    print("PASS: native capture uses app Documents; v7.355 helper identity agrees")
