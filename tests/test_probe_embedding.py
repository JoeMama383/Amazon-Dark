...
def main():
    ...
    assert 'AmazonDark-v7.348-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.348' in control
    print("PASS: native capture uses app Documents; v7.348 helper identity agrees")
