...
def main():
    ...
    assert 'AmazonDark-v7.353-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.353' in control
    print("PASS: native capture uses app Documents; v7.353 helper identity agrees")
