...
def main():
    ...
    assert 'AmazonDark-v7.368-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.368' in control
    print("PASS: native capture uses app Documents; v7.368 helper identity agrees")
