...
def main():
    ...
    assert 'AmazonDark-v7.351-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.351' in control
    print("PASS: native capture uses app Documents; v7.351 helper identity agrees")
