...
def main():
    ...
    assert 'AmazonDark-v7.352-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.352' in control
    print("PASS: native capture uses app Documents; v7.352 helper identity agrees")
