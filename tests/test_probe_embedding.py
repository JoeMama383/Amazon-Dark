...
def main():
    ...
    assert 'AmazonDark-v7.358-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.358' in control
    print("PASS: native capture uses app Documents; v7.358 helper identity agrees")
