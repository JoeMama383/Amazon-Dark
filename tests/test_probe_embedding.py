...
def main():
    ...
    assert 'AmazonDark-v7.365-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.365' in control
    print("PASS: native capture uses app Documents; v7.365 helper identity agrees")
