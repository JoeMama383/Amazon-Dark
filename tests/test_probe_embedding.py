...
def main():
    ...
    assert 'AmazonDark-v7.361-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.361' in control
    print("PASS: native capture uses app Documents; v7.360 helper identity agrees")
