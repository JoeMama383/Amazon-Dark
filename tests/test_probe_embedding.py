...
def main():
    ...
    assert 'AmazonDark-v7.364-probe.arm' in native
    assert 'AD_PROBE_NAME=AmazonDark-v7.364' in control
    print("PASS: native capture uses app Documents; v7.364 helper identity agrees")
