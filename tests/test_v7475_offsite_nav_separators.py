...
for t in ('static void ADHideThinBarHairlines7475(UIView *v){','%hook ANXTabBarView','%hook UITabBar','ADHideThinBarHairlines7475(v);','- (void)layoutSubviews {'):
    assert t in S,t
# v7.477 intentionally retires the v7.475 broad offsite wrapper and wrong mshop geometry experiments.
...
print('PASS: v7.477 retains v7.475 lifecycle ownership while retiring its two probe-disproven broad selectors')
