...
assert 'VER=7.406' in UI
assert 'AD_PROBE_VERSION=7.406' in SK and 'AD_PROBE_NAME=AmazonDark-v7.406' in SK
assert 'AMAZONDARK v7.406 UNIVERSAL' in INC and 'AmazonDark-v7.406-ui-viewport.arm' in INC
assert "version:'7.406'" in JS
print('PASS: v7.406 keeps one video+copy border while restoring the authored Sponsored footer and regenerates all probes')
