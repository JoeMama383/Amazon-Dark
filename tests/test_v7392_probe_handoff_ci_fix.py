...
assert '#define AD_VERSION "v7.427-native-ai-results-oled"' in T
assert 'AD_PROBE_VERSION=7.427' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.427' in S
assert 'VER=7.427' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.427-probe.arm' in H and 'AmazonDark-v7.427-probe-status.json' in H
assert 'AMAZONDARK v7.427 UNIVERSAL' in INC and 'AmazonDark-v7.427-ui-viewport.arm' in INC
assert 'AmazonDark-v7.427-launch-sb-probe.txt' in SB
