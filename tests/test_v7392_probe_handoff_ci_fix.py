...
assert 'AD_PROBE_VERSION=7.447' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.447' in S
assert 'VER=7.447' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.447-probe.arm' in H and 'AmazonDark-v7.447-probe-status.json' in H
