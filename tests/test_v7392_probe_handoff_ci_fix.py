...
assert '#define AD_VERSION "v7.423-cart-message-banner-fix"' in T
assert 'AD_PROBE_VERSION=7.423' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.423' in S
assert 'VER=7.423' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.423-probe.arm' in H and 'AmazonDark-v7.423-probe-status.json' in H
assert 'AMAZONDARK v7.423 UNIVERSAL' in INC and 'AmazonDark-v7.423-ui-viewport.arm' in INC
assert 'AmazonDark-v7.423-launch-sb-probe.txt' in SB
