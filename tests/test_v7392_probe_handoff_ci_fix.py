...
assert 'AD_PROBE_VERSION=7.460' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.460' in S
assert 'VER=7.460' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.460-probe.arm' in H and 'AmazonDark-v7.460-probe-status.json' in H
assert 'AMAZONDARK v7.460 UNIVERSAL' in INC and 'AmazonDark-v7.460-ui-viewport.arm' in INC
assert 'AmazonDark-v7.460-launch-sb-probe.txt' in SB
