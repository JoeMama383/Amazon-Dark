...
assert '#define AD_VERSION "v7.441-pdp-site-isolated-frames"' in T
assert 'AD_PROBE_VERSION=7.441' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.441' in S
assert 'VER=7.441' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.441-probe.arm' in H and 'AmazonDark-v7.441-probe-status.json' in H
assert 'AMAZONDARK v7.441 UNIVERSAL' in INC and 'AmazonDark-v7.441-ui-viewport.arm' in INC
assert 'AmazonDark-v7.441-launch-sb-probe.txt' in SB
