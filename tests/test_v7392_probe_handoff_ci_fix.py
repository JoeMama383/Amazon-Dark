...
assert '#define AD_VERSION "v7.408-permission-location-switcher-hardening"' in T
assert 'AD_PROBE_VERSION=7.408' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.408' in S
assert 'VER=7.408' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.408-probe.arm' in H and 'AmazonDark-v7.408-probe-status.json' in H
assert 'AMAZONDARK v7.408 UNIVERSAL' in INC and 'AmazonDark-v7.408-ui-viewport.arm' in INC
assert 'AmazonDark-v7.408-launch-sb-probe.txt' in SB
