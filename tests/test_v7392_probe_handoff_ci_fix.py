...
assert 'AD_PROBE_VERSION=7.420' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.420' in S
assert 'VER=7.420' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.420-probe.arm' in H and 'AmazonDark-v7.420-probe-status.json' in H
assert 'AMAZONDARK v7.420 UNIVERSAL' in INC and 'AmazonDark-v7.420-ui-viewport.arm' in INC
assert 'AmazonDark-v7.420-launch-sb-probe.txt' in SB
