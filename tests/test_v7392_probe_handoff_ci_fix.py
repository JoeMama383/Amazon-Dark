...
assert 'AD_PROBE_VERSION=7.403' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.403' in S
assert 'VER=7.403' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.403-probe.arm' in H and 'AmazonDark-v7.403-probe-status.json' in H
assert 'AMAZONDARK v7.403 UNIVERSAL' in INC and 'AmazonDark-v7.403-ui-viewport.arm' in INC
assert 'AmazonDark-v7.403-launch-sb-probe.txt' in SB
