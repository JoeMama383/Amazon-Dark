...
assert '#define AD_VERSION "v7.424-native-header-oled-fix"' in T
assert 'AD_PROBE_VERSION=7.424' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.424' in S
assert 'VER=7.424' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.424-probe.arm' in H and 'AmazonDark-v7.424-probe-status.json' in H
assert 'AMAZONDARK v7.424 UNIVERSAL' in INC and 'AmazonDark-v7.424-ui-viewport.arm' in INC
assert 'AmazonDark-v7.424-launch-sb-probe.txt' in SB
