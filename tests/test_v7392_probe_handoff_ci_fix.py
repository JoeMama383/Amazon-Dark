...
assert '#define AD_VERSION "v7.395-ui-coverage-audit-fix"' in T
assert 'AD_PROBE_VERSION=7.395' in S and 'AD_PROBE_NAME=AmazonDark-v7.395' in S
assert 'VER=7.395' in U
...
assert 'AmazonDark-v7.395-probe.arm' in H and 'AmazonDark-v7.395-probe-status.json' in H
assert 'AMAZONDARK v7.395 UNIVERSAL' in INC and 'AmazonDark-v7.395-ui-viewport.arm' in INC
assert 'AmazonDark-v7.395-launch-sb-probe.txt' in SB
...
assert '[ "$AD_PROBE_RECEIPT_VER" -le 399 ]' in S
