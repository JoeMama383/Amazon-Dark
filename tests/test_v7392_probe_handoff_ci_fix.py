...
assert '#define AD_VERSION "v7.422-person-returns-medical-fix"' in T
assert 'AD_PROBE_VERSION=7.422' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.422' in S
assert 'VER=7.422' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.422-probe.arm' in H and 'AmazonDark-v7.422-probe-status.json' in H
assert 'AMAZONDARK v7.422 UNIVERSAL' in INC and 'AmazonDark-v7.422-ui-viewport.arm' in INC
assert 'AmazonDark-v7.422-launch-sb-probe.txt' in SB
