...
assert '#define AD_VERSION "v7.392-probe-handoff-ci-fix"' in T
assert 'AD_PROBE_VERSION=7.392' in S and 'AD_PROBE_NAME=AmazonDark-v7.392' in S
assert 'VER=7.392' in U
...
assert 'AmazonDark-v7.392-probe.arm' in H and 'AmazonDark-v7.392-probe-status.json' in H
assert 'AMAZONDARK v7.392 UNIVERSAL' in INC and 'AmazonDark-v7.392-ui-viewport.arm' in INC
assert 'AmazonDark-v7.392-launch-sb-probe.txt' in SB
