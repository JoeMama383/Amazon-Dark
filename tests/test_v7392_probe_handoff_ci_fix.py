...
assert '#define AD_VERSION "v7.429-compact-stripe-taming"' in T
assert 'AD_PROBE_VERSION=7.429' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.429' in S
assert 'VER=7.429' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.429-probe.arm' in H and 'AmazonDark-v7.429-probe-status.json' in H
assert 'AMAZONDARK v7.429 UNIVERSAL' in INC and 'AmazonDark-v7.429-ui-viewport.arm' in INC
assert 'AmazonDark-v7.429-launch-sb-probe.txt' in SB
