...
assert '#define AD_VERSION "v7.431-pdp-r2-r5-fix"' in T
assert 'AD_PROBE_VERSION=7.431' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.431' in S
assert 'VER=7.431' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.431-probe.arm' in H and 'AmazonDark-v7.431-probe-status.json' in H
assert 'AMAZONDARK v7.431 UNIVERSAL' in INC and 'AmazonDark-v7.431-ui-viewport.arm' in INC
assert 'AmazonDark-v7.431-launch-sb-probe.txt' in SB
