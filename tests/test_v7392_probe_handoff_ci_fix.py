...
assert '#define AD_VERSION "v7.448-performance-consolidation"' in T
assert 'AD_PROBE_VERSION=7.448' in S and 'AD_PROBE_CUR=${AD_PROBE_VERSION#7.}' in S and 'AD_PROBE_NAME=AmazonDark-v7.448' in S
assert 'VER=7.448' in U and 'CUR=${VER#7.}' in U
...
assert 'AmazonDark-v7.448-probe.arm' in H and 'AmazonDark-v7.448-probe-status.json' in H
