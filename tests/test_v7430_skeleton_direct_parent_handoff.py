...
with tempfile.TemporaryDirectory(prefix='ad-v7430-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.429-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.429-compact-stripe-taming'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.429 receipt and arms current-version probe paths')
