...
assert 'VER=7.411' in UI and 'AD_PROBE_VERSION=7.411' in SK and 'AD_PROBE_NAME=AmazonDark-v7.411' in SK
assert 'AMAZONDARK v7.411 UNIVERSAL' in INC and 'AmazonDark-v7.411-ui-viewport.arm' in INC
assert "version:'7.411'" in JS
...
assert 'if(gP.enabled&&ADPermissionButtonText7409((UIView *)self))' in paragraph
