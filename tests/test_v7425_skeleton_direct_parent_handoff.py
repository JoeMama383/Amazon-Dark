...
with tempfile.TemporaryDirectory(prefix='ad-v7425-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.424-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.424-native-header-oled-fix'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.424 receipt and arms current-version probe paths')
