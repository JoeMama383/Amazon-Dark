...
with tempfile.TemporaryDirectory(prefix='ad-v7428-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.427-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.427-native-ai-results-oled'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.427 receipt and arms current-version probe paths')
