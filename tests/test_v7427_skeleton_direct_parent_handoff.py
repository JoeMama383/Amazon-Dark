...
with tempfile.TemporaryDirectory(prefix='ad-v7427-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.426-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.426-pdp-oled-attach-sheet-fix'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.426 receipt and arms current-version probe paths')
