...
with tempfile.TemporaryDirectory(prefix='ad7403-parent-handoff-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.402-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.402-payment-first-paint-switcher-fix'}))
...
print('PASS: v7.403 skeleton helper discovers Amazon from exact direct-parent v7.402 receipt with metadata/plutil unavailable')
