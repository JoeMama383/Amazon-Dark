...
with tempfile.TemporaryDirectory(prefix='ad7405-parent-handoff-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.404-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.404-product-scroll-video-alexa-polish'}))
...
print('PASS: inherited v7.405 skeleton helper discovers Amazon from exact direct-parent v7.404 receipt')
