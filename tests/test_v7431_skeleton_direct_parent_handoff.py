...
with tempfile.TemporaryDirectory(prefix='ad-v7431-parent-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.430-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.430-native-review-menu'}))
...
print('PASS: v7.437 transition helper accepts the direct-parent v7.430 receipt and arms current-version probe paths')
