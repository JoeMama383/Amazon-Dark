...
hero="""#gwm-dashboard [class*='_single-video-card_style_sponsored-label-pill__']{background:rgba(0,0,0,.6)!important;background-color:rgba(0,0,0,.6)!important;}"""
assert hero in T
...
print('PASS: v7.459 makes VIEWPORT single-pass/terminal-safe and flips the exact home hero sponsored pill to black at the same alpha')
