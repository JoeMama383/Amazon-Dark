...
with tempfile.TemporaryDirectory(prefix='ad7413-parent-handoff-') as td:
    ...
    receipt=amazon/'AmazonDark-v7.412-probe-status.json'
    receipt.write_text(json.dumps({'event':'PROBE_BOOTSTRAP','bundle':'com.amazon.Amazon','version':'v7.412-address-location-aux-theme'}))
...
print('PASS: v7.413 helper accepts exact direct-parent v7.412 receipt')
