...
floor=S[S.index('static NSString *ADHomeAdShellFloorJS7381(void)'):S.index('// v7.387: Sponsored-content filtering follows AmznKiller')]
...
# v7.387 intentionally removes the v7.381 broad ancestor promotion that could
...
print('PASS: v7.387 OLED ad loading floor retained; broad outer-slot sponsored promotion removed')
