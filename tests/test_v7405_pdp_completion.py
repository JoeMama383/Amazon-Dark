...
assert '@"%@%@%@%@%@%@%@%@%@%@%@"' in core  # 11 appended programs; do not silently drop PDP TWB
...
assert 'VER=7.405' in UI
assert 'AD_PROBE_VERSION=7.405' in SK and 'AD_PROBE_NAME=AmazonDark-v7.405' in SK
assert 'AMAZONDARK v7.405 UNIVERSAL' in INC and 'AmazonDark-v7.405-ui-viewport.arm' in INC
assert "version:'7.405'" in JS
print('PASS: v7.405 completes probe-backed PDP floors/text/controls/media/share/pagination/top-ad treatment and regenerates all probes')
