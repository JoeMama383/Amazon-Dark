...
# Core integration retains the existing programs and v7.439 completion while v7.452 adds main-residual + frame-owner triggers with no recurring machinery.
core=S.split('static NSString *ADCoreWebJS7271(void){',1)[1].split('static WKUserScript *ADSharedUserScript7387',1)[0]
assert '@"%@%@%@%@%@%@%@%@%@%@%@%@%@%@%@%@"' in core  # v7.452 appends two event-driven programs, for 16 total
