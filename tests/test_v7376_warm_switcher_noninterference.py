...
owner=S[S.index('static void ADOwnAmazonSplash7376'):S.index('%hook AXUSplashScreenViewController')]
...
assert 'ADOwnAmazonSplash7376(self);' in hooks
...
print('PASS: v7.376 restores warm/app-switcher non-interference and leaves cold exact-splash theming intact')
