...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "rk-(?:unfill|fill)/i.test(c))sc+=100;if(/01rrzVoKd5L|01rrz/i.test(src))sc+=100;if(/lists-framework/i.test(c)&&/(icon|image|add|list|action|button)/i.test(c))sc+=55;else if(/cards|two-card|list|add|plus|action/i.test(c))sc+=34;if(/^(IMG|I|SVG|PATH|USE|POLYGON)$/.test(tg))sc+=10;if(bi!=='none'||mi!=='none')sc+=12;if(pb||pa)sc+=10;if(/checkbox|heart|wish|favorite|chevron|arrow|caret/i.test(c+' '+src))sc-=100;return sc;}function squareHost(root,g){var p=g,b=null,bd=1e9,u=0;while(p&&u++<7){if(!cb(p)){var r=rr(p),tg=String(p.tagName||'').toUpperCase();if(r&&!/^(IMG|I|INPUT|SVG|PATH|USE|POLYGON)$/.test(tg)&&r.width>=24&&r.width<=56&&r.height>=24&&r.height<=56&&Math.abs(r.width-r.height)<=10&&!ovr("
         "p)){var d=Math.abs(Math.max(r.width,r.height)-36);if(d<bd){bd=d;b=p;}}}if(p===root)break;p=p.parentElement;}return b;}function markGlyph(g){if(!g||cb(g))return 0;var tg=String(g.tagName||'').toUpperCase(),cs=getComputedStyle(g),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none'),pb=pseudo(g,'::before'),pa=pseudo(g,'::after'),n=0;g.setAttribute('data-ad-cards409-glyph','1');g.style.setProperty('position','relative','important');g.style.setProperty('z-index','2','important');g.style.setProperty('visibility','visible','important');g.style.setProperty('opacity','1','important');if(/^(SVG|PATH|USE|POLYGON)$/.test(tg)){g.setAttribute('data-ad-cards409-vector'"
         ",'1');n++;}else if(mi!=='none'){g.setAttribute('data-ad-cards409-mask','1');n++;}else if(tg==='IMG'||tg==='I'||bi!=='none'){g.setAttribute('data-ad-cards409-raster','1');n++;}if(pb){g.setAttribute('data-ad-cards409-before',pb);n++;}if(pa){g.setAttribute('data-ad-cards409-after',pa);n++;}return n;}function suppress(g){if(!g)return;g.setAttribute('data-ad-cards409-suppressed','1');}function unsuppress(g){if(g)g.removeAttribute('data-ad-cards409-suppressed');}var R=document.querySelectorAll('[class*=lists-framework-action-button]'),roots=0,seeds=0,hosts=0,discs=0,glyphs=0,miss=0,cbskip=0,ovskip=0,hidden=0,live=[];for(var ri=0;ri<R.length&&ri<140;ri++){var root=R[ri];if(cb(root)){cbskip++;co"
         "ntinue;}var A=[root],Q=root.querySelectorAll('*');for(var qi=0;qi<Q.length&&qi<180;qi++)A.push(Q[qi]);var best=null,bs=-1;for(var ai=0;ai<A.length&&ai<181;ai++){var sc=strong(A[ai]);if(sc>bs){bs=sc;best=A[ai];}}if(!best||bs<30){miss++;continue;}seeds++;var gr=rr(best);if(!gr){miss++;continue;}var gx=gr.left+gr.width/2,gy=gr.top+gr.height/2;if(ovxy(gx,gy)||ovr(best)){if(bs>=80){suppress(best);hidden++;}ovskip++;continue;}unsuppress(best);roots++;live.push(root);var h=squareHost(root,best);if(h){h.setAttribute('data-ad-cards409-host','1');h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('background-image','none','important');h.style.setProperty('border-radius',"
         "'50%%','important');h.style.setProperty('border','1.5px solid rgba(255,255,255,.65)','important');h.style.setProperty('box-shadow','none','important');h.style.setProperty('box-sizing','border-box','important');hosts++;}else{var rr0=rr(root);if(!rr0){miss++;continue;}root.setAttribute('data-ad-cards409-root','1');root.style.setProperty('position','relative','important');root.style.setProperty('overflow','visible','important');var d=root.querySelector(':scope > [data-ad-cards409-disc]');if(!d){d=document.createElement('span');d.setAttribute('data-ad-cards409-disc','1');d.setAttribute('aria-hidden','true');root.insertBefore(d,root.firstChild);}var relx=gx-rr0.left,rely=gy-rr0.top;d.style.setProp"
         "erty('left',(relx-18)+'px','important');d.style.setProperty('top',(rely-18)+'px','important');discs++;}glyphs+=markGlyph(best);}var OD=document.querySelectorAll('[data-ad-cards409-disc]');for(var oi=0;oi<OD.length;oi++){var pr=OD[oi].parentElement;if(!pr||live.indexOf(pr)<0){if(OD[oi].parentNode)OD[oi].parentNode.removeChild(OD[oi]);}}window.__AD_CARDS409_STATE__='roots='+R.length+' seeds='+seeds+' owned='+roots+' hosts='+hosts+' discs='+discs+' glyph='+glyphs+' hiddenOverlap='+hidden+' miss='+miss+' cbskip='+cbskip+' ovskip='+ovskip;return roots;}catch(e){window.__AD_CARDS409_STATE__='err '+(e&&e.message||e);return -1;}};try{if(document&&!document.getElementById('adcards409')){var c=doc"
         "ument.createElement('style');c.id='adcards409';c.textContent='[data-ad-cards409-host]{background-color:#181a1b !important;background-image:none !important;border-radius:50%% !important;border:1.5px solid rgba(255,255,255,.65) !important;box-shadow:none !important;box-sizing:border-box !important;}[data-ad-cards409-disc]{position:absolute !important;width:36px !important;height:36px !important;border-radius:50%% !important;background:#181a1b !important;border:1.5px solid rgba(255,255,255,.65) !important;box-shadow:none !important;box-sizing:border-box !important;pointer-events:none !important;z-index:0 !important;}[data-ad-cards409-glyph]{background-color:transparent !important;}[data-ad-cards4"
         "09-raster]{filter:brightness(0) invert(1) !important;background-color:transparent !important;opacity:1 !important;visibility:visible !important;}[data-ad-cards409-mask]{background-color:#fff !important;color:#fff !important;opacity:1 !important;visibility:visible !important;}[data-ad-cards409-vector],[data-ad-cards409-vector] *{color:#fff !important;fill:#fff !important;stroke:#fff !important;opacity:1 !important;visibility:visible !important;}[data-ad-cards409-before=\"raster\"]::before,[data-ad-cards409-after=\"raster\"]::after{filter:brightness(0) invert(1) !important;}[data-ad-cards409-before=\"mask\"]::before,[data-ad-cards409-after=\"mask\"]::after{background-color:#fff !important;color:#fff !"
         "important;}[data-ad-cards409-before=\"ink\"]::before,[data-ad-cards409-after=\"ink\"]::after{color:#fff !important;border-color:#fff !important;}[data-ad-cards409-suppressed]{visibility:hidden !important;opacity:0 !important;}[data-ad-cards409-suppressed]::before,[data-ad-cards409-suppressed]::after{visibility:hidden !important;opacity:0 !important;}';(document.head||document.documentElement).appendChild(c);}}catch(e){}try{window.__AD_PRODUCTCTRL391_PRE409__=window.__AD_PRODUCTCTRL391RUN__;window.__AD_PRODUCTCTRL391RUN__=function(){var r=window.__AD_PRODUCTCTRL391_PRE409__?window.__AD_PRODUCTCTRL391_PRE409__():0;try{window.__AD_CARDS409__();}catch(x){}return r;};}catch(e){}try{window.__AD_CARD"
         "S409__();setTimeout(window.__AD_CARDS409__,60);setTimeout(window.__AD_CARDS409__,300);setTimeout(window.__AD_CARDS409__,1200);}catch(e){}"
         ...
         // v5.409 therefore owns only the existing square descendant host selected above.
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // P78CARDS409: current-DOM stock glyph plus existing-host/backdrop-only ownership.
       "try{var H=document.querySelectorAll('[data-ad-cards409-host],[data-ad-cards409-disc]'),n=H.length,bg=0,ring=0,shape=0,glyph=0,cb=0,ov=0,Q=[],X=document.querySelectorAll('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[class*=a-icon-checkbox],[data-ad-compare380],[data-ad-comparelegacy387]');function c(e){var r=e.getBoundingClientRect();return [r.left+r.width/2,r.top+r.height/2,r.width,r.height];}for(var i=0;i<H.length&&i<80;i++){var e=H[i],r=e.getBoundingClientRect(),s=getComputedStyle(e),bc=String(s.backgroundColor||'').replace(/\\s+/g,''),bw=parseFloat(s.borderTopWidth||'0'),br=parseFloat(s.borderTopLeftRadius||'0');if(e.closest&&e.closest('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[class*=a-icon-checkbox],[data-ad-compare380],[data-ad-comparelegacy387]'))cb++;if(bc!=='rgb(24,26,27)'&&bc!=='rgba(24,26,27,1)')bg++;if(Math.abs(bw-1.5)>.26)ring++;if(br<Math.min(r.width,r.height)*.40)shape++;var cc=c(e);for(var x=0;x<X.length&&x<300;x++){var xc=c(X"
       "[x]);if(xc[2]<8||xc[3]<8||xc[2]>64||xc[3]>64)continue;if(Math.abs(cc[0]-xc[0])<18&&Math.abs(cc[1]-xc[1])<18){ov++;break;}}if(Q.length<8)Q.push((e.hasAttribute('data-ad-cards409-disc')?'D':'H')+'@'+Math.round(r.width)+'x'+Math.round(r.height)+'|bg='+bc+'|bw='+bw);}var G=document.querySelectorAll('[data-ad-cards409-glyph]'),good=0;for(var g=0;g<G.length;g++){var z=G[g],zs=getComputedStyle(z),f=String(zs.filter||''),ink=String(zs.color||'')+'|'+String(zs.fill||'')+'|'+String(zs.backgroundColor||'');if(f.indexOf('invert')>=0||/rgb\\(255,\\s*255,\\s*255\\)|#fff/i.test(ink))good++;}glyph=Math.max(0,G.length-good);out.push('P78CARDS409[n='+n+' badBg='+bg+' badRing='+ring+' badShape='+shape+' badGlyph='+glyph+' inCheckbox='+cb+' overlap='+ov+' glyphs='+G.length+' suppressed='+document.querySelectorAll('[data-ad-cards409-suppressed]').length+' disabled391='+String(window.__AD_CARDS391_DISABLED408__||0)+' state='+String(window.__AD_CARDS409_STATE__||'-')+(Q.length?' '+Q.join(' ~~ '):'')+']');}catch("
       "e){out.push('P78CARDS409[err '+(e&&e.message||e)+']');}"
