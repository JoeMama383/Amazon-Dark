...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           "window.__AMZDARK_ADTHEME__=function(){try{"
             ...
             "var strip375=window.__AD_PRODUCTSTRIP375__?window.__AD_PRODUCTSTRIP375__():0;if(strip375){var cl375=window.__AD_CLEARSTRIP374__?window.__AD_CLEARSTRIP374__():0;var in375=window.__AD_ADTEXT371__?window.__AD_ADTEXT371__():0;var tx377=window.__AD_STRIPTEXT377__?window.__AD_STRIPTEXT377__():0;var tm375=window.__AD_STRIPMEDIA374__?window.__AD_STRIPMEDIA374__():0;var sp375=window.__AD_SPON365__?window.__AD_SPON365__():0;window.__AD_STANDALONE__='strip-stock377';window.__AD_ADTHEME__='mode='+mode+' strip377=1 t377='+String(window.__AD_STRIPTEXT377_N__||0)+' d377='+String(window.__AD_STRIPTEXT377_DARK__||0)+' f377='+String(window.__AD_STRIPTEXT377_FILTERS__||0)+' full377='+String(window.__AD_STRIPTEXT377_FULL__||0)+' sticky='+String(window.__AD_STRIPCONF375__?1:0)+' strip375=1 strip376=1 first='+String(window.__AD_STRIP375_FIRSTMODE__||'-')+' clean375='+cl375+' chrome375='+String(window.__AD_STRIPCHROME374_LEFT__||0)+' ink375='+in375+' white376='+String(window.__AD_ADTEXT376_LOCKED__||0)+' grayleft376='+String(window.__AD_ADTEXT376_GRAYLEFT__||0)+' media375='+String(window.__AD_STRIPMEDIA374_N__||0)+' fullSkip375='+String(window.__AD_STRIPFULL374_N__||0)+' spon='+sp375;return cl375+in375+tx377+tm375+sp375;}"
           ...
           "try{var __ad377rf=0;function __ad377raf(){if(++__ad377rf>180)return;try{if(window.__AD_STRIPCONF375__&&window.__AD_STRIPTEXT377__)window.__AD_STRIPTEXT377__();}catch(e){}requestAnimationFrame(__ad377raf);}requestAnimationFrame(__ad377raf);}catch(e){}"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
             ...
             "for(var ig=0;ig<IMGC.length&&ig<40&&((ig&15)||!ovr());ig++){var box=IMGC[ig];"
               ...
               "for(var an=0;an<alln.length&&an<150&&((an&15)||!ovr());an++){var el2=alln[an];"
                 ...
                 "if(!art&&selfArt&&(ecs.webkitMaskImage||ecs.maskImage||'none')!=='none'){"
                   "tgt.style.removeProperty('background-color');tgt.style.removeProperty('border');tgt.style.removeProperty('box-shadow');}"
         ...
         "function _adTameFast362(root){try{if(!window.__ADTAME_ON__||!root||root.nodeType!==1)return 0;_adTameCss362();var S365=Math.max(0,Math.min(100,window.__ADTAME_S__||45)),bb365=(1-0.50*(S365/100)).toFixed(3),aa365=(0.50*(S365/100)).toFixed(3);var A=[];"
           ...
           "var bg=0;for(var z=0;z<B.length&&z<36;z++){var be=B[z],bandb=_adTameBand362(be);if(bandb<0||bandb===3||_adExploreIcon363(be)||_adNoTameGlyph367(be)){be.removeAttribute('data-ad-tame-bgfast364');if(String(be.__adBy||'').indexOf('whiteTame')===0){be.style.removeProperty('background-color');be.style.removeProperty('background-blend-mode');be.__adBy='tameSkip365';}continue;}"
         ...
         "try{window._adProductAds367=_adProductAds367;window._adCompactSponsoredInk371=_adCompactSponsoredInk371;window._adBorderFast367=_adBorderFast367;window._adExactBorder370=_adExactBorder370;window._adMosaicBorder371=_adMosaicBorder371;_adProductAds367(document.documentElement);_adCompactSponsoredInk371(document.documentElement);_adBorderFast367(document.documentElement);_adExactBorder370(document.documentElement);_adMosaicBorder371(document.documentElement);setTimeout(function(){try{_adExactBorder370(document.documentElement);_adMosaicBorder371(document.documentElement);}catch(e){}},120);setTimeout(function(){try{_adExactBorder370(document.documentElement);_adMosaicBorder371(document.documentElement);}catch(e){}},650);setTimeout(function(){try{_adExactBorder370(document.documentElement);_adMosaicBorder371(document.documentElement);}catch(e){}},1800);}catch(e){}"
         ...
         "try{var _t=null;new MutationObserver(function(muts){var structural=0;"
           "try{for(var m2=0;m2<muts.length&&m2<40;m2++){var mm2=muts[m2];if(mm2.type==='attributes'){if(mm2.target){_adTameFast362(mm2.target);_adBorderFast367(mm2.target);_adExactBorder370(mm2.target);_adMosaicBorder371(mm2.target);if(mm2.target.hasAttribute&&mm2.target.hasAttribute('data-ad-sponsored-light363'))_adSponsorPin366(mm2.target);if(mm2.target.hasAttribute&&mm2.target.hasAttribute('data-ad-reviewink367')){mm2.target.style.setProperty('color','#e8e6e3','important');mm2.target.style.setProperty('-webkit-text-fill-color','#e8e6e3','important');}}continue;}structural=1;var ad=mm2.addedNodes;for(var a2=0;a2<ad.length&&a2<20;a2++){_adPin(ad[a2]);_adTameFast362(ad[a2]);_adTextPins363(ad[a2]);if(ad[a2]&&ad[a2].nodeType===1){var tx367=String(ad[a2].textContent||'');if(tx367.length<7000&&/sponsored/i.test(tx367)){_adProductAds367(ad[a2]);_adCompactSponsoredInk371(ad[a2]);}_adBorderFast367(ad[a2]);_adExactBorder370(ad[a2]);_adMosaicBorder371(ad[a2]);}}try{_adVideoCtlMain362();}catch(e){}}}catch(e){}"
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         "function actionFix377(){try{var H=document.querySelectorAll('[class*=lists-framework-action-button]'),hosts=0,canon=0,hidden=0,skip=0;function mk(h){if(!h||h.nodeType!==1)return 0;var hr=h.getBoundingClientRect();if(hr.width<18||hr.width>64||hr.height<18||hr.height>64||Math.abs(hr.width-hr.height)>14)return 0;var lab=String(h.getAttribute&&h.getAttribute('aria-label')||h.getAttribute&&h.getAttribute('title')||'').toLowerCase();if(/heart|wish|favorite|favourite|save for later|like/.test(lab))return 0;hosts++;h.setAttribute('data-ad-actionhost376','1');h.setAttribute('data-ad-actionwhy376','list');var pos=getComputedStyle(h).position;if(pos==='static')h.style.setProperty('position','relative','important');h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('border-radius','50%%','important');h.style.setProperty('border','1.5px solid rgba(255,255,255,.65)','important');h.style.setProperty('box-shadow','none','important');h.style.setProperty('box-sizing','border-box','important');var old=h.querySelector(':scope > [data-ad-actioncanonical375]');if(old&&old.parentNode)old.parentNode.removeChild(old);var v=h.querySelector(':scope > [data-ad-actioncanonical376]');if(!v){var ns='http://www.w3.org/2000/svg';v=document.createElementNS(ns,'svg');v.setAttribute('viewBox','0 0 24 24');v.setAttribute('data-ad-actioncanonical376','1');v.setAttribute('aria-hidden','true');var back=document.createElementNS(ns,'rect');back.setAttribute('x','8.2');back.setAttribute('y','4.2');back.setAttribute('width','11.2');back.setAttribute('height','14');back.setAttribute('rx','1.8');back.setAttribute('transform','rotate(12 13.8 11.2)');var front=document.createElementNS(ns,'rect');front.setAttribute('x','4.5');front.setAttribute('y','6.3');front.setAttribute('width','11.5');front.setAttribute('height','13.2');front.setAttribute('rx','1.8');var plus=document.createElementNS(ns,'path');plus.setAttribute('d','M10.25 10v5.7M7.4 12.85h5.7');v.appendChild(back);v.appendChild(front);v.appendChild(plus);h.appendChild(v);}v.__adGlyph=1;v.__adBy='actionCanonical377';var O=h.querySelectorAll('img,picture,svg,i,[class*=icon],[class*=unfill],[class*=fill]');for(var k=0;k<O.length&&k<50;k++){var a=O[k];if(a===v||a.hasAttribute&&a.hasAttribute('data-ad-actioncanonical376')||a.closest&&a.closest('[data-ad-actioncanonical376]'))continue;a.setAttribute('data-ad-actionorig376','1');a.style.setProperty('visibility','hidden','important');a.style.setProperty('opacity','0','important');hidden++;}v.style.setProperty('visibility','visible','important');v.style.setProperty('opacity','1','important');canon++;return 1;}for(var i=0;i<H.length&&i<120;i++){if(!mk(H[i]))skip++;}window.__AD_ACTION377__='hosts='+hosts+' canonical='+canon+' hidden='+hidden+' skip='+skip;}catch(e){window.__AD_ACTION377__='err '+e;}}"
         "function compareFix377(){try{var C=document.querySelectorAll('[class*=mlt-icon-container],[class*=copilot-compare],[aria-label*=ompare],[data-csa-c-content-id*=ompare],input[type=checkbox],[role=checkbox]'),hosts=[],n=0,on=0,off=0,skip=0;function picked(h,inp){try{if(inp&&inp.checked)return true;var ac=String(h.getAttribute&&h.getAttribute('aria-checked')||'').toLowerCase(),ds=String(h.getAttribute&&h.getAttribute('data-checked')||h.getAttribute&&h.getAttribute('data-selected')||'').toLowerCase(),cl=h.className;cl=String(cl&&cl.baseVal!==undefined?cl.baseVal:(cl||'')).toLowerCase();if(ac==='true'||ds==='true'||/(^|[ _-])(checked|selected|active)([ _-]|$)/.test(cl))return true;var q=h.querySelector&&h.querySelector('input[type=checkbox]:checked,[role=checkbox][aria-checked=true],[aria-checked=true]');if(q)return true;var z=h.querySelectorAll?h.querySelectorAll('*'):[];for(var zi=0;zi<z.length&&zi<20;zi++){var bc=String(getComputedStyle(z[zi]).backgroundColor||'').replace(/ /g,'');if(bc==='rgb(33,98,161)'||bc==='rgb(35,97,161)')return true;}return false;}catch(e){return false;}}for(var i=0;i<C.length&&i<220;i++){var e=C[i],ec=e.className;ec=String(ec&&ec.baseVal!==undefined?ec.baseVal:(ec||''));var h=e;if(!/mlt-icon-container/i.test(ec)){var mh=e.closest&&e.closest('[class*=mlt-icon-container]');if(mh)h=mh;else{var card=e.closest&&e.closest('[class*=puis-card],[data-component-type*=search-result],[class*=s-result-item]');if(!card){skip++;continue;}var p=e.parentElement,up=0;while(p&&p!==card&&up++<3){var pr=p.getBoundingClientRect();if(pr.width>=22&&pr.width<=64&&pr.height>=22&&pr.height<=64&&Math.abs(pr.width-pr.height)<=14){h=p;break;}p=p.parentElement;}}}if(!h||hosts.indexOf(h)>=0)continue;var r=h.getBoundingClientRect();if(r.width<22||r.width>64||r.height<22||r.height>64||Math.abs(r.width-r.height)>14){skip++;continue;}hosts.push(h);var inp=(String(e.tagName||'').toUpperCase()==='INPUT')?e:(h.querySelector&&h.querySelector('input[type=checkbox]'));var sel=picked(h,inp);h.setAttribute('data-ad-comparehost377','1');h.setAttribute('data-ad-comparechecked377',sel?'1':'0');var pos=getComputedStyle(h).position;if(pos==='static')h.style.setProperty('position','relative','important');h.style.setProperty('background','transparent','important');h.style.setProperty('border','0','important');h.style.setProperty('border-radius','4px','important');h.style.setProperty('box-shadow','none','important');var old=h.querySelector(':scope > [data-ad-actioncanonical376],:scope > [data-ad-actioncanonical375]');if(old&&old.parentNode)old.parentNode.removeChild(old);var oldO=h.querySelectorAll('[data-ad-actionorig376],[data-ad-actionorig375]');for(var o=0;o<oldO.length;o++){oldO[o].style.removeProperty('visibility');oldO[o].style.removeProperty('opacity');oldO[o].removeAttribute('data-ad-actionorig376');oldO[o].removeAttribute('data-ad-actionorig375');}var b=h.querySelector(':scope > [data-ad-comparebox377]');if(!b){b=document.createElement('span');b.setAttribute('data-ad-comparebox377','1');var ns='http://www.w3.org/2000/svg',v=document.createElementNS(ns,'svg');v.setAttribute('viewBox','0 0 24 24');v.setAttribute('data-ad-comparecheck377','1');var path=document.createElementNS(ns,'path');path.setAttribute('d','M5.5 12.5l4.1 4.1L18.8 7.4');v.appendChild(path);b.appendChild(v);h.appendChild(b);}if(inp){inp.setAttribute('data-ad-compareinput377','1');inp.style.setProperty('opacity','0','important');}var orig=h.querySelectorAll('img,picture,svg,i,[class*=icon]');for(var j=0;j<orig.length&&j<30;j++){var a=orig[j];if(a===b||a.closest&&a.closest('[data-ad-comparebox377]'))continue;a.style.setProperty('visibility','hidden','important');a.style.setProperty('opacity','0','important');a.setAttribute('data-ad-compareorig377','1');}n++;if(sel)on++;else off++;}window.__AD_COMPARE377__='hosts='+n+' on='+on+' off='+off+' skip='+skip;}catch(e){window.__AD_COMPARE377__='err '+e;}}"
         ...
         "}catch(e){}}""badgeFix();dotFix();packFix();actionFix377();compareFix377();shareFix377();sponsorFix376();ratingFix376();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(actionFix377,60);setTimeout(actionFix377,240);setTimeout(actionFix377,800);setTimeout(actionFix377,1800);setTimeout(compareFix377,20);setTimeout(compareFix377,120);setTimeout(compareFix377,500);setTimeout(compareFix377,1500);setTimeout(sponsorFix376,20);setTimeout(sponsorFix376,180);setTimeout(sponsorFix376,700);setTimeout(sponsorFix376,1800);setTimeout(ratingFix376,40);setTimeout(ratingFix376,240);setTimeout(ratingFix376,900);setTimeout(ratingFix376,2200);setTimeout(shareFix377,40);setTimeout(shareFix377,180);setTimeout(shareFix377,700);setTimeout(shareFix377,1800);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){badgeFix();dotFix();packFix();actionFix377();compareFix377();shareFix377();sponsorFix376();ratingFix376();},80);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();actionFix377();compareFix377();shareFix377();sponsorFix376();ratingFix376();},20);}).observe(document.documentElement,"
         ...
         "try{document.addEventListener('change',function(e){try{if(e&&e.target&&(String(e.target.type||'').toLowerCase()==='checkbox'||(e.target.closest&&e.target.closest('[class*=mlt-icon-container]'))))compareFix377();}catch(x){}},true);document.addEventListener('click',function(e){try{if(e&&e.target&&e.target.closest&&e.target.closest('[class*=mlt-icon-container]')){setTimeout(compareFix377,0);setTimeout(compareFix377,80);}}catch(x){}},true);}catch(e){}"
       "})();}catch(e){}"
       "/*V5314FIX*//*V5315FIX*/"
"/*V5317FIX*//*V5376FIX*//*V5377FIX*/"
       ...
       // P39V377: distinguish the stock-style compare checkbox from the
       // separate lists-framework cards action.
       "try{var C39=document.querySelectorAll('[data-ad-comparehost377]'),A39=document.querySelectorAll('[data-ad-actionhost376]'),Q39=[];for(var h39=0;h39<C39.length&&Q39.length<14;h39++){var x39=C39[h39],r39=x39.getBoundingClientRect(),b39=x39.querySelector(':scope > [data-ad-comparebox377]'),bs39=b39?getComputedStyle(b39):null,ch39=b39?b39.querySelector('[data-ad-comparecheck377]'):null,cs39=ch39?getComputedStyle(ch39):null,inp39=x39.querySelector('[data-ad-compareinput377]'),is39=inp39?getComputedStyle(inp39):null;Q39.push(Math.round(r39.left)+','+Math.round(r39.top)+'/'+Math.round(r39.width)+'x'+Math.round(r39.height)+'|sel='+String(x39.getAttribute('data-ad-comparechecked377')||'0')+'|bg='+(bs39?String(bs39.backgroundColor||'-').replace(/ /g,''):'-')+'|br='+(bs39?String(bs39.borderTopColor||'-').replace(/ /g,''):'-')+'|rad='+(bs39?String(bs39.borderRadius||'-'):'-')+'|check='+(cs39?String(cs39.display||'-'):'-')+'|inp='+(is39?String(is39.opacity||'-'):'-'));}out.push('P39V377[compare='+C39.length+' cards='+A39.length+(Q39.length?' '+Q39.join(' ~~ '):'')+' state='+String(window.__AD_COMPARE377__||'-')+' action='+String(window.__AD_ACTION377__||'-')+']');}catch(e39){out.push('P39V377[err '+(e39&&e39.message||e39)+']');}"
       // P40V377: unified Sponsored product-strip iframe + wrapper state.
       "try{var F40=document.querySelectorAll('iframe[data-ad-stripframe374]'),W40=document.querySelectorAll('[data-ad-stripwrap374]'),Q40=[];for(var i40=0;i40<F40.length&&i40<10;i40++){var f40=F40[i40],r40=f40.getBoundingClientRect();if(r40.width<250||r40.height>230)continue;var s40=getComputedStyle(f40),p40=f40.parentElement,ps40=p40?getComputedStyle(p40):null;Q40.push(String(f40.getAttribute('data-ad-frame-mode362')||'-')+'@'+Math.round(r40.left)+','+Math.round(r40.top)+'/'+Math.round(r40.width)+'x'+Math.round(r40.height)+'|conf='+(f40.hasAttribute('data-ad-stripconfirmed374')?1:0)+'|bg='+String(s40.backgroundColor||'-').replace(/ /g,'')+'|fil='+String(s40.filter||'-').replace(/ /g,'')+'|pbg='+(ps40?String(ps40.backgroundColor||'-').replace(/ /g,''):'-'));}out.push('P40V377[frames='+F40.length+' wraps='+W40.length+(Q40.length?' '+Q40.join(' ~~ '):'')+']');}catch(e40){out.push('P40V377[err '+(e40&&e40.message||e40)+']');}"
       // P41V377: PDP share glyph must stay white across recycled product templates.
       "try{var S41=document.querySelectorAll('.ssf-share-trigger,[data-ad-share377]'),Q41=[];for(var i41=0;i41<S41.length&&i41<8;i41++){var h41=S41[i41],r41=h41.getBoundingClientRect();if(r41.width<8||r41.height<8)continue;var a41=h41.querySelector('[data-ad-shareleaf375],svg,path,i,img,[class*=icon]'),hs41=getComputedStyle(h41),s41=a41?getComputedStyle(a41):hs41,b41=getComputedStyle(h41,'::before'),z41=getComputedStyle(h41,'::after');Q41.push(Math.round(r41.left)+','+Math.round(r41.top)+'/'+Math.round(r41.width)+'x'+Math.round(r41.height)+'|mk='+(h41.hasAttribute('data-ad-share377')?1:0)+'|c='+String(s41.color||'-').replace(/ /g,'')+'|fill='+String(s41.fill||'-').replace(/ /g,'')+'|hflt='+String(hs41.filter||'-').slice(0,22)+'|flt='+String(s41.filter||'-').slice(0,22)+'|bef='+String(b41.color||'-').replace(/ /g,'')+'/'+String(b41.filter||'-').slice(0,12)+'|aft='+String(z41.color||'-').replace(/ /g,'')+'/'+String(z41.filter||'-').slice(0,12));}out.push('P41V377[n='+Q41.length+(Q41.length?' '+Q41.join(' ~~ '):'')+' state='+String(window.__AD_SHARE377__||'-')+']');}catch(e41){out.push('P41V377[err '+(e41&&e41.message||e41)+']');}"
