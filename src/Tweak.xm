...
#define AD_VERSION "v7.478-home-pdp-six-fix"
...
- (void)didMoveToSuperview {
    ...
    if(gP.enabled && self.superview && strcmp(object_getClassName(self), "WKScrollView")==0){
        ...
        self.indicatorStyle=UIScrollViewIndicatorStyleWhite;self.showsHorizontalScrollIndicator=NO;
    }
}
- (void)setBackgroundColor:(UIColor *)color {
    if(ADInternalPaintWrite7226()){
