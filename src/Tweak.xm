...
static NSString *ADFixesLiteral(void){
    ...
    gADFixesLiteral613 = [NSString stringWithFormat:
            @"{css:'"
             ...
             "{filter:invert(1) !important;opacity:1 !important;visibility:visible !important;"
             ...
             // v6.0.128: exact v5.446 standalone-ad shell rule. Home feedback/
             // sponsored wrappers are chrome, not photo content; keep their structural
             // background transparent so White Background Taming cannot veil the card.
...
static NSString *ADDarkReaderBootstrap(void){
    ...
    gADBootstrap613 = [NSString stringWithFormat:
        @"(function(){try{"
         ...
         "window.__AD_FLASH_TOUCH6101__=function(n){};"
