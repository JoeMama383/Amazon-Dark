...
static NSString *ADWhiteTameWebJS446(void){
    ...
    gADTameWeb613 = [NSString stringWithFormat:
        @"(function(){try{window.__ADTAME_ON__=1;window.__ADTAME_S__=%ld;"
         ...
         "function _adBgPlacement365(e){try{var p=e,d=0;while(p&&d++<4){var c=p.className;c=String(c&&c.baseVal!==undefined?c.baseVal:(c||''));var id=String(p.id||''),cw=String((p.getAttribute&&p.getAttribute('data-cel-widget'))||'');if(/ape-placement|ape-wrapper|adfeedbackmaincomponent|ad-slot|adslot/i.test(c+' '+id+' '+cw))return true;if(p.querySelector&&p.querySelector('iframe')&&p.getBoundingClientRect().width>240)return true;p=p.parentElement;}return false;}catch(x){return false;}}function _adHomeBgLeaf395(e){try{if(window.__AD_TWB_FRAME_MODE446__||!e||!document.body||!window.__ADTAME_ON__)return false;if(document.querySelector('#search,.s-search-results,[data-component-type=\"s-search-result\"],#productTitle,#dp-container,#ppd'))return false;var c=e.className;c=String(c&&c.baseVal!==undefined?c.baseVal:(c||''));if(!/theming-card-background|vjs-poster/i.test(c))return false;if(String(e.textContent||'').replace(/\\s+/g,' ').trim().length>2){if(typeof _adTameRelease625==='function')_adTameRelease625(e);return false;}var p=e,u=0,ctx=c;while(p&&u++<7){ctx+=' '+String(p.className||'')+' '+String(p.id||'');if(/single-video-card|single-creative-card|video-card|video-js|vjs-|sbv-video|theming-card/i.test(ctx))break;p=p.parentElement;}if(!/single-video-card|single-creative-card|video-card|video-js|vjs-|sbv-video|theming-card/i.test(ctx))return false;var S=Math.max(0,Math.min(100,window.__ADTAME_S__||45)),aa=(0.50*(S/100)).toFixed(3);e.removeAttribute('data-ad-tame-bgfast364');e.removeAttribute('data-ad-tame-fast362');e.style.setProperty('filter','none','important');e.style.removeProperty('background-color');e.style.setProperty('background-blend-mode','normal','important');e.style.setProperty('box-shadow','inset 0 0 0 9999px rgba(0,0,0,'+aa+')','important');e.setAttribute('data-ad-homebg395','1');e.__adTamed=1;e.__adTameSig='HBG395|'+String(getComputedStyle(e).backgroundImage||'');e.__adBy='homeBgLeaf395';return true;}catch(x){return false;}}"
         ...
         "window.__AD_TWB_FRAME_MODE446__=(function(){try{if(window.top===window)return '';var u=String(document.referrer||'').toLowerCase(),prod=u.indexOf('/dp/')>=0||u.indexOf('/gp/aw/d/')>=0||u.indexOf('/gp/product/')>=0||u.indexOf('/s?')>=0||u.indexOf('/search')>=0||u.indexOf('?k=')>=0||u.indexOf('&k=')>=0||u.indexOf('field-keywords=')>=0;if(prod)return 'productad';return ((innerHeight||0)<180||((innerWidth||1)/(innerHeight||1))>2.25)?'standalone':'hero';}catch(e){return '';}})();"
           ...
           "window.__AD_HEROFAST365__=function(root){try{if(window.__AD_TWB_FRAME_MODE446__!=='hero'||!window.__ADTAME_ON__||!root||root.nodeType!==1)return 0;var S=Math.max(0,Math.min(100,window.__ADTAME_S__||45)),bb=(1-0.50*(S/100)).toFixed(3),aa=(0.50*(S/100)).toFixed(3),A=[];if(!document.getElementById('adheropseudo366')){var ps=document.createElement('style');ps.id='adheropseudo366';ps.textContent='[data-ad-herobefore366]::before,[data-ad-heroafter366]::after{filter:brightness('+bb+') saturate(1.08) !important;}';(document.head||document.documentElement).appendChild(ps);}if(/^(IMG|VIDEO|CANVAS)$/i.test(String(root.tagName||'')))A.push(root);try{var q=root.querySelectorAll('img,video,canvas');for(var i=0;i<q.length&&i<120;i++)A.push(q[i]);}catch(e){}var n=0,b=0,pn=0;for(var j=0;j<A.length;j++){var x=A[j],r=x.getBoundingClientRect();if(r.width<32||r.height<32)continue;if(!_adNativeMediaOK615(x)){_adTameRelease625(x);continue;}_adReleaseNativeAncestors625(x);var c=x.className;c=String(c&&c.baseVal!==undefined?c.baseVal:(c||''));if(/sprite|icon|logo|pixel/i.test(c))continue;var w='brightness('+bb+') saturate(1.08)';if(String(x.style.getPropertyValue('filter')||'')!==w||x.style.getPropertyPriority('filter')!=='important')x.style.setProperty('filter',w,'important');x.setAttribute('data-ad-tame362','media');x.__adBy='heroFast366';n++;}var B=[];if(/^(HTML|BODY|DIV|SECTION|A|SPAN|LI|FIGURE|PICTURE)$/i.test(String(root.tagName||'')))B.push(root);try{var qb=root.querySelectorAll('html,body,div,section,a,span,li,figure,picture');for(var k=0;k<qb.length&&k<120;k++)B.push(qb[k]);}catch(e){}for(var z=0;z<B.length&&b<40;z++){var e=B[z],rr=e.getBoundingClientRect();if(rr.width<32||rr.height<32)continue;if(_adTameChrome625(e)){_adTameRelease625(e);continue;}var cc=e.className;cc=String(cc&&cc.baseVal!==undefined?cc.baseVal:(cc||''));if(/sprite|icon|logo|pixel/i.test(cc))continue;var cs=getComputedStyle(e),bi=String(cs.backgroundImage||'none');if(bi.indexOf('url(')>=0){e.style.setProperty('background-color','rgba(0,0,0,'+aa+')','important');e.style.setProperty('background-blend-mode','multiply','important');e.setAttribute('data-ad-tame362','bg');e.__adBy='heroFastBg366';b++;}try{var bf=getComputedStyle(e,'::before'),af=getComputedStyle(e,'::after'),bfi=String(bf.backgroundImage||'none'),afi=String(af.backgroundImage||'none');if(bfi.indexOf('url(')>=0){e.setAttribute('data-ad-herobefore366','1');e.__adBy='heroPseudo366';pn++;}if(afi.indexOf('url(')>=0){e.setAttribute('data-ad-heroafter366','1');e.__adBy='heroPseudo366';pn++;}}catch(px){}}window.__AD_HEROFAST365_N__=n+b+pn;return n+b+pn;}catch(e){return 0;}};"
                  "function _adHomeMedia395(){try{if(window.__AD_TWB_FRAME_MODE446__||!document.body||!window.__ADTAME_ON__)return 0;if(document.querySelector('#search,.s-search-results,[data-component-type=\"s-search-result\"],#productTitle,#dp-container,#ppd')){window.__AD_HOMEMEDIA395__='home=0 product=1';return 0;}var S=Math.max(0,Math.min(100,window.__ADTAME_S__||45)),bb=(1-0.50*(S/100)).toFixed(3),E=document.querySelectorAll('img[class*=\"_single-creative-card\"],img[class*=\"_single-video-card\"],[class*=\"single-creative-card\"] img,[class*=\"single-video-card\"] img,video.vjs-tech,[class*=\"single-video-card\"] video,[class*=\"theming-card-background\"],.vjs-poster,[class*=\"vjs-poster\"]'),media=0,bg=0,uncovered=0,hazard=0;for(var i=0;i<E.length&&i<240;i++){var e=E[i],r=e.getBoundingClientRect(),tg=String(e.tagName||'').toUpperCase();if(r.width<100||r.height<70)continue;if(tg==='DIV'||tg==='SECTION'||tg==='SPAN'){if(!_adHomeBgLeaf395(e))continue;bg++;var cs=getComputedStyle(e);if(String(cs.filter||'none')!=='none'||String(cs.backgroundBlendMode||'normal').indexOf('multiply')>=0)hazard++;if(!e.hasAttribute('data-ad-homebg395'))uncovered++;continue;}if(tg!=='IMG'&&tg!=='VIDEO'&&tg!=='CANVAS')continue;if(!_adNativeMediaOK615(e)){_adTameRelease625(e);continue;}_adReleaseNativeAncestors625(e);var want='brightness('+bb+') saturate(1.08)';e.setAttribute('data-ad-tame-fast362','1');e.setAttribute('data-ad-homemedia395','1');if(String(e.style.getPropertyValue('filter')||'')!==want||e.style.getPropertyPriority('filter')!=='important')e.style.setProperty('filter',want,'important');e.__adTamed=1;e.__adTameSig='HM395|'+String(e.currentSrc||e.src||e.poster||'');e.__adBy='homeMedia395';media++;if(String(getComputedStyle(e).filter||'').indexOf('brightness')<0)uncovered++;}window.__AD_HOMEMEDIA395__='media='+media+' bg='+bg+' uncovered='+uncovered+' hazard='+hazard;return media+bg;}catch(e){window.__AD_HOMEMEDIA395__='err '+(e&&e.message||e);return 0;}}"
         // v6.0.25: keep TWB media-only on Home cards. v5.446's ad-frame path
         // explicitly cleared structural/chrome taming and skipped full-frame rasters;
         // this compact equivalent runs inside the existing TWB passes only.
         "function _adTameRelease625(e){try{if(!e)return;var by=String(e.__adBy||''),tg=String(e.tagName||'').toUpperCase(),media=/^(IMG|VIDEO|CANVAS)$/.test(tg),owned=/^(whiteTame|homeMedia395|homeBgLeaf395|heroFast|heroPseudo|compactMedia373|stripMedia374|adMedia)/.test(by)||e.hasAttribute('data-ad-tame-fast362')||e.hasAttribute('data-ad-tame-bgfast364')||e.hasAttribute('data-ad-tame362')||e.hasAttribute('data-ad-homebg395')||e.hasAttribute('data-ad-herobefore366')||e.hasAttribute('data-ad-heroafter366');if(!owned)return;if(media)e.style.removeProperty('filter');else{e.style.removeProperty('filter');e.style.removeProperty('background-color');e.style.removeProperty('background-blend-mode');if(by==='homeBgLeaf395')e.style.removeProperty('box-shadow');}e.removeAttribute('data-ad-tame-fast362');e.removeAttribute('data-ad-tame-bgfast364');e.removeAttribute('data-ad-tame362');e.removeAttribute('data-ad-homebg395');e.removeAttribute('data-ad-homemedia395');e.removeAttribute('data-ad-herobefore366');e.removeAttribute('data-ad-heroafter366');e.__adTamed=0;e.__adTame362=0;e.__adTameSig='';}catch(x){}}"
         "function _adTameChrome625(e){try{if(!e)return false;var tg=String(e.tagName||'').toUpperCase();if(/^(IMG|VIDEO|CANVAS)$/.test(tg))return false;var c=e.className;c=String(c&&c.baseVal!==undefined?c.baseVal:(c||''));var id=String(e.id||''),tx=String(e.textContent||'').replace(/\\s+/g,' ').trim(),r=e.getBoundingClientRect();var named=/deal|badge|coupon|discount|offer|promo|saving|label|chip|pill/i.test(c+' '+id),text=/^(?:limited time deal|deal|sponsored(?: ad)?|save \\$?\\d|\\d{1,3}%%\\s*off)$/i.test(tx);if((named||text)&&r.height>0&&r.height<=86&&r.width>0&&r.width<=340)return true;if(window.__AD_IS_NATIVE615__&&window.__AD_IS_NATIVE615__(e)&&!/theming-card-background|vjs-poster/i.test(c))return true;return false;}catch(x){return false;}}"
         "function _adReleaseNativeAncestors625(e){try{if(!(window.__AD_IS_NATIVE615__&&window.__AD_IS_NATIVE615__(e)))return;var p=e.parentElement,d=0;while(p&&d++<6){if(p.hasAttribute('data-ad-native615')||(window.__AD_NATIVE_SEL615__&&p.matches&&p.matches(window.__AD_NATIVE_SEL615__))){_adTameRelease625(p);break;}if(_adTameChrome625(p)||p.hasAttribute('data-ad-tame-bgfast364')||p.hasAttribute('data-ad-tame362'))_adTameRelease625(p);p=p.parentElement;}}catch(x){}}"
         "function _adNativeMediaOK615(e){try{if(!(window.__AD_IS_NATIVE615__&&window.__AD_IS_NATIVE615__(e)))return true;var tg=String(e.tagName||'').toUpperCase();if(tg!=='IMG'&&tg!=='VIDEO'&&tg!=='CANVAS')return false;var p=e,d=0,ctx='';while(p&&d++<5){var c=p.className;c=String(c&&c.baseVal!==undefined?c.baseVal:(c||''));ctx+=' '+c+' '+String(p.id||'');p=p.parentElement;}if(/sprite|icon|logo|pixel|avatar|profile|author|reviewer|byline|merchant|seller|brand|store|headshot|user-image|customer/i.test(ctx))return false;var card=e.closest&&e.closest('[data-ad-native615]');if(!card&&e.closest&&window.__AD_NATIVE_SEL615__)card=e.closest(window.__AD_NATIVE_SEL615__);if(card){var er=e.getBoundingClientRect(),cr=card.getBoundingClientRect(),txt=String(card.innerText||card.textContent||'').replace(/\\s+/g,' ').trim();if(txt.length>8&&cr.width>60&&cr.height>40&&((er.width>cr.width*.72&&er.height>cr.height*.72)||(er.width*er.height>cr.width*cr.height*.66)))return false;}return true;}catch(x){return false;}}"
         ...
         "function _adTameFast362(root,full){try{if(!window.__ADTAME_ON__||!root||root.nodeType!==1)return 0;_adTameCss362();var mc446=full?360:100,ml446=full?420:120,bc446=full?900:120,bl446=full?930:130;var S365=Math.max(0,Math.min(100,window.__ADTAME_S__||45)),bb365=(1-0.50*(S365/100)).toFixed(3),aa365=(0.50*(S365/100)).toFixed(3);var A=[];"
           ...
           "var n=0;for(var j=0;j<A.length&&j<ml446;j++){var x=A[j];if(!_adNativeMediaOK615(x)){_adTameRelease625(x);continue;}_adReleaseNativeAncestors625(x);var tg=String(x.tagName||'').toUpperCase(),cn=x.className;cn=String(cn&&cn.baseVal!==undefined?cn.baseVal:(cn||''));var band=_adTameBand362(x),xr=x.getBoundingClientRect(),prod366=(tg==='IMG'&&_adKnownProduct366(x)),review366=(band===3);"
