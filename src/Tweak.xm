...
static NSString *ADDarkReaderBootstrap(void){
    ...
    gADBootstrap613 = [NSString stringWithFormat:
        @"(function(){try{"
         ...
         // v6.0.34: Off-to-College is normal dark-theme chrome, not TWB. Keep this
         // owner in the always-on bootstrap so the green pane stays dark even when
         // White Background Taming is disabled. Reuse the existing contrast lifecycle;
         // no additional observer, scroll callback, or recurring timer is installed.
         "try{if(!document.getElementById('adcollege6034')){var c34=document.createElement('style');c34.id='adcollege6034';"
           "c34.textContent='[data-ad-college6034],[data-ad-college-card6034]{background-color:var(--ad-college6034-bg,#181a1b)!important;background-image:none!important;filter:none!important;mix-blend-mode:normal!important;opacity:1!important;box-shadow:none!important;}[data-ad-college6034]::before,[data-ad-college6034]::after,[data-ad-college-card6034]::before,[data-ad-college-card6034]::after{background-color:var(--ad-college6034-bg,#181a1b)!important;background-image:none!important;filter:none!important;mix-blend-mode:normal!important;box-shadow:none!important;}[data-ad-college6034],[data-ad-college6034] h1,[data-ad-college6034] h2,[data-ad-college6034] h3,[data-ad-college6034] h4,[data-ad-college6034] h5,[data-ad-college6034] h6,[data-ad-college6034] p,[data-ad-college6034] a,[data-ad-college6034] span,[data-ad-college6034] strong{color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}[data-ad-college6034] .a-icon-next-rounded,[data-ad-college6034] .a-icon-previous-rounded,[data-ad-college6034] [class*=chevron]{color:#e8e6e3!important;filter:brightness(0) invert(1)!important;}[data-ad-college6034] svg,[data-ad-college6034] path{fill:#e8e6e3!important;stroke:#e8e6e3!important;}';"
           "(document.head||document.documentElement).appendChild(c34);}}catch(e){}"
         "window.__AD_COLLEGE6034__=function(root){try{if(window.top!==window||!document.body)return 0;"
           ...
           "function pin(pane){try{if(!pane||!pane.isConnected)return 0;var bg=appbg(),R=pane.getBoundingClientRect(),vw=innerWidth||390,n=1;pane.setAttribute('data-ad-college6034','1');pane.style.setProperty('--ad-college6034-bg',bg);pane.style.setProperty('background-color',bg,'important');pane.style.setProperty('background-image','none','important');pane.style.setProperty('box-shadow','none','important');var K=pane.getElementsByTagName?pane.getElementsByTagName('*'):[];for(var i=0;i<K.length&&i<280;i++){var e=K[i],tg=String(e.tagName||'').toUpperCase();if(!/^(DIV|SECTION|ARTICLE|UL|OL|LI|A)$/.test(tg))continue;var r=e.getBoundingClientRect();if(r.width<vw*.55||r.height<140||r.width>vw*1.05)continue;var cs=getComputedStyle(e),bc=String(cs.backgroundColor||'').replace(/\\s+/g,''),bi=String(cs.backgroundImage||'none'),cl=String(e.className&&e.className.baseVal!==undefined?e.className.baseVal:(e.className||'')).toLowerCase();if((!bc||bc==='transparent'||bc==='rgba(0,0,0,0)')&&bi==='none')continue;var cardish=/mosaic|college|card|pane|tile|container/.test(cl)||(r.width>=vw*.68&&r.height>=180);if(!cardish)continue;e.setAttribute('data-ad-college-card6034','1');e.style.setProperty('--ad-college6034-bg',bg);e.style.setProperty('background-color',bg,'important');e.style.setProperty('background-image','none','important');e.style.setProperty('filter','none','important');e.style.setProperty('mix-blend-mode','normal','important');e.style.setProperty('box-shadow','none','important');n++;}window.__AD_COLLEGE6034_STATE__='pane=1 cards='+(n-1)+' '+Math.round(R.width)+'x'+Math.round(R.height);return n;}catch(x){return 0;}}"
           "var held=window.__AD_COLLEGE6034_ROOT__;if(held&&held.isConnected){if(!root||root===document||(held.contains&&held.contains(root))||(root.contains&&root.contains(held)))return pin(held);return 1;}"
           "var base=(root&&root.getElementsByTagName)?root:document,H=(window.__AD_COLLEGE6034_HEADING__&&window.__AD_COLLEGE6034_HEADING__.isConnected)?window.__AD_COLLEGE6034_HEADING__:null,budget=1600,tags=['h1','h2','h3','h4','span','div'];if(!H&&base&&base.nodeType===1&&/^(H1|H2|H3|H4|SPAN|DIV)$/i.test(String(base.tagName||''))){var bt=String(base.textContent||'').replace(/\\s+/g,' ').trim().toLowerCase();if(bt==='off to college')H=base;}for(var ti=0;ti<tags.length&&budget>0&&!H;ti++){var Q=base.getElementsByTagName(tags[ti]);for(var q=0;q<Q.length&&budget-- >0;q++){var e=Q[q];if(e.children&&e.children.length>6)continue;var tx=String(e.textContent||'').replace(/\\s+/g,' ').trim().toLowerCase();if(tx==='off to college'){H=e;break;}}}if(H)window.__AD_COLLEGE6034_HEADING__=H;"
           "if(!H)return 0;var vw=innerWidth||390,P=H.parentElement,pane=null,d=0;while(P&&d++<10){var r=P.getBoundingClientRect(),ni=P.getElementsByTagName?P.getElementsByTagName('img').length:0,nv=P.getElementsByTagName?P.getElementsByTagName('video').length:0;if(r.width>=vw*.88&&r.width<=vw*1.12&&r.height>=150&&r.height<=900&&ni+nv>=2){pane=P;break;}P=P.parentElement;}if(!pane)return 0;window.__AD_COLLEGE6034_ROOT__=pane;return pin(pane);}catch(e){return 0;}};"
         "%@\n" // DarkReader UMD
         ...
         "window.__AMZDARK_APPLY__=function(){try{"
           ...
           "if(window.__AD_COLLEGE6034__)window.__AD_COLLEGE6034__(document);"
         ...
         "try{var _t=null,_roots=[];new MutationObserver(function(ms){try{for(var mi=0;mi<ms.length&&_roots.length<24;mi++){var A=ms[mi].addedNodes||[];for(var ai=0;ai<A.length&&_roots.length<24;ai++){var n=A[ai];if(n&&n.nodeType===3)n=n.parentElement;if(!n||n.nodeType!==1)continue;if(window.__AD_IS_NATIVE615__&&window.__AD_IS_NATIVE615__(n))continue;if(_roots.indexOf(n)<0)_roots.push(n);}}if(!_roots.length)return;clearTimeout(_t);"
           "_t=setTimeout(function(){try{var R=_roots;_roots=[];for(var i=0;i<R.length;i++){var r=R[i];if(!r||!r.isConnected)continue;var nested=false;for(var j=0;j<R.length;j++){if(i!==j&&R[j]&&R[j].contains&&R[j].contains(r)){nested=true;break;}}if(!nested){window.__AMZDARK_FIXCONTRAST__(r);if(window.__AD_COLLEGE6034__)window.__AD_COLLEGE6034__(r);}}}catch(e){}},180);}catch(e){}})"
