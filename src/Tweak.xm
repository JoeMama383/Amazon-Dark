...
static NSString *ADFloorJS(void){
    ...
    return
        ...
        @"#search#search .puis-card-container .puis-variations-block{background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;}#search#search .puis-card-container :is([data-csa-c-content-id=variation-options-link],[class*=s-variations-options-justify-content],[class*=s-variation-options-text],[class*=s-variation-options-link],.s-color-swatch-container-list-view,.puis-csi-with-label-container,.s-color-swatch-container){background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;}#search#search .puis-card-container :is([data-csa-c-content-id=variation-options-link],[class*=s-variations-options-justify-content],[class*=s-variation-options-text],[class*=s-variation-options-link],.s-color-swatch-container-list-view,.puis-csi-with-label-container,.s-color-swatch-container)::before,#search#search .puis-card-container :is([data-csa-c-content-id=variation-options-link],[class*=s-variations-options-justify-content],[class*=s-variation-options-text],[class*=s-variation-options-link],.s-color-swatch-container-list-view,.puis-csi-with-label-container,.s-color-swatch-container)::after{background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;}#search#search .puis-card-container .s-color-swatch-outer-circle{background-color:transparent!important;box-shadow:none!important;filter:none!important;-webkit-filter:none!important;}#search#search .puis-card-container .s-color-swatch-outer-circle::before,#search#search .puis-card-container .s-color-swatch-outer-circle::after{background-color:transparent!important;box-shadow:none!important;filter:none!important;-webkit-filter:none!important;}#search#search .puis-card-container .s-color-swatch-outer-circle :is(.s-color-swatch-inner-circle-fill,[class*=s-color-swatch-inner-circle],[class*=swatch-fill],[class*=swatch-image]){filter:none!important;-webkit-filter:none!important;mix-blend-mode:normal!important;opacity:1!important;}#search#search .puis-card-container :is(.s-color-swatch-container,[data-csa-c-content-id*=color-swatch],[class*=color-swatch]) :is(img,picture,canvas,svg,[style*=background-image]){filter:none!important;-webkit-filter:none!important;opacity:1!important;mix-blend-mode:normal!important;isolation:auto!important;}#search#search .puis-card-container :is(.s-color-swatch-container,[data-csa-c-content-id*=color-swatch],[class*=color-swatch]) img{background-color:transparent!important;}"
        ...
        @"important;box-shadow:none!important;color:#00a650!important;-webkit-text-fill-color:#00a650!important;}#search .a-badge[data-a-badge-type=\\\"deal\\\"]{background:transparent!important"
        ...
        @":8px!important;border:2px solid transparent!important;background-clip:content-box!important;}::-webkit-scrollbar-thumb:hover{background-color:#8a8a8a!important;}\");}if(document.rea"
...
static NSString *ADTWBJS(void){
    ...
    return [NSString stringWithFormat:
        ...
        @"*=checkbox]):not([class*=heart]):not([class*=wishlist]):not([class*=icon]):not([class*=glyph]):not([class*=badge]){filter:brightness(%.3f)!important;}\");return;}var p='';try{p=String(location.pathname||'');}catch(_){}var s=null;if(p==='/autocomplete'||p.indexOf('/autocomplete/')===0){s=put('ad7-search-pane-twb',\"img.ufs_tiles_card_widget-sug-image,img.s-entity-pd-carousel-tile-element-image{filter:brightness(%.3f)!important;-webkit-filter:brightness(%.3f)!important;opacity:1!important;}#attach-to-me img.s-image,#attach-to-me img.s-product-image,.s-suggestion-container img.s-image,.s-suggestion-container img.s-product-image{filter:none!important;-webkit-filter:none!important;opacity:%.3f!important;}\");}else if(p==='/s'||p.indexOf('/s/')===0){s=put('ad7-product-feed-twb',\"#search img.scx-stt-image,#search img._c2Itd_image_3UiYm,#search img._bXVsd_image_iVomf,#search img._bXVsd_lifestyleImage_1fluW{filter:brightness(%.3f)!important;-webkit-filter:brightness(%.3f)!important;opacity:1!important;}#search img.s-image,#search img.s-product-image,#search [data-component-type=s-product-image] img,#search img.ufs_tiles_card_widget-sug-image,#search img.nice-cat-card_image,#search img.haul-puis-portrait-img,#search img._c2Itd_image_pQREQ{filter:none!important;-webkit-filter:none!important;opacity:%.3f!important;}#search#search .puis-card-container :is(.s-color-swatch-container,[data-csa-c-content-id*=color-swatch],[class*=color-swatch]) :is(img,picture,canvas,svg){filter:none!important;-webkit-filter:none!important;opacity:1!important;mix-blend-mode:normal!important;}#search video.sbv-video-player-ecx,#search video._"
