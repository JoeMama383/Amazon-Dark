...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "try{if(!document.getElementById('adstandparent393')){var sp393=document.createElement('style');sp393.id='adstandparent393';sp393.textContent='[data-ad-standparent393]{background-color:transparent !important;box-shadow:none !important;}[data-ad-standparentbefore393]::before,[data-ad-standparentafter393]::after{background-color:transparent !important;background-image:none !important;box-shadow:none !important;}';(document.head||document.documentElement).appendChild(sp393);}}catch(e){}"
                  "function _adStandaloneSweep394(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;if(document.querySelector('#search,.s-search-results,[data-component-type=\"s-search-result\"],#productTitle,#dp-container,#ppd')){window.__AD_STANDSWEEP394__='home=0 product=1';return 0;}var F=document.querySelectorAll('iframe[data-ad-frame-mode362=\"standalone\"]'),n=0,wraps=0;for(var i=0;i<F.length&&i<60;i++){var f=F[i],r=f.getBoundingClientRect();if(r.width<360||r.width>440||r.height<40||r.height>100)continue;var sig=(String(f.src||'')+' '+String(f.title||'')+' '+String(f.name||'')+' '+String(f.className||'')).toLowerCase();if(/video|player|youtube|vimeo|captcha|challenge|map|payment/.test(sig))continue;f.setAttribute('data-ad-homeauto394','1');if(window.__AD_MARKSTRIP374__)window.__AD_MARKSTRIP374__(f,true);n++;var p=f.parentElement,d=0;while(p&&d++<4){if(p.hasAttribute&&p.hasAttribute('data-ad-stripwrap374'))wraps++;p=p.parentElement;}}window.__AD_STANDSWEEP394__='frames='+n+' wraps='+wraps;return n;}catch(e){window.__AD_STANDSWEEP394__='err '+(e&&e.message||e);return 0;}}"
         "window._adStandaloneSweep394=_adStandaloneSweep394;"
         ...
         "try{window.__AD_FRAMECLASS362__=function(){var F=document.querySelectorAll('iframe'),n=0;"
           "for(var fi=0;fi<F.length&&fi<80;fi++){var f=F[fi],r=f.getBoundingClientRect();if(r.width<120||r.height<50)continue;"
             ...
             "var productAd=(!hero&&productDoc&&r.width>=300&&r.height>=55&&r.height<=260);var mode=hero?'hero':(productAd?'productad':'standalone');f.setAttribute('data-ad-frame-mode362',mode);f.setAttribute('data-ad-frame-why369',productAd?(prodURL369?'url369':'dom369'):(hero?'hero':'standalone'));if(window.__AD_MARKSTRIP374__){if(productAd)window.__AD_MARKSTRIP374__(f,true);else if(mode==='standalone'&&r.width>=280&&r.height<=180){var auto394=(!productDoc&&r.width>=360&&r.width<=440&&r.height>=40&&r.height<=100);if(auto394)f.setAttribute('data-ad-homeauto394','1');window.__AD_MARKSTRIP374__(f,auto394);}}try{f.contentWindow&&f.contentWindow.postMessage({__amzAdMode:mode},'*');}catch(e){}n++;}"
         ...
         "window.__AMZDARK_FIXCONTRAST__=function(){try{"
           ...
           "try{if(window.__ADTAME_ON__){"
             ...
             "for(var z9=0;z9<PB.length&&z9<900&&((z9&15)||!ovr())&&bgtamed<72;z9++){"
               "var be9=PB[z9];if(_adHomeBgLeaf394(be9))continue;if(_adBgPlacement365(be9))continue;var bs9=getComputedStyle(be9),bi9=String(bs9.backgroundImage||'none');"
         ...
         "function _adBgPlacement365(e){try{var p=e,d=0;while(p&&d++<4){var c=p.className;c=String(c&&c.baseVal!==undefined?c.baseVal:(c||''));var id=String(p.id||''),cw=String((p.getAttribute&&p.getAttribute('data-cel-widget'))||'');if(/ape-placement|ape-wrapper|adfeedbackmaincomponent|ad-slot|adslot/i.test(c+' '+id+' '+cw))return true;if(p.querySelector&&p.querySelector('iframe')&&p.getBoundingClientRect().width>240)return true;p=p.parentElement;}return false;}catch(x){return false;}}function _adHomeBgLeaf394(e){try{if(window.__ADFRAME_MODE__||!e||!document.body)return false;if(document.querySelector('#search,.s-search-results,[data-component-type=\"s-search-result\"],#productTitle,#dp-container,#ppd'))return false;var c=e.className;c=String(c&&c.baseVal!==undefined?c.baseVal:(c||''));if(!/theming-card-background|vjs-poster/i.test(c))return false;var p=e,u=0,ctx=c;while(p&&u++<7){ctx+=' '+String(p.className||'')+' '+String(p.id||'');if(/single-video-card|single-creative-card|video-card|video-js|vjs-|sbv-video|theming-card/i.test(ctx))break;p=p.parentElement;}if(!/single-video-card|single-creative-card|video-card|video-js|vjs-|sbv-video|theming-card/i.test(ctx))return false;e.removeAttribute('data-ad-tame-bgfast364');e.style.removeProperty('background-color');e.style.removeProperty('background-blend-mode');e.setAttribute('data-ad-tame-fast362','1');e.setAttribute('data-ad-homebgskip394','1');e.__adTamed=1;e.__adBy='homeBgLeaf394';return true;}catch(x){return false;}}"
         ...
         // saturated ancestor paint. No video attributes/playback/filter/layout writes.
                  "function _adHomeVideoBackdrop394(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;if(document.querySelector('#search,.s-search-results,[data-component-type=\"s-search-result\"],#productTitle,#dp-container,#ppd')){window.__AD_HOMEBACK394__='home=0 product=1';return 0;}var E=document.querySelectorAll('[class*=\"theming-card-background\"],.vjs-poster,[class*=\"vjs-poster\"]'),n=0,left=0;for(var i=0;i<E.length&&i<120;i++){var e=E[i],r=e.getBoundingClientRect();if(r.width<120||r.height<90)continue;if(!_adHomeBgLeaf394(e))continue;n++;var cs=getComputedStyle(e);if(e.hasAttribute('data-ad-tame-bgfast364')||String(cs.backgroundBlendMode||'').indexOf('multiply')>=0)left++;}window.__AD_HOMEBACK394__='fixed='+n+' left='+left;return n;}catch(e){window.__AD_HOMEBACK394__='err '+(e&&e.message||e);return 0;}}"
         "window._adHomeVideoBackdrop394=_adHomeVideoBackdrop394;"
         "try{_adHomeVideoBackdrop394();_adStandaloneSweep394();setTimeout(_adHomeVideoBackdrop394,220);setTimeout(_adHomeVideoBackdrop394,900);setTimeout(_adStandaloneSweep394,260);setTimeout(_adStandaloneSweep394,1000);if(!window.__ADHOMEP394INIT__){window.__ADHOMEP394INIT__=1;var hp394=0;addEventListener('scroll',function(){if(hp394)return;hp394=1;var f=function(){hp394=0;try{_adHomeVideoBackdrop394();_adStandaloneSweep394();}catch(e){}};if(requestAnimationFrame)requestAnimationFrame(f);else setTimeout(f,0);},{passive:true,capture:true});}}catch(e){}"
         ...
         "try{if(window._adHomeVideoBackdrop394)_adHomeVideoBackdrop394();}catch(e){}try{if(window._adStandaloneSweep394)_adStandaloneSweep394();}catch(e){}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // anchored to confirmed standalone iframe ancestry; bleed is anchored to video-card ancestry.
              "try{var F56=document.querySelectorAll('iframe[data-ad-homeauto394=\"1\"]'),stand56=F56.length,wrap56=0,black56=0;function p56c(v){var m=/rgba?\\((\\d+),\\s*(\\d+),\\s*(\\d+)(?:,\\s*([0-9.]+))?/i.exec(String(v||''));return m?[+m[1],+m[2],+m[3],m[4]===undefined?1:+m[4]]:null;}function p56dark(q){return !!(q&&q[3]>.25&&Math.max(q[0],q[1],q[2])<55);}for(var i56=0;i56<F56.length;i56++){var p56=F56[i56].parentElement,d56=0;while(p56&&d56++<4){if(p56.hasAttribute&&p56.hasAttribute('data-ad-stripwrap374')){wrap56++;if(p56dark(p56c(getComputedStyle(p56).backgroundColor)))black56++;}p56=p56.parentElement;}}var B56=document.querySelectorAll('[data-ad-homebgskip394]'),bleft56=0;for(var b56=0;b56<B56.length;b56++){var s56=getComputedStyle(B56[b56]);if(B56[b56].hasAttribute('data-ad-tame-bgfast364')||String(s56.backgroundBlendMode||'').indexOf('multiply')>=0)bleft56++;}out.push('P56HOME394[stand='+stand56+' wraps='+wrap56+' blackleft='+black56+' bgleaf='+B56.length+' bleedleft='+bleft56+' sstate='+String(window.__AD_STANDSWEEP394__||'-')+' bstate='+String(window.__AD_HOMEBACK394__||'-')+']');}catch(e56){out.push('P56HOME394[err '+(e56&&e56.message||e56)+']');}"
