         ...
         "if(window.top!==window){try{"
           ...
           "window.__AMZDARK_ADTHEME__=function(){try{"
             ...
             "if(mode==='standalone'){var old=document.getElementById('adfrmin');if(old&&old.parentNode)old.parentNode.removeChild(old);var prodst=document.getElementById('adfrproduct370');if(prodst&&prodst.parentNode)prodst.parentNode.removeChild(prodst);"
               ...
               "window.__AD_ADTHEME__='mode=standalone '+String(window.__AD_STANDALONE__||('theme='+sn))+' ink371='+ink371+' left='+String(window.__AD_ADTEXT371_LEFT__||0)+' roots='+String(window.__AD_ADTEXT371_ROOTS__||1)+' compact='+String(window.__AD_COMPACT371__||0)+' '+String(window.__AD_ADTAME__||('tame='+stn))+' spon='+sp367;return sn+ink371+stn+sp367;}"
...
"/*V5317FIX*/"
       ...
       "try{var P32=document.querySelectorAll('iframe[data-ad-frame-mode362=\"productad\"]'),R32=[];for(var i32=0;i32<P32.length&&i32<8;i32++){var f32=P32[i32],r32=f32.getBoundingClientRect();R32.push(String(f32.getAttribute('data-ad-frame-why369')||'-')+'@'+Math.round(r32.left)+','+Math.round(r32.top)+'/'+Math.round(r32.width)+'x'+Math.round(r32.height));}out.push('P32V371[productDoc='+String(window.__AD_PRODUCTDOC369__||0)+' productFrame='+P32.length+(R32.length?' '+R32.join(' ~~ '):'')+']');}catch(e32){out.push('P32V371[err '+(e32&&e32.message||e32)+']');}"
       "try{var A33=document.querySelectorAll('[class*=_hp-mosaic-container_style_widgetContainer],[class*=_mosaic-container_style_widgetContainer]'),Q33=[];for(var i33=0;i33<A33.length&&i33<10;i33++){var e33=A33[i33],r33=e33.getBoundingClientRect(),s33=getComputedStyle(e33);if(r33.width<100||r33.height<50)continue;Q33.push(e33.tagName+'.'+cls(e33)+'@'+Math.round(r33.top)+'/'+Math.round(r33.width)+'x'+Math.round(r33.height)+'|t='+String(s33.borderTopColor||'-').replace(/ /g,'')+'|sec='+String(e33.getAttribute('data-ad-border-section')||'-')+'|by='+(e33.__adBy||'-'));}out.push('P33V371[n='+Q33.length+(Q33.length?' '+Q33.join(' ~~ '):'')+']');}catch(e33){out.push('P33V371[err '+(e33&&e33.message||e33)+']');}"
       "try{var A34=document.querySelectorAll('[class*=_hp-mosaic-container_style_widgetContainer],[class*=_mosaic-container_style_widgetContainer]'),Q34=[],brown34=0,fixed34=0;for(var i34=0;i34<A34.length;i34++){var e34=A34[i34],r34=e34.getBoundingClientRect(),s34=getComputedStyle(e34),bc34=String(s34.borderTopColor||'').replace(/ /g,''),isB34=(bc34==='rgb(84,78,69)'||bc34==='rgb(85,79,70)'||bc34==='rgb(83,77,68)');if(isB34)brown34++;if(e34.getAttribute&&e34.getAttribute('data-ad-border-section')==='exact371')fixed34++;if(Q34.length<12&&(isB34||(r34.bottom>=-80&&r34.top<=(window.innerHeight||900)+80)))Q34.push(e34.tagName+'.'+cls(e34)+'@'+Math.round(r34.top)+'/'+Math.round(r34.width)+'x'+Math.round(r34.height)+'|t='+bc34+'|sec='+String(e34.getAttribute('data-ad-border-section')||'-')+'|by='+(e34.__adBy||'-'));}out.push('P34V371[total='+A34.length+' brown='+brown34+' fixed='+fixed34+(Q34.length?' '+Q34.join(' ~~ '):'')+']');}catch(e34){out.push('P34V371[err '+(e34&&e34.message||e34)+']');}"
       "try{var C35=document.querySelectorAll('[data-ad-compactad371]'),I35=document.querySelectorAll('[data-ad-compactink371]'),Q35=[];for(var i35=0;i35<I35.length&&i35<8;i35++){var e35=I35[i35],r35=e35.getBoundingClientRect(),s35=getComputedStyle(e35),t35=String(e35.textContent||'').replace(/\\s+/g,' ').trim();Q35.push(t35.slice(0,24)+'@'+Math.round(r35.top)+'|c='+String(s35.color||'-').replace(/ /g,'')+'|fill='+String(s35.webkitTextFillColor||'-').replace(/ /g,'')+'|by='+(e35.__adBy||'-'));}out.push('P35V371[cards='+C35.length+' ink='+I35.length+(Q35.length?' '+Q35.join(' ~~ '):'')+']');}catch(e35){out.push('P35V371[err '+(e35&&e35.message||e35)+']');}"
