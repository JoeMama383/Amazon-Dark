...
#define AD_VERSION "v7.437-pdp-standalone-ad-treatment"
...
static NSString *ADCoreWebJS7271(void){
    ...
    gADCoreWebJSCached7271=[NSString stringWithFormat:@"%@%@%@%@%@%@%@%@%@%@%@%@%@",ADFullRasterHostBridgeJS7266(),
        ...
        ADProductScrollVideoBorderJS7405(),ADPDPCompletionJS7405(),ADPDPSafeFrameJS7432(),ADPDPCompletionTWBJS7405(),ADAddressManagementJS7412()];
