/* AmazonDark v7.470 — isolated-world PDP frame ownership. */
...
#define AD_VERSION "v7.470-pdp-isolated-frame-ownership"
...
static NSString *ADPDPIsolatedFrameThemeJS7470(void){
    return @"(function(){try{var d=document,h=d.documentElement;if(!h)return;h.setAttribute('data-ad7470-pdp-theme','1');var C=`#offsite-buy-box :is([data-testid=brand-name],[data-testid=brand-name] *,[data-testid=product-description],[data-testid=product-description] *,[data-testid=combined-brand-and-description],[data-testid=combined-brand-and-description] *){color:#fff!important;-webkit-text-fill-color:#fff!important;opacity:1!important}#offsite-buy-box button[data-testid=sponsored-container],#offsite-buy-box button[data-testid=sponsored-container] span{color:#b1aaa0!important}#offsite-buy-box svg[data-testid=info-icon] path:first-of-type{fill:#b1aaa0!important}#offsite-buy-box svg[data-testid=info-icon] path:not(:first-of-type){fill:#000!important}#ad [data-testid=gridContainer]{background:#000!important;border:0!important;outline:0!important;box-shadow:none!important}#ad [data-testid=gridContainer] :is([data-testid=gridWrapper],[data-testid=gridRegion],.grid-inset-carousel,.grid.bg-zinc-100,.swiper-slide.bg-white){background:#000!important;box-shadow:none!important}#ad [data-testid=gridContainer] .swiper-slide.bg-white{border:0!important;outline:0!important}#ad [data-testid^=gridRegionCarousel]{background:#000!important;border:1px solid #494d4d!important;outline:0!important;box-shadow:none!important}#ad [data-testid=gridContainer] :is([data-testid=price],[data-testid=price-text],[data-testid=currency]){color:#fff!important;-webkit-text-fill-color:#fff!important}#dp :is(#ape_detail_mobile-hero-quick-promo_mshop_placement,#ape_detail_btf_mshop_placement,#ape_detail_btf2_mshop_placement){border:0!important;outline:0!important;box-shadow:none!important}`;function put(){var s=d.getElementById('ad7470-pdp-isolated-theme');if(!s){s=d.createElement('style');s.id='ad7470-pdp-isolated-theme';(d.head||h).appendChild(s)}if(s.textContent!==C)s.textContent=C}function q(sel,p){try{var e=d.querySelector(sel);if(e)for(var j=0;j<p.length;j++)e.style.setProperty(p[j][0],p[j][1],'important')}catch(_){}}function pin(){var T=[['color','#fff'],['-webkit-text-fill-color','#fff'],['opacity','1']];q('#offsite-buy-box [data-testid=brand-name]',T);q('#offsite-buy-box [data-testid=product-description]',T);q('#offsite-buy-box [data-testid=combined-brand-and-description]',T);q('#ad [data-testid=gridContainer]',[['background','#000'],['border','0'],['outline','0'],['box-shadow','none']]);q('#ad [data-testid=gridContainer] [data-testid=gridWrapper],#ad [data-testid=gridContainer] [data-testid=gridRegion],#ad [data-testid=gridContainer] .grid-inset-carousel,#ad [data-testid=gridContainer] .grid.bg-zinc-100,#ad [data-testid=gridContainer] .swiper-slide.bg-white',[['background','#000'],['box-shadow','none']]);q('#ad [data-testid=gridContainer] .swiper-slide.bg-white',[['border','0'],['outline','0']]);q('#ad [data-testid^=gridRegionCarousel]',[['background','#000'],['border','1px solid #494d4d'],['outline','0'],['box-shadow','none']]);q('#ad [data-testid=gridContainer] [data-testid=price],#ad [data-testid=gridContainer] [data-testid=price-text],#ad [data-testid=gridContainer] [data-testid=currency]',[['color','#fff'],['-webkit-text-fill-color','#fff']]);var B=[['border','0'],['outline','0'],['box-shadow','none']];q('#dp #ape_detail_mobile-hero-quick-promo_mshop_placement',B);q('#dp #ape_detail_btf_mshop_placement',B);q('#dp #ape_detail_btf2_mshop_placement',B)}function apply(){if(!d.querySelector('#offsite-buy-box,#ad [data-testid=gridContainer],#dp'))return;put();pin()}apply();if(d.readyState==='loading')d.addEventListener('DOMContentLoaded',apply,{once:true});d.addEventListener('readystatechange',apply);window.addEventListener('load',apply,{once:true});window.addEventListener('pageshow',apply,false)}catch(_){}})();";
}
