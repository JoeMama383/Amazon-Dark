    ...
    return
       ...
       "try{var CL=[],EC=document.querySelectorAll('*');"
         "for(var q2=0;q2<EC.length&&CL.length<8;q2++){var c2=EC[q2];"
           ...
           "CL.push(x2.slice(0,12)+'|'+c2.tagName+'|bg='+y2.backgroundColor+'|col='+y2.color+'|'+k2.join('>'));}"
       ...
       "try{(function(){"
         ...
         "function clr(){try{var N=document.querySelectorAll(SEL),c=0;"
           "for(var i=0;i<N.length&&i<400;i++){var e=N[i];"
         ...
         "clr();setTimeout(clr,300);setTimeout(clr,1200);"
