...
#define AD_VERSION "v7.158-search-floor-scx-fix-probe"
...
static NSString *ADFloorJS(void){
    // v7.157: three route-exclusive static style lanes. /autocomplete gets only
    // the Search-pane sheet, /s gets only the product-feed sheet, and all other
    // main documents get the menu sheet. No observer, polling, DOM scan or :has().
    return
        @"(function(){try{var host='';try{host=String(location.hostname||'').toLowerCase();}catch(_){}if(host==='flashtalking.com'||/\\.flashtalking\\.com$/.test(host))return;var child=0;try{child=window.top!==window;}catch(_){child=1;}if(child&&document.documentElement){document.documentElement.setAttribute('data-ad7-child-frame','1');try{var ref=String(document.referrer||'').toLowerCase();var productish=/\\/dp\\/|\\/gp\\/product\\/|\\/gp\\/aw\\/d\\/|\\/s(?:[\\/?]|$)|[?&]k=/.test(ref);if(!productish)document.documentElement.setAttribute('data-ad7-standalone-candidate','1');}catch(__){}}function put(id,css){var s=document.getElementById(id);if(!s){s=document.createElement('style');s.id=id;(document.head||document.documentElement||document).appendChild(s);}s.textContent=css;return s;}function relink(s){try{if(s&&!s.isConnected)(document.head||document.documentElement).appendChild(s)}catch(_){}}function rootBlack(){try{var h=document.documentElement;if(h){h.style.setProperty('background-color','#0"
        @"00','important');h.style.setProperty('color-scheme','dark','important');}if(document.body){document.body.style.setProperty('background-color','#000','important');document.body.style.setProperty('color-scheme','dark','important');}}catch(_){}}if(child&&document.documentElement&&document.documentElement.hasAttribute('data-ad7-standalone-candidate')){put('ad7-child-floor-min','html,body{background:#000!important;background-color:#000!important;color-scheme:dark!important;}');rootBlack();return;}var p='';try{p=String(location.pathname||'');}catch(_){}var s=null;if(!child&&(p==='/autocomplete'||p.indexOf('/autocomplete/')===0)){s=put('ad7-search-pane-theme',\"html,body,#a-page,#attach-to-me{background:#000!important;background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;color-scheme:dark!important;box-shadow:none!important;}#a-page :is(.a-color-base,.a-text-normal,.a-size-base,.a-size-base-plus,.a-size-medium,h1,h2,h3,h4,h5,h6,p,span,a,div,label,st"
        @"rong,b){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#a-page :is(.a-color-secondary,.a-size-small){color:#b1b5b5!important;-webkit-text-fill-color:#b1b5b5!important;}#a-page input,#a-page textarea{background:#181a1b!important;background-color:#181a1b!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;border-color:#494d4d!important;}#a-page ::placeholder{color:#b1aaa0!important;opacity:1!important;}.s-suggestion-container,.s-suggestion,.autocomplete-results-container,[class*=autocomplete],[class*=recentSearch]:not([class*=icon]):not([class*=glyph]),[class*=search-suggestion]:not([class*=icon]):not([class*=glyph]){background:#000!important;background-color:#000!important;color:#e8e6e3!important;}:is(.s-suggestion-container,.s-suggestion,.autocomplete-results-container,[class*=autocomplete],[class*=recentSearch],[class*=search-suggestion]) :is(h1,h2,h3,h4,h5,h6,p,span,a,div){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}."
        @"s-suggestion-section-heading,.sac-header-component-single-line-header{color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#a-page :is([id^=sac-query-row-].s-query-row,.s-query-row-container,.s-query-row-link){background:#000!important;background-color:#000!important;-webkit-tap-highlight-color:transparent!important;}#a-page :is([id^=sac-query-row-].s-query-row,.s-query-row-container,.s-query-row-link):is(:active,:focus,:focus-visible,:focus-within){background:#000!important;background-color:#000!important;-webkit-tap-highlight-color:transparent!important;box-shadow:none!important;}#attach-to-me :is([class*=location],[class*=delivery],[id*=location],[id*=delivery],[class*=glow],[id*=glow],[class*=ship-to],[id*=ship-to],[class*=shipto],[id*=shipto]):not(img):not(svg):not(i):not([class*=icon]):not([class*=glyph]):not([id*=icon]){background-color:#000!important;border-color:#494d4d!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#attach-to-me>div"
        @",#attach-to-me>section,#attach-to-me>article{background:#000!important;background-color:#000!important;border-color:#494d4d!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;box-shadow:none!important;}#attach-to-me :is([class*=location],[class*=delivery],[id*=location],[id*=delivery],[class*=glow],[id*=glow],[class*=ship-to],[id*=ship-to],[class*=shipto],[id*=shipto]) :is(span,a,p,div,label,strong,b){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#attach-to-me :is([class*=location],[class*=delivery],[id*=location],[id*=delivery],[class*=glow],[id*=glow],[class*=ship-to],[id*=ship-to],[class*=shipto],[id*=shipto]) :is(img,svg,i,[class*=icon],[class*=glyph],[id*=icon]){background-color:transparent!important;color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;filter:brightness(0) invert(1)!important;-webkit-filter:brightness(0) invert(1)!important;}.s-suggestion-container{border-color:#494d4d!important;outline-color:#494d4d"
        @"!important;}.s-suggestion-container :is(img[class*=icon],img[alt*=search],img[alt*=arrow],svg,i.a-icon,[class*=glyph]),.s-suggestion :is(img[class*=icon],img[alt*=search],img[alt*=arrow],svg,i.a-icon,[class*=glyph]){color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;filter:brightness(0) invert(1)!important;-webkit-filter:brightness(0) invert(1)!important;}.s-suggestion-container i.icon-past-search-suggestion.s-suggestion-icon-left{background-color:transparent!important;color:#9da3a3!important;fill:#9da3a3!important;stroke:#9da3a3!important;filter:brightness(0) invert(1) brightness(0.65)!important;-webkit-filter:brightness(0) invert(1) brightness(0.65)!important;opacity:1!important;box-shadow:none!important;}.s-suggestion-container i.icon-close.s-suggestion-icon-left{background-color:transparent!important;color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;filter:brightness(0) invert(1)!important;-webkit-filter:brightness(0) invert(1)!important;o"
        @"pacity:1!important;box-shadow:none!important;}.s-query-row i.icon-search-suggestion.s-query-row-search-icon,.s-suggestion-container i:is([class*=icon-search],[class*=search-icon]),.s-suggestion i:is([class*=icon-search],[class*=search-icon]),.s-suggestion-container i.s-suggestion-icon-right{background-color:transparent!important;color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;filter:brightness(0) invert(1) brightness(0.91)!important;-webkit-filter:brightness(0) invert(1) brightness(0.91)!important;opacity:1!important;box-shadow:none!important;}#attach-to-me,.s-suggestion-container,.s-suggestion,.autocomplete-results-container{background:#000!important;background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#attach-to-me :is(.s-suggestion-container,.s-suggestion,.s-query-row,.s-query-row-container,.s-query-row-link),#a-page :is([id^=sac-query-row-].s-query-row,.s-query-row-container,.s-query-row-link){background:#000!imp"
        @"ortant;background-color:#000!important;-webkit-tap-highlight-color:transparent!important;box-shadow:none!important;}#attach-to-me :is(.s-suggestion-container,.s-suggestion,.s-query-row,.s-query-row-container,.s-query-row-link){border-top-color:#494d4d!important;border-right-color:#494d4d!important;border-bottom-color:#494d4d!important;border-left-color:#494d4d!important;outline-color:#494d4d!important;}#attach-to-me hr{border-color:#494d4d!important;background-color:#494d4d!important;color:#494d4d!important;}html,body,#a-page,#attach-to-me{min-height:100vh!important;background:#000!important;background-color:#000!important;}#attach-to-me>div,#attach-to-me>section,#attach-to-me>article,#attach-to-me>main,#attach-to-me>footer{background:#000!important;background-color:#000!important;}#attach-to-me::before,#attach-to-me::after{background:#000!important;background-color:#000!important;}\");}else if(!child&&(p==='/s'||p.indexOf('/s/')===0)){s=put('ad7-product-feed-theme',\"html,body,#a-page,#search,.s-main-slot,.s-result-item,[data-component-type=s-search-result],.s-card-container,.puis-card-container,.puisg-row,.puisg-col,.puisg-col-inner{background:#000!important;background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;box-shadow:none!important;}#search :is(.a-color-base,.a-text-normal,.a-size-base,.a-size-base-plus,.a-size-medium,.a-pric"
        @"e,.a-price-whole,.a-price-symbol,.a-price-fraction,.a-offscreen,.s-title-instructions-style,h1,h2,h3,h4,h5,h6,p,label,strong,b){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#search :is(.a-color-secondary,.a-size-small){color:#b1b5b5!important;-webkit-text-fill-color:#b1b5b5!important;}#search :is(.s-result-item,.s-card-container,.puis-card-container,[data-component-type=s-search-result]){border-color:#494d4d!important;outline-color:#494d4d!important;}#search :is(.a-divider-inner)::before,#search :is(.a-divider-inner)::after,#search hr{border-color:#494d4d!important;background-color:#494d4d!important;}.ufs_tiles_card_widget-suggestion{background:#000!important;background-color:#000!important;color:#e8e6e3!important;}.ufs_tiles_card_widget-suggestion :is(.ufs_tiles_card_widget-sug-container-top,.ufs_tiles_card_widget-sug-column,.ufs_tiles_card_widget-sug-card,.ufs_tiles_card_widget-sug-link,.ufs_tiles_card_widget-sug-image-container,.ufs_tiles_card_widget-sug-image-"
        @"background){background-color:transparent!important;border-color:#494d4d!important;}.ufs_tiles_card_widget-suggestion :is(h1,h2,h3,h4,h5,h6,p,span,a,div){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}.ufs_tiles_card_widget-suggestion .ufs_tiles_card_widget-sug-text{background:#000!important;background-color:#000!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}.ufs_tiles_card_widget-suggestion .ufs_tiles_card_widget-sug-text *{color:#fff!important;-webkit-text-fill-color:#fff!important;}#search :is(.puis-product-insight-prompt-group,#rufus-overviews-pills-carousel,#rufus-mobile-overviews-expandable-pills-carousel-container,#rufus-overviews-category-cards-carousel){background-color:#000!important;border-color:#494d4d!important;box-shadow:none!important;}#nav-global-location-slot,#glow-ingress-block{background:#000!important;background-color:#000!important;background-image:none!important;border-color:#000!important;color:#f2f2f2!important;-webkit"
        @"-text-fill-color:#f2f2f2!important;box-shadow:none!important;}#nav-global-location-slot :is(span,a,p,div,label,strong,b),#glow-ingress-block :is(span,a,p,div,label,strong,b){color:#f2f2f2!important;-webkit-text-fill-color:#f2f2f2!important;}#nav-global-location-slot :is(svg,i),#glow-ingress-block :is(svg,i){background-color:transparent!important;color:#f2f2f2!important;fill:#f2f2f2!important;stroke:#f2f2f2!important;}#a-page :is(.s-mobile-toolbar,.sf-rib30-toolbar,.sf-rib30-panel,.sf-rib30-content){background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;border-color:#494d4d!important;}#a-page :is(.s-rib-toggle-container,.sf-rib30-dropdown-title,a.sf-rib30-dropdown-pill-option){background-color:#202324!important;border-color:#747a7c!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;box-shadow:none!important;}#a-page :is(.sf-mobile-rib-filter-icon,.sf-rib30-dropdown-arrow-icon){background-color:transparent!important;filt"
        @"er:brightness(0) invert(1) brightness(.88)!important;-webkit-filter:brightness(0) invert(1) brightness(.88)!important;}#a-page .sf-rib30-dropdown-pill-icon,#a-page i.a-icon-prime{filter:none!important;-webkit-filter:none!important;}#search :is(.puis-status-badge-container,.puis-status-badge-container .a-section,.puis-status-badge-container .rush-component,.puis-status-badge-container .a-badge,.puis-status-badge-container .a-badge-label,.puis-status-badge-container .a-badge-label-inner){background:#000!important;background-color:#000!important;background-image:none!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;box-shadow:none!important;}#search .puis-status-badge-container :is(i,svg,[class*=icon]){background-color:transparent!important;color:#d6d9d9!important;fill:#d6d9d9!important;stroke:#d6d9d9!important;filter:brightness(0) invert(1) brightness(.88)!important;-webkit-filter:brightness(0) invert(1) brightness(.88)!important;}#search#search .more-like-this"
        @"-container{background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;}#search#search .nile-ingress-pill-button,#search#search .nile-ingress-pill-button .a-button-inner{background:#4a4f51!important;background-color:#4a4f51!important;background-image:none!important;border-color:#747a7c!important;box-shadow:none!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}#search#search .nile-ingress-pill-button :is(span,div){color:#fff!important;-webkit-text-fill-color:#fff!important;}#search#search .haul-puis-widget-faceout-container{background:#000!important;background-color:#000!important;border-color:#000!important;outline-color:#000!important;box-shadow:none!important;}#search#search .haul-puis-widget-faceout-container > :not(.haul-puis-image-container):not(.haul-puis-widget-action-button){border-color:#000!important;outline-color:#000!important;box-shadow:none!important;}#search#search .haul-puis-widg"
        @"et-faceout-container > :not(.haul-puis-image-container):not(.haul-puis-widget-action-button){background:#000!important;background-color:#000!important;border-color:#000!important;outline-color:#000!important;box-shadow:none!important;}#search#search .s-coupon-tile,#search#search .s-coupon-tile-price-content,#search#search .s-coupon-unclipped,#search#search .s-coupon-highlight-color{background:#405a4a!important;background-color:#405a4a!important;background-image:none!important;border-color:#587161!important;box-shadow:none!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}#search#search .s-coupon-tile-text-content,#search#search .s-coupon-checkbox-label,#search#search .s-coupon-tile-price-content,#search#search .s-coupon-unclipped,#search#search .s-coupon-highlight-color{color:#fff!important;-webkit-text-fill-color:#fff!important;}#search#search :is(video.sbv-video-player-ecx,video._c2Itd_video_17g-f){color-scheme:light!important;accent-color:auto!important;filter:n"
        @"one!important;-webkit-filter:none!important;}#search#search :is(.sbv-video-pause-button-container,.sbv-video-mute-button-container,.sbv-mobile-video-play-click-region,._c2Itd_playClickRegion_87ZZa){background-color:transparent!important;border-color:transparent!important;outline-color:transparent!important;box-shadow:none!important;filter:none!important;-webkit-filter:none!important;}#search#search .puis-card-container.mobile-video-product-view.puis-card-border{background:#000!important;background-color:#000!important;border:1px solid #494d4d!important;border-color:#494d4d!important;outline-color:#494d4d!important;box-shadow:none!important;}#search#search .sbv-video-single-product .sbv-product-container,#search#search .sbv-video-single-product .sbv-product-container :is(.puisg-row,.puisg-col,.puisg-col-inner,.faceout-product-title,.faceout-product-review,.faceout-product-price,.puis-delivery-recipe,.udm-delivery-block){background-color:#000!important;border-color:#494d4d!important;outl"
        @"ine-color:#494d4d!important;box-shadow:none!important;}#search#search ._c2Itd_container_ut_MN.sb-video-creative{background:#000!important;background-color:#000!important;border:1px solid #494d4d!important;border-color:#494d4d!important;border-radius:4px!important;outline-color:#494d4d!important;box-shadow:none!important;overflow:hidden!important;}#search#search ._c2Itd_cardContent_3OGkG.sbv-ad-content-container,#search#search ._c2Itd_content_2L-a5,#search#search ._c2Itd_singleAsin_fHkKv{background:#000!important;background-color:#000!important;background-image:none!important;border-color:#494d4d!important;outline-color:#494d4d!important;box-shadow:none!important;}#search#search ._c2Itd_singleAsin_fHkKv{border:1px solid #494d4d!important;}#search#search ._c2Itd_singleAsin_fHkKv :is(._c2Itd_pdCntr_2lxVH,._c2Itd_pdRowCntr_1SQrE,._c2Itd_pdImgCol_3WO1V,._c2Itd_pdcol_3gSOx,.productDetailsContainer){background-color:#000!important;border-color:#494d4d!important;outline-color:#494d4d!important"
        @";box-shadow:none!important;}#search#search ._c2Itd_singleAsin_fHkKv :is(.productDetailsContainer,._c2Itd_productTitle_1rGyG,._c2Itd_reviewStars_1pJ4C,._c2Itd_badgeContainer_3rI4l,._c2Itd_dealMessage_1qaio,._c2Itd_priceLinkContainer_6y-Wc,._c2Itd_savingPercentage_3sw1C){background-color:transparent!important;box-shadow:none!important;}#search#search ._c2Itd_singleAsin_fHkKv :is(._c2Itd_singleProductImageContainer_1xhVQ,._c2Itd_productImageLinkContainer_3novt,a._c2Itd_productImageLink_2cbWY){background-color:transparent!important;box-shadow:none!important;}#search#search ._c2Itd_singleAsin_fHkKv img._c2Itd_image_pQREQ{display:block!important;visibility:visible!important;position:relative!important;z-index:6!important;background-color:transparent!important;mix-blend-mode:normal!important;}#search :is(.sf-mobile-rib-filter-icon,.sf-rib30-dropdown-arrow-icon,.rufus-expandable-pills-chevron){background-color:transparent!important;color:#d6d9d9!important;fill:#d6d9d9!important;stroke:#d6d9d9!"
        @"important;}#search#search .s-rib-toggle-icon{background:transparent!important;background-color:transparent!important;filter:none!important;-webkit-filter:none!important;mix-blend-mode:normal!important;opacity:1!important;}#search#search .s-rib-toggle-container{background:transparent!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;filter:none!important;-webkit-filter:none!important;}#search#search .sf-rib30-dropdown-pill-icon{background-color:#202324!important;border-color:#747a7c!important;box-shadow:none!important;filter:none!important;-webkit-filter:none!important;mix-blend-mode:normal!important;opacity:1!important;}#search#search .sf-rib30-review-star{filter:none!important;-webkit-filter:none!important;mix-blend-mode:normal!important;opacity:1!important;}#search#search .sf-rib30-dropdown-pill-icon .sf-rib30-review-content,#search#search .sf-rib30-dropdown-pill-icon .sf-rib30-review-stars-gr"
        @"oup{background:transparent!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;filter:none!important;-webkit-filter:none!important;}#search#search .sf-rib30-dropdown-title > .a-declarative > .sf-rib30-title-content-container,#search#search .sf-rib30-dropdown-title .sf-rib30-title-content-container .sf-rib30-dropdown-pill-content,#search#search .sf-rib30-dropdown-title .sf-rib30-title-content-container .sf-rib30-dropdown-pill-text{background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;filter:none!important;-webkit-filter:none!important;}#search#search .sf-rib30-dropdown-title{background:#202324!important;background-color:#202324!important;border-color:#747a7c!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;box-shadow:none!important;}#search#search .sf-rib30-dropdown-title .sf-rib30-dropdown-arrow-"
        @"icon{background:transparent!important;background-color:transparent!important;background-image:none!important;filter:none!important;-webkit-filter:none!important;box-shadow:none!important;position:relative!important;}#search#search .sf-rib30-dropdown-title .sf-rib30-dropdown-arrow-icon::before{content:\\\"\\\"!important;display:block!important;position:absolute!important;left:1px!important;top:-1px!important;width:5px!important;height:5px!important;background:transparent!important;background-color:transparent!important;border:0!important;border-right:1.5px solid #d6d9d9!important;border-bottom:1.5px solid #d6d9d9!important;box-sizing:border-box!important;transform:rotate(45deg)!important;-webkit-transform:rotate(45deg)!important;filter:none!important;-webkit-filter:none!important;}#search#search .sf-rib30-dropdown-title .sf-rib30-dropdown-arrow-icon::after{content:none!important;}#search#search .rufus-expandable-pills-chevron{background:transparent!important;background-color:transparent"
        @"!important;border-color:transparent!important;box-shadow:none!important;}#search#search .rufus-expandable-pills-chevron img{background-color:transparent!important;filter:none!important;-webkit-filter:none!important;mix-blend-mode:normal!important;opacity:1!important;}#search#search :is(#rufus-overviews-pills-carousel,#rufus-mobile-overviews-expandable-pills-carousel-container) .a-carousel-card{background:transparent!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;}#search#search :is(#rufus-overviews-pills-carousel,#rufus-mobile-overviews-expandable-pills-carousel-container) :is(.nile-inline-pill-button,.nile-inline-ingress-pill-button,.a-button,[role=button],.a-carousel-card>a){background:#4a4f51!important;background-color:#4a4f51!important;background-image:none!important;border:1px solid #34383a!important;border-color:#34383a!important;box-shadow:none!important;color:#fff!important;-webkit-te"
        @"xt-fill-color:#fff!important;}#search#search :is(#rufus-overviews-pills-carousel,#rufus-mobile-overviews-expandable-pills-carousel-container) :is(.nile-inline-pill-button,.nile-inline-ingress-pill-button,.a-button,[role=button],.a-carousel-card>a) .a-button-inner{background:#4a4f51!important;background-color:#4a4f51!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}#search#search :is(#rufus-overviews-pills-carousel,#rufus-mobile-overviews-expandable-pills-carousel-container) :is(.nile-inline-pill-button,.nile-inline-ingress-pill-button,.a-button,[role=button],.a-carousel-card>a) .a-button-text{background:transparent!important;background-color:transparent!important;background-image:none!important;border:0!important;box-shadow:none!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}#search#search :is(#rufus-overviews-pills-carousel,#rufus-mobile-overviews-"
        @"expandable-pills-carousel-container) :is(.nile-inline-pill-button,.nile-inline-ingress-pill-button,.a-button,[role=button],.a-carousel-card>a) :is(.a-button-text,span,p,strong,b,div){color:#fff!important;-webkit-text-fill-color:#fff!important;}#search#search :is(#rufus-overviews-pills-carousel,#rufus-mobile-overviews-expandable-pills-carousel-container) :is(.nile-inline-pill-button,.nile-inline-ingress-pill-button,.a-button,[role=button],.a-carousel-card>a)::before,#search#search :is(#rufus-overviews-pills-carousel,#rufus-mobile-overviews-expandable-pills-carousel-container) :is(.nile-inline-pill-button,.nile-inline-ingress-pill-button,.a-button,[role=button],.a-carousel-card>a)::after{background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;}#search #rufus-overviews-category-cards-carousel .a-carousel-card,#search #rufus-overviews-category-cards-carousel .a-carousel-card > .a-box,#search #rufus-overviews-category"
        @"-cards-carousel .a-carousel-card > .a-box > .a-box-inner{background:#000!important;background-color:#000!important;border-color:#494d4d!important;box-shadow:none!important;}#search #rufus-overviews-category-cards-carousel .a-carousel-card :is(span,a,p,strong,b,div){color:#fff!important;-webkit-text-fill-color:#fff!important;}#search#search .puis-atcb-button{background:#000!important;background-color:#000!important;border:1px solid #747a7c!important;box-shadow:inset 0 0 0 1px #747a7c!important;filter:none!important;-webkit-filter:none!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#search#search .puis-atcb-button .a-button-inner{background:transparent!important;background-color:transparent!important;border-color:transparent!important;box-shadow:none!important;}#search#search .puis-atcb-button .a-button-text{color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}.puis-mab-chevron :is(i.a-icon-dropdown,.a-icon.a-icon-dropdown),.puis-mab-chevron-gl"
        @"yph :is(i.a-icon-dropdown,.a-icon.a-icon-dropdown){filter:brightness(0) invert(1)!important;opacity:1!important;}#search [data-a-badge-color=\\\"sx-cloud\\\"],#search [data-a-badge-color=\\\"sx-cloud\\\"] :is(.a-badge-label,.a-badge-label-inner,.a-badge-text){background:transparent!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;color:#ffd814!important;-webkit-text-fill-color:#ffd814!important;}#search [data-a-badge-color=\\\"sx-cloud\\\"]::before,#search [data-a-badge-color=\\\"sx-cloud\\\"]::after,#search [data-a-badge-color=\\\"sx-cloud\\\"] :is(.a-badge-label,.a-badge-label-inner)::before,#search [data-a-badge-color=\\\"sx-cloud\\\"] :is(.a-badge-label,.a-badge-label-inner)::after{background:transparent!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;}#search .a-color-success{background:transparen"
        @"t!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;color:#00a650!important;-webkit-text-fill-color:#00a650!important;}#search .a-badge[data-a-badge-type=\\\"deal\\\"]{background:transparent!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}#search .a-badge[data-a-badge-type=\\\"deal\\\"]>.a-badge-label{background:#cc0c39!important;background-color:#cc0c39!important;background-image:none!important;border-color:#cc0c39!important;box-shadow:none!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}#search .a-badge[data-a-badge-type=\\\"deal\\\"] .a-badge-label-inner{background:transparent!important;background-color:transparent!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}#search .puis-ad-feedback-info-ic"
        @"on{color:#b1aaa0!important;-webkit-text-fill-color:#b1aaa0!important;background-color:transparent!important;}#search .puis-ad-feedback-info-icon b[class*=\\\"ad-feedback-sprite\\\"]{color:#b1aaa0!important;background-color:#b1aaa0!important;filter:none!important;-webkit-filter:none!important;}#search>div,#search>section,#search>article,#search .s-main-slot>div,#search .s-main-slot>section,#search .s-main-slot>article{background-color:#000!important;background-image:none!important;box-shadow:none!important;}#search :is(div,section,article)[class*=rufus],#search :is(div,section,article)[id*=rufus],#search :is(div,section,article)[class*=alexa],#search :is(div,section,article)[id*=alexa],#search :is(div,section,article)[class*=research],#search :is(div,section,article)[id*=research]{background:#000!important;background-color:#000!important;border-color:#494d4d!important;box-shadow:none!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#search .sf-rib30-panel .a-"
        @"button,#search .sf-rib30-panel .a-button-inner,#search .sf-rib30-panel button{background:#202324!important;background-color:#202324!important;background-image:none!important;border-color:#747a7c!important;box-shadow:none!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#search .sf-rib30-panel .a-button-text{background:transparent!important;background-color:transparent!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#search .a-badge[data-a-badge-type=\\\"deal\\\"],#search .a-badge[data-a-badge-type=\\\"deal\\\"] *,#search .a-badge[id^=DEAL_],#search .a-badge[id^=DEAL_] *{color:#fff!important;-webkit-text-fill-color:#fff!important;}#search .mlt-icon-container :is(img,svg,i,[class*=glyph],[class*=icon]){color:#0f1111!important;fill:#0f1111!important;stroke:#0f1111!important;filter:brightness(0)!important;-webkit-filter:brightness(0)!important;opacity:1!important;mix-blend-mode:normal!important;}#search img.scx-stt-image{background-c"
        @"olor:transparent!important;mix-blend-mode:normal!important;}#search [class^=\\\"scx-stt-\\\"]:not(img),#search [class*=\\\" scx-stt-\\\"]:not(img){color:#fff!important;-webkit-text-fill-color:#fff!important;}\");}else{s=put('ad7-menu-theme',\"html,body,#a-page,#gwm-PageContent,#dp,main,[role=main],#cart-page,#sc-active-cart,#sc-saved-cart{background:#000!important;background-color:#000!important;}.s-main-slot,#sc-active-cart .sc-list-item,#sc-saved-cart .sc-list-item,[class*=sc-][class*=content],[class*=sc-][class*=container],#dp [class*=a-box],#dp [class*=a-expander],#dp [class*=celwidget]:not([class*=image]):not([class*=media]),#authportal-main-section,#auth-footer,.auth-footer,[id*=auth-footer],[class*=variation],[class*=swatch-container],[class*=status-shell],[class*=badge-message],[class*=puis-card]:not([class*=creative]):not([class*=image]),[class*=product-card]:not([class*=image]){background-color:#181a1b!important;}[class*=suggestion]:not([class*=icon]):not([class*=glyph]){back"
        @"ground:#000!important;background-color:#000!important;color:#e8e6e3!important;}#sc-active-cart .sc-list-item,#sc-saved-cart .sc-list-item,#dp .a-box,#dp .a-divider,#dp [class*=card],#auth-footer .a-divider,.auth-footer .a-divider,[class*=swatch-outer-circle],[class*=puis-card]{border-color:#494d4d!important;outline-color:#494d4d!important;}.a-divider-inner:after,.a-divider-inner:before,hr,[class*=separator]{border-color:#494d4d!important;background-color:#494d4d!important;}#wd-backdrop-gradient,.wd-backdrop-gradient,[class*=wd-backdrop-gradient],[class*=a-reactive-container],[class*=reactive-contain],#auth-footer,.auth-footer,[id*=auth-footer]{background-image:none!important;box-shadow:none!important;}#auth-footer .a-divider-inner,.auth-footer .a-divider-inner{background-image:none!important;box-shadow:none!important;}.s-color-swatch-container,.s-color-swatch-outer-circle{background-color:transparent!important;}.s-color-swatch-outer-circle{border-color:#494d4d!important;outline-color:#"
        @"494d4d!important;}[class*=nav-search] img,[class*=searchbar] img,[class*=search-bar] img,[role=search] img,[class*=nav-] img[class*=icon],[class*=header] img[class*=icon]{background-color:transparent!important;}.puis-mab-overlay-row-share .puis-mab-overlay-icon-share{background-color:#e8e6e3!important;color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;filter:none!important;}:is(#gwm-PageContent,#gwm-Deck-btf) :is(.a-cardui,[class*=asin-container],[class*=mosaic-card],[class*=p13n-uf],[class*=hp-mosaic-container_style_container],[class*=_mosaic-container_style_widgetContainer]){background-color:#000!important;border-color:#494d4d!important;mix-blend-mode:normal!important;isolation:auto!important;}.gwm-dashboard-container :is(.a-cardui,[class*=asin-container],[class*=mosaic-card],[class*=p13n-uf]){background-color:#000!important;border-color:#494d4d!important;mix-blend-mode:normal!important;isolation:auto!important;}:is(#gwm-PageContent,#gwm-Deck-btf,#gwm-Deck,.gwm-d"
        @"ashboard-container) :is(.a-cardui,[class*=asin-container],[class*=mosaic-card],[class*=p13n-uf]) img:not([class*=logo]):not([class*=avatar]):not([class*=profile]):not([class*=merchant]):not([class*=seller]):not([class*=brand]):not([class*=store]):not([class*=rating]):not([class*=star]):not([class*=sprite]):not([class*=pixel]):not([class*=icon]):not([class*=glyph]):not([class*=badge]):not([class*=checkbox]):not([class*=heart]):not([class*=wishlist]):not(:where([class*=sponsored] *)):not(:where([class*=ad-feedback] *)):not(:where([class*=adFeedback] *)):not(:where([id^=ad-feedback-] *)):not(:where([id^=af-label-] *)){mix-blend-mode:normal!important;isolation:auto!important;background-color:transparent!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) :is(.a-cardui,[class*=asin-container],[class*=mosaic-card],[class*=p13n-uf]) :is(picture,[class*=image-wrapper],[class*=img-wrapper],[class*=image-container]){mix-blend-mode:normal!important;isolation:auto!important;background-color:tra"
        @"nsparent!important;}:is(#gwm-PageContent,#gwm-Deck-btf,#gwm-Deck,.gwm-dashboard-container) :is(.a-cardui,[class*=asin-container],[class*=mosaic-card],[class*=p13n-uf]) [class*=asin-metadata]{mix-blend-mode:normal!important;isolation:auto!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) [class*=multi-category-card] img{mix-blend-mode:normal!important;isolation:auto!important;background-color:transparent!important;}:is(#gwm-PageContent,#gwm-Deck-btf,#gwm-Deck,.gwm-dashboard-container) [class*=badgeMessage]{background-color:transparent!important;box-shadow:none!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) :is(.a-cardui,[class*=asin-container],[class*=mosaic-card],[class*=p13n-uf]) :is(h1,h2,h3,h4,h5,h6,p,span,a):not([class*=sponsored]):not([class*=ad-feedback]):not([class*=adFeedback]):not([id^=ad-feedback-text-]):not([id^=af-label-primary-link-]):not(:where([class*=sponsored] *)):not(:where([class*=ad-feedback] *)):not(:where([class*=adFeedback] *)):not(:where([id^=ad-fee"
        ...
        @"):not([id^=ad-feedback-text-]):not([id^=af-label-primary-link-]):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not(:where([class*=badge] *)):not(:where([class*=deal] *)):not(:where([class*=coupon] *)):not(:where([class*=sponsored] *)):not(:where([class*=ad-feedback] *)):not(:where([class*=adFeedback] *)):not(:where([id^=ad-feedback-] *)):not(:where([id^=af-label-] *)):not(:where([class*=hero] *)):not(:where([class*=single-creative] *)):not(:where([class*=single-video] *)):not(:where([class*=theming-card] *)):not(:where([class*=creative-card] *)):not(:where([class*=ad-card] *)):not(:where([class*=canvas-card] *)):not(:where([class*=mobile-mshop-ad] *)):not(:where([class*=mobile-ad-container] *)):not(:where(#mobile-third-party-ad *)):not(:where([class*=ape-wrapper] *)):not(:where([class*=ape-placement] *)){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) .a-cardui-header :is(h1,h2,h3,h4,h5,h6,a,span,p):not([class"
        @"*=sponsored]):not([class*=ad-feedback]):not([class*=adFeedback]):not([id^=ad-feedback-text-]):not([id^=af-label-primary-link-]){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) .a-cardui :is([class*=wpTitle],[class*=windowPaneHeaderContainer]){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) :is(h1,h2,h3,h4,h5,h6):not([class*=sponsored]):not([class*=ad-feedback]):not([class*=adFeedback]):not([id^=ad-feedback-text-]):not([id^=af-label-primary-link-]):not(:where([class*=sponsored] *)):not(:where([class*=ad-feedback] *)):not(:where([class*=adFeedback] *)):not(:where([id^=ad-feedback-] *)):not(:where([id^=af-label-] *)):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not(:where([class*=badge] *)):not(:where([class*=deal] *)):not(:where([class*=coupon] *)):not(:where([class*=hero] *)):not(:where([class*=single-creative] *)):not(:where([class*=single-video] "
        @"*)):not(:where([class*=theming-card] *)):not(:where([class*=creative-card] *)):not(:where([class*=ad-card] *)):not(:where([class*=canvas-card] *)):not(:where([class*=mobile-mshop-ad] *)):not(:where([class*=mobile-ad-container] *)):not(:where([class*=ape-wrapper] *)):not(:where([class*=ape-placement] *)){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}:is(#gwm-PageContent,#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=hp-mosaic-container],[class*=_mosaic-container_style_widgetContainer]) :is(div,section,article,ul,ol,li,a,p,span,h1,h2,h3,h4,h5,h6):not([class*=sponsored]):not([class*=ad-feedback]):not([class*=adFeedback]):not([id^=ad-feedback-text-]):not([id^=af-label-primary-link-]){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}:is(#gwm-PageContent,#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=hp-mosaic-container],[class*=_mosaic-container_style_widgetContainer]) :is([class*=next],[class*=prev],[class*=chevron],[class*=arrow]){color:#e8"
        @"e6e3!important;-webkit-text-fill-color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;}.puis-mab-chevron :is(i.a-icon-dropdown,.a-icon.a-icon-dropdown),.puis-mab-chevron-glyph :is(i.a-icon-dropdown,.a-icon.a-icon-dropdown){filter:brightness(0) invert(1)!important;opacity:1!important;}:is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf,.gwm-dashboard-container) i.a-icon.a-icon-dropdown,:is(#gwm-PageContent,#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=hp-mosaic-container],[class*=_mosaic-container_style_widgetContainer],[class*=_npack-asin-card_style_theming-background-override__]) :is([class*=next],[class*=prev],[class*=chevron],[class*=arrow]) :is(i.a-icon,.a-icon,[class*=glyph]),:is(#gwm-PageContent,#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=hp-mosaic-container],[class*=_mosaic-container_style_widgetContainer],[class*=_npack-asin-card_style_theming-background-override__]) :is(i.a-icon-dropdown,i[class*=chevron],i[class*=arrow]){filter:brightness(0) invert(1"
        @")!important;-webkit-filter:brightness(0) invert(1)!important;opacity:1!important;}i.a-icon.a-icon-dropdown,.a-icon.a-icon-dropdown,i[class*=chevron],i[class*=arrow],[class*=chevron-glyph],[class*=puis-mab-chevron] :is(i.a-icon-dropdown,.a-icon.a-icon-dropdown){filter:brightness(0) invert(1) brightness(0.91)!important;-webkit-filter:brightness(0) invert(1) brightness(0.91)!important;opacity:1!important;visibility:visible!important;mix-blend-mode:normal!important;}:is([class*=a-cardui],[class*=npack-asin-card],[class*=gwm-asin-tile],[class*=gwm-window-layout],[class*=window-container],[class*=gwm-dashboard-container],[class*=wd-backdrop],[class*=theming-card],[class*=a-unordered-list],[class*=mosaic-container],[class*=puis-card],[class*=gwm-tile],[class*=_container_]):not([class*=deal]):not([class*=badge]):not([class*=prime]):not([class*=error]):not([class*=alert]):not([class*=warning]){border-color:#3b4043!important;outline-color:#3b4043!important;}:is([class*=hp-mosaic-container],[clas"
        @"s*=_mosaic-container_style_widgetContainer]) :is(div,section,article,ul,ol,li){border-color:#3b4043!important;outline-color:#3b4043!important;}[data-csa-c-painter=amazon-shopping-guides-quad-card-cards] [class*=_colored-background_],[data-csa-c-painter=amazon-shopping-guides-quad-card-cards] [class*=_product-image_],[data-csa-c-painter=amazon-shopping-guides-quad-card-cards] [class*=_image_]{mix-blend-mode:normal!important;isolation:auto!important;}[data-csa-c-painter=amazon-shopping-guides-quad-card-cards] [class*=_colored-background_]{background:#000!important;background-color:#000!important;border-color:#000!important;outline-color:#000!important;box-shadow:none!important;transition-property:none!important;}html[data-ad7-standalone-candidate] :is(body,#ad,section[data-is-ad=true],[data-testid=ad-background-container]){background:#000!important;background-color:#000!important;color:#e8e6e3!important;}html[data-ad7-standalone-candidate] [data-testid=ad-background-container]{background"
        @":#000!important;background-color:#000!important;background-image:none!important;border-color:#3b4043!important;outline-color:#3b4043!important;box-shadow:none!important;}html[data-ad7-standalone-candidate] [data-testid=ad-background-container] > div{background:#000!important;background-color:#000!important;background-image:none!important;}html[data-ad7-standalone-candidate] #ad[data-html-dimensions=\\\"300x250\\\"]{background:#000!important;background-color:#000!important;}html[data-ad7-standalone-candidate] #ad[data-html-dimensions=\\\"300x250\\\"] [data-testid=gridContainer]{background:#000!important;background-color:#000!important;background-image:none!important;}html[data-ad7-standalone-candidate] #ad[data-html-dimensions=\\\"300x250\\\"] :is(div,section,article,main,header,footer,ul,ol,li):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=prime]):not(:where([class*=badge] *)):not(:where([class*=deal] *)):not(:where([class*=coupon] *)):not(:where([class*=prime"
        @"] *)){background-color:transparent!important;}html[data-ad7-standalone-candidate] #ad[data-html-dimensions=\\\"300x250\\\"] .swiper-slide > [class*=border-gray-]{border-color:#3b4043!important;outline-color:#3b4043!important;box-shadow:none!important;}html[data-ad7-standalone-candidate] #ad[data-html-dimensions=\\\"300x250\\\"] :is(h1,h2,h3,h4,h5,h6,p,span,a,strong,small,b,em,label,div):not(div:has([class*=prime],[data-testid*=prime],[class*=star],[data-testid*=star])):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=prime]):not([class*=star]):not([class*=sponsored]):not([class*=ad-feedback]):not([class*=adFeedback]):not([data-testid*=prime]):not([data-testid*=star]):not(:where([data-testid*=prime] *)):not(:where([data-testid*=star] *)):not(:where([class*=badge] *)):not(:where([class*=deal] *)):not(:where([class*=coupon] *)):not(:where([class*=prime] *)):not(:where([class*=star] *)):not(:where([class*=ad-feedback] *)):not(:where([class*=adFeedback] *)){color:#e8e"
        @"6e3!important;-webkit-text-fill-color:#e8e6e3!important;}html[data-ad7-standalone-candidate] #ad[data-html-dimensions=\\\"300x250\\\"] :is(div,span,p,a,small,strong,b)[class*=sponsored],html[data-ad7-standalone-candidate] #ad[data-html-dimensions=\\\"300x250\\\"] :is(div,span,p,a,small,strong,b)[data-testid*=sponsored]{color:#b1aaa0!important;-webkit-text-fill-color:#b1aaa0!important;opacity:1!important;}html[data-ad7-standalone-candidate] [data-testid=renderer-factory-ad-container] [data-testid^=modern-][data-testid$=-layout-container]{background:#000!important;background-color:#000!important;border-color:#3b4043!important;outline-color:#3b4043!important;box-shadow:none!important;}html[data-ad7-standalone-candidate] [data-testid=renderer-factory-ad-container] [data-testid=content]{background:#000!important;background-color:#000!important;}html[data-ad7-standalone-candidate] #dynamic-bb [data-testid=deal-badge] > div[style*=\\\"background-color: rgb(255, 255, 255)\\\"]{background-color"
        @":transparent!important;box-shadow:none!important;}html[data-ad7-standalone-candidate] [data-testid=renderer-factory-ad-container] :is([data-id=brand-name-text],[data-id=product-name-text],[data-testid=ratings-value],[data-testid=formatted-price],[data-testid=formatted-price] *){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}html[data-ad7-standalone-candidate] [data-testid=renderer-factory-ad-container] :is([data-testid=ratings-review-count],[data-testid=full-price]){color:#b1aaa0!important;-webkit-text-fill-color:#b1aaa0!important;}html[data-ad7-standalone-candidate] [data-testid=brand-product-description] p,html[data-ad7-standalone-candidate] [data-testid=ratings-value],html[data-ad7-standalone-candidate] [data-testid=price-container] :is(div,span):not([data-testid=full-price]):not([data-testid=prime-badge]):not(:where([data-testid=prime-badge] *)),html[data-ad7-standalone-candidate] [data-testid=sns-coupon-badge-container] :is(div,span,p),html[data-ad7-standalone-"
        @"candidate] [data-testid=ad-background-container] :is(p,span,div,a,small,strong,b)[style*=\\\"color: rgb(15, 17, 17)\\\"]:not(:where([data-testid=ratings-stars] *)):not(:where([data-testid=prime-badge] *)),html[data-ad7-standalone-candidate] [data-testid=ad-background-container] :is(p,span,div,a,small,strong,b)[style*=\\\"color: black\\\"]:not(:where([data-testid=ratings-stars] *)):not(:where([data-testid=prime-badge] *)){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}html[data-ad7-standalone-candidate] [data-testid=ratings-review-count],html[data-ad7-standalone-candidate] [data-testid=full-price],html[data-ad7-standalone-candidate] [data-testid=ad-background-container] :is(p,span,div,a,small,strong,b)[style*=\\\"color: rgb(86, 89, 89)\\\"],html[data-ad7-standalone-candidate] [data-testid=ad-background-container] :is(p,span,div,a,small,strong,b)[style*=\\\"color:#565959\\\"]{color:#b1aaa0!important;-webkit-text-fill-color:#b1aaa0!important;}html[data-ad7-standalone-c"
        @"andidate] :is([data-testid*=product-picture],[data-testid*=product-image],[data-testid*=asin-image],picture){background-color:transparent!important;box-shadow:none!important;}picture,img,video,canvas,#imgTagWrapperId,.s-product-image-container,[data-component-type=s-product-image],[class*=image-wrapper],[class*=img-wrapper],[class*=image-container],[class*=product-image],[class*=asin-image]{background-color:transparent!important;}[class*=ape-wrapper],[class*=ape-placement],[class*=ape-feedback]:not(:where(#gwm-window *)):not(:where([class*=single-creative-card] *)):not(:where([class*=single-video-card] *)):not([id*=mobile-wd-]){background-color:transparent!important;border-color:transparent!important;outline-color:transparent!important;box-shadow:none!important;}iframe[id*=ape_],iframe[class*=ape_]{background-color:transparent!important;border-color:transparent!important;outline-color:transparent!important;}.ape-wrapper[style*=\\\"--ad-height:50\\\"] > .ape-placement[style*=\\\"aspect-"
        @"ratio: 320 / 50\\\"]{border-color:#3b4043!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=mobile-mshop-ad],[class*=mobile-ad-container]):has(:is([class*=carousel],[data-testid*=carousel])){background:#000!important;background-color:#000!important;border-color:#3b4043!important;outline-color:#3b4043!important;box-shadow:none!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=mobile-mshop-ad],[class*=mobile-ad-container]):has(:is([class*=carousel],[data-testid*=carousel])) :is(div,section,article,main,header,footer,ul,ol,li):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=prime]):not(:where([class*=badge] *)):not(:where([class*=deal] *)):not(:where([class*=coupon] *)):not(:where([class*=prime] *)){background-color:transparent!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=mobile-mshop-ad],[class*=mobile-ad-container]):has(:is([class*=carousel],[data-testid*=carousel])) :is(h1,h2,h3,h4,h5,h6,p,span,a,strong,sma"
        @"ll,b,em,label):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=prime]):not([class*=sponsored]):not([class*=ad-feedback]):not([class*=adFeedback]):not([data-testid=prime-badge]):not(:where([data-testid=prime-badge] *)):not(:where([class*=badge] *)):not(:where([class*=deal] *)):not(:where([class*=coupon] *)):not(:where([class*=prime] *)):not(:where([class*=ad-feedback] *)):not(:where([class*=adFeedback] *)){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}:is(#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=mobile-mshop-ad],[class*=mobile-ad-container]):has(:is([class*=carousel],[data-testid*=carousel])) :is(span,p,a,small,strong,b)[class*=sponsored],:is(#gwm-Deck-btf,.gwm-dashboard-container) :is([class*=mobile-mshop-ad],[class*=mobile-ad-container]):has(:is([class*=carousel],[data-testid*=carousel])) :is(span,p,a,small,strong,b)[data-testid*=sponsored]{color:#b1aaa0!important;-webkit-text-fill-color:#b1aaa0!important;opacity:1!important;}:is"
        @"([class*=ad-feedback-text],[class*=ad-feedback-text-desktop],[id^=ad-feedback-text-],[id^=af-label-primary-link-],[aria-label^=\\\"Leave feedback on Sponsored\\\"]):not(:where(#gwm-window [id^=wd-shoppable-] *)):not(:where([id*=mobile-wd-] *)):not(:where([class*=single-creative-card] *)):not(:where([class*=single-video-card] *)):is(:focus,:focus-visible){outline:none!important;box-shadow:none!important;-webkit-tap-highlight-color:transparent!important;}body:has([id^=adFeedbackBottomSheet_]) :is(.a-sheet-web-container,.a-sheet-web,.a-sheet-content-container),body:has([id^=adFeedbackBottomSheet_]) [class*=ad-feedback-bottom-sheet-container],body:has([id^=adFeedbackBottomSheet_]) :is(#af-form-top-container,#mobile-ad-feedback-container){background:#000!important;background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}body:has([id^=adFeedbackBottomSheet_]) :is(#af-form-top-container,#mobile-ad-feedback-container) :is(div,section,article,form,field"
        @"set,header,footer){background-color:transparent!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}body:has([id^=adFeedbackBottomSheet_]) :is(#af-form-top-container,#mobile-ad-feedback-container) :is(h1,h2,h3,h4,h5,h6,p,span,label,legend,small,strong,b,a){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}body:has([id^=adFeedbackBottomSheet_]) #mobile-ad-feedback-container textarea{background:#303335!important;background-color:#303335!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;border-color:#6f6f6f!important;box-shadow:none!important;}body:has([id^=adFeedbackBottomSheet_]) #mobile-ad-feedback-container input[type=checkbox]{background-color:#000!important;border-color:#b1aaa0!important;accent-color:#303335!important;color-scheme:dark!important;}body:has([id^=adFeedbackBottomSheet_]) #mobile-ad-feedback-container :is(.a-icon-checkbox,i.a-icon-checkbox){filter:invert(1)!important;-webkit-filter:invert(1)!important;o"
        @"pacity:1!important;}body:has([id^=adFeedbackBottomSheet_]) #mobile-ad-feedback-container :is(.a-button,.a-button-inner,button,input[type=button],input[type=submit]){background:#181a1b!important;background-color:#181a1b!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;border-color:#6f6f6f!important;box-shadow:none!important;}body:has([id^=adFeedbackBottomSheet_]) #mobile-ad-feedback-container :is(button,input[type=button],input[type=submit]):disabled,body:has([id^=adFeedbackBottomSheet_]) #mobile-ad-feedback-container .a-button-disabled{background:#181a1b!important;background-color:#181a1b!important;color:#8a8a8a!important;-webkit-text-fill-color:#8a8a8a!important;border-color:#494d4d!important;}input:not([type=button]):not([type=submit]),textarea,select{background-color:#181a1b!important;color:#e8e6e3!important;border-color:#494d4d!important;}::placeholder{color:#b1aaa0!important;opacity:1!important;}[class*=header-icon],[class*=header-icon] path,[class*=head"
        @"er-icon] use,[class*=header-link] svg path,[class*=cardui-header] svg path,a[class*=header-link] path,[class*=see-more] path,[class*=view-all] path{fill:#e8e6e3!important;stroke:#e8e6e3!important;color:#e8e6e3!important;opacity:1!important;}[class*=hp-mosaic-container] .a-icon-next-rounded,[class*=hp-mosaic-container] .a-icon-previous-rounded,[class*=hp-mosaic-container] [class*=chevron],[class*=hp-mosaic-container] [class*=arrow],[class*=_mosaic-container_style_widgetContainer] .a-icon-next-rounded,[class*=_mosaic-container_style_widgetContainer] .a-icon-previous-rounded,[class*=_mosaic-container_style_widgetContainer] [class*=chevron],[class*=_mosaic-container_style_widgetContainer] [class*=arrow],.a-icon-next-rounded,.a-icon-previous-rounded{filter:brightness(0) invert(1)!important;-webkit-filter:brightness(0) invert(1)!important;opacity:1!important;color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;}:is([class*=_npack-asin-card_style_ad-feedback-spr],[class*=_n"
        @"pack-asin-card_style_ad-feedback-sprite],[class*=_cXVhZ_ad-feedback-spr],[class*=_cXVhZ_ad-feedback-sprite],[class*=_sponsored-products-mo]):not(:where(#gwm-window [id^=wd-shoppable-] *)):not(:where([id*=mobile-wd-] *)):not(:where([class*=single-creative-card] *)):not(:where([class*=single-video-card] *)){color:#e8e6e3!important;background-color:#e8e6e3!important;filter:none!important;-webkit-filter:none!important;opacity:1!important;}html body [data-ad-feedback-label-id] b[class*=ad-feedback-sprite-mobile][class*=labelThemeStyle_ad-feedback-sprite-mobile]:not(:where(#gwm-window [id^=wd-shoppable-] *)):not(:where([id*=mobile-wd-] *)):not(:where([class*=single-creative-card] *)):not(:where([class*=single-video-card] *)),html body [data-ad-feedback-label-id] b[class*=ad-feedback-sprite-mobile]:not(:where(#gwm-window [id^=wd-shoppable-] *)):not(:where([id*=mobile-wd-] *)):not(:where([class*=single-creative-card] *)):not(:where([class*=single-video-card] *)){color:inherit!important;backgro"
        @"und-color:currentColor!important;background-image:none!important;-webkit-mask-image:url(https://m.media-amazon.com/images/G/01/ad-feedback/new_info_icon_3x.png)!important;mask-image:url(https://m.media-amazon.com/images/G/01/ad-feedback/new_info_icon_3x.png)!important;-webkit-mask-size:contain!important;mask-size:contain!important;-webkit-mask-repeat:no-repeat!important;mask-repeat:no-repeat!important;-webkit-mask-position:center!important;mask-position:center!important;filter:none!important;-webkit-filter:none!important;opacity:1!important;}html body :is([class*=widget-sponsored-badge-container],[class*=asin-sponsored-badge-container]) [data-ad-feedback-label-id] [class*=ad-feedback-text]{color:#b1aaa0!important;-webkit-text-fill-color:#b1aaa0!important;opacity:1!important;}html body :is([class*=widget-sponsored-badge-container],[class*=asin-sponsored-badge-container]) [data-ad-feedback-label-id] [class*=ad-feedback-text] > b[class*=ad-feedback-sprite-mobile]{color:#b1aaa0!important;b"
        @"ackground-color:#b1aaa0!important;background-image:none!important;-webkit-mask-image:url(https://m.media-amazon.com/images/G/01/ad-feedback/new_info_icon_3x.png)!important;mask-image:url(https://m.media-amazon.com/images/G/01/ad-feedback/new_info_icon_3x.png)!important;-webkit-mask-size:contain!important;mask-size:contain!important;-webkit-mask-repeat:no-repeat!important;mask-repeat:no-repeat!important;-webkit-mask-position:center!important;mask-position:center!important;filter:none!important;-webkit-filter:none!important;opacity:1!important;}html body :is(.ape-feedback,[id^=ape_][id*=\\\"_Feedback\\\"]):not(:where(#gwm-window [id^=wd-shoppable-] *)):not(:where([id*=mobile-wd-] *)):not(:where([class*=single-creative-card] *)):not(:where([class*=single-video-card] *)) [id^=ad-feedback-text-]{color:#b1aaa0!important;-webkit-text-fill-color:#b1aaa0!important;opacity:1!important;}html body :is(.ape-feedback,[id^=ape_][id*=\\\"_Feedback\\\"]):not(:where(#gwm-window [id^=wd-shoppable-] *)):n"
        @"ot(:where([id*=mobile-wd-] *)):not(:where([class*=single-creative-card] *)):not(:where([class*=single-video-card] *)) [id^=ad-feedback-sprite-]{color:#b1aaa0!important;background-color:#b1aaa0!important;background-image:none!important;-webkit-mask-image:url(https://m.media-amazon.com/images/G/01/ad-feedback/new_info_icon_3x.png)!important;mask-image:url(https://m.media-amazon.com/images/G/01/ad-feedback/new_info_icon_3x.png)!important;-webkit-mask-size:contain!important;mask-size:contain!important;-webkit-mask-repeat:no-repeat!important;mask-repeat:no-repeat!important;-webkit-mask-position:center!important;mask-position:center!important;filter:none!important;-webkit-filter:none!important;opacity:1!important;}[class*=_hp-mosaic-container_style_loadingSpinner]::after{background:#000!important;background-color:#000!important;box-shadow:none!important;}#gwm-CardLoadingIndicator.gwm-LoadingIndicator::after{background:#000!important;background-color:#000!important;box-shadow:none!important;}"
        @"::-webkit-scrollbar{background-color:transparent!important;}::-webkit-scrollbar-track{background-color:transparent!important;}::-webkit-scrollbar-thumb{background-color:#6f6f6f!important;border-radius:8px!important;border:2px solid transparent!important;background-clip:content-box!important;}::-webkit-scrollbar-thumb:hover{background-color:#8a8a8a!important;}\");}if(document.readyState==='loading')window.addEventListener('load',function(){relink(s);rootBlack();},{once:true});else relink(s);rootBlack();}catch(e){}})();";
}
...
static NSString *ADTWBJS(void){
    // v7.157: TWB follows the same three route-exclusive interfaces as ADFloorJS.
    // The /autocomplete lane only owns suggestion thumbnails; the product-feed lane
    // keeps the proven exact Search media owners; the menu lane excludes Search media.
    CGFloat strength=MAX(0,MIN(100,gP.whiteTameStrength));
    CGFloat t=strength/100.0;
    CGFloat shade=0.10+(0.48*t);
    CGFloat factor=1.0-shade;
    return [NSString stringWithFormat:
        ...
        @"*=checkbox]):not([class*=heart]):not([class*=wishlist]):not([class*=icon]):not([class*=glyph]):not([class*=badge]){filter:brightness(%.3f)!important;}\");return;}var p='';try{p=String(location.pathname||'');}catch(_){}var s=null;if(p==='/autocomplete'||p.indexOf('/autocomplete/')===0){s=put('ad7-search-pane-twb',\"#attach-to-me img.s-image,#attach-to-me img.s-product-image,.s-suggestion-container img.s-image,.s-suggestion-container img.s-product-image{filter:none!important;-webkit-filter:none!important;opacity:%.3f!important;}\");}else if(p==='/s'||p.indexOf('/s/')===0){s=put('ad7-product-feed-twb',\"#search img.scx-stt-image{filter:brightness(%.3f)!important;-webkit-filter:brightness(%.3f)!important;opacity:1!important;}#search img.s-image,#search img.s-product-image,#search [data-component-type=s-product-image] img,#search img.ufs_tiles_card_widget-sug-image,#search img.nice-cat-card_image,#search img.haul-puis-portrait-img,#search img._c2Itd_image_pQREQ{filter:none!important;-webkit-filter:none!important;opacity:%.3f!important;}#search video.sbv-video-player-ecx,#search video._"
...
static void ADOwnAutocompleteHost7157(WKWebView *wv);
...
- (void)setAccessibilityIdentifier:(NSString *)identifier {
    %orig(identifier);
    // The exact autocomplete identifier may be assigned after WebView creation.
    // Catch that one event so the proven transition-sibling floor is owned before
    // the next Search reopen; no layout polling or recurring traversal is added.
    if(gP.enabled && [identifier isEqualToString:@"Autocomplete_Webview_Identifier"]){
...
// v7.157: the dedicated autocomplete WKWebView is shorter than its surrounding
// UIKit host on some Search-focus layouts, exposing a stock-white tail above the
// keyboard. Own only the exact Autocomplete webview's shallow host chain. Plain
// UIViews reuse the existing transition-backing marker so later Amazon white writes
// are rejected by the already-hot UIView preservation hook.
static void ADOwnAutocompleteHost7157(WKWebView *wv){
    if(!gP.enabled||!wv)return;
    @try {
        NSString *aid=wv.accessibilityIdentifier?:@"";
        if(![aid isEqualToString:@"Autocomplete_Webview_Identifier"])return;
        UIColor *black=ADOLED();
        UIView *n=wv.superview;
        CGFloat ww=wv.bounds.size.width;
        for(int d=0;n&&d<10;d++,n=n.superview){
            if([n isKindOfClass:[UIWindow class]])break;
            if(ww>0.0&&n.bounds.size.width>=ww*0.90&&n.layer.contents==nil){
                const char *cn=object_getClassName(n);
                if(cn&&strcmp(cn,"UIView")==0)
                    objc_setAssociatedObject(n,kADTransitionBacking7133,@YES,OBJC_ASSOCIATION_RETAIN_NONATOMIC);
                n.backgroundColor=black;
                n.layer.backgroundColor=black.CGColor;
            }
            // v7.158: restore the exact v7.133 Search-gap mechanism at the moment
            // the dedicated autocomplete WebView mounts. The old white floor was a
            // sibling plain UIView under these transition wrappers, not the DOM or
            // keyboard compositor. Re-run only the existing bounded two-level pass;
            // marked sibling planes then reject Amazon's later white assignment.
            if([n isKindOfClass:%c(UILayoutContainerView)]||
               [n isKindOfClass:%c(UITransitionView)]||
               [n isKindOfClass:%c(UINavigationTransitionView)]||
               [n isKindOfClass:%c(UIViewControllerWrapperView)]){
                ADPaintWrapperChildren7129(n);
            }
        }
    } @catch(...) {}
}
...
static NSString *ADSearchResultsProbePath7139(void){
    @try {
        ...
        if(docs.length)return [docs stringByAppendingPathComponent:@"AmazonDark-v7.158-search-floor-scx-fix-probe.txt"];
    } @catch(...) {}
    return [NSTemporaryDirectory() stringByAppendingPathComponent:@"AmazonDark-v7.158-search-floor-scx-fix-probe.txt"];
}
