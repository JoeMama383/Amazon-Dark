...
static NSString *ADFixesLiteral(void){
    ...
    return [NSString stringWithFormat:
            @"{css:'"
             ...
             // v5.413: mlt-icon-container is the TWO-CARDS control (probe: no
             ...
             "[data-ad-compareorig379=\"1\"]{opacity:0 !important;pointer-events:auto !important;background-color:transparent !important;border:0 !important;box-shadow:none !important;}"
             ...
             "[data-ad-compareorig380=\"1\"]{opacity:0 !important;pointer-events:auto !important;background-color:transparent !important;border:0 !important;box-shadow:none !important;}"
             ...
             "border:solid #fff !important;border-width:0 2.5px 2.5px 0 !important;"
             "transform:translate(-50%%,-62%%) rotate(45deg) !important;z-index:4 !important;pointer-events:none !important;}"
             "[data-ad-comparelegacyorig387=\"1\"]{opacity:0 !important;pointer-events:auto !important;background-color:transparent !important;border:0 !important;box-shadow:none !important;}"
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         // v5.428: restore Amazon's real Compare hit target.  v5.378 fixed this
         // exact failure by keeping the stock input/artwork in the DOM instead of
         // substituting a control. Later painters hid the a-icon/image with
         // visibility:hidden + pointer-events:none and the capture listener could
         // then flip only our visual attribute without invoking Amazon's handler.
         // This layer creates no control and dispatches no click: it makes the one
         // native target transparent-but-hit-testable, observes Amazon's real state,
         // and paints only the selected blue/check state above the frozen v5.427 skin.
         // v5.428: v5.413 proved mlt-icon-container is the two-cards control; both that
         // family and every lists/cards/Heart owner are hard exclusions here.
         "function compareNative428(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           "if(!document.getElementById('adcomparenative428')){var s428=document.createElement('style');s428.id='adcomparenative428';"
             "s428.textContent='[data-ad-comparefunc428]{pointer-events:auto !important;}[data-ad-comparehit428=\"input\"],[data-ad-compareorig380=\"1\"],[data-ad-compareorig379=\"1\"],[data-ad-comparelegacyorig387=\"1\"]{position:absolute !important;inset:0 !important;width:100%% !important;height:100%% !important;margin:0 !important;z-index:9 !important;pointer-events:auto !important;opacity:0 !important;}[data-ad-comparehit428=\"input\"]{visibility:visible !important;opacity:0 !important;pointer-events:auto !important;position:absolute !important;inset:0 !important;width:100%% !important;height:100%% !important;margin:0 !important;z-index:8 !important;cursor:pointer !important;}[data-ad-comparehit428=\"leaf\"]{visibility:visible !important;opacity:0 !important;pointer-events:auto !important;position:relative !important;z-index:8 !important;cursor:pointer !important;}[data-ad-comparehit428=\"container\"]{visibility:visible !important;pointer-events:auto !important;cursor:pointer !important;}[data-ad-comparefunc428][data-ad-compareselected428=\"1\"]{background-color:#2162a1 !important;border-color:#2162a1 !important;}[data-ad-comparefunc428][data-ad-compareselected428=\"1\"]::before{background:#2162a1 !important;border-color:#2162a1 !important;}[data-ad-comparefunc428][data-ad-compareselected428=\"1\"]::after{content:\"\" !important;display:block !important;position:absolute !important;left:50%% !important;top:50%% !important;width:7px !important;height:13px !important;background:transparent !important;border:solid #fff !important;border-width:0 2.5px 2.5px 0 !important;transform:translate(-50%%,-62%%) rotate(45deg) !important;box-shadow:none !important;pointer-events:none !important;z-index:7 !important;box-sizing:border-box !important;}';"
             "s428.textContent+='[data-ad-comparefunc428]{position:relative !important;}';"
             "(document.head||document.documentElement).appendChild(s428);}"
           "function cn428(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}"
           "function rect428(e){try{return e&&e.getBoundingClientRect?e.getBoundingClientRect():null;}catch(x){return null;}}"
           "function square428(e){var r=rect428(e);return !!(r&&r.width>=24&&r.width<=48&&r.height>=24&&r.height<=48&&Math.abs(r.width-r.height)<=9);}"
           "function product428(e){return e&&e.closest&&e.closest('[class*=puis-card],[class*=s-result-item],[data-asin],[class*=s-product-image],[class*=product-image]');}"
           "function foreign428(e){try{return !!(e&&e.closest&&e.closest('[class*=mlt-icon-container],[class*=lists-framework-action-button],[data-ad-cards410-root],[data-ad-cards410-host],[data-ad-cards410-disc],[data-ad-cards410-glyph],[data-ad-heart-shell427],[class*=puis-heart-position],[class*=lists-treatment-hear]'));}catch(x){return true;}}"
           "function host428(e){if(!e||!e.closest||foreign428(e))return null;"
             "/*native428-host*/var h=e.closest('[data-ad-stock403=\"c\"],[data-ad-product391=\"checkbox\"],[data-ad-compare380],[data-ad-comparelegacy387]');"
             "if(h&&square428(h)&&!foreign428(h))return h;"
             "var p=String(e.tagName||'').toUpperCase()==='INPUT'?e.parentElement:e,best=null,u=0;"
             "while(p&&u++<7){if(foreign428(p))return null;var tg=String(p.tagName||'').toUpperCase();"
               "if(!/^(IMG|I|INPUT|SVG|PATH|USE|POLYGON)$/.test(tg)&&square428(p))best=p;"
               "if(product428(p)&&best)break;p=p.parentElement;}return best;}"
           "function selected428(h){try{var q=h.querySelector('input[type=checkbox]');if(q)return !!q.checked;"
             "var A=[h],z=h.querySelectorAll('[role=checkbox],[aria-checked],[data-checked],[data-selected]');for(var i=0;i<z.length&&i<20;i++)A.push(z[i]);"
             "for(var j=0;j<A.length;j++){var e=A[j],a=String(e.getAttribute('aria-checked')||e.getAttribute('data-checked')||e.getAttribute('data-selected')||'').toLowerCase();if(a==='true')return true;if(a==='false')return false;var c=cn428(e).toLowerCase();if(/(^|[ _-])(checked|selected|active)([ _-]|$)/.test(c))return true;}"
             "var im=h.querySelector('img[src],img[data-src]'),src=im?String(im.currentSrc||im.src||im.getAttribute('data-src')||'').toLowerCase():'';"
             "if(/checkbox[_-]?(?:on|checked)|checkmark|selected/.test(src))return true;if(/checkbox[_-]?(?:off|unchecked)/.test(src))return false;"
             "return String(h.getAttribute('data-ad-stocksel403')||h.getAttribute('data-ad-productselected391')||'0')==='1';}catch(x){return false;}}"
           "function hit428(h){var q=h.querySelector('input[type=checkbox]');if(q)return [q,'input'];"
             "q=(h.matches&&h.matches('[role=checkbox]'))?h:h.querySelector('[role=checkbox]');if(q)return [q,'container'];"
             "q=h.querySelector('[onclick]');if(!q)q=h.querySelector('i.a-icon-checkbox,[class*=a-icon-checkbox],img[src*=checkbox],img[data-src*=checkbox]');"
             "if(!q)q=h.querySelector('button,[role=button],a,label');if(!q)q=h;var t=String(q.tagName||'').toUpperCase();"
             "return [q,/^(INPUT|IMG|I|SVG|PATH|USE)$/.test(t)?'leaf':'container'];}"
           "var oldHit=document.querySelectorAll('[data-ad-comparehit428]');for(var oh=0;oh<oldHit.length;oh++)oldHit[oh].removeAttribute('data-ad-comparehit428');"
           "/*native428-scan*/var C=document.querySelectorAll('[class*=a-checkbox],[data-ad-stock403=\"c\"],[data-ad-product391=\"checkbox\"],[data-ad-compare380],[data-ad-comparelegacy387],input[type=checkbox],[role=checkbox],i.a-icon-checkbox,[class*=a-icon-checkbox]'),seen=[],hits=[],inputs=0,leaves=0,containers=0,on=0,skip=0;"
           "for(var i=0;i<C.length&&i<420;i++){var h=host428(C[i]);if(!h||seen.indexOf(h)>=0){skip++;continue;}"
             "if(!product428(h)&&!h.hasAttribute('data-ad-stock403')&&!h.hasAttribute('data-ad-product391')&&!h.hasAttribute('data-ad-compare380')&&!h.hasAttribute('data-ad-comparelegacy387')){skip++;continue;}"
             "seen.push(h);h.setAttribute('data-ad-comparefunc428','1');delete h.__adManual380;delete h.__adManualSig380;"
             "var hv=hit428(h),hit=hv[0],kind=hv[1];hit.setAttribute('data-ad-comparehit428',kind);hits.push(hit);if(kind==='input')inputs++;else if(kind==='leaf')leaves++;else containers++;"
             "var sel=selected428(h);h.setAttribute('data-ad-compareselected428',sel?'1':'0');if(sel){on++;if(h.style.getPropertyValue('background-color')!=='#2162a1')h.style.setProperty('background-color','#2162a1','important');if(h.style.getPropertyValue('border-color')!=='#2162a1')h.style.setProperty('border-color','#2162a1','important');h.__adCompareBlue428=1;}else if(h.__adCompareBlue428){h.style.removeProperty('background-color');h.style.removeProperty('border-color');delete h.__adCompareBlue428;}}"
           "var oldHost=document.querySelectorAll('[data-ad-comparefunc428]');for(var x=0;x<oldHost.length;x++){var o=oldHost[x];if(seen.indexOf(o)>=0)continue;o.removeAttribute('data-ad-comparefunc428');o.removeAttribute('data-ad-compareselected428');if(o.__adCompareBlue428){o.style.removeProperty('background-color');o.style.removeProperty('border-color');delete o.__adCompareBlue428;}}"
           "window.__AD_COMPARE_NATIVE428_STATE__='hosts='+seen.length+' input='+inputs+' leaf='+leaves+' container='+containers+' on='+on+' skip='+skip;return seen.length;"
         "}catch(e){window.__AD_COMPARE_NATIVE428_STATE__='err '+(e&&e.message||e);return -1;}}"
         "try{window.__AD_COMPARE_NATIVE428__=compareNative428;if(!window.__AD_COMPARE_WRAP428__){window.__AD_COMPARE_WRAP428__=1;"
           "window.__AD_PRODUCTCTRL391_PRE428__=window.__AD_PRODUCTCTRL391RUN__;window.__AD_PRODUCTCTRL391RUN__=function(){var r=window.__AD_PRODUCTCTRL391_PRE428__?window.__AD_PRODUCTCTRL391_PRE428__():0;try{window.__AD_COMPARE_NATIVE428__();}catch(x){}return r;};"
           "var t428=0;new MutationObserver(function(){clearTimeout(t428);t428=setTimeout(function(){try{window.__AD_COMPARE_NATIVE428__();}catch(x){}},25);}).observe(document.documentElement,{childList:true,subtree:true,attributes:true,attributeFilter:['class','aria-checked','data-checked','data-selected','checked','src','data-src','data-ad-stock403','data-ad-stocksel403']});"
           "document.addEventListener('change',function(e){try{if(e&&e.target&&(String(e.target.type||'').toLowerCase()==='checkbox'||(e.target.closest&&e.target.closest('[data-ad-comparefunc428]')))){setTimeout(window.__AD_COMPARE_NATIVE428__,0);setTimeout(window.__AD_COMPARE_NATIVE428__,100);}}catch(x){}},true);"
           "document.addEventListener('click',function(e){try{if(e&&e.target&&e.target.closest&&e.target.closest('[data-ad-comparefunc428]')){setTimeout(window.__AD_COMPARE_NATIVE428__,0);setTimeout(window.__AD_COMPARE_NATIVE428__,80);setTimeout(window.__AD_COMPARE_NATIVE428__,260);setTimeout(window.__AD_COMPARE_NATIVE428__,700);}}catch(x){}},true);"
           "addEventListener('scroll',function(){clearTimeout(window.__adCompareScroll428);window.__adCompareScroll428=setTimeout(window.__AD_COMPARE_NATIVE428__,90);},{passive:true,capture:true});}"
           "compareNative428();setTimeout(compareNative428,40);setTimeout(compareNative428,180);setTimeout(compareNative428,700);setTimeout(compareNative428,1800);"
         "}catch(e){}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // P83COMPARE428: functional target/state probe.  hitDead=0 proves the
       // real Amazon input/icon can receive taps; blueBad=0 proves checked state
       // is the requested stock blue with a visible paint-only checkmark.
       "try{var H83=document.querySelectorAll('[data-ad-comparefunc428]'),hitDead83=0,on83=0,blueBad83=0,Q83=[];"
       "for(var i83=0;i83<H83.length&&i83<80;i83++){var h83=H83[i83],t83=h83.querySelector('[data-ad-comparehit428]'),ts83=t83?getComputedStyle(t83):null,sel83=h83.getAttribute('data-ad-compareselected428')==='1',hs83=getComputedStyle(h83),bs83=getComputedStyle(h83,'::before'),as83=getComputedStyle(h83,'::after');"
       "if(!t83||!ts83||ts83.pointerEvents==='none'||ts83.visibility==='hidden')hitDead83++;if(sel83){on83++;var b83=String(hs83.backgroundColor||'').replace(/\s+/g,''),pb83=String(bs83.content||'none'),pbg83=String(bs83.backgroundColor||'').replace(/\s+/g,''),ct83=String(as83.content||'none');if(b83!=='rgb(33,98,161)'||((pb83!=='none'&&pb83!=='normal')&&pbg83!=='rgb(33,98,161)')||ct83==='none'||ct83==='normal')blueBad83++;}"
       "if(Q83.length<8){var r83=h83.getBoundingClientRect();Q83.push(Math.round(r83.width)+'x'+Math.round(r83.height)+'|hit='+(t83?String(t83.getAttribute('data-ad-comparehit428')):'none')+'|pe='+(ts83?String(ts83.pointerEvents):'-')+'|sel='+(sel83?1:0)+'|pbg='+String(bs83.backgroundColor||'-').replace(/\s+/g,''));}}"
       "var pane83=/compare with similar|keep selecting/i.test(String((document.body&&document.body.innerText)||''))?1:0;"
       "out.push('P83COMPARE428[hosts='+H83.length+' on='+on83+' hitDead='+hitDead83+' blueBad='+blueBad83+' pane='+pane83+' state='+String(window.__AD_COMPARE_NATIVE428_STATE__||'-')+(Q83.length?' '+Q83.join(' ~~ '):'')+']');"
       "}catch(e83){out.push('P83COMPARE428[err '+(e83&&e83.message||e83)+']');}"
