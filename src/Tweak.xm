...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "}catch(e){}"
           "function disc419(){try{var DB=document.querySelectorAll('[class*=lists-framework-action-button]');"
             "var ndisc=0,dskip=0;"
             "for(var db=0;db<DB.length&&db<80;db++){var de=DB[db];"
               ...
               "ndisc++;}"
             "window.__AD_DISC419__='on='+ndisc+' skipped='+dskip;"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       "out.push('P80SYM413{n='+Z4.length+' badBg='+b4+' badRing='+r4+' '+Q4.join(' ~ ')+' state='+String(window.__AD_SYM413__||'-')+' bs='+String(window.__AD_SYM414__||'-')+' disc='+String(window.__AD_DISC419__||'-')+'}');"
