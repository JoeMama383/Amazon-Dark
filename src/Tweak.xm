 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "try{window.__AD_FRAMECLASS362__=function(){var F=document.querySelectorAll('iframe'),n=0;"
           "for(var fi=0;fi<F.length&&fi<80;fi++){var f=F[fi],r=f.getBoundingClientRect();if(r.width<120||r.height<50)continue;"
             ...
             "var productAd=(!hero&&productDoc&&r.width>=300&&r.height>=55&&r.height<=260);var mode=hero?'hero':(productAd?'productad':'standalone');f.setAttribute('data-ad-frame-mode362',mode);f.setAttribute('data-ad-frame-why369',productAd?(prodURL369?'url369':'dom369'):(hero?'hero':'standalone'));if(mode==='standalone'&&r.width>=280&&r.height<=100&&window.__AD_MARKCOMPACT373__)window.__AD_MARKCOMPACT373__(f,false);try{f.contentWindow&&f.contentWindow.postMessage({__amzAdMode:mode},'*');}catch(e){}n++;}"
           ...
           "if(!window.__ADFB__){window.__ADFB__=1;"
             "if(window.top===window){window.__AD_FRAMES__={};"
               "addEventListener('message',function(ev){try{"
                 "var d=ev.data;if(!d||typeof d!=='object')return;if(d.__adCompact373===1){try{var IF373=document.querySelectorAll('iframe');for(var ci373=0;ci373<IF373.length&&ci373<80;ci373++){if(IF373[ci373].contentWindow===ev.source){window.__AD_MARKCOMPACT373__&&window.__AD_MARKCOMPACT373__(IF373[ci373],true);break;}}}catch(ec373){}return;}if(d.__adfr!==1)return;"
                 ...
                 // probe budgets.
                 "var interesting=/STAR |stars=[1-9]|ADFRAME mode=productad|compact373=1/.test(String(d.r||''));"
...
"/*V5317FIX*/"
       ...
       "try{var P32=document.querySelectorAll('iframe[data-ad-frame-mode362=\"productad\"]'),R32=[];for(var i32=0;i32<P32.length&&i32<8;i32++){var f32=P32[i32],r32=f32.getBoundingClientRect();R32.push(String(f32.getAttribute('data-ad-frame-why369')||'-')+'@'+Math.round(r32.left)+','+Math.round(r32.top)+'/'+Math.round(r32.width)+'x'+Math.round(r32.height));}out.push('P32V373[productDoc='+String(window.__AD_PRODUCTDOC369__||0)+' productFrame='+P32.length+(R32.length?' '+R32.join(' ~~ '):'')+']');}catch(e32){out.push('P32V373[err '+(e32&&e32.message||e32)+']');}"
       "try{var A33=document.querySelectorAll('[class*=_hp-mosaic-container_style_widgetContainer],[class*=_mosaic-container_style_widgetContainer]'),Q33=[];for(var i33=0;i33<A33.length&&i33<10;i33++){var e33=A33[i33],r33=e33.getBoundingClientRect(),s33=getComputedStyle(e33);if(r33.width<100||r33.height<50)continue;Q33.push(e33.tagName+'.'+cls(e33)+'@'+Math.round(r33.top)+'/'+Math.round(r33.width)+'x'+Math.round(r33.height)+'|t='+String(s33.borderTopColor||'-').replace(/ /g,'')+'|sec='+String(e33.getAttribute('data-ad-border-section')||'-')+'|by='+(e33.__adBy||'-'));}out.push('P33V373[n='+Q33.length+(Q33.length?' '+Q33.join(' ~~ '):'')+']');}catch(e33){out.push('P33V373[err '+(e33&&e33.message||e33)+']');}"
       "try{var A34=document.querySelectorAll('[class*=_hp-mosaic-container_style_widgetContainer],[class*=_mosaic-container_style_widgetContainer]'),Q34=[],brown34=0,fixed34=0;for(var i34=0;i34<A34.length;i34++){var e34=A34[i34],r34=e34.getBoundingClientRect(),s34=getComputedStyle(e34),bc34=String(s34.borderTopColor||'').replace(/ /g,''),isB34=(bc34==='rgb(84,78,69)'||bc34==='rgb(85,79,70)'||bc34==='rgb(83,77,68)');if(isB34)brown34++;if(e34.getAttribute&&e34.getAttribute('data-ad-border-section')==='exact371')fixed34++;if(Q34.length<12&&(isB34||(r34.bottom>=-80&&r34.top<=(window.innerHeight||900)+80)))Q34.push(e34.tagName+'.'+cls(e34)+'@'+Math.round(r34.top)+'/'+Math.round(r34.width)+'x'+Math.round(r34.height)+'|t='+bc34+'|sec='+String(e34.getAttribute('data-ad-border-section')||'-')+'|by='+(e34.__adBy||'-'));}out.push('P34V373[total='+A34.length+' brown='+brown34+' fixed='+fixed34+(Q34.length?' '+Q34.join(' ~~ '):'')+']');}catch(e34){out.push('P34V373[err '+(e34&&e34.message||e34)+']');}"
       "try{var C35=document.querySelectorAll('[data-ad-compactad371]'),I35=document.querySelectorAll('[data-ad-compactink371]'),Q35=[];for(var i35=0;i35<I35.length&&i35<8;i35++){var e35=I35[i35],r35=e35.getBoundingClientRect(),s35=getComputedStyle(e35),t35=String(e35.textContent||'').replace(/\\s+/g,' ').trim();Q35.push(t35.slice(0,24)+'@'+Math.round(r35.top)+'|c='+String(s35.color||'-').replace(/ /g,'')+'|fill='+String(s35.webkitTextFillColor||'-').replace(/ /g,'')+'|by='+(e35.__adBy||'-'));}out.push('P35V373[cards='+C35.length+' ink='+I35.length+(Q35.length?' '+Q35.join(' ~~ '):'')+']');}catch(e35){out.push('P35V373[err '+(e35&&e35.message||e35)+']');}"
       "try{var F36=document.querySelectorAll('iframe[data-ad-frame-mode362=\"standalone\"]'),Q36=[];for(var i36=0;i36<F36.length&&i36<12;i36++){var f36=F36[i36],r36=f36.getBoundingClientRect();if(r36.width<280||r36.height>100)continue;Q36.push(Math.round(r36.left)+','+Math.round(r36.top)+'/'+Math.round(r36.width)+'x'+Math.round(r36.height));}out.push('P36V373[compactStandalone='+Q36.length+(Q36.length?' '+Q36.join(' ~~ '):'')+']');}catch(e36){out.push('P36V373[err '+(e36&&e36.message||e36)+']');}"
       "try{var F37=document.querySelectorAll('iframe[data-ad-compactframe373]'),W37=document.querySelectorAll('[data-ad-compactwrap373]'),Q37=[];for(var i37=0;i37<F37.length&&i37<8;i37++){var f37=F37[i37],r37=f37.getBoundingClientRect();if(r37.width<250||r37.height>110)continue;var s37=getComputedStyle(f37),p37=f37.parentElement,ps37=p37?getComputedStyle(p37):null;Q37.push(Math.round(r37.left)+','+Math.round(r37.top)+'/'+Math.round(r37.width)+'x'+Math.round(r37.height)+'|conf='+(f37.hasAttribute('data-ad-compactconfirmed373')?1:0)+'|bg='+String(s37.backgroundColor||'-').replace(/ /g,'')+'|fil='+String(s37.filter||'-').replace(/ /g,'')+'|pbg='+(ps37?String(ps37.backgroundColor||'-').replace(/ /g,''):'-'));}out.push('P37V373[frames='+F37.length+' wraps='+W37.length+(Q37.length?' '+Q37.join(' ~~ '):'')+']');}catch(e37){out.push('P37V373[err '+(e37&&e37.message||e37)+']');}"
