...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           "window.__AD_STRIPCHROME378__=function(){try{if(!document.body||!window.__AD_STRIPCONF375__){window.__AD_STRIPCHROME378_N__=0;window.__AD_STRIPCHROME378_LEFT__=0;return 0;}function pc(v){var m=/rgba?\\((\\d+),\\s*(\\d+),\\s*(\\d+)(?:,\\s*([0-9.]+))?/i.exec(String(v||''));return m?[+m[1],+m[2],+m[3],m[4]===undefined?1:+m[4]]:null;}var E=document.querySelectorAll('div,span,a,label,section,button'),n=0,left=0;for(var i=0;i<E.length&&i<1200;i++){var e=E[i],r=e.getBoundingClientRect();if(r.width<18||r.width>240||r.height<10||r.height>70)continue;var c=getComputedStyle(e),bg=pc(c.backgroundColor);if(!bg||bg[3]<.55)continue;var mx=Math.max(bg[0],bg[1],bg[2]),mn=Math.min(bg[0],bg[1],bg[2]),lum=(.2126*bg[0]+.7152*bg[1]+.0722*bg[2])/255,sat=(mx-mn)/255;if(lum<.80||sat>.14)continue;var cls=String(e.className||'').toLowerCase(),txt=String(e.textContent||'').replace(/\\s+/g,' ').trim();if(/prime|star|rating|deal|discount|percent|badge/.test(cls)&&lum<.92)continue;if(e.querySelector&&e.querySelector('img,video,canvas'))continue;e.setAttribute('data-ad-stripchrome378','1');e.style.setProperty('background-color','#181a1b','important');e.style.setProperty('background-image','none','important');e.style.setProperty('box-shadow','none','important');e.style.setProperty('border-color','#3b4043','important');if(txt)e.style.setProperty('color','#ffffff','important');n++;}var Q=document.querySelectorAll('[data-ad-stripchrome378]');for(var j=0;j<Q.length;j++){var q=pc(getComputedStyle(Q[j]).backgroundColor);if(q){var l=(.2126*q[0]+.7152*q[1]+.0722*q[2])/255;if(l>.70)left++;}}window.__AD_STRIPCHROME378_N__=n;window.__AD_STRIPCHROME378_LEFT__=left;return n;}catch(e){window.__AD_STRIPCHROME378_N__=-1;return 0;}};"
           ...
           "window.__AMZDARK_ADTHEME__=function(){try{"
             "var mode=window.__ADFRAME_MODE__||'hero',sp365=window.__AD_SPON365__?window.__AD_SPON365__():0;"
             "var strip375=window.__AD_PRODUCTSTRIP375__?window.__AD_PRODUCTSTRIP375__():0;if(strip375){var cl375=window.__AD_CLEARSTRIP374__?window.__AD_CLEARSTRIP374__():0;var in375=window.__AD_ADTEXT371__?window.__AD_ADTEXT371__():0;var tx377=window.__AD_STRIPTEXT377__?window.__AD_STRIPTEXT377__():0;var bx378=window.__AD_STRIPCHROME378__?window.__AD_STRIPCHROME378__():0;var tm375=window.__AD_STRIPMEDIA374__?window.__AD_STRIPMEDIA374__():0;var sp375=window.__AD_SPON365__?window.__AD_SPON365__():0;window.__AD_STANDALONE__='strip-stock378';window.__AD_ADTHEME__='mode='+mode+' strip378=1 t377='+String(window.__AD_STRIPTEXT377_N__||0)+' d377='+String(window.__AD_STRIPTEXT377_DARK__||0)+' box378='+String(window.__AD_STRIPCHROME378_N__||0)+' boxleft378='+String(window.__AD_STRIPCHROME378_LEFT__||0)+' sticky='+String(window.__AD_STRIPCONF375__?1:0)+' clean375='+cl375+' chrome375='+String(window.__AD_STRIPCHROME374_LEFT__||0)+' ink375='+in375+' white376='+String(window.__AD_ADTEXT376_LOCKED__||0)+' grayleft376='+String(window.__AD_ADTEXT376_GRAYLEFT__||0)+' media375='+String(window.__AD_STRIPMEDIA374_N__||0)+' fullSkip375='+String(window.__AD_STRIPFULL374_N__||0)+' spon='+sp375;return cl375+in375+tx377+bx378+tm375+sp375;}"
           ...
           "try{var __ad377rf=0;function __ad377raf(){if(++__ad377rf>180)return;try{if(window.__AD_STRIPCONF375__&&window.__AD_STRIPTEXT377__)window.__AD_STRIPTEXT377__();if(window.__AD_STRIPCONF375__&&window.__AD_STRIPCHROME378__)window.__AD_STRIPCHROME378__();}catch(e){}requestAnimationFrame(__ad377raf);}requestAnimationFrame(__ad377raf);}catch(e){}"
           "try{var __ad378iv=0,__ad378tm=setInterval(function(){if(++__ad378iv>60){clearInterval(__ad378tm);return;}try{if(window.__AD_STRIPCONF375__){if(window.__AD_STRIPTEXT377__)window.__AD_STRIPTEXT377__();if(window.__AD_STRIPCHROME378__)window.__AD_STRIPCHROME378__();}}catch(e){}},500);}catch(e){}"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "function _adStripParentInk378(root){try{if(!root||root.nodeType!==1||!document.createTreeWalker)return 0;function pc(v){var m=/rgba?\\((\\d+),\\s*(\\d+),\\s*(\\d+)/.exec(String(v||''));return m?[+m[1],+m[2],+m[3]]:null;}var W=document.createTreeWalker(root,NodeFilter.SHOW_TEXT),nd,n=0,dark=0,seen=0;while((nd=W.nextNode())&&seen++<2200){var t=String(nd.nodeValue||'').replace(/\\s+/g,' ').trim();if(!/^sponsored(?: ad)?$/i.test(t))continue;var lab=nd.parentElement,card=lab,d=0,best=null;while(card&&d++<8){var r=card.getBoundingClientRect(),tx=String(card.textContent||'').replace(/\\s+/g,' ').trim();if(r.width>=280&&r.height>=38&&r.height<=230&&tx.length<900&&(card.querySelector('iframe[data-ad-stripframe374],iframe,img,picture')))best=card;card=card.parentElement;}if(!best)continue;var E=best.querySelectorAll('span,p,a,div,h1,h2,h3,h4,h5,label');for(var i=0;i<E.length&&i<420;i++){var e=E[i],own='';for(var q=0;q<e.childNodes.length&&q<12;q++){if(e.childNodes[q].nodeType===3)own+=String(e.childNodes[q].nodeValue||'');}own=own.replace(/\\s+/g,' ').trim();if(!own)continue;var cs=getComputedStyle(e),c=pc(cs.color);if(!c)continue;var mx=Math.max(c[0],c[1],c[2]),mn=Math.min(c[0],c[1],c[2]),sat=(mx-mn)/255;if(sat>=.34)continue;e.style.setProperty('color','#ffffff','important');e.style.setProperty('-webkit-text-fill-color','#ffffff','important');e.style.setProperty('opacity','1','important');e.style.setProperty('visibility','visible','important');e.style.setProperty('filter','none','important');e.setAttribute('data-ad-parentstripink378','1');e.__adBy='parentStripInk378';n++;var c2=pc(getComputedStyle(e).color);if(c2&&(.2126*c2[0]+.7152*c2[1]+.0722*c2[2])/255<.92)dark++;}}window.__AD_PARENTSTRIP378__='ink='+n+' dark='+dark;return n;}catch(e){window.__AD_PARENTSTRIP378__='err '+e;return 0;}}"
         ...
         "try{window._adProductAds367=_adProductAds367;window._adCompactSponsoredInk371=_adCompactSponsoredInk371;window._adForceCompactStrip378=_adForceCompactStrip378;window._adStripParentInk378=_adStripParentInk378;window._adBorderFast367=_adBorderFast367;window._adExactBorder370=_adExactBorder370;window._adMosaicBorder371=_adMosaicBorder371;_adProductAds367(document.documentElement);_adCompactSponsoredInk371(document.documentElement);_adForceCompactStrip378(document.documentElement);_adStripParentInk378(document.documentElement);_adBorderFast367(document.documentElement);_adExactBorder370(document.documentElement);_adMosaicBorder371(document.documentElement);setTimeout(function(){try{_adExactBorder370(document.documentElement);_adMosaicBorder371(document.documentElement);}catch(e){}},120);setTimeout(function(){try{_adExactBorder370(document.documentElement);_adMosaicBorder371(document.documentElement);}catch(e){}},650);setTimeout(function(){try{_adExactBorder370(document.documentElement);_adMosaicBorder371(document.documentElement);}catch(e){}},1800);}catch(e){}"
         ...
         "try{if(!window.__ADPS378INIT__){window.__ADPS378INIT__=1;var _ps378=0;addEventListener('scroll',function(){clearTimeout(_ps378);_ps378=setTimeout(function(){try{_adForceCompactStrip378(document.documentElement);_adStripParentInk378(document.documentElement);}catch(e){}},90);},{passive:true,capture:true});addEventListener('pageshow',function(){try{_adForceCompactStrip378(document.documentElement);_adStripParentInk378(document.documentElement);}catch(e){}},{passive:true});}}catch(e){}"
        ...
        while(p && up++<6){
            ...
            for(NSUInteger qi=0; qi<q.count && seen++<42; qi++){
                ...
                if([lo containsString:@"medical care"] || [lo isEqualToString:@"health ai"] ||
                   ...
                   [lo containsString:@"keep streaming"]) return YES;
...
static int ADWTNativeContext(UIView *v){
    @try {
        ...
        if (ADWTExploreTile363(v) || ADWTNoTameGlyph367(v)) return 1;
...
static void ADPrimeNativeWhiteTame363(UIView *v, UIImage *incoming){
    @try {
        ...
        int ctx=ADWTStableContext365(v);
        CALayer *ov=objc_getAssociatedObject(v,kADWhiteTameOverlayKey);
        if(ctx==1||ADWTInHighlightsCarousel368(v)||ADWTNoTameGlyph367(v)){ if(ov){[ov removeFromSuperlayer];objc_setAssociatedObject(v,kADWhiteTameOverlayKey,nil,OBJC_ASSOCIATION_RETAIN_NONATOMIC);} objc_setAssociatedObject(v,kADWTForcedImage364,nil,OBJC_ASSOCIATION_RETAIN_NONATOMIC); return; }
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         "function stockActionFix378(){try{var H=document.querySelectorAll('[class*=lists-framework-action-button]'),hosts=0,leaves=0,skip=0;for(var i=0;i<H.length&&i<160;i++){var h=H[i],r=h.getBoundingClientRect();if(r.width<18||r.width>64||r.height<18||r.height>64||Math.abs(r.width-r.height)>14){skip++;continue;}if(h.querySelector&&h.querySelector('[class*=mlt-icon-container],input[type=checkbox],[role=checkbox]')){skip++;continue;}h.setAttribute('data-ad-stockaction378','1');h.removeAttribute('data-ad-actionhost375');h.removeAttribute('data-ad-actionhost376');var old=h.querySelectorAll(':scope > [data-ad-actioncanonical375],:scope > [data-ad-actioncanonical376],:scope > [data-ad-actionfallback374]');for(var o=0;o<old.length;o++){if(old[o].parentNode)old[o].parentNode.removeChild(old[o]);}var O=h.querySelectorAll('[data-ad-actionorig375],[data-ad-actionorig376]');for(var z=0;z<O.length;z++){O[z].style.removeProperty('visibility');O[z].style.removeProperty('opacity');O[z].removeAttribute('data-ad-actionorig375');O[z].removeAttribute('data-ad-actionorig376');}var A=h.querySelectorAll('img,i,svg,path,[class*=lists-framework-unfill],[class*=lists-framework-fill],[class*=icon]');for(var j=0;j<A.length&&j<48;j++){var a=A[j],tg=String(a.tagName||'').toUpperCase(),ar=a.getBoundingClientRect();if(ar.width>70||ar.height>70)continue;a.setAttribute('data-ad-stockglyph378','1');a.style.setProperty('visibility','visible','important');a.style.setProperty('opacity','1','important');a.style.setProperty('background-color','transparent','important');a.__adGlyph=1;a.__adBy='stockAction378';if(tg==='IMG'||tg==='I')a.setAttribute('data-ad-raster378','1');else if(tg==='SVG'||tg==='PATH'){a.style.setProperty('color','#ffffff','important');a.style.setProperty('fill','#ffffff','important');a.style.setProperty('stroke','#ffffff','important');}leaves++;}hosts++;}window.__AD_STOCKACTION378__='hosts='+hosts+' leaves='+leaves+' skip='+skip;}catch(e){window.__AD_STOCKACTION378__='err '+e;}}"
         "function compareStock378(){try{var C=document.querySelectorAll('[class*=mlt-icon-container]'),hosts=0,on=0,off=0,leaves=0;function pick(h){try{var q=h.querySelector('input[type=checkbox]');if(q&&q.checked)return true;var ac=String(h.getAttribute('aria-checked')||h.getAttribute('data-checked')||h.getAttribute('data-selected')||'').toLowerCase(),cl=h.className;cl=String(cl&&cl.baseVal!==undefined?cl.baseVal:(cl||'')).toLowerCase();if(ac==='true'||/(^|[ _-])(checked|selected|active)([ _-]|$)/.test(cl))return true;var im=h.querySelector('img');if(im&&/checkbox[_-]?(?:on|checked)|checkmark|selected/i.test(String(im.getAttribute('src')||im.getAttribute('data-src')||'')))return true;return false;}catch(e){return false;}}for(var i=0;i<C.length&&i<180;i++){var h=C[i],r=h.getBoundingClientRect();if(r.width<18||r.width>70||r.height<18||r.height>70)continue;var sel=pick(h);h.setAttribute('data-ad-compare378',sel?'1':'0');h.removeAttribute('data-ad-comparehost377');h.removeAttribute('data-ad-comparechecked377');var b=h.querySelector(':scope > [data-ad-comparebox377]');if(b&&b.parentNode)b.parentNode.removeChild(b);var old=h.querySelectorAll('[data-ad-compareorig377]');for(var o=0;o<old.length;o++){old[o].style.removeProperty('visibility');old[o].style.removeProperty('opacity');old[o].removeAttribute('data-ad-compareorig377');}var inp=h.querySelector('input[type=checkbox]');if(inp){inp.style.removeProperty('opacity');inp.style.removeProperty('position');inp.style.removeProperty('inset');inp.style.removeProperty('width');inp.style.removeProperty('height');inp.style.removeProperty('margin');inp.style.removeProperty('z-index');inp.style.setProperty('accent-color','#2162a1','important');inp.removeAttribute('data-ad-compareinput377');}var A=h.querySelectorAll('img,i,svg,path,[class*=icon],[class*=image]');for(var j=0;j<A.length&&j<30;j++){var a=A[j],ar=a.getBoundingClientRect(),tg=String(a.tagName||'').toUpperCase();if(ar.width>70||ar.height>70)continue;a.setAttribute('data-ad-compareleaf378','1');a.style.setProperty('visibility','visible','important');a.style.setProperty('opacity','1','important');a.style.setProperty('background-color','transparent','important');if(tg==='IMG'||tg==='I')a.setAttribute('data-ad-compare-raster378','1');else if(!sel&&(tg==='SVG'||tg==='PATH')){a.style.setProperty('color','#ffffff','important');a.style.setProperty('fill','#ffffff','important');a.style.setProperty('stroke','#ffffff','important');}leaves++;}hosts++;if(sel)on++;else off++;}window.__AD_COMPARE378__='hosts='+hosts+' on='+on+' off='+off+' leaves='+leaves;}catch(e){window.__AD_COMPARE378__='err '+e;}}"
         "function cartChrome378(){try{var tx=String((document.body&&document.body.innerText)||'').toLowerCase();if(tx.indexOf('subtotal')<0||tx.indexOf('save for later')<0){window.__AD_CART378__='off';return;}var E=document.querySelectorAll('button,[role=button],a,span,div'),n=0;function pc(v){var m=/rgba?\\((\\d+),\\s*(\\d+),\\s*(\\d+)/.exec(String(v||''));return m?[+m[1],+m[2],+m[3]]:null;}for(var i=0;i<E.length&&i<1800;i++){var e=E[i],r=e.getBoundingClientRect();if(r.width<36||r.width>135||r.height<26||r.height>58)continue;if(r.bottom<0||r.top>(innerHeight||900)+100)continue;var s=getComputedStyle(e),c=pc(s.backgroundColor);if(!c)continue;var mx=Math.max(c[0],c[1],c[2]),mn=Math.min(c[0],c[1],c[2]),lum=(.2126*c[0]+.7152*c[1]+.0722*c[2])/255,sat=(mx-mn)/255;if(lum<.78||sat>.12)continue;var txt=String(e.textContent||'').replace(/\\s+/g,' ').trim().toLowerCase();if(/checkout|add to cart|quantity/.test(txt))continue;e.setAttribute('data-ad-cartchrome378','1');e.style.setProperty('background-color','#181a1b','important');e.style.setProperty('background-image','none','important');e.style.setProperty('border','1px solid #6c7073','important');e.style.setProperty('box-shadow','none','important');e.style.setProperty('color','#e8e6e3','important');e.style.setProperty('-webkit-text-fill-color','#e8e6e3','important');var A=e.querySelectorAll('img,i,svg,path,[class*=icon]');for(var j=0;j<A.length&&j<18;j++){var a=A[j],tg=String(a.tagName||'').toUpperCase();a.style.setProperty('opacity','1','important');a.setAttribute('data-ad-carticon378','1');a.__adGlyph=1;a.__adBy='cartChrome378';if(tg==='IMG'||tg==='I')a.setAttribute('data-ad-cart-raster378','1');else{a.style.setProperty('color','#ffffff','important');a.style.setProperty('fill','#ffffff','important');a.style.setProperty('stroke','#ffffff','important');}}n++;}window.__AD_CART378__='fixed='+n;}catch(e){window.__AD_CART378__='err '+e;}}"
         ...
         "}catch(e){}}""badgeFix();dotFix();packFix();stockActionFix378();compareStock378();cartChrome378();shareFix377();sponsorFix376();ratingFix376();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(stockActionFix378,60);setTimeout(stockActionFix378,240);setTimeout(stockActionFix378,800);setTimeout(stockActionFix378,1800);setTimeout(compareStock378,20);setTimeout(compareStock378,120);setTimeout(compareStock378,500);setTimeout(compareStock378,1500);setTimeout(cartChrome378,40);setTimeout(cartChrome378,350);setTimeout(cartChrome378,1400);setTimeout(sponsorFix376,20);setTimeout(sponsorFix376,180);setTimeout(sponsorFix376,700);setTimeout(sponsorFix376,1800);setTimeout(ratingFix376,40);setTimeout(ratingFix376,240);setTimeout(ratingFix376,900);setTimeout(ratingFix376,2200);setTimeout(shareFix377,40);setTimeout(shareFix377,180);setTimeout(shareFix377,700);setTimeout(shareFix377,1800);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){badgeFix();dotFix();packFix();stockActionFix378();compareStock378();cartChrome378();shareFix377();sponsorFix376();ratingFix376();},80);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();stockActionFix378();compareStock378();cartChrome378();shareFix377();sponsorFix376();ratingFix376();},20);}).observe(document.documentElement,"
         ...
         "try{document.addEventListener('change',function(e){try{if(e&&e.target&&(String(e.target.type||'').toLowerCase()==='checkbox'||(e.target.closest&&e.target.closest('[class*=mlt-icon-container]')) ))compareStock378();}catch(x){}},true);document.addEventListener('click',function(e){try{if(e&&e.target&&e.target.closest&&e.target.closest('[class*=mlt-icon-container]')){setTimeout(compareStock378,0);setTimeout(compareStock378,80);}}catch(x){}},true);}catch(e){}"
       "})();}catch(e){}"
       "/*V5314FIX*//*V5315FIX*/"
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*/"
       ...
       // P39V378: stock icon policy. No synthetic cards/compare nodes may survive.
       "try{var A39=document.querySelectorAll('[data-ad-stockaction378]'),C39=document.querySelectorAll('[data-ad-compare378]'),syn39=document.querySelectorAll('[data-ad-actioncanonical375],[data-ad-actioncanonical376],[data-ad-comparebox377]').length,Q39=[];for(var i39=0;i39<A39.length&&Q39.length<8;i39++){var h39=A39[i39],r39=h39.getBoundingClientRect(),g39=h39.querySelector('[data-ad-stockglyph378]'),s39=g39?getComputedStyle(g39):null;Q39.push('A@'+Math.round(r39.left)+','+Math.round(r39.top)+'/'+Math.round(r39.width)+'x'+Math.round(r39.height)+'|f='+(s39?String(s39.filter||'none').slice(0,18):'-'));}for(var j39=0;j39<C39.length&&Q39.length<14;j39++){var c39=C39[j39],rr39=c39.getBoundingClientRect(),lf39=c39.querySelector('[data-ad-compareleaf378]'),ls39=lf39?getComputedStyle(lf39):null;Q39.push('C@'+Math.round(rr39.left)+','+Math.round(rr39.top)+'/'+Math.round(rr39.width)+'x'+Math.round(rr39.height)+'|sel='+String(c39.getAttribute('data-ad-compare378')||'-')+'|f='+(ls39?String(ls39.filter||'none').slice(0,18):'-'));}out.push('P39V378[action='+A39.length+' compare='+C39.length+' synthetic='+syn39+(Q39.length?' '+Q39.join(' ~~ '):'')+' state='+String(window.__AD_STOCKACTION378__||'-')+' cmp='+String(window.__AD_COMPARE378__||'-')+']');}catch(e39){out.push('P39V378[err '+(e39&&e39.message||e39)+']');}"
       // P40V378: unified Sponsored frame state plus parent-side neutral text lock.
       "try{var F40=document.querySelectorAll('iframe[data-ad-stripframe374]'),W40=document.querySelectorAll('[data-ad-stripwrap374]'),PI40=document.querySelectorAll('[data-ad-parentstripink378]'),pd40=0,Q40=[];for(var p40=0;p40<PI40.length;p40++){var cs40=getComputedStyle(PI40[p40]),m40=/rgb\\((\\d+),\\s*(\\d+),\\s*(\\d+)/.exec(String(cs40.color||''));if(m40&&(.2126*(+m40[1])+.7152*(+m40[2])+.0722*(+m40[3]))/255<.92)pd40++;}for(var i40=0;i40<F40.length&&i40<8;i40++){var f40=F40[i40],r40=f40.getBoundingClientRect();if(r40.width<250||r40.height>230)continue;var s40=getComputedStyle(f40),p=f40.parentElement,ps=p?getComputedStyle(p):null;Q40.push(String(f40.getAttribute('data-ad-frame-mode362')||'-')+'@'+Math.round(r40.left)+','+Math.round(r40.top)+'/'+Math.round(r40.width)+'x'+Math.round(r40.height)+'|conf='+(f40.hasAttribute('data-ad-stripconfirmed374')?1:0)+'|bg='+String(s40.backgroundColor||'-').replace(/ /g,'')+'|pbg='+(ps?String(ps.backgroundColor||'-').replace(/ /g,''):'-'));}out.push('P40V378[frames='+F40.length+' wraps='+W40.length+' forced='+String(window.__AD_FORCESTRIP378__||0)+' parentInk='+PI40.length+' parentDark='+pd40+(Q40.length?' '+Q40.join(' ~~ '):'')+']');}catch(e40){out.push('P40V378[err '+(e40&&e40.message||e40)+']');}"
       ...
       // P43V378: regression targets outside the icon lane: Cart light pills + tame counts.
       "try{var C43=document.querySelectorAll('[data-ad-cartchrome378]'),K43=document.querySelectorAll('[data-ad-tame-fast362],[data-ad-tame-bgfast364]');out.push('P43V378[cart='+C43.length+' tame='+K43.length+' cartState='+String(window.__AD_CART378__||'-')+' parent='+String(window.__AD_PARENTSTRIP378__||'-')+']');}catch(e43){out.push('P43V378[err '+(e43&&e43.message||e43)+']');}"
