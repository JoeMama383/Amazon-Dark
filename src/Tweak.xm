/*
 * AmazonDark v7.356 — Product inline-ad controls/media + Search carousel correction on v7.355
 *
 * Architecture:
...
#define AD_VERSION "v7.356-product-inline-ad-controls-fix"
...
static NSString *ADFloorJS(void){
    ...
    return
        ...
        // v7.356 new Shop-by-style visual-search family fallback. Semantic owner only; no generic ad/image sweep.
        @"#search#search :is([class*=shop-by-style],[class*=shopByStyle],[id*=shop-by-style],[data-csa-c-painter*=shop-by-style],[data-csa-c-content-id*=shop-by-style]),#search#search :is(.s-widget-container,.celwidget):has(:is([class*=shop-by-style],[class*=shopByStyle],[id*=shop-by-style],[data-csa-c-painter*=shop-by-style],[data-csa-c-content-id*=shop-by-style])){background:#000!important;background-color:#000!important;background-image:none!important;border-color:#494d4d!important;outline-color:#494d4d!important;box-shadow:none!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#search#search :is(.s-widget-container,.celwidget):has(:is([class*=shop-by-style],[class*=shopByStyle],[id*=shop-by-style],[data-csa-c-painter*=shop-by-style],[data-csa-c-content-id*=shop-by-style])) :is(h1,h2,h3,h4,h5,h6,p,span,a,strong,b,em,label,.a-color-base,.a-color-secondary,.a-text-normal){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}"
