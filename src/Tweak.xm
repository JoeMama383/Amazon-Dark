...
static NSString *ADDarkReaderBootstrapBuild(void){
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         "try{(function(){"
           ...
           "new MutationObserver(function(){clearTimeout(window.__adAdd);"
             "window.__adAdd=setTimeout(function(){sweep(document);},8);"
           "}).observe(document.documentElement,{subtree:true,childList:true});"
           "var _adSafe=setInterval(function(){try{"
             "var h=document.querySelectorAll('[class*=ape-placement]:not([data-adok]),[class*=ape-wrapper]:not([data-adok]),[class*=theming-card]:not([data-adok])');"
             "for(var q=0;q<h.length;q++)h[q].setAttribute('data-adok','1');"
           "}catch(e){}},700);"
           "setTimeout(function(){clearInterval(_adSafe);},20000);"
