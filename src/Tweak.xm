...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           // v5.372: the compact 396x62-style Sponsored strip must NOT run the
           // standalone chrome/background painter. 5.371 fixed its text but the
           // standalone root/background made the black rounded box visible again.
           // Detect only short Sponsored strips, clear writes made by standalone362,
           // keep the iframe/root transparent, then run text + media-only tame.
           "window.__AD_COMPACTSTRIP372__=function(){try{if(!document.body||String(window.__ADFRAME_MODE__||'')!=='standalone')return 0;var w=innerWidth||0,h=innerHeight||999;if(w<280||h>96)return 0;var tx=String(document.body.innerText||document.body.textContent||'').replace(/\\s+/g,' ').trim();var ok=/\\bsponsored(?: ad)?\\b/i.test(tx);window.__AD_COMPACTSTRIP372_N__=ok?1:0;return ok?1:0;}catch(e){window.__AD_COMPACTSTRIP372_N__=0;return 0;}};"
           "window.__AD_CLEARSTAND372__=function(){try{var n=0,st=document.getElementById('adfrstand362');if(st&&st.parentNode){st.parentNode.removeChild(st);n++;}var old=document.getElementById('adfrmin');if(old&&old.parentNode)old.parentNode.removeChild(old);var prod=document.getElementById('adfrproduct370');if(prod&&prod.parentNode)prod.parentNode.removeChild(prod);if(!document.getElementById('adfrcompact372')){var cs=document.createElement('style');cs.id='adfrcompact372';cs.textContent='html,body,body div,body section,body article,body main,body a{background-color:transparent !important;box-shadow:none !important;outline-color:transparent !important;border-color:transparent !important;}html,body{background:transparent !important;}';(document.head||document.documentElement).appendChild(cs);}var E=document.querySelectorAll('*');for(var i=0;i<E.length&&i<1200;i++){var e=E[i];if(!e.__adStand362)continue;var bg=String(e.style.getPropertyValue('background-color')||'').replace(/\\s+/g,'').toLowerCase();if(bg==='#181a1b'||bg==='rgb(24,26,27)'){e.style.removeProperty('background-color');n++;}var bi=String(e.style.getPropertyValue('background-image')||'').replace(/\\s+/g,'').toLowerCase();if(bi==='none')e.style.removeProperty('background-image');var S=['top','right','bottom','left'];for(var j=0;j<4;j++){var bp='border-'+S[j]+'-color',bv=String(e.style.getPropertyValue(bp)||'').replace(/\\s+/g,'').toLowerCase();if(bv==='#3b3c3e'||bv==='rgb(59,60,62)'){e.style.removeProperty(bp);n++;}}e.__adStand362=0;}window.__AD_CLEARSTAND372_N__=n;return n;}catch(e){window.__AD_CLEARSTAND372_N__=-1;return 0;}};"
           ...
           "window.__AMZDARK_ADTHEME__=function(){try{"
             ...
             "if(mode==='productad'){var csp=document.getElementById('adfrcompact372');if(csp&&csp.parentNode)csp.parentNode.removeChild(csp);var oldp=document.getElementById('adfrstand362');if(oldp&&oldp.parentNode)oldp.parentNode.removeChild(oldp);var oldm=document.getElementById('adfrmin');if(oldm&&oldm.parentNode)oldm.parentNode.removeChild(oldm);if(!document.getElementById('adfrproduct370')){var pst=document.createElement('style');pst.id='adfrproduct370';pst.textContent='html,body{background-color:transparent !important;}';(document.head||document.documentElement).appendChild(pst);}try{var pe=document.querySelectorAll('*');for(var pi=0;pi<pe.length&&pi<900;pi++){var px=pe[pi];if(!px.__adStand362)continue;var pv=String(px.style.getPropertyValue('background-color')||'').replace(/\\s+/g,'').toLowerCase();if(pv==='#181a1b'||pv==='rgb(24,26,27)')px.style.removeProperty('background-color');var bs=['top','right','bottom','left'];for(var pbi=0;pbi<4;pbi++){var bp='border-'+bs[pbi]+'-color',bv=String(px.style.getPropertyValue(bp)||'').replace(/\\s+/g,'').toLowerCase();if(bv==='#3b3c3e'||bv==='rgb(59,60,62)')px.style.removeProperty(bp);}}}catch(pc369){}var ptx=window.__AD_ADTEXT371__?window.__AD_ADTEXT371__():0;var pt=window.__AMZDARK_ADTAME__?window.__AMZDARK_ADTAME__():0;var ps=window.__AD_SPON365__?window.__AD_SPON365__():0;window.__AD_STANDALONE__='product-stock372';window.__AD_ADTHEME__='mode=productad stock=1 ink371='+ptx+' left='+String(window.__AD_ADTEXT371_LEFT__||0)+' roots='+String(window.__AD_ADTEXT371_ROOTS__||1)+' '+String(window.__AD_ADTAME__||('tame='+pt))+' spon='+ps+' pref='+(window.__AD_PRODUCTREF369__?1:0);return ptx+pt+ps;}"
             "if(mode==='standalone'){var compact372=window.__AD_COMPACTSTRIP372__?window.__AD_COMPACTSTRIP372__():0;if(compact372){var clean372=window.__AD_CLEARSTAND372__?window.__AD_CLEARSTAND372__():0;var ink372=window.__AD_ADTEXT371__?window.__AD_ADTEXT371__():0;var tame372=window.__AMZDARK_ADTAME__?window.__AMZDARK_ADTAME__():0;var spon372=window.__AD_SPON365__?window.__AD_SPON365__():0;window.__AD_STANDALONE__='compact-stock372';window.__AD_ADTHEME__='mode=standalone compact372=1 clean372='+clean372+' ink371='+ink372+' left='+String(window.__AD_ADTEXT371_LEFT__||0)+' roots='+String(window.__AD_ADTEXT371_ROOTS__||1)+' '+String(window.__AD_ADTAME__||('tame='+tame372))+' spon='+spon372;return clean372+ink372+tame372+spon372;}var cst=document.getElementById('adfrcompact372');if(cst&&cst.parentNode)cst.parentNode.removeChild(cst);var old=document.getElementById('adfrmin');if(old&&old.parentNode)old.parentNode.removeChild(old);var prodst=document.getElementById('adfrproduct370');if(prodst&&prodst.parentNode)prodst.parentNode.removeChild(prodst);"
           ...
           "if(!window.__ADFB__){window.__ADFB__=1;"
             "if(window.top===window){window.__AD_FRAMES__={};"
               "addEventListener('message',function(ev){try{"
                 ...
                 // probe budgets.
                 "var interesting=/STAR |stars=[1-9]|ADFRAME mode=productad/.test(String(d.r||''));"
...
"/*V5317FIX*/"
       ...
       "try{var P32=document.querySelectorAll('iframe[data-ad-frame-mode362=\"productad\"]'),R32=[];for(var i32=0;i32<P32.length&&i32<8;i32++){var f32=P32[i32],r32=f32.getBoundingClientRect();R32.push(String(f32.getAttribute('data-ad-frame-why369')||'-')+'@'+Math.round(r32.left)+','+Math.round(r32.top)+'/'+Math.round(r32.width)+'x'+Math.round(r32.height));}out.push('P32V372[productDoc='+String(window.__AD_PRODUCTDOC369__||0)+' productFrame='+P32.length+(R32.length?' '+R32.join(' ~~ '):'')+']');}catch(e32){out.push('P32V372[err '+(e32&&e32.message||e32)+']');}"
       "try{var A33=document.querySelectorAll('[class*=_hp-mosaic-container_style_widgetContainer],[class*=_mosaic-container_style_widgetContainer]'),Q33=[];for(var i33=0;i33<A33.length&&i33<10;i33++){var e33=A33[i33],r33=e33.getBoundingClientRect(),s33=getComputedStyle(e33);if(r33.width<100||r33.height<50)continue;Q33.push(e33.tagName+'.'+cls(e33)+'@'+Math.round(r33.top)+'/'+Math.round(r33.width)+'x'+Math.round(r33.height)+'|t='+String(s33.borderTopColor||'-').replace(/ /g,'')+'|sec='+String(e33.getAttribute('data-ad-border-section')||'-')+'|by='+(e33.__adBy||'-'));}out.push('P33V372[n='+Q33.length+(Q33.length?' '+Q33.join(' ~~ '):'')+']');}catch(e33){out.push('P33V372[err '+(e33&&e33.message||e33)+']');}"
       "try{var A34=document.querySelectorAll('[class*=_hp-mosaic-container_style_widgetContainer],[class*=_mosaic-container_style_widgetContainer]'),Q34=[],brown34=0,fixed34=0;for(var i34=0;i34<A34.length;i34++){var e34=A34[i34],r34=e34.getBoundingClientRect(),s34=getComputedStyle(e34),bc34=String(s34.borderTopColor||'').replace(/ /g,''),isB34=(bc34==='rgb(84,78,69)'||bc34==='rgb(85,79,70)'||bc34==='rgb(83,77,68)');if(isB34)brown34++;if(e34.getAttribute&&e34.getAttribute('data-ad-border-section')==='exact371')fixed34++;if(Q34.length<12&&(isB34||(r34.bottom>=-80&&r34.top<=(window.innerHeight||900)+80)))Q34.push(e34.tagName+'.'+cls(e34)+'@'+Math.round(r34.top)+'/'+Math.round(r34.width)+'x'+Math.round(r34.height)+'|t='+bc34+'|sec='+String(e34.getAttribute('data-ad-border-section')||'-')+'|by='+(e34.__adBy||'-'));}out.push('P34V372[total='+A34.length+' brown='+brown34+' fixed='+fixed34+(Q34.length?' '+Q34.join(' ~~ '):'')+']');}catch(e34){out.push('P34V372[err '+(e34&&e34.message||e34)+']');}"
       "try{var C35=document.querySelectorAll('[data-ad-compactad371]'),I35=document.querySelectorAll('[data-ad-compactink371]'),Q35=[];for(var i35=0;i35<I35.length&&i35<8;i35++){var e35=I35[i35],r35=e35.getBoundingClientRect(),s35=getComputedStyle(e35),t35=String(e35.textContent||'').replace(/\\s+/g,' ').trim();Q35.push(t35.slice(0,24)+'@'+Math.round(r35.top)+'|c='+String(s35.color||'-').replace(/ /g,'')+'|fill='+String(s35.webkitTextFillColor||'-').replace(/ /g,'')+'|by='+(e35.__adBy||'-'));}out.push('P35V372[cards='+C35.length+' ink='+I35.length+(Q35.length?' '+Q35.join(' ~~ '):'')+']');}catch(e35){out.push('P35V372[err '+(e35&&e35.message||e35)+']');}"
       "try{var F36=document.querySelectorAll('iframe[data-ad-frame-mode362=\"standalone\"]'),Q36=[];for(var i36=0;i36<F36.length&&i36<12;i36++){var f36=F36[i36],r36=f36.getBoundingClientRect();if(r36.width<280||r36.height>100)continue;Q36.push(Math.round(r36.left)+','+Math.round(r36.top)+'/'+Math.round(r36.width)+'x'+Math.round(r36.height));}out.push('P36V372[compactStandalone='+Q36.length+(Q36.length?' '+Q36.join(' ~~ '):'')+']');}catch(e36){out.push('P36V372[err '+(e36&&e36.message||e36)+']');}"
