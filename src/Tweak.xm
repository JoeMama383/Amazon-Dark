...
static NSString *ADDarkReaderBootstrapBuild(void){
    ...
    NSString *adBody = [NSString stringWithFormat:
        @"(function(){try{"
         ...
         // v5.398: one canonical chrome geometry for Search/PDP action symbols.
         // v5.333 still owns glyph paint; this sheet owns only host size/chrome.
         // Compare is a single square host -- never a circle plus an inner square.
         "try{if(document&&!document.getElementById('adcontrol398')){var __c398=document.createElement('style');__c398.id='adcontrol398';"
           "__c398.textContent='"
             "[data-ad-control398]{width:32px !important;height:32px !important;min-width:32px !important;min-height:32px !important;max-width:32px !important;max-height:32px !important;background:#181a1b !important;background-color:#181a1b !important;border:0 !important;border-radius:50%% !important;box-shadow:inset 0 0 0 1.5px #9aa0a3 !important;box-sizing:border-box !important;}"
             "[data-ad-control398=\"checkbox\"]{border-radius:4px !important;background:#181a1b !important;background-color:#181a1b !important;box-shadow:inset 0 0 0 1.5px #9aa0a3 !important;}"
             "[data-ad-control398=\"checkbox\"][data-ad-selected398=\"1\"]{background:#2162a1 !important;background-color:#2162a1 !important;box-shadow:inset 0 0 0 1.5px #9aa0a3 !important;}"
             "[data-ad-control398=\"checkbox\"]::before,[data-ad-checkaux398]::before,[data-ad-checkaux398]::after{content:none !important;display:none !important;background:transparent !important;border:0 !important;box-shadow:none !important;}"
             "[data-ad-control398=\"checkbox\"]::after{content:none !important;}"
             "[data-ad-control398=\"checkbox\"][data-ad-selected398=\"1\"]::after{content:\"\" !important;display:block !important;position:absolute !important;left:50%% !important;top:50%% !important;width:8px !important;height:14px !important;border:solid #fff !important;border-width:0 2.5px 2.5px 0 !important;transform:translate(-50%%,-62%%) rotate(45deg) !important;z-index:8 !important;pointer-events:none !important;background:transparent !important;box-shadow:none !important;}"
             "[data-ad-checkaux398]{background:transparent !important;background-color:transparent !important;border:0 !important;box-shadow:none !important;}"
             "[data-ad-control398=\"checkbox\"] [data-ad-compareorig380],[data-ad-control398=\"checkbox\"] [data-ad-comparelegacyorig387],[data-ad-control398=\"checkbox\"] i.a-icon-checkbox,[data-ad-control398=\"checkbox\"] img[class*=s-image]{visibility:hidden !important;opacity:0 !important;pointer-events:none !important;}"
           "';(document.head||document.documentElement).appendChild(__c398);}}catch(e){}"
         // v5.398: v5.396 matched only some Home ancestry shapes. Device probe showed
         // P59 risk=7, proving live theming-card-background nodes escaped that selector.
         // Neutralize the ambient layer directly in the top frame before first paint.
         "try{if(document&&!document.getElementById('adbleed398')){var __b398=document.createElement('style');__b398.id='adbleed398';"
           "__b398.textContent='[data-ad-main396] [class*=theming-card-background]{background:#181a1b !important;background-color:#181a1b !important;background-image:none !important;filter:none !important;mix-blend-mode:normal !important;background-blend-mode:normal !important;animation:none !important;transition:none !important;isolation:auto !important;}[data-ad-main396] [class*=theming-card-background]::before,[data-ad-main396] [class*=theming-card-background]::after{background:#181a1b !important;background-color:#181a1b !important;background-image:none !important;filter:none !important;mix-blend-mode:normal !important;animation:none !important;transition:none !important;}';"
           "(document.head||document.documentElement).appendChild(__b398);}}catch(e){}"
...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         // v5.398: normalize the 4-5 product action-symbol hosts after v5.333 has
         // restored the correct glyphs. Geometry/chrome only; no glyph recoloring here.
         "window.__AD_CONTROL398__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           "function rr398(e){try{return e&&e.getBoundingClientRect?e.getBoundingClientRect():null;}catch(x){return null;}}"
           "function cn398(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}"
           "function sq398(e,lo,hi){var r=rr398(e);return !!(r&&r.width>=lo&&r.width<=hi&&r.height>=lo&&r.height<=hi&&Math.abs(r.width-r.height)<=8);}"
           "function card398(e){return e&&e.closest&&e.closest('[class*=puis-card],[class*=s-result-item],[data-asin],[class*=s-product-image],[class*=product-image]');}"
           "function host398(root,g,lo,hi){if(!root||!g)return null;var p=g,b=null,bd=999,u=0;while(p&&u++<8){var tg=String(p.tagName||'').toUpperCase();if(!/^(IMG|I|INPUT|SVG|PATH|USE|POLYGON)$/.test(tg)&&sq398(p,lo,hi)){var r=rr398(p),d=Math.abs(Math.max(r.width,r.height)-32);if(d<bd){bd=d;b=p;}}if(p===root)break;p=p.parentElement;}return b;}"
           "function mark398(h,t){if(!h||!sq398(h,20,54))return 0;h.setAttribute('data-ad-control398',t);h.style.setProperty('width','32px','important');h.style.setProperty('height','32px','important');h.style.setProperty('min-width','32px','important');h.style.setProperty('min-height','32px','important');h.style.setProperty('max-width','32px','important');h.style.setProperty('max-height','32px','important');h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('border','0','important');h.style.setProperty('border-radius',t==='checkbox'?'4px':'50%%','important');h.style.setProperty('box-shadow','inset 0 0 0 1.5px #9aa0a3','important');h.style.setProperty('box-sizing','border-box','important');return 1;}"
           "function sel398(h){try{var q=h.querySelector&&h.querySelector('input[type=checkbox]');if(q)return !!q.checked;var p=h,u=0;while(p&&u++<5){var a=String(p.getAttribute&&p.getAttribute('aria-checked')||p.getAttribute&&p.getAttribute('data-checked')||p.getAttribute&&p.getAttribute('data-selected')||'').toLowerCase(),c=cn398(p).toLowerCase();if(a==='true'||/(^|[ _-])(checked|selected|active)([ _-]|$)/.test(c))return true;if(a==='false')return false;p=p.parentElement;}var im=h.querySelector&&h.querySelector('img'),src=im?String(im.currentSrc||im.src||'').toLowerCase():'';return /checkbox[_-]?(?:on|checked)|checkmark|selected/.test(src);}catch(x){return false;}}"
           "var heart398=0,cards398=0,arrow398=0,check398=0,share398=0,seen398=[];"
           "var H398=document.querySelectorAll('[class*=puis-heart-position]');for(var hi398=0;hi398<H398.length&&hi398<180;hi398++){var hr398=H398[hi398],Q398=hr398.querySelectorAll('button,[role=button],a,span,div,i,svg,img'),hh398=sq398(hr398,24,50)?hr398:null,bh398=hh398?Math.abs(Math.max(rr398(hh398).width,rr398(hh398).height)-32):999;for(var hq398=0;hq398<Q398.length&&hq398<100;hq398++){var xh398=Q398[hq398];if(!sq398(xh398,24,50))continue;var rh398=rr398(xh398),dh398=Math.abs(Math.max(rh398.width,rh398.height)-32);if(dh398<bh398){bh398=dh398;hh398=xh398;}}if(hh398&&seen398.indexOf(hh398)<0){seen398.push(hh398);heart398+=mark398(hh398,'heart');}}"
           "var A398=document.querySelectorAll('[class*=lists-framework-action-button]');for(var ai398=0;ai398<A398.length&&ai398<200;ai398++){var ah398=A398[ai398];if(ah398.closest&&ah398.closest('[class*=puis-heart-position]'))continue;if(!sq398(ah398,18,54))continue;if(seen398.indexOf(ah398)>=0)continue;seen398.push(ah398);cards398+=mark398(ah398,'cards');}"
           "var E398=document.querySelectorAll('[class*=a-icon-dropdown],[class*=a-icon-extender],[class*=chevron],[class*=caret],[class*=arrow]');for(var ei398=0;ei398<E398.length&&ei398<500;ei398++){var eg398=E398[ei398],ec398=card398(eg398),cl398=cn398(eg398);if(!ec398||/carousel|next|previous|prev/i.test(cl398))continue;if(eg398.closest&&eg398.closest('[class*=puis-heart-position],[class*=lists-framework-action-button],[class*=mlt-icon-container],[role=checkbox]'))continue;var eh398=host398(ec398,eg398,22,50);if(!eh398||seen398.indexOf(eh398)>=0)continue;seen398.push(eh398);arrow398+=mark398(eh398,'arrow');}"
           "var S398=document.querySelectorAll('.ssf-share-trigger');for(var si398=0;si398<S398.length&&si398<20;si398++){var sh398=S398[si398];if(!sq398(sh398,20,54)||seen398.indexOf(sh398)>=0)continue;seen398.push(sh398);share398+=mark398(sh398,'share');}"
           "var C398=document.querySelectorAll('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],i.a-icon-checkbox,[class*=a-icon-checkbox],[data-ad-compare380],[data-ad-comparelegacy387],[data-ad-product391=\"checkbox\"]'),seenC398=[];for(var ci398=0;ci398<C398.length&&ci398<500;ci398++){var ce398=C398[ci398],ch398=host398(card398(ce398)||document.body,ce398,24,48);if(!ch398){var pp398=ce398&&String(ce398.tagName||'').toUpperCase()==='INPUT'?ce398.parentElement:ce398,u398=0,bd398=999;while(pp398&&u398++<7){if(sq398(pp398,24,48)){var rp398=rr398(pp398),dd398=Math.abs(Math.max(rp398.width,rp398.height)-32);if(dd398<bd398){bd398=dd398;ch398=pp398;}}if(/mlt-icon-container/i.test(cn398(pp398))&&ch398)break;pp398=pp398.parentElement;}}if(!ch398||seenC398.indexOf(ch398)>=0)continue;if(!card398(ch398)&&!/mlt-icon-container/i.test(cn398(ch398)))continue;seenC398.push(ch398);mark398(ch398,'checkbox');var sv398=sel398(ch398);ch398.setAttribute('data-ad-selected398',sv398?'1':'0');ch398.style.setProperty('background-color',sv398?'#2162a1':'#181a1b','important');var near398=ch398.querySelectorAll('[data-ad-compare380],[data-ad-comparelegacy387],[class*=a-icon-checkbox],i.a-icon-checkbox');for(var ni398=0;ni398<near398.length;ni398++){if(near398[ni398]!==ch398)near398[ni398].setAttribute('data-ad-checkaux398','1');}var pa398=ch398.parentElement,pu398=0;while(pa398&&pu398++<4){if(pa398!==ch398&&(pa398.hasAttribute('data-ad-compare380')||pa398.hasAttribute('data-ad-comparelegacy387')))pa398.setAttribute('data-ad-checkaux398','1');pa398=pa398.parentElement;}check398++;}"
           "window.__AD_CONTROL398_STATE__='heart='+heart398+' cards='+cards398+' arrow='+arrow398+' checkbox='+check398+' share='+share398;return heart398+cards398+arrow398+check398+share398;"
         "}catch(e){window.__AD_CONTROL398_STATE__='err '+(e&&e.message||e);return -1;}};"
         "try{window.__AD_PRODUCTCTRL391_ORIG398__=window.__AD_PRODUCTCTRL391RUN__;window.__AD_PRODUCTCTRL391RUN__=function(){var r398=window.__AD_PRODUCTCTRL391_ORIG398__?window.__AD_PRODUCTCTRL391_ORIG398__():0;try{window.__AD_CONTROL398__();}catch(c398){}return r398;};}catch(e){}"
         "try{window.__AD_CONTROL398__();setTimeout(window.__AD_CONTROL398__,40);setTimeout(window.__AD_CONTROL398__,220);setTimeout(window.__AD_CONTROL398__,900);setTimeout(window.__AD_CONTROL398__,1800);}catch(e){}"
         // v5.398 runtime reinforcement for Home ambient bleed. The documentStart CSS
         // is the first-paint fix; this defeats later inline hydration/recycling writes.
         "window.__AD_BLEED398__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;if(document.querySelector('#search,.s-search-results,[data-component-type=\"s-search-result\"],#productTitle,#dp-container,#ppd')){window.__AD_BLEED398_STATE__='home=0';return 0;}var B398=document.querySelectorAll('[class*=theming-card-background]'),n398=0;for(var bi398=0;bi398<B398.length&&bi398<100;bi398++){var b398=B398[bi398],r398=b398.getBoundingClientRect();if(r398&&r398.width<80&&r398.height<60)continue;b398.setAttribute('data-ad-bleed398','1');b398.style.setProperty('background','#181a1b','important');b398.style.setProperty('background-color','#181a1b','important');b398.style.setProperty('background-image','none','important');b398.style.setProperty('filter','none','important');b398.style.setProperty('mix-blend-mode','normal','important');b398.style.setProperty('background-blend-mode','normal','important');b398.style.setProperty('animation','none','important');b398.style.setProperty('transition','none','important');n398++;}window.__AD_BLEED398_STATE__='home=1 n='+n398;return n398;}catch(e){window.__AD_BLEED398_STATE__='err '+(e&&e.message||e);return -1;}};"
         "try{window.__AD_BLEED398__();setTimeout(window.__AD_BLEED398__,20);setTimeout(window.__AD_BLEED398__,120);setTimeout(window.__AD_BLEED398__,500);setTimeout(window.__AD_BLEED398__,1400);addEventListener('scroll',function(){try{window.__AD_BLEED398__();}catch(x){}},{passive:true,capture:true});}catch(e){}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // P61CTRL398: canonical 32px chrome geometry across target action symbols.
       "try{var C61=document.querySelectorAll('[data-ad-control398]'),n61=C61.length,badSize61=0,badRing61=0,badShape61=0,cb61=0,inner61=0,Q61=[];for(var i61=0;i61<C61.length&&i61<220;i61++){var e61=C61[i61],r61=e61.getBoundingClientRect(),s61=getComputedStyle(e61),t61=String(e61.getAttribute('data-ad-control398')||'-');if(Math.abs(r61.width-32)>1.5||Math.abs(r61.height-32)>1.5)badSize61++;if(String(s61.boxShadow||'').indexOf('1.5px')<0||String(s61.boxShadow||'').indexOf('154, 160, 163')<0)badRing61++;var br61=parseFloat(s61.borderTopLeftRadius||'0');if(t61==='checkbox'){cb61++;if(br61<3||br61>6)badShape61++;var pb61=getComputedStyle(e61,'::before');if(String(pb61.content||'none')!=='none')inner61++;}else if(br61<12)badShape61++;if(Q61.length<10)Q61.push(t61+'@'+Math.round(r61.width)+'x'+Math.round(r61.height)+'|r='+Math.round(br61));}out.push('P61CTRL398[n='+n61+' checkbox='+cb61+' badSize='+badSize61+' badRing='+badRing61+' badShape='+badShape61+' inner='+inner61+' state='+String(window.__AD_CONTROL398_STATE__||'-')+(Q61.length?' '+Q61.join(' ~~ '):'')+']');}catch(e61){out.push('P61CTRL398[err '+(e61&&e61.message||e61)+']');}"
       // P62BLEED398: direct live ambient-layer verification after the broadened prepaint guard.
       "try{var B62=document.querySelectorAll('[class*=theming-card-background]'),seen62=0,risk62=0,Q62=[];for(var i62=0;i62<B62.length&&i62<100;i62++){var e62=B62[i62],r62=e62.getBoundingClientRect();if(r62.width<80&&r62.height<60)continue;seen62++;var s62=getComputedStyle(e62),bi62=String(s62.backgroundImage||'none'),bc62=String(s62.backgroundColor||'').replace(/\\s+/g,''),f62=String(s62.filter||'none'),mb62=String(s62.mixBlendMode||'normal');var bad62=bi62!=='none'||(bc62!=='rgb(24,26,27)'&&bc62!=='rgba(24,26,27,1)'&&bc62!=='#181a1b')||f62!=='none'||mb62!=='normal';if(bad62)risk62++;if(Q62.length<8)Q62.push(Math.round(r62.width)+'x'+Math.round(r62.height)+'|'+bc62+'|bi='+(bi62==='none'?0:1));}out.push('P62BLEED398[seen='+seen62+' risk='+risk62+' state='+String(window.__AD_BLEED398_STATE__||'-')+(Q62.length?' '+Q62.join(' ~~ '):'')+']');}catch(e62){out.push('P62BLEED398[err '+(e62&&e62.message||e62)+']');}"
