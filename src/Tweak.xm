    ...
    cached = [NSString stringWithFormat:
       @"(function(){try{if(window.__AD_SYM605_LOADED__)return 'already';window.__AD_SYM605_LOADED__=1;"
         ...
         "function stockCheckbox434(){if(window.__ADFRAME_MODE__||!document.body||window.__AD_CHECKBOX434_RUNNING__)return 0;window.__AD_CHECKBOX434_RUNNING__=1;try{"
           ...
           // v6.0.115: Search's product-card overflow menu reuses several global
           // symbol families (checkbox, MLT, background-image glyphs) but needs different
           // paint. Handle only the four exact menu leaves when Amazon inserts the menu.
           // This piggybacks on the existing filtered observer; no new observer/listener/timer.
           "function mabClass6115(e){try{return !!(e&&e.nodeType===1&&cn434(e).indexOf('puis-mab-')>=0);}catch(x){return false;}}"
           "function mab6115(root){try{if(!root||root.nodeType!==1)return 0;var box=(root.classList&&root.classList.contains('puis-mab-overlay'))?root:(root.closest&&root.closest('.puis-mab-overlay'))||root,R=[],n=0;if(box.classList&&box.classList.contains('puis-mab-overlay-row'))R.push(box);var L=box.getElementsByClassName?box.getElementsByClassName('puis-mab-overlay-row'):[];for(var i=0;i<L.length&&i<12;i++)if(R.indexOf(L[i])<0)R.push(L[i]);for(var j=0;j<R.length;j++){var r=R[j],sv=r.querySelector&&r.querySelector('.puis-mab-overlay-heart'),ml=r.querySelector&&r.querySelector('.mlt-icon-container'),cb=r.querySelector&&r.querySelector('i.a-icon.a-icon-checkbox'),tx=String(r.textContent||'').replace(/\s+/g,' ').trim().toLowerCase();if(sv){sv.setAttribute('data-ad-mabsave6115','1');sv.style.setProperty('filter','brightness(0) invert(1)','important');sv.style.setProperty('background-color','transparent','important');sv.__adGlyph=1;sv.__adBy='mabsave6115';n++;}if(ml){ml.setAttribute('data-ad-mabmlt6115','1');ml.style.setProperty('background-color','transparent','important');ml.style.setProperty('border','0','important');ml.style.setProperty('border-radius','0','important');ml.style.setProperty('box-shadow','none','important');ml.style.setProperty('outline','0','important');ml.style.setProperty('box-sizing','border-box','important');n++;}if(cb){var h=cb.closest&&cb.closest('.a-checkbox');cb.removeAttribute('data-ad-checkbox434-art');if(h)h.removeAttribute('data-ad-checkbox434-host');cb.setAttribute('data-ad-mabselect6115','1');cb.style.setProperty('filter','none','important');cb.style.setProperty('background-color','transparent','important');cb.style.setProperty('background-image','url(data:image/svg+xml;base64,)','important');cb.style.setProperty('background-repeat','no-repeat','important');cb.style.setProperty('background-position','center','important');cb.style.setProperty('background-size','16px 16px','important');cb.style.setProperty('border','0','important');cb.style.setProperty('border-radius','0','important');cb.style.setProperty('box-shadow','none','important');cb.style.setProperty('outline','0','important');cb.__adGlyph=1;cb.__adBy='mabselect6115';n++;}if(/^share(?:\s|$)/.test(tx)){var S=r.getElementsByClassName?r.getElementsByClassName('aok-inline-block'):[],sh=S&&S.length?S[0]:null;if(sh){sh.setAttribute('data-ad-mabshare6115','1');sh.style.setProperty('filter','brightness(0) invert(1)','important');sh.style.setProperty('background-color','transparent','important');sh.style.setProperty('opacity','1','important');sh.__adGlyph=1;sh.__adBy='mabshare6115';n++;}}}window.__AD_MAB6115__=n;return n;}catch(x){window.__AD_MAB6115__=-1;return 0;}}"
