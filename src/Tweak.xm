...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           "window.__AMZDARK_ADTHEME__=function(){try{"
             ...
             "if(mode==='standalone'||mode==='productad'){var old=document.getElementById('adfrmin');if(old&&old.parentNode)old.parentNode.removeChild(old);"
               ...
               "window.__AD_ADTHEME__='mode='+mode+' '+String(window.__AD_STANDALONE__||('theme='+sn))+' '+String(window.__AD_ADTAME__||('tame='+stn))+' spon='+sp367;return sn+stn+sp367;}"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "try{window.__AD_FRAMECLASS362__=function(){var F=document.querySelectorAll('iframe'),n=0;"
           "for(var fi=0;fi<F.length&&fi<80;fi++){var f=F[fi],r=f.getBoundingClientRect();if(r.width<120||r.height<50)continue;"
             ...
             "var productDoc=false;try{productDoc=!!document.querySelector('#dp,#ppd,#centerCol,.s-search-results,[data-component-type=\"s-search-result\"]');}catch(e){}"
             "var productAd=(!hero&&productDoc&&r.width>=300&&r.height>=70&&r.height<=440);var mode=hero?'hero':(productAd?'productad':'standalone');f.setAttribute('data-ad-frame-mode362',mode);try{f.contentWindow&&f.contentWindow.postMessage({__amzAdMode:mode},'*');}catch(e){}n++;}"
...
"/*V5317FIX*/"
       ...
       "try{var pa31=document.querySelectorAll('[data-ad-productad367]').length,ri31=document.querySelectorAll('[data-ad-reviewink367]').length,bf31=document.querySelectorAll('[data-ad-border-section=\"fast367\"],[data-ad-border-section=\"fast368\"]').length,pf31=document.querySelectorAll('iframe[data-ad-frame-mode362=\"productad\"]').length;out.push('P31FIX[productAd='+pa31+' productFrame='+pf31+' reviewInk='+ri31+' borderFast='+bf31+']');}catch(e31){out.push('P31FIX[err '+(e31&&e31.message||e31)+']');}"
