...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "function _adStandaloneSweep393(){try{if(window.__ADFRAME_MODE__)return 0;var F=document.querySelectorAll('iframe[data-ad-frame-mode362=\"standalone\"][data-ad-stripframe374]'),n=0;for(var i=0;i<F.length&&i<40;i++)if(window.__AD_STANDPARENT393__)n+=window.__AD_STANDPARENT393__(F[i]);window.__AD_STANDSWEEP393__='frames='+F.length+' fixed='+n;return n;}catch(e){window.__AD_STANDSWEEP393__='err '+(e&&e.message||e);return 0;}}"
         "window._adStandaloneSweep393=_adStandaloneSweep393;"
         ...
         "window.__AD_PRODUCTCTRL391RUN__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           ...
           "var H=document.querySelectorAll('[class*=\"puis-heart-position\"]');for(var hi=0;hi<H.length&&hi<180;hi++){var hr=H[hi],pick=heartGlyph393(hr);if(!pick){clearHeart393(hr);miss++;continue;}var hg=pick.e,hh=around(hr,hg,24,48);if(!hh&&square(hr,24,48))hh=hr;if(!hh){clearHeart393(hr);miss++;continue;}if(skin(hh,'heart')){paint(hg,hh);if(pick.pb)markps393(hg,'::before',pick.pb);if(pick.pa)markps393(hg,'::after',pick.pa);heart++;}}"
         ...
         "function _adHomeVideoBackdrop393(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;if(document.querySelector('#search,.s-search-results,[data-component-type=\"s-search-result\"],#productTitle,#dp-container,#ppd')){window.__AD_HOMEBACK393__='home=0 product=1';return 0;}var V=document.querySelectorAll('video'),W=innerWidth||390,H=innerHeight||900,n=0,left=0,seen=[];function cls(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}function pc(v){var m=/rgba?\\((\\d+),\\s*(\\d+),\\s*(\\d+)(?:,\\s*([0-9.]+))?/i.exec(String(v||''));return m?[+m[1],+m[2],+m[3],m[4]===undefined?1:+m[4]]:null;}function hot(q){if(!q||q[3]<.28)return false;var mx=Math.max(q[0],q[1],q[2]),mn=Math.min(q[0],q[1],q[2]),sat=(mx-mn)/255;return sat>.16;}function hs(c){if(!c)return false;var bi=String(c.backgroundImage||'none');return bi.indexOf('url(')<0&&(hot(pc(c.backgroundColor))||/gradient\\(/i.test(bi));}function adctx(v){var p=v,u=0,t='';while(p&&u++<7){t+=' '+cls(p)+' '+String(p.id||'');if(/single-video-card|video-card|sbv-video|vjs-tech|sponsored|advert|ad[-_]|ape[-_]|creative|theming-card/i.test(t))return true;p=p.parentElement;}return false;}for(var i=0;i<V.length&&i<50;i++){var v=V[i],vr=v.getBoundingClientRect();if(vr.width<180||vr.height<120||!adctx(v))continue;var p=v.parentElement,d=0;while(p&&p!==document.body&&d++<10){var pr=p.getBoundingClientRect(),cl=cls(p).toLowerCase();if(pr.width>=W*.80&&pr.width<=W*1.20&&pr.height>=Math.min(260,vr.height*.55)&&pr.height<=H*1.65&&!/single-video-card|single-creative-card|video-js|vjs-player|vjs-tech/i.test(cl)){if(seen.indexOf(p)<0){seen.push(p);var cs=getComputedStyle(p),bi=String(cs.backgroundImage||'none'),bad=hs(cs),bp=hs(getComputedStyle(p,'::before')),ap=hs(getComputedStyle(p,'::after'));if(bad||bp||ap){if(bad){p.setAttribute('data-ad-homeback393','1');p.style.setProperty('background-color','#181a1b','important');if(/gradient\\(/i.test(bi)&&bi.indexOf('url(')<0)p.style.setProperty('background-image','none','important');}if(bp)p.setAttribute('data-ad-homebackbefore393','1');if(ap)p.setAttribute('data-ad-homebackafter393','1');n++;}}}p=p.parentElement;}}var Q=document.querySelectorAll('[data-ad-homeback393],[data-ad-homebackbefore393],[data-ad-homebackafter393]');for(var j=0;j<Q.length;j++){var e=Q[j];if(e.hasAttribute('data-ad-homeback393')&&hs(getComputedStyle(e)))left++;if(e.hasAttribute('data-ad-homebackbefore393')&&hs(getComputedStyle(e,'::before')))left++;if(e.hasAttribute('data-ad-homebackafter393')&&hs(getComputedStyle(e,'::after')))left++;}window.__AD_HOMEBACK393__='fixed='+n+' left='+left+' anchors='+V.length;return n;}catch(e){window.__AD_HOMEBACK393__='err '+(e&&e.message||e);return 0;}}"
         "window._adHomeVideoBackdrop393=_adHomeVideoBackdrop393;"
         "try{_adHomeVideoBackdrop393();_adStandaloneSweep393();setTimeout(_adHomeVideoBackdrop393,220);setTimeout(_adHomeVideoBackdrop393,900);setTimeout(_adStandaloneSweep393,260);setTimeout(_adStandaloneSweep393,1000);if(!window.__ADHOMEP393INIT__){window.__ADHOMEP393INIT__=1;var hp393=0;addEventListener('scroll',function(){if(hp393)return;hp393=1;var f=function(){hp393=0;try{_adHomeVideoBackdrop393();_adStandaloneSweep393();}catch(e){}};if(requestAnimationFrame)requestAnimationFrame(f);else setTimeout(f,0);},{passive:true,capture:true});}}catch(e){}"
         ...
         "try{if(window._adHomeVideoBackdrop393)_adHomeVideoBackdrop393();}catch(e){}try{if(window._adStandaloneSweep393)_adStandaloneSweep393();}catch(e){}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       "try{var S56=document.querySelectorAll('[data-ad-standparent393]'),B56=document.querySelectorAll('[data-ad-homeback393],[data-ad-homebackbefore393],[data-ad-homebackafter393]'),sb56=0,bl56=0,Q56=[];function p56(v){var m=/rgba?\\((\\d+),\\s*(\\d+),\\s*(\\d+)(?:,\\s*([0-9.]+))?/i.exec(String(v||''));return m?[+m[1],+m[2],+m[3],m[4]===undefined?1:+m[4]]:null;}function sat56(q){return q?(Math.max(q[0],q[1],q[2])-Math.min(q[0],q[1],q[2]))/255:0;}function bad56(c){var q=p56(c.backgroundColor),bi=String(c.backgroundImage||'none');return !!((q&&q[3]>.28&&sat56(q)>.16)||(/gradient\\(/i.test(bi)&&bi.indexOf('url(')<0));}for(var s56=0;s56<S56.length;s56++){var q56=p56(getComputedStyle(S56[s56]).backgroundColor);if(q56&&q56[3]>.3&&(.2126*q56[0]+.7152*q56[1]+.0722*q56[2])/255<.20&&sat56(q56)<.10)sb56++;if(Q56.length<4){var sr56=S56[s56].getBoundingClientRect();Q56.push('S@'+Math.round(sr56.left)+','+Math.round(sr56.top)+'/'+Math.round(sr56.width)+'x'+Math.round(sr56.height));}}for(var b56=0;b56<B56.length;b56++){var e56=B56[b56];if(e56.hasAttribute('data-ad-homeback393')&&bad56(getComputedStyle(e56)))bl56++;if(e56.hasAttribute('data-ad-homebackbefore393')&&bad56(getComputedStyle(e56,'::before')))bl56++;if(e56.hasAttribute('data-ad-homebackafter393')&&bad56(getComputedStyle(e56,'::after')))bl56++;if(Q56.length<8){var br56=e56.getBoundingClientRect();Q56.push('B@'+Math.round(br56.left)+','+Math.round(br56.top)+'/'+Math.round(br56.width)+'x'+Math.round(br56.height));}}out.push('P56HOME393[stand='+S56.length+' blackleft='+sb56+' bleed='+B56.length+' bleedleft='+bl56+' sstate='+String(window.__AD_STANDPARENT393_STATE__||window.__AD_STANDSWEEP393__||'-')+' bstate='+String(window.__AD_HOMEBACK393__||'-')+(Q56.length?' '+Q56.join(' ~~ '):'')+']');}catch(e56){out.push('P56HOME393[err '+(e56&&e56.message||e56)+']');}"
       ...
       "try{var H57=document.querySelectorAll('[data-ad-product391=\"heart\"]'),g57=0,p57=0,empty57=0,Q57=[];for(var i57=0;i57<H57.length;i57++){var h57=H57[i57],G57=h57.querySelectorAll('[data-ad-productglyph391]'),P57=h57.querySelectorAll('[data-ad-heartbefore393],[data-ad-heartafter393]'),ok57=G57.length+P57.length;if(G57.length)g57++;if(P57.length)p57++;if(!ok57)empty57++;if(Q57.length<8){var r57=h57.getBoundingClientRect();Q57.push(Math.round(r57.left)+','+Math.round(r57.top)+'/'+Math.round(r57.width)+'x'+Math.round(r57.height)+'|g='+G57.length+'|p='+P57.length);}}out.push('P57HEART393[hosts='+H57.length+' elem='+g57+' pseudo='+p57+' empty='+empty57+(Q57.length?' '+Q57.join(' ~~ '):'')+']');}catch(e57){out.push('P57HEART393[err '+(e57&&e57.message||e57)+']');}"
