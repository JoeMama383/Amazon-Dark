...
// v7.405 FULL r2/r3: comprehensive Product Detail Page completion. Both captures are
// the same #dp renderer at different hydration/sweep states. Own only the probe-proven
...
// v7.405: tame only PDP media families proven bright/untamed by FULL r2/r3. Brightness
// preserves hue; star/Prime/brand/icon/sprite families are not in these selectors.
...
// v7.448 main-document residue proven by the v7.435 probes and current device shots:
