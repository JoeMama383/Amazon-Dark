/*
 * AmazonDark v7.358 — Search row chrome + Search Tiles separator + certification icon correction on v7.357
 *
 * Architecture:
...
#define AD_VERSION "v7.358-search-row-shop-style-leaf-fix"
