...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           "window.__AMZDARK_ADTHEME__=function(){try{"
             ...
             "var strip375=window.__AD_PRODUCTSTRIP375__?window.__AD_PRODUCTSTRIP375__():0;if(strip375){var cl375=window.__AD_CLEARSTRIP374__?window.__AD_CLEARSTRIP374__():0;var in375=window.__AD_ADTEXT371__?window.__AD_ADTEXT371__():0;var tm375=window.__AD_STRIPMEDIA374__?window.__AD_STRIPMEDIA374__():0;var sp375=window.__AD_SPON365__?window.__AD_SPON365__():0;window.__AD_STANDALONE__='strip-stock375';window.__AD_ADTHEME__='mode='+mode+' strip375=1 strip376=1 sticky375='+String(window.__AD_STRIPCONF375__?1:0)+' first='+String(window.__AD_STRIP375_FIRSTMODE__||'-')+' clean375='+cl375+' chrome375='+String(window.__AD_STRIPCHROME374_LEFT__||0)+' ink375='+in375+' white376='+String(window.__AD_ADTEXT376_LOCKED__||0)+' grayleft376='+String(window.__AD_ADTEXT376_GRAYLEFT__||0)+' left='+String(window.__AD_ADTEXT371_LEFT__||0)+' vis375='+String(window.__AD_ADVIS375_N__||0)+' roots='+String(window.__AD_ADTEXT371_ROOTS__||1)+' media375='+String(window.__AD_STRIPMEDIA374_N__||0)+' fullSkip375='+String(window.__AD_STRIPFULL374_N__||0)+' spon='+sp375;return cl375+in375+tm375+sp375;}"
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         "}catch(e){}}""badgeFix();dotFix();packFix();actionFix376();shareFix375();sponsorFix376();ratingFix376();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(actionFix376,60);setTimeout(actionFix376,240);setTimeout(actionFix376,800);setTimeout(actionFix376,1800);setTimeout(sponsorFix376,20);setTimeout(sponsorFix376,180);setTimeout(sponsorFix376,700);setTimeout(sponsorFix376,1800);setTimeout(ratingFix376,40);setTimeout(ratingFix376,240);setTimeout(ratingFix376,900);setTimeout(ratingFix376,2200);setTimeout(shareFix375,80);setTimeout(shareFix375,360);setTimeout(shareFix375,1200);setTimeout(shareFix375,2600);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){badgeFix();dotFix();packFix();actionFix376();shareFix375();sponsorFix376();ratingFix376();},80);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();actionFix376();shareFix375();sponsorFix376();ratingFix376();},35);}).observe(document.documentElement,"
...
"/*V5317FIX*//*V5376FIX*/"
       ...
       // P39V376: list and MLT action controls use one canonical white add-to-list vector.
       "try{var H39=document.querySelectorAll('[data-ad-actionhost376]'),Q39=[];for(var h39=0;h39<H39.length&&Q39.length<14;h39++){var x39=H39[h39],r39=x39.getBoundingClientRect(),v39=x39.querySelector(':scope > [data-ad-actioncanonical376]'),paint39=v39?v39.querySelector('rect,path'):null,ps39=paint39?getComputedStyle(paint39):null,orig39=x39.querySelector('[data-ad-actionorig376]'),os39=orig39?getComputedStyle(orig39):null,hs39=getComputedStyle(x39);Q39.push(Math.round(r39.left)+','+Math.round(r39.top)+'/'+Math.round(r39.width)+'x'+Math.round(r39.height)+'|why='+String(x39.getAttribute('data-ad-actionwhy376')||'-')+'|canon='+(v39?1:0)+'|bg='+String(hs39.backgroundColor||'-').replace(/ /g,'')+'|stroke='+(ps39?String(ps39.stroke||'-').replace(/ /g,''):'-')+'|origVis='+(os39?String(os39.visibility||'-'):'-'));}out.push('P39V376[n='+Q39.length+(Q39.length?' '+Q39.join(' ~~ '):'')+' state='+String(window.__AD_ACTION376__||'-')+']');}catch(e39){out.push('P39V376[err '+(e39&&e39.message||e39)+']');}"
       // P40V376: unified Sponsored product-strip iframe + wrapper state.
       "try{var F40=document.querySelectorAll('iframe[data-ad-stripframe374]'),W40=document.querySelectorAll('[data-ad-stripwrap374]'),Q40=[];for(var i40=0;i40<F40.length&&i40<10;i40++){var f40=F40[i40],r40=f40.getBoundingClientRect();if(r40.width<250||r40.height>230)continue;var s40=getComputedStyle(f40),p40=f40.parentElement,ps40=p40?getComputedStyle(p40):null;Q40.push(String(f40.getAttribute('data-ad-frame-mode362')||'-')+'@'+Math.round(r40.left)+','+Math.round(r40.top)+'/'+Math.round(r40.width)+'x'+Math.round(r40.height)+'|conf='+(f40.hasAttribute('data-ad-stripconfirmed374')?1:0)+'|bg='+String(s40.backgroundColor||'-').replace(/ /g,'')+'|fil='+String(s40.filter||'-').replace(/ /g,'')+'|pbg='+(ps40?String(ps40.backgroundColor||'-').replace(/ /g,''):'-'));}out.push('P40V376[frames='+F40.length+' wraps='+W40.length+(Q40.length?' '+Q40.join(' ~~ '):'')+']');}catch(e40){out.push('P40V376[err '+(e40&&e40.message||e40)+']');}"
       // P41V376: PDP share glyph must stay white across recycled product templates.
       "try{var S41=document.querySelectorAll('.ssf-share-trigger'),Q41=[];for(var i41=0;i41<S41.length&&i41<8;i41++){var h41=S41[i41],r41=h41.getBoundingClientRect();if(r41.width<8||r41.height<8)continue;var a41=h41.querySelector('[data-ad-shareleaf375],svg,path,i,img,[class*=icon]'),s41=a41?getComputedStyle(a41):getComputedStyle(h41),b41=getComputedStyle(h41,'::before'),z41=getComputedStyle(h41,'::after');Q41.push(Math.round(r41.left)+','+Math.round(r41.top)+'/'+Math.round(r41.width)+'x'+Math.round(r41.height)+'|mk='+(h41.hasAttribute('data-ad-share375')?1:0)+'|c='+String(s41.color||'-').replace(/ /g,'')+'|fill='+String(s41.fill||'-').replace(/ /g,'')+'|flt='+String(s41.filter||'-').slice(0,22)+'|bef='+String(b41.color||'-').replace(/ /g,'')+'/'+String(b41.filter||'-').slice(0,12)+'|aft='+String(z41.color||'-').replace(/ /g,'')+'/'+String(z41.filter||'-').slice(0,12));}out.push('P41V376[n='+Q41.length+(Q41.length?' '+Q41.join(' ~~ '):'')+' state='+String(window.__AD_SHARE375__||'-')+']');}catch(e41){out.push('P41V376[err '+(e41&&e41.message||e41)+']');}"
