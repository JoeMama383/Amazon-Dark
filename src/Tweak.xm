...
#define AD_VERSION "v7.435-probe-backed-pdp-search-fixes"
...
static NSString *ADPDPCompletionTWBJS7405(void){
    ...
    CGFloat shade=0.10+(0.48*t);
    CGFloat factor=1.0-shade;
    return [NSString stringWithFormat:@"(function(){try{var d=document,s=d.getElementById('ad7405-pdp-twb');if(!s){s=d.createElement('style');s.id='ad7405-pdp-twb';(d.head||d.documentElement||d).appendChild(s);}var child=window.top!==window,ref=String(d.referrer||'');var embedded=child&&/(\\/dp\\/|\\/gp\\/product\\/|\\/gp\\/aw\\/d\\/)/i.test(ref);s.textContent=(embedded?`html body video,html body .vjs-poster,html body [data-testid=product-image] img,html body img[data-testid=product-image],html body img.product-image{filter:brightness(%.3f)!important;-webkit-filter:brightness(%.3f)!important;mix-blend-mode:normal!important;}`:'')+`#dp :is([class*=_c3Atb_image-display-small_],[class*=_c3Atb_image-display-full_],[class*=_rufus-comparison-card_style_cardImage__]) img,#dp #horizontalMediaCarousel :is(img.a-amazon-image,img.video-slate-img),#dp #aplus_feature_div .aplus-v2 img,#dp #sponsoredProducts_feature_div img,#dp #product-image-gallery img,#dp img[class*=_dnNlL_vseThumbnailPreviewImg_],#dp img[class*=_Y3Itb_media-thumbnail-image_],#dp img[class*=_Y3Itd_notable-quote-thumbnail-image_],#dp img[id^=inline-twister-image-],#dp img[class*=_c2Itb_image_],#dp [class*=_rufus-comparison-card_style_pillImageWrapper__] img,#dp video.pjs-tech,#dp img.vftp-hoc-thumbnail,#dp #value-pick-image,#dp #sp_phoneapp_detail_image_container img,#dp #thumbnail-product-image-container img,#dp video[class*=_multi-brand-video-mobile_style_video__],#dp img[class*=_multi-brand-video-mobile_style_image__],#dp .vse-video-thumbnail-wrapper[class*=_dnNlL_vseVideoImageWrapper_]::before,#attach-accessory-card-deck img.attach-accessory-image,#attach-accessory-card-deck .attach-primary-atc-confirm-box img{filter:brightness(%.3f)!important;-webkit-filter:brightness(%.3f)!important;opacity:1!important;mix-blend-mode:normal!important;}`;}catch(_){}})();",factor,factor,factor,factor];
}
...
static NSString *ADPDPSafeFrameJS7432(void){
    return @"(function(){try{if(window.top===window)return;var d=document,s=d.getElementById('ad7432-pdp-safeframe');if(!s){s=d.createElement('style');s.id='ad7432-pdp-safeframe';(d.head||d.documentElement||d).appendChild(s);}s.textContent=`"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)){background:#000!important;background-color:#000!important;color:#e8e6e3!important;color-scheme:dark!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) body{background:#000!important;background-color:#000!important;color:#e8e6e3!important;color-scheme:dark!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(#ad,[data-testid=renderer-factory-ad-container],[data-testid=ad-background-container],[data-testid=main-content],[data-testid=content],[data-testid=product-details],[data-testid=product-card],.product-details,.product-info,.product-card,.carousel-container,.swiper-slide){background:#000!important;background-color:#000!important;box-shadow:none!important;border-color:#494d4d!important;outline-color:#494d4d!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(div,section,article,main,header,footer,a,ul,ol,li,table,tbody,thead,tfoot,tr,td):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=promotion]):not([class*=promo]):not([class*=prime]):not([class*=star]):not([class*=rating]):not(:where([class*=badge] *)):not(:where([class*=deal] *)):not(:where([class*=coupon] *)):not(:where([class*=promotion] *)):not(:where([class*=promo] *)):not(:where([class*=prime] *)):not(:where([class*=star] *)):not(:where([class*=rating] *)){background-color:transparent!important;box-shadow:none!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(div,section,article,main,header,footer,li,td,a)[style*=\"background-color: rgb(255, 255, 255)\"],html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(div,section,article,main,header,footer,li,td,a)[style*=\"background-color:#fff\"],html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(div,section,article,main,header,footer,li,td,a)[style*=\"background: rgb(255, 255, 255)\"]{background:#000!important;background-color:#000!important;box-shadow:none!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(h1,h2,h3,h4,h5,h6,p,span,strong,b,em,small,label,div,a):not([style*=color]):not(.a-color-link):not(.a-color-success):not(.a-color-attainable):not(.a-color-error):not(.a-color-state):not(.a-color-price):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=promotion]):not([class*=promo]):not([class*=prime]):not([class*=star]):not([class*=rating]):not([class*=sponsored]):not([class*=ad-feedback]):not([class*=adFeedback]):not([data-testid*=sponsored]):not([data-ad-feedback-label-id]):not(:where(.a-color-link *)):not(:where(.a-color-success *)):not(:where(.a-color-attainable *)):not(:where(.a-color-error *)):not(:where(.a-color-state *)):not(:where(.a-color-price *)):not(:where([class*=badge] *)):not(:where([class*=deal] *)):not(:where([class*=coupon] *)):not(:where([class*=promotion] *)):not(:where([class*=promo] *)):not(:where([class*=prime] *)):not(:where([class*=star] *)):not(:where([class*=rating] *)):not(:where([class*=sponsored] *)):not(:where([class*=ad-feedback] *)):not(:where([class*=adFeedback] *)):not(:where([data-ad-feedback-label-id] *)){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(a,p,span,div,strong,b)[style*=\"color: rgb(15, 17, 17)\"],html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(a,p,span,div,strong,b)[style*=\"color: rgb(17, 17, 17)\"],html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(a,p,span,div,strong,b)[style*=\"color: rgb(0, 0, 0)\"],html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(a,p,span,div,strong,b)[style*=\"color: rgb(0, 0, 17)\"]{color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) .a-color-link,html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) .a-color-link *{color:rgb(33,98,161)!important;-webkit-text-fill-color:currentColor!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(.a-color-secondary,.a-color-tertiary,[class*=sponsored],[data-testid*=sponsored],[data-ad-feedback-label-id],[class*=ad-feedback],[class*=adFeedback]){color:#b1aaa0!important;-webkit-text-fill-color:#b1aaa0!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(.a-color-success,.a-color-attainable,.a-color-error,.a-color-state,.a-color-price,[class*=badge],[class*=deal],[class*=coupon],[class*=promotion],[class*=promo],[class*=prime],[class*=star],[class*=rating]),html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(.a-color-success,.a-color-attainable,.a-color-error,.a-color-state,.a-color-price,[class*=badge],[class*=deal],[class*=coupon],[class*=promotion],[class*=promo],[class*=prime],[class*=star],[class*=rating]) *{-webkit-text-fill-color:currentColor!important;}"
        "html[data-ad7-child-frame]:is(:has(#ad),:has([data-testid=renderer-factory-ad-container]),:has([data-testid=ad-background-container]),:has([data-ad-feedback-label-id]),:has([id^=ad-feedback-]),:has(.creative-container)) :is(img,video,canvas,picture,svg){mix-blend-mode:normal!important;}"
        "`;}catch(_){}})();";
}
...
static void ADAttachScriptsToUCC710(WKUserContentController *ucc){
    ...
    ADUIProbeAttach7362(ucc); // v7.435 dormant all-frame FULL/VIEWPORT bridge
    @try {
...
// v7.435: universal native/main-Web/cross-frame UI forensics subsystem.
