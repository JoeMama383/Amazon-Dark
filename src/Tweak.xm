...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "function sym414(){try{"
           ...
           "function cn4(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}"
           "function sq4(e){var r=e.getBoundingClientRect();"
           "return r.width>=22&&r.width<=48&&r.height>=22&&r.height<=48&&Math.abs(r.width-r.height)<=10;}"
           "function kind4(e){var c=cn4(e);"
             "if(new RegExp('mlt-icon-'+'container').test(c))return 'cards';"
             "if(new RegExp('a-check'+'box').test(c)&&!/a-icon-checkbox/.test(c))return 'checkbox';"
             ...
             "return '';}"
           "var SEL4='[class*=mlt-icon-'+'container],[class*=a-check'+'box],[class*=puis-mab-chevron],[class*=puis-heart-position],[class*=lists-framework-action-button]';"
           "var Q4=document.querySelectorAll(SEL4),n4=0,s4=0;"
           "for(var i4=0;i4<Q4.length&&i4<400;i4++){var e4=Q4[i4],k4=kind4(e4);"
             "if(!k4){s4++;continue;}"
             "if(!sq4(e4)){"
               "var alt4=null;"
               "if(k4==='heart'){var HD4=e4.querySelectorAll('*');"
                 "for(var q4=0;q4<HD4.length&&q4<20;q4++){if(sq4(HD4[q4])){alt4=HD4[q4];break;}}}"
               "if(!alt4){s4++;continue;}"
               "try{var UF4=e4.querySelectorAll('*');"
                 "for(var u4=0;u4<UF4.length&&u4<20;u4++){var un4=UF4[u4];"
                   "var ur4=un4.getBoundingClientRect();"
                   "if(ur4.height>48||ur4.width>48){"
                     "un4.style.setProperty('background-image','none','important');"
                     "un4.style.setProperty('background-color','transparent','important');"
                     "un4.style.setProperty('border','0','important');"
                     "un4.style.setProperty('box-shadow','none','important');}}"
               "}catch(xu4){}"
               "e4=alt4;}"
             "if(e4.parentElement&&e4.parentElement.closest&&e4.parentElement.closest('[data-ad-sym413]')){s4++;continue;}"
             "e4.setAttribute('data-ad-sym413',k4);e4.__adBy='sym414';"
             "e4.style.setProperty('background-color',SPEC.bg,'important');"
             "e4.style.setProperty('border',SPEC.bd,'important');"
             "e4.style.setProperty('border-radius','50%%','important');"
             "e4.style.setProperty('box-shadow','none','important');"
             "e4.style.setProperty('box-sizing','border-box','important');"
             "e4.style.setProperty('width','32px','important');"
             "e4.style.setProperty('height','32px','important');"
             "e4.style.setProperty('min-width','32px','important');"
             "e4.style.setProperty('min-height','32px','important');"
             "e4.style.setProperty('max-width','32px','important');"
             "e4.style.setProperty('max-height','32px','important');"
             "e4.style.setProperty('padding','0','important');"
             "e4.style.setProperty('overflow','visible','important');"
             "try{var an4=e4.parentElement,ad4=0;"
               "while(an4&&ad4++<3){var ar4=an4.getBoundingClientRect();"
                 "if(ar4.width<=52&&ar4.height<=52&&ar4.width>=18&&ar4.height>=18){"
                   "an4.style.setProperty('border','0','important');"
                   "an4.style.setProperty('box-shadow','none','important');"
                   "an4.style.setProperty('outline','none','important');}"
                 "an4=an4.parentElement;}"
             "}catch(x4){}"
             "try{var D4=e4.querySelectorAll('*');"
               "for(var d4=0;d4<D4.length&&d4<32;d4++){var dn4=D4[d4];"
                 "dn4.style.setProperty('background-color','transparent','important');"
                 "dn4.style.setProperty('background-image','none','important');"
                 "dn4.style.setProperty('border','0','important');"
                 "dn4.style.setProperty('box-shadow','none','important');"
                 "dn4.style.setProperty('outline','none','important');"
                 "dn4.style.setProperty('border-radius','0','important');"
                 "if(/unfill|heart-art|placeholder/i.test(String(dn4.className||'')))"
                   "{dn4.style.setProperty('background-image','none','important');"
                    "dn4.style.setProperty('width','32px','important');"
                    "dn4.style.setProperty('height','32px','important');}}"
             "}catch(x5){}"
             "var G4=e4.querySelectorAll('img,i,svg,path,p');"
             "for(var j4=0;j4<G4.length&&j4<24;j4++){var g4=G4[j4],gr4=g4.getBoundingClientRect();"
               "if(gr4.width>48||gr4.height>48)continue;"
               "var t4=String(g4.tagName||'').toUpperCase();"
               "if(t4==='IMG'||t4==='I'||t4==='P')"
                 "g4.style.setProperty('filter','brightness(0) invert(1)','important');"
               "g4.__adBy='sym414glyph';g4.setAttribute('data-ad-sym413glyph','1');"
               "if(t4==='SVG'||t4==='PATH'){g4.style.setProperty('fill','#ffffff','important');"
                 "g4.style.setProperty('color','#ffffff','important');}"
               "g4.style.setProperty('background-color','transparent','important');"
               "g4.style.setProperty('visibility','visible','important');"
               "g4.style.setProperty('opacity','1','important');}"
             "n4++;}"
           "window.__AD_SYM414__='n='+n4+' skip='+s4;"
         "}catch(e){window.__AD_SYM414__='err '+e;}}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       "out.push('P80SYM413{n='+Z4.length+' badBg='+b4+' badRing='+r4+' '+Q4.join(' ~ ')+' state='+String(window.__AD_SYM413__||'-')+' bs='+String(window.__AD_SYM414__||'-')+'}');"
