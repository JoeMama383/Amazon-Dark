/*
 * AmazonDark v7.436 — probe-backed PDP/search fixes
 *
 * Architecture:
...
#define AD_VERSION "v7.439-pdp-ui-completion"
...
static NSString *ADCoreWebJS7271(void){
    ...
    gADCoreWebJSCached7271=[NSString stringWithFormat:@"%@%@%@%@%@%@%@%@%@%@%@%@%@%@",ADFullRasterHostBridgeJS7266(),
        ...
        ADProductScrollVideoBorderJS7405(),ADPDPCompletionJS7405(),ADPDPSafeFrameJS7432(),ADPDPCompletionTWBJS7405(),ADPDPUICompletionJS7439(),ADAddressManagementJS7412()];
...
static void ADAttachScriptsToUCC710(WKUserContentController *ucc){
    ...
    ADUIProbeAttach7362(ucc); // v7.436 dormant all-frame FULL/VIEWPORT bridge
    @try {
