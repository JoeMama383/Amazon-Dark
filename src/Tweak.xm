...
#define AD_VERSION "v7.165-swatch-art-preservation-probe"
...
static NSString *ADSearchResultsProbePath7139(void){
    @try {
        ...
        if(docs.length)return [docs stringByAppendingPathComponent:@"AmazonDark-v7.165-swatch-art-preservation-probe.txt"];
    } @catch(...) {}
    return [NSTemporaryDirectory() stringByAppendingPathComponent:@"AmazonDark-v7.165-swatch-art-preservation-probe.txt"];
}
