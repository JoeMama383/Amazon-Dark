...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           "window.__AD_ADTEXT371__=function(){try{if(!document.body)return 0;var mode=String(window.__ADFRAME_MODE__||''),compact=(mode==='standalone'&&(innerWidth||0)>=240&&(innerHeight||999)<=190);if(mode!=='productad'&&!compact){window.__AD_ADTEXT371_N__=0;window.__AD_ADTEXT371_LEFT__=0;window.__AD_ADTEXT371_ROOTS__=1;window.__AD_COMPACT371__=0;return 0;}var roots=[document],ri=0;while(ri<roots.length&&roots.length<24){var rt=roots[ri++],H=[];try{H=rt.querySelectorAll?rt.querySelectorAll('*'):[];}catch(er){H=[];}for(var hi=0;hi<H.length&&hi<1000&&roots.length<24;hi++){var sr=H[hi].shadowRoot;if(sr&&roots.indexOf(sr)<0)roots.push(sr);}}var n=0,left=0,budget=0;for(var rr=0;rr<roots.length&&budget<2200;rr++){var R=roots[rr],E=[];try{E=R.querySelectorAll?R.querySelectorAll('*'):[];}catch(eq){E=[];}for(var i=0;i<E.length&&budget++<2200;i++){var e=E[i],tg=String(e.tagName||'').toUpperCase();if(tg==='IMG'||tg==='PICTURE'||tg==='VIDEO'||tg==='CANVAS'||tg==='SVG'||tg==='USE'||tg==='PATH'||tg==='SCRIPT'||tg==='STYLE'||tg==='INPUT'||tg==='TEXTAREA'||tg==='SELECT'||tg==='OPTION')continue;var own='';try{for(var q=0;q<e.childNodes.length&&q<12;q++){var nd=e.childNodes[q];if(nd.nodeType===3)own+=String(nd.nodeValue||'');}}catch(et){}var txt=own.replace(/\\s+/g,' ').trim();try{if(!txt&&e.childElementCount<=2&&!e.querySelector('img,svg,picture,video,canvas,input,select,textarea')){var tx=String(e.textContent||'').replace(/\\s+/g,' ').trim();if(tx.length>0&&tx.length<180)txt=tx;}}catch(ex){}if(!txt)continue;var cs=getComputedStyle(e),fg=AF.p(cs.color),ff=AF.p(cs.webkitTextFillColor||cs.getPropertyValue('-webkit-text-fill-color')),fl=AF.p(cs.fill),bad=((fg&&AF.l(fg)<0.72&&AF.s(fg)<0.26)||(ff&&AF.l(ff)<0.72&&AF.s(ff)<0.26)||((tg==='TEXT'||tg==='TSPAN')&&fl&&AF.l(fl)<0.72&&AF.s(fl)<0.26));if(!bad)continue;e.style.setProperty('color','#e8e6e3','important');e.style.setProperty('-webkit-text-fill-color','#e8e6e3','important');if(tg==='TEXT'||tg==='TSPAN')e.style.setProperty('fill','#e8e6e3','important');e.setAttribute('data-ad-adtext371','1');e.__adBy='adText371';n++;try{var cs2=getComputedStyle(e),fg2=AF.p(cs2.color),ff2=AF.p(cs2.webkitTextFillColor||cs2.getPropertyValue('-webkit-text-fill-color'));if((fg2&&AF.l(fg2)<0.60&&AF.s(fg2)<0.26)||(ff2&&AF.l(ff2)<0.60&&AF.s(ff2)<0.26))left++;}catch(ec){}}}window.__AD_ADTEXT371_N__=n;window.__AD_ADTEXT371_LEFT__=left;window.__AD_ADTEXT371_ROOTS__=roots.length;window.__AD_COMPACT371__=compact?1:0;return n;}catch(e){window.__AD_ADTEXT371_N__=-1;return 0;}};"
           ...
           "window.__AD_PRODUCTSTRIP374__=function(){try{if(!document.body)return 0;var mode=String(window.__ADFRAME_MODE__||''),w=innerWidth||0,h=innerHeight||999,tx=String(document.body.innerText||document.body.textContent||'').replace(/\\s+/g,' ').trim(),spon=/\\bsponsored(?: ad)?\\b/i.test(tx),ok=(mode==='productad')||(mode==='standalone'&&w>=280&&h<=180&&spon);window.__AD_STRIP374_N__=ok?1:0;window.__AD_STRIP374_SPON__=spon?1:0;if(ok){try{window.top.postMessage({__adStrip374:1},'*');}catch(ep){}}return ok?1:0;}catch(e){window.__AD_STRIP374_N__=0;return 0;}};"
           ...
           "window.__AMZDARK_ADTHEME__=function(){try{"
             ...
             "var strip374=window.__AD_PRODUCTSTRIP374__?window.__AD_PRODUCTSTRIP374__():0;if(strip374){var cl374=window.__AD_CLEARSTRIP374__?window.__AD_CLEARSTRIP374__():0;var in374=window.__AD_ADTEXT371__?window.__AD_ADTEXT371__():0;var tm374=window.__AD_STRIPMEDIA374__?window.__AD_STRIPMEDIA374__():0;var sp374=window.__AD_SPON365__?window.__AD_SPON365__():0;window.__AD_STANDALONE__='strip-stock374';window.__AD_ADTHEME__='mode='+mode+' strip374=1 clean374='+cl374+' chrome374='+String(window.__AD_STRIPCHROME374_LEFT__||0)+' ink374='+in374+' left='+String(window.__AD_ADTEXT371_LEFT__||0)+' roots='+String(window.__AD_ADTEXT371_ROOTS__||1)+' media374='+String(window.__AD_STRIPMEDIA374_N__||0)+' fullSkip374='+String(window.__AD_STRIPFULL374_N__||0)+' spon='+sp374;return cl374+in374+tm374+sp374;}"
           ...
           "if(!window.__ADFB__){window.__ADFB__=1;"
             "if(window.top===window){window.__AD_FRAMES__={};"
               "addEventListener('message',function(ev){try{"
                 ...
                 // probe budgets.
                 "var interesting=/STAR |stars=[1-9]|ADFRAME mode=productad|strip374=1|compact373=1/.test(String(d.r||''));"
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         // v5.374: hide a lazy/grey-pixel action placeholder, restore a real glyph
         // when it arrives, and provide a deterministic cards+ fallback otherwise.
         "function actionFix374(){try{var H=document.querySelectorAll('[class*=lists-framework-action-button],[class*=mlt-icon-container]'),hosts=0,ph=0,real=0,fb=0;for(var i=0;i<H.length&&i<100;i++){var h=H[i],hr=h.getBoundingClientRect();if(hr.width<18||hr.width>64||hr.height<18||hr.height>64||Math.abs(hr.width-hr.height)>14)continue;hosts++;var A=h.querySelectorAll('img,svg,i,[class*=lists-framework-unfill],[class*=lists-framework-fill]'),has=false;for(var j=0;j<A.length&&j<32;j++){var a=A[j],tg=String(a.tagName||'').toUpperCase(),cn=a.className;cn=String(cn&&cn.baseVal!==undefined?cn.baseVal:(cn||''));if(tg==='IMG'){var src=String(a.currentSrc||a.src||'').toLowerCase(),nw=a.naturalWidth||0,nh=a.naturalHeight||0,isph=/grey[-_]?pixel|gray[-_]?pixel|transparent[-_]?pixel|placeholder|spacer|(?:^|[\\/_-])blank(?:[._-]|$)/i.test(src+' '+cn)||(a.complete&&nw>0&&nh>0&&nw<=2&&nh<=2);if(isph){a.setAttribute('data-ad-actionplaceholder374','1');a.style.setProperty('display','none','important');a.style.setProperty('filter','none','important');a.style.setProperty('opacity','0','important');ph++;continue;}if((nw>2&&nh>2)||(!a.complete&&src)){a.removeAttribute('data-ad-actionplaceholder374');a.style.setProperty('display','inline-block','important');a.__adGlyph=1;a.__adBy='action374';a.style.setProperty('background-color','transparent','important');a.style.setProperty('opacity','1','important');a.setAttribute('data-ad-actionglyph374','1');has=true;real++;}}else{var ar=a.getBoundingClientRect();if(ar.width>=5&&ar.height>=5){a.style.setProperty('color','#ffffff','important');a.style.setProperty('fill','#ffffff','important');a.style.setProperty('stroke','#ffffff','important');a.style.setProperty('opacity','1','important');a.setAttribute('data-ad-actionglyph374','1');a.__adGlyph=1;a.__adBy='action374vec';has=true;real++;}}}var old=h.querySelector('[data-ad-actionfallback374]');if(has){if(old&&old.parentNode)old.parentNode.removeChild(old);}else if(!old){var ns='http://www.w3.org/2000/svg',v=document.createElementNS(ns,'svg');v.setAttribute('viewBox','0 0 24 24');v.setAttribute('data-ad-actionfallback374','1');v.setAttribute('aria-hidden','true');var r1=document.createElementNS(ns,'rect');r1.setAttribute('x','4');r1.setAttribute('y','7');r1.setAttribute('width','12');r1.setAttribute('height','12');r1.setAttribute('rx','1.5');var r2=document.createElementNS(ns,'rect');r2.setAttribute('x','8');r2.setAttribute('y','4');r2.setAttribute('width','12');r2.setAttribute('height','12');r2.setAttribute('rx','1.5');var pp=document.createElementNS(ns,'path');pp.setAttribute('d','M14 7v6M11 10h6');v.appendChild(r1);v.appendChild(r2);v.appendChild(pp);h.appendChild(v);fb++;}}window.__AD_ACTION374__='hosts='+hosts+' ph='+ph+' real='+real+' fallback='+fb;}catch(e){window.__AD_ACTION374__='err '+e;}}"
         ...
         "}catch(e){}}""badgeFix();dotFix();packFix();actionFix374();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(actionFix374,60);setTimeout(actionFix374,240);setTimeout(actionFix374,800);setTimeout(actionFix374,1800);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){badgeFix();dotFix();packFix();actionFix374();},120);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();actionFix374();},50);}).observe(document.documentElement,"
           "{subtree:true,childList:true,attributes:true,attributeFilter:['style','class','aria-current','aria-selected','data-selected','src','data-src','data-darkreader-inline-bgcolor','data-darkreader-inline-color']});"
       "})();}catch(e){}"
       "/*V5314FIX*//*V5315FIX*/"
"/*V5317FIX*/"
       ...
       // P39V374: search action glyph must have no visible placeholder square.
       "try{var H39=document.querySelectorAll('[class*=lists-framework-action-button],[class*=mlt-icon-container]'),Q39=[];for(var h39=0;h39<H39.length&&Q39.length<10;h39++){var x39=H39[h39],r39=x39.getBoundingClientRect();if(r39.width<18||r39.width>64||r39.height<18||r39.height>64||Math.abs(r39.width-r39.height)>14)continue;var ph39=x39.querySelectorAll('[data-ad-actionplaceholder374]').length,fb39=x39.querySelectorAll('[data-ad-actionfallback374]').length,re39=x39.querySelectorAll('[data-ad-actionglyph374]').length,im39=x39.querySelector('img'),is39=im39?getComputedStyle(im39):null;Q39.push(Math.round(r39.left)+','+Math.round(r39.top)+'/'+Math.round(r39.width)+'x'+Math.round(r39.height)+'|ph='+ph39+'|real='+re39+'|fb='+fb39+(im39?'|nat='+(im39.naturalWidth||0)+'x'+(im39.naturalHeight||0)+'|disp='+String(is39.display||'-')+'|flt='+String(is39.filter||'-').slice(0,18)+'|src='+String(im39.currentSrc||im39.src||'-').slice(-28):''));}out.push('P39V374[n='+Q39.length+(Q39.length?' '+Q39.join(' ~~ '):'')+' state='+String(window.__AD_ACTION374__||'-')+']');}catch(e39){out.push('P39V374[err '+(e39&&e39.message||e39)+']');}"
       // P40V374: unified Sponsored product-strip iframe + wrapper state.
       "try{var F40=document.querySelectorAll('iframe[data-ad-stripframe374]'),W40=document.querySelectorAll('[data-ad-stripwrap374]'),Q40=[];for(var i40=0;i40<F40.length&&i40<10;i40++){var f40=F40[i40],r40=f40.getBoundingClientRect();if(r40.width<250||r40.height>230)continue;var s40=getComputedStyle(f40),p40=f40.parentElement,ps40=p40?getComputedStyle(p40):null;Q40.push(String(f40.getAttribute('data-ad-frame-mode362')||'-')+'@'+Math.round(r40.left)+','+Math.round(r40.top)+'/'+Math.round(r40.width)+'x'+Math.round(r40.height)+'|conf='+(f40.hasAttribute('data-ad-stripconfirmed374')?1:0)+'|bg='+String(s40.backgroundColor||'-').replace(/ /g,'')+'|fil='+String(s40.filter||'-').replace(/ /g,'')+'|pbg='+(ps40?String(ps40.backgroundColor||'-').replace(/ /g,''):'-'));}out.push('P40V374[frames='+F40.length+' wraps='+W40.length+(Q40.length?' '+Q40.join(' ~~ '):'')+']');}catch(e40){out.push('P40V374[err '+(e40&&e40.message||e40)+']');}"
