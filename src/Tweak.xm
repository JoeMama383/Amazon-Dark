/*
 * AmazonDark v7.353 — Search carousel media + Top-reviewed header correction on v7.352
 *
 * Architecture:
...
#define AD_VERSION "v7.353-search-carousel-media-header-fix"
