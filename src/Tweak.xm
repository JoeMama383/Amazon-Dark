...
static NSString *ADFixesLiteral(void){
    ...
    return [NSString stringWithFormat:
            @"{css:'"
             ...
             "{background:#181a1b !important;background-image:none !important;box-shadow:none !important;}"
             // v5.381: the cards/list action keeps Amazon's stock painter but owns a
             // deterministic dark circle + chrome bezel. No synthetic icon is drawn.
             "[data-ad-stockaction381=\"1\"]{position:relative !important;background:#181a1b !important;"
             "background-color:#181a1b !important;background-image:none !important;border-radius:50%% !important;"
             "border:1.5px solid #6c7073 !important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.10) !important;"
             "box-sizing:border-box !important;overflow:hidden !important;isolation:isolate !important;}"
             "[data-ad-stockaction381=\"1\"] [data-ad-stockglyph381=\"1\"]{position:relative !important;z-index:2 !important;"
             "visibility:visible !important;opacity:1 !important;background-color:transparent !important;}"
             "[data-ad-stockglyph381=\"1\"][data-ad-stockraster381=\"1\"]{filter:brightness(0) invert(1) !important;}"
             "[data-ad-stockglyph381=\"1\"] svg,[data-ad-stockglyph381=\"1\"] path,"
             "svg[data-ad-stockglyph381=\"1\"],path[data-ad-stockglyph381=\"1\"]"
             "{color:#fff !important;fill:#fff !important;stroke:#fff !important;}"
             ...
             // v5.382: cards/list chrome is ONLY placed on a true icon-sized host.
             // The v5.381 broad semantic row selector is gone; Compare remains separate.
             "[data-ad-stockaction382=\"1\"]{position:relative !important;background:#181a1b !important;"
             "background-color:#181a1b !important;background-image:none !important;border-radius:50%% !important;"
             "border:1.5px solid rgba(255,255,255,.65) !important;box-shadow:none !important;"
             "box-sizing:border-box !important;overflow:hidden !important;isolation:isolate !important;}"
             "[data-ad-stockaction382=\"1\"] [data-ad-stockglyph382=\"1\"]{position:relative !important;z-index:2 !important;"
             "visibility:visible !important;opacity:1 !important;background-color:transparent !important;}"
             "[data-ad-stockglyph382=\"1\"][data-ad-stockraster382=\"1\"]{filter:brightness(0) invert(1) !important;}"
             "[data-ad-stockglyph382=\"1\"] svg,[data-ad-stockglyph382=\"1\"] path,"
             "svg[data-ad-stockglyph382=\"1\"],path[data-ad-stockglyph382=\"1\"]"
             "{color:#fff !important;fill:#fff !important;stroke:#fff !important;}"
             // v5.384: the stock two-card action sometimes has no square host at all.
             // Preserve Amazon's real glyph and place the Heart-identical disc either
             // on a true square wrapper or as a pointer-events-none sibling behind it.
             "[data-ad-stockaction384=\"1\"]{position:relative !important;background:#181a1b !important;"
             "background-color:#181a1b !important;background-image:none !important;border-radius:50%% !important;"
             "border:1.5px solid rgba(255,255,255,.65) !important;box-shadow:none !important;box-sizing:border-box !important;}"
             "[data-ad-stockdisc384=\"1\"]{position:absolute !important;width:36px !important;height:36px !important;"
             "border-radius:50%% !important;background:#181a1b !important;border:1.5px solid rgba(255,255,255,.65) !important;"
             "box-shadow:none !important;box-sizing:border-box !important;pointer-events:none !important;z-index:1 !important;}"
             "[data-ad-stockglyph384=\"1\"]{position:relative !important;z-index:2 !important;visibility:visible !important;"
             "opacity:1 !important;color:#fff !important;fill:#fff !important;stroke:#fff !important;background-color:transparent !important;}"
             "[data-ad-stockglyph384=\"1\"][data-ad-stockraster384=\"1\"]{filter:brightness(0) invert(1) !important;}"
             "[data-ad-stockbefore384=\"1\"]::before,[data-ad-stockafter384=\"1\"]::after"
             "{color:#fff !important;fill:#fff !important;stroke:#fff !important;filter:brightness(0) invert(1) !important;}"
             // v5.386: the old Heart painter owns the glyph again. We only add the
             // missing chrome ring to a square host; never recolor/invert the glyph.
             "[data-ad-heartbezel386=\"1\"]{border-radius:50%% !important;"
             "box-shadow:inset 0 0 0 1.5px rgba(255,255,255,.65) !important;}"
             // v5.387: one canonical visual language for product action controls.
             // Heart and two-card use the SAME 35-ish px dark circular host + chrome
             // bezel. Compare remains a square checkbox. Glyph paint is leaf-only so
             // the v5.385 blank-white-disc regression cannot return.
             "[data-ad-heart387=\"1\"],[data-ad-stockaction387=\"1\"]"
             "{position:relative !important;background:#181a1b !important;background-color:#181a1b !important;"
             "background-image:none !important;border:1.5px solid rgba(255,255,255,.65) !important;"
             "border-radius:50%% !important;box-shadow:none !important;box-sizing:border-box !important;}"
             "[data-ad-heartinner387=\"1\"]{background-color:transparent !important;border:0 !important;"
             "box-shadow:none !important;}"
             "html body [class*=puis-heart-position] i.a-icon,"
             "html body [data-ad-heartglyph387=\"1\"][data-ad-heartraster387=\"1\"]"
             "{filter:brightness(0) invert(1) !important;background-color:transparent !important;"
             "visibility:visible !important;opacity:1 !important;}"
             "html body [class*=puis-heart-position] svg,html body [class*=puis-heart-position] svg *,"
             "html body [data-ad-heartglyph387=\"1\"] svg,html body svg[data-ad-heartglyph387=\"1\"],"
             "html body [data-ad-heartglyph387=\"1\"] path,html body path[data-ad-heartglyph387=\"1\"]"
             "{color:#fff !important;fill:#fff !important;stroke:#fff !important;opacity:1 !important;}"
             "html body [data-ad-stockaction387=\"1\"] [data-ad-stockglyph387=\"1\"]"
             "{position:relative !important;z-index:2 !important;visibility:visible !important;opacity:1 !important;"
             "color:#fff !important;fill:#fff !important;stroke:#fff !important;background-color:transparent !important;}"
             "html body [data-ad-stockaction387=\"1\"] [data-ad-stockglyph387=\"1\"][data-ad-stockraster387=\"1\"]"
             "{filter:brightness(0) invert(1) !important;}"
             "html body [data-ad-stockaction387=\"1\"] [data-ad-stockglyph387=\"1\"] svg,"
             "html body [data-ad-stockaction387=\"1\"] svg[data-ad-stockglyph387=\"1\"],"
             "html body [data-ad-stockaction387=\"1\"] [data-ad-stockglyph387=\"1\"] path,"
             "html body [data-ad-stockaction387=\"1\"] path[data-ad-stockglyph387=\"1\"]"
             "{color:#fff !important;fill:#fff !important;stroke:#fff !important;}"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "try{window.__AD_FRAMECLASS362__=function(){var F=document.querySelectorAll('iframe'),n=0;"
           "for(var fi=0;fi<F.length&&fi<80;fi++){var f=F[fi],r=f.getBoundingClientRect();if(r.width<120||r.height<50)continue;"
             ...
             "var productAd=(!hero&&productDoc&&r.width>=300&&r.height>=55&&r.height<=260);var mode=hero?'hero':(productAd?'productad':'standalone');f.setAttribute('data-ad-frame-mode362',mode);f.setAttribute('data-ad-frame-why369',productAd?(prodURL369?'url369':'dom369'):(hero?'hero':'standalone'));if(window.__AD_MARKSTRIP374__){if(productAd)window.__AD_MARKSTRIP374__(f,true);else if(mode==='standalone'&&r.width>=280&&r.height<=180)window.__AD_MARKSTRIP374__(f,false);}try{f.contentWindow&&f.contentWindow.postMessage({__amzAdMode:mode},'*');}catch(e){}n++;}"
         ...
         "try{var _t=null;new MutationObserver(function(muts){var structural=0;"
           ...
           "try{_adCollegeFast59();}catch(e){}if(structural){clearTimeout(_t);_t=setTimeout(function(){try{if(!document.hidden&&!window.__ADSCROLLING__)window.__AMZDARK_FIXCONTRAST__();}catch(e){}},1900);}})"
...
// v5.386: final Person-grid fallback. Keep Shopping is a native 3-column grid,
// not always a UIScrollView; one recycled 100x100 tile can therefore have no local
// heading ancestry at all. Four similarly-sized RCT image leaves inside one compact
// ancestor is structural product-grid evidence. Cache per ancestor; retain no UIImage.
static const void *kADWTGrid386 = &kADWTGrid386;
static const void *kADWTGridTime386 = &kADWTGridTime386;
static BOOL ADWTGridPeer386(UIView *v){
    @try {
        ...
        if(vw<88||vw>155||vh<78||vh>175) return NO;
        // v5.387: this is structural product-grid evidence. Do not let the broad
        // Medical/Help glyph-text census veto one recycled 100x100 product tile.
        // Menu and Highlights remain hard exclusions; generic glyph exclusions are
        // applied later only when no positive product-grid context exists.
        if(ADMenuRole382(v)!=0||ADWTInHighlightsCarousel368(v)) return NO;
        UIWindow *w=v.window; UIView *p=v.superview; int up=0;
        while(p&&p!=w&&up++<6){
            CGFloat pw=p.bounds.size.width,ph=p.bounds.size.height;
            if(pw>=240&&pw<=w.bounds.size.width*1.25&&ph>=170&&ph<=780){
                CFAbsoluteTime now=CFAbsoluteTimeGetCurrent();
                NSNumber *tm=objc_getAssociatedObject(p,kADWTGridTime386);
                NSNumber *cv=objc_getAssociatedObject(p,kADWTGrid386);
                if(tm&&cv&&now-tm.doubleValue<0.75){ if(cv.boolValue)return YES; }
                int peers=0; NSMutableArray *q=[NSMutableArray arrayWithObject:p];
                for(NSUInteger qi=0;qi<q.count&&qi<90;qi++){
                    UIView *x=q[qi];
                    if([x isKindOfClass:[UIImageView class]]){
                        ...
                        if(xc&&strstr(xc,"RCTUIImageView")&&xw>=88&&xw<=155&&xh>=78&&xh<=175&&
                           !ADWTInHighlightsCarousel368(x)) peers++;
                    }
                    if(qi<30){for(UIView *sv in x.subviews){if(q.count<90)[q addObject:sv];else break;}}
                }
                BOOL hit=peers>=4;
                objc_setAssociatedObject(p,kADWTGrid386,@(hit),OBJC_ASSOCIATION_RETAIN_NONATOMIC);
                objc_setAssociatedObject(p,kADWTGridTime386,@(now),OBJC_ASSOCIATION_RETAIN_NONATOMIC);
                if(hit) return YES;
            }
            p=p.superview;
        }
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         "function stockActionFix379(){try{var H=document.querySelectorAll('[class*=lists-framework-action-button]'),hosts=0,leaves=0,skip=0;for(var i=0;i<H.length&&i<180;i++){var h=H[i],r=h.getBoundingClientRect();if(r.width<18||r.width>64||r.height<18||r.height>64||Math.abs(r.width-r.height)>14){skip++;continue;}if(h.querySelector&&h.querySelector('[class*=mlt-icon-container],input[type=checkbox],[role=checkbox]')){skip++;continue;}h.removeAttribute('data-ad-stockaction378');h.setAttribute('data-ad-stockaction379','1');h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('border-radius','50%%','important');h.style.setProperty('border','0','important');h.style.setProperty('box-shadow','inset 0 0 0 64px #181a1b,0 0 0 1.5px rgba(255,255,255,.65)','important');h.style.setProperty('overflow','hidden','important');h.style.setProperty('box-sizing','border-box','important');h.removeAttribute('data-ad-actionhost375');h.removeAttribute('data-ad-actionhost376');var old=h.querySelectorAll(':scope > [data-ad-actioncanonical375],:scope > [data-ad-actioncanonical376],:scope > [data-ad-actionfallback374]');for(var o=0;o<old.length;o++){if(old[o].parentNode)old[o].parentNode.removeChild(old[o]);}var O=h.querySelectorAll('[data-ad-actionorig375],[data-ad-actionorig376]');for(var z=0;z<O.length;z++){O[z].style.removeProperty('visibility');O[z].style.removeProperty('opacity');O[z].removeAttribute('data-ad-actionorig375');O[z].removeAttribute('data-ad-actionorig376');}var A=h.querySelectorAll('img,i,svg,path,[class*=lists-framework-unfill],[class*=lists-framework-fill],[class*=icon]');for(var j=0;j<A.length&&j<48;j++){var a=A[j],tg=String(a.tagName||'').toUpperCase(),ar=a.getBoundingClientRect();if(ar.width>70||ar.height>70)continue;a.removeAttribute('data-ad-stockglyph378');a.removeAttribute('data-ad-raster378');a.setAttribute('data-ad-stockglyph379','1');a.style.setProperty('visibility','visible','important');a.style.setProperty('opacity','1','important');a.style.setProperty('background-color','transparent','important');a.__adGlyph=1;a.__adBy='stockAction379';if(tg==='IMG'||tg==='I')a.setAttribute('data-ad-raster379','1');else if(tg==='SVG'||tg==='PATH'){a.style.setProperty('color','#ffffff','important');a.style.setProperty('fill','#ffffff','important');a.style.setProperty('stroke','#ffffff','important');}leaves++;}hosts++;}window.__AD_STOCKACTION379__='hosts='+hosts+' leaves='+leaves+' skip='+skip;}catch(e){window.__AD_STOCKACTION379__='err '+e;}}"
         ...
         "function stockActionFix382(){try{var S=document.querySelectorAll('[class*=lists-framework-unfill],[class*=lists-framework-fill],img[src*=\\\"01rrz\\\"]'),hosts=[],leaves=0,rowSkip=0,seedSkip=0;function cls(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}function sq(e){if(!e||!e.getBoundingClientRect)return false;var r=e.getBoundingClientRect();return r.width>=24&&r.width<=58&&r.height>=24&&r.height<=58&&Math.abs(r.width-r.height)<=10;}function blocked(e){return !!(e&&e.closest&&e.closest('[class*=heart],[class*=wish],[class*=favorite],[class*=mlt-icon-container],[role=checkbox],input[type=checkbox]'));}function pick(seed){if(!seed||blocked(seed))return null;var p=seed.parentElement,u=0,best=null;while(p&&u++<6){if(blocked(p))return null;var r=p.getBoundingClientRect();if(r.width>82||r.height>82)break;if(sq(p)&&!(p.querySelector&&p.querySelector('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox]'))){best=p;var tg=String(p.tagName||'').toUpperCase(),ro=String(p.getAttribute&&p.getAttribute('role')||'').toLowerCase();if(tg==='BUTTON'||tg==='A'||ro==='button'||/lists-framework-action-button/i.test(cls(p)))return p;}p=p.parentElement;}return best;}function clear(h){if(!h)return;h.removeAttribute('data-ad-stockaction382');['background-color','background-image','border-radius','border','box-shadow','box-sizing','overflow'].forEach(function(k){h.style.removeProperty(k);});}function paint(h){if(!h||hosts.indexOf(h)>=0)return;var r=h.getBoundingClientRect();if(!sq(h)){rowSkip++;return;}h.removeAttribute('data-ad-stockaction381');h.removeAttribute('data-ad-stockaction380');h.removeAttribute('data-ad-stockaction379');h.setAttribute('data-ad-stockaction382','1');h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('border-radius','50%%','important');h.style.setProperty('border','1.5px solid rgba(255,255,255,.65)','important');h.style.setProperty('box-shadow','none','important');h.style.setProperty('box-sizing','border-box','important');var rr=h.getBoundingClientRect();if(rr.width>64||rr.height>64||Math.abs(rr.width-rr.height)>14){clear(h);rowSkip++;return;}hosts.push(h);var A=h.querySelectorAll('img,i,svg,path,[class*=lists-framework-unfill],[class*=lists-framework-fill]');for(var k=0;k<A.length&&k<40;k++){var a=A[k];if(blocked(a))continue;var ar=a.getBoundingClientRect();if(ar.width>52||ar.height>52)continue;var tg=String(a.tagName||'').toUpperCase(),bi='none';try{bi=String(getComputedStyle(a).backgroundImage||'none');}catch(x){}if(!(tg==='IMG'||tg==='I'||tg==='SVG'||tg==='PATH'||/lists-framework-(?:unfill|fill)/i.test(cls(a))||bi!=='none'))continue;a.setAttribute('data-ad-stockglyph382','1');if(tg==='IMG'||tg==='I'||(!['SVG','PATH'].includes(tg)&&bi!=='none'))a.setAttribute('data-ad-stockraster382','1');a.style.setProperty('visibility','visible','important');a.style.setProperty('opacity','1','important');a.style.setProperty('background-color','transparent','important');a.__adGlyph=1;a.__adBy='stockAction382';leaves++;}}for(var i=0;i<S.length&&i<260;i++){var h=pick(S[i]);if(h)paint(h);else seedSkip++;}var old=document.querySelectorAll('[data-ad-stockaction382]');for(var z=0;z<old.length;z++){var zr=old[z].getBoundingClientRect();if(zr.width>64||zr.height>64||Math.abs(zr.width-zr.height)>14){clear(old[z]);rowSkip++;}}window.__AD_STOCKACTION382__='hosts='+hosts.length+' leaves='+leaves+' rowSkip='+rowSkip+' seedSkip='+seedSkip;}catch(e){window.__AD_STOCKACTION382__='err '+e;}}"
         "function heartBezel386(){try{var R=document.querySelectorAll('[class*=puis-heart-position]'),n=0,ringless=0,skip=0;function cls(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}function pc(v){var m=/rgba?\\((\\d+),\\s*(\\d+),\\s*(\\d+)(?:,\\s*([0-9.]+))?/i.exec(String(v||''));return m?[+m[1],+m[2],+m[3],m[4]===undefined?1:+m[4]]:null;}function sq(e){if(!e||!e.getBoundingClientRect)return false;var r=e.getBoundingClientRect();return r.width>=26&&r.width<=58&&r.height>=26&&r.height<=58&&Math.abs(r.width-r.height)<=10;}function lum(v){var q=pc(v);return q&&q[3]>.25?(.2126*q[0]+.7152*q[1]+.0722*q[2])/255:-1;}function score(e){if(!sq(e))return -1;var tg=String(e.tagName||'').toUpperCase();if(tg==='IMG'||tg==='I'||tg==='SVG'||tg==='PATH')return -1;if(e.querySelector&&e.querySelector('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[class*=lists-framework-action-button]'))return -1;var ro=String(e.getAttribute&&e.getAttribute('role')||'').toLowerCase(),c=cls(e),cs=getComputedStyle(e),sc=0;if(tg==='BUTTON'||ro==='button')sc+=8;else if(tg==='A')sc+=5;if(/heart|wish|favor/i.test(c))sc+=5;if(e.querySelector&&e.querySelector('img,i,svg,path,[class*=icon]'))sc+=5;var L=lum(cs.backgroundColor);if(L>=0&&L<.32)sc+=6;var rad=parseFloat(cs.borderRadius||'0');if(rad>=10)sc+=4;try{var b=getComputedStyle(e,'::before'),a=getComputedStyle(e,'::after');if(String(b.backgroundImage||'none')!=='none'||String(a.backgroundImage||'none')!=='none')sc+=3;}catch(x){}return sc;}for(var i=0;i<R.length&&i<160;i++){var root=R[i],A=[root],Q=root.querySelectorAll('button,[role=button],a,span,div');for(var q=0;q<Q.length&&q<60;q++)A.push(Q[q]);var best=null,bs=-1;for(var j=0;j<A.length;j++){var z=score(A[j]);if(z>bs){bs=z;best=A[j];}}if(!best||bs<8){skip++;continue;}best.setAttribute('data-ad-heartbezel386','1');best.style.setProperty('border-radius','50%','important');best.style.setProperty('box-shadow','inset 0 0 0 1.5px rgba(255,255,255,.65)','important');n++;var sh=String(getComputedStyle(best).boxShadow||'');if(sh.indexOf('1.5px')<0)ringless++;}window.__AD_HEART386__='hosts='+n+' ringless='+ringless+' skip='+skip;}catch(e){window.__AD_HEART386__='err '+e;}}"
         "function heartFix387(){try{var OLD=document.querySelectorAll('[data-ad-heartbezel386],[data-ad-heart387],[data-ad-heartinner387],[data-ad-heartglyph387]');for(var oi=0;oi<OLD.length;oi++){var o=OLD[oi];if(o.hasAttribute('data-ad-heartbezel386')){o.style.removeProperty('box-shadow');o.style.removeProperty('border-radius');}o.removeAttribute('data-ad-heartbezel386');o.removeAttribute('data-ad-heart387');o.removeAttribute('data-ad-heartinner387');o.removeAttribute('data-ad-heartglyph387');o.removeAttribute('data-ad-heartraster387');}var R=document.querySelectorAll('[class*=puis-heart-position]'),P=[],dup=0,miss=0,glyph=0;function sq(e){if(!e||!e.getBoundingClientRect)return false;var r=e.getBoundingClientRect();return r.width>=28&&r.width<=42&&r.height>=28&&r.height<=42&&Math.abs(r.width-r.height)<=7;}function leaf(e){var t=String(e&&e.tagName||'').toUpperCase();return t==='IMG'||t==='I'||t==='SVG'||t==='PATH';}function bad(e){return !!(e&&e.closest&&e.closest('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[class*=lists-framework-action-button]'));}function center(e){var r=e.getBoundingClientRect();return [r.left+r.width/2,r.top+r.height/2,r.width*r.height];}function same(a,b){return Math.abs(a[0]-b[0])<3&&Math.abs(a[1]-b[1])<3;}for(var i=0;i<R.length&&i<180;i++){var root=R[i];if(bad(root))continue;var A=[root],Q=root.querySelectorAll('button,[role=button],a,span,div');for(var q=0;q<Q.length&&q<70;q++)A.push(Q[q]);var best=null,ba=-1;for(var j=0;j<A.length;j++){var e=A[j];if(leaf(e)||bad(e)||!sq(e))continue;var r=e.getBoundingClientRect(),a=r.width*r.height;if(a>ba){ba=a;best=e;}}if(!best){miss++;continue;}var c=center(best),slot=-1;for(var p=0;p<P.length;p++)if(same(c,P[p].c)){slot=p;break;}if(slot>=0){dup++;if(c[2]>P[slot].c[2])P[slot]={e:best,c:c};}else P.push({e:best,c:c});}for(var k=0;k<P.length;k++){var h=P[k].e;h.setAttribute('data-ad-heart387','1');h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('background-image','none','important');h.style.setProperty('border','1.5px solid rgba(255,255,255,.65)','important');h.style.setProperty('border-radius','50%%','important');h.style.setProperty('box-shadow','none','important');h.style.setProperty('box-sizing','border-box','important');var hr=h.getBoundingClientRect(),cx=hr.left+hr.width/2,cy=hr.top+hr.height/2,D=h.querySelectorAll('button,[role=button],a,span,div');for(var d=0;d<D.length&&d<50;d++){var z=D[d];if(z===h||!sq(z))continue;var zr=z.getBoundingClientRect();if(Math.abs((zr.left+zr.width/2)-cx)<2.5&&Math.abs((zr.top+zr.height/2)-cy)<2.5){z.setAttribute('data-ad-heartinner387','1');z.style.setProperty('background-color','transparent','important');z.style.setProperty('border','0','important');z.style.setProperty('box-shadow','none','important');}}var G=h.querySelectorAll('img,i,svg,path');for(var g=0;g<G.length&&g<36;g++){var x=G[g],xr=x.getBoundingClientRect();if(xr.width<7||xr.height<7||xr.width>30||xr.height>30)continue;var cl=String(x.className&&x.className.baseVal!==undefined?x.className.baseVal:(x.className||'')),src=String(x.currentSrc||x.src||'');if(/placehold|spacer|grey-pixel|gray-pixel|transparent-pixel/i.test(cl+' '+src))continue;x.setAttribute('data-ad-heartglyph387','1');var tg=String(x.tagName||'').toUpperCase(),cs=getComputedStyle(x),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none');if(tg==='IMG'||tg==='I'||bi!=='none'||mi!=='none')x.setAttribute('data-ad-heartraster387','1');if(tg==='SVG'||tg==='PATH'){x.style.setProperty('color','#fff','important');x.style.setProperty('fill','#fff','important');x.style.setProperty('stroke','#fff','important');}x.style.setProperty('visibility','visible','important');x.style.setProperty('opacity','1','important');glyph++;}}window.__AD_HEART387__='hosts='+P.length+' glyph='+glyph+' dup='+dup+' miss='+miss;}catch(e){window.__AD_HEART387__='err '+e;}}"
         ...
         "function stockActionFix387(){try{var H=document.querySelectorAll('[class*=lists-framework-action-button]'),C=document.querySelectorAll('[data-ad-compare380],[data-ad-comparelegacy387],[class*=mlt-icon-container],[role=checkbox],input[type=checkbox]'),CR=[],hosts=[],glyph=0,skip=0,miss=0,over=0;for(var ci=0;ci<C.length&&ci<260;ci++){var cr=C[ci].getBoundingClientRect();if(cr.width>=20&&cr.width<=54&&cr.height>=20&&cr.height<=54)CR.push(cr);}function sq(e){if(!e||!e.getBoundingClientRect)return false;var r=e.getBoundingClientRect();return r.width>=26&&r.width<=52&&r.height>=26&&r.height<=52&&Math.abs(r.width-r.height)<=9;}function blocked(e){return !!(e&&e.closest&&e.closest('[class*=heart],[class*=wish],[class*=favorite],[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[data-ad-compare380],[data-ad-comparelegacy387]'));}function ov(r){var cx=r.left+r.width/2,cy=r.top+r.height/2;for(var i=0;i<CR.length;i++){var q=CR[i];if(Math.abs(cx-(q.left+q.width/2))<18&&Math.abs(cy-(q.top+q.height/2))<18)return true;}return false;}function real(x){var tg=String(x.tagName||'').toUpperCase(),c=String(x.className&&x.className.baseVal!==undefined?x.className.baseVal:(x.className||'')),src=String(x.currentSrc||x.src||''),cs=getComputedStyle(x),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none');if(/placehold|spacer|grey-pixel|gray-pixel|transparent-pixel/i.test(c+' '+src))return false;return tg==='IMG'||tg==='I'||tg==='SVG'||tg==='PATH'||/lists-framework-(?:unfill|fill)/i.test(c)||bi!=='none'||mi!=='none';}for(var hi=0;hi<H.length&&hi<180;hi++){var root=H[hi];if(blocked(root)){skip++;continue;}var host=null;if(sq(root))host=root;var G=root.querySelectorAll('img,i,svg,path,[class*=lists-framework-unfill],[class*=lists-framework-fill]'),leaf=null;for(var gi=0;gi<G.length&&gi<50;gi++){var g=G[gi],gr=g.getBoundingClientRect();if(gr.width<5||gr.height<5||gr.width>34||gr.height>34||!real(g))continue;leaf=g;break;}if(!host&&leaf){var p=leaf.parentElement,u=0,best=null,ba=-1;while(p&&p!==root.parentElement&&u++<6){if(blocked(p))break;if(sq(p)){var pr=p.getBoundingClientRect(),a=pr.width*pr.height;if(a>ba){ba=a;best=p;}}if(p===root)break;p=p.parentElement;}host=best;}if(!host){miss++;continue;}var hr=host.getBoundingClientRect();if(ov(hr)){over++;continue;}var dupe=false;for(var h=0;h<hosts.length;h++){var rr=hosts[h].getBoundingClientRect();if(Math.abs((rr.left+rr.width/2)-(hr.left+hr.width/2))<3&&Math.abs((rr.top+rr.height/2)-(hr.top+hr.height/2))<3){dupe=true;break;}}if(dupe)continue;hosts.push(host);host.setAttribute('data-ad-stockaction387','1');host.style.setProperty('background-color','#181a1b','important');host.style.setProperty('background-image','none','important');host.style.setProperty('border','1.5px solid rgba(255,255,255,.65)','important');host.style.setProperty('border-radius','50%%','important');host.style.setProperty('box-shadow','none','important');host.style.setProperty('box-sizing','border-box','important');if(!leaf){var X=host.querySelectorAll('img,i,svg,path,[class*=lists-framework-unfill],[class*=lists-framework-fill]');for(var xi=0;xi<X.length&&xi<40;xi++){var xr=X[xi].getBoundingClientRect();if(xr.width>=5&&xr.height>=5&&xr.width<=34&&xr.height<=34&&real(X[xi])){leaf=X[xi];break;}}}if(leaf){leaf.setAttribute('data-ad-stockglyph387','1');var tg=String(leaf.tagName||'').toUpperCase(),cs=getComputedStyle(leaf),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none');if(tg==='IMG'||tg==='I'||bi!=='none'||mi!=='none')leaf.setAttribute('data-ad-stockraster387','1');if(tg==='SVG'||tg==='PATH'){leaf.style.setProperty('color','#fff','important');leaf.style.setProperty('fill','#fff','important');leaf.style.setProperty('stroke','#fff','important');}leaf.style.setProperty('visibility','visible','important');leaf.style.setProperty('opacity','1','important');glyph++;}}window.__AD_STOCKACTION387__='hosts='+hosts.length+' glyph='+glyph+' skip='+skip+' miss='+miss+' overlap='+over;}catch(e){window.__AD_STOCKACTION387__='err '+e;}}"
         "function stockActionFix384(){try{var H=document.querySelectorAll('[class*=lists-framework-action-button]'),CMP=document.querySelectorAll('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox]'),CR=[],direct=0,synth=0,leafn=0,cmpSkip=0,miss=0;for(var ci=0;ci<CMP.length&&ci<180;ci++){var cr=CMP[ci].getBoundingClientRect();if(cr.width>=20&&cr.width<=54&&cr.height>=20&&cr.height<=54)CR.push(cr);}function cls(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}function blocked(e){return !!(e&&e.closest&&e.closest('[class*=heart],[class*=wish],[class*=favorite],[class*=mlt-icon-container],[role=checkbox],input[type=checkbox]'));}function overlap(r){var cx=r.left+r.width/2,cy=r.top+r.height/2;for(var i=0;i<CR.length;i++){var q=CR[i],qx=q.left+q.width/2,qy=q.top+q.height/2;if(Math.abs(cx-qx)<18&&Math.abs(cy-qy)<18)return true;}return false;}function pseudo(e,w){try{var c=getComputedStyle(e,w),bi=String(c.backgroundImage||'none'),mi=String(c.maskImage||c.webkitMaskImage||'none'),ct=String(c.content||'none');return bi!=='none'||mi!=='none'||(ct&&ct!=='none'&&ct!=='normal'&&ct!=='\"\"');}catch(x){return false;}}function score(e){if(!e||blocked(e)||(e.hasAttribute&&e.hasAttribute('data-ad-stockdisc384')))return -1;var r=e.getBoundingClientRect();if(r.width<5||r.height<5||r.width>48||r.height>48)return -1;if(overlap(r))return -2;var tg=String(e.tagName||'').toUpperCase(),c=cls(e),cs=getComputedStyle(e),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none'),sc=0;if(/lists-framework-(?:unfill|fill)/i.test(c))sc+=12;if(tg==='IMG'&&/01rrz/i.test(String(e.currentSrc||e.src||'')))sc+=12;if(tg==='IMG'||tg==='I'||tg==='SVG'||tg==='PATH')sc+=4;if(/icon|action/i.test(c))sc+=2;if(bi!=='none'||mi!=='none')sc+=5;if(pseudo(e,'::before')||pseudo(e,'::after'))sc+=4;return sc;}function square(e){if(!e||blocked(e))return false;var r=e.getBoundingClientRect();return r.width>=26&&r.width<=52&&r.height>=26&&r.height<=52&&Math.abs(r.width-r.height)<=10&&!(e.querySelector&&e.querySelector('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox]'));}function cleanOld(e){if(!e)return;['data-ad-stockaction382','data-ad-stockaction381','data-ad-stockaction380','data-ad-stockaction379'].forEach(function(a){e.removeAttribute(a);});}for(var hi=0;hi<H.length&&hi<140;hi++){var root=H[hi];if(blocked(root)){cmpSkip++;continue;}var old=root.querySelectorAll('[data-ad-stockdisc384]');for(var od=0;od<old.length;od++)old[od].remove();var Q=root.querySelectorAll('img,i,svg,path,span,div,[class*=lists-framework-unfill],[class*=lists-framework-fill]'),A=[root];for(var aq=0;aq<Q.length&&aq<90;aq++)A.push(Q[aq]);var best=null,bs=-1;for(var ai=0;ai<A.length&&ai<91;ai++){var sc=score(A[ai]);if(sc===-2){cmpSkip++;continue;}if(sc>bs){bs=sc;best=A[ai];}}if(!best||bs<4){miss++;continue;}var br=best.getBoundingClientRect();if(overlap(br)){cmpSkip++;continue;}cleanOld(root);var anchor=best,p=best,u=0;while(p&&p!==root.parentElement&&u++<6){if(square(p)){anchor=p;break;}if(p===root)break;p=p.parentElement;}if(square(anchor)&&anchor!==best){cleanOld(anchor);anchor.setAttribute('data-ad-stockaction384','1');direct++;}else{var rr=root.getBoundingClientRect(),cs=getComputedStyle(root);if(cs.position==='static')root.style.setProperty('position','relative','important');var d=document.createElement('span');d.setAttribute('data-ad-stockdisc384','1');var sz=36,cx=br.left+br.width/2-rr.left,cy=br.top+br.height/2-rr.top;d.style.setProperty('left',(cx-sz/2)+'px','important');d.style.setProperty('top',(cy-sz/2)+'px','important');root.appendChild(d);synth++;}var tg=String(best.tagName||'').toUpperCase(),csb=getComputedStyle(best),bgi=String(csb.backgroundImage||'none'),msk=String(csb.maskImage||csb.webkitMaskImage||'none');best.setAttribute('data-ad-stockglyph384','1');if(tg==='IMG'||tg==='I'||bgi!=='none'||msk!=='none')best.setAttribute('data-ad-stockraster384','1');if(pseudo(best,'::before'))best.setAttribute('data-ad-stockbefore384','1');if(pseudo(best,'::after'))best.setAttribute('data-ad-stockafter384','1');best.style.setProperty('visibility','visible','important');best.style.setProperty('opacity','1','important');best.__adGlyph=1;best.__adBy='stockAction384';leafn++;}window.__AD_STOCKACTION384__='direct='+direct+' synth='+synth+' leaf='+leafn+' cmpSkip='+cmpSkip+' miss='+miss;}catch(e){window.__AD_STOCKACTION384__='err '+e;}}"
         ...
         "}catch(e){}}""homeAmbient386();badgeFix();dotFix();packFix();compareStock380();legacyCompare387();heartFix387();stockActionFix387();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(homeAmbient386,300);setTimeout(homeAmbient386,1200);setTimeout(homeAmbient386,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(compareStock380,0);setTimeout(compareStock380,120);setTimeout(compareStock380,500);setTimeout(compareStock380,1500);setTimeout(legacyCompare387,0);setTimeout(legacyCompare387,120);setTimeout(legacyCompare387,500);setTimeout(legacyCompare387,1500);setTimeout(heartFix387,0);setTimeout(heartFix387,80);setTimeout(heartFix387,300);setTimeout(heartFix387,900);setTimeout(stockActionFix387,0);setTimeout(stockActionFix387,80);setTimeout(stockActionFix387,300);setTimeout(stockActionFix387,900);setTimeout(cartChrome382,20);setTimeout(cartChrome382,180);setTimeout(cartChrome382,700);setTimeout(cartChrome382,1800);setTimeout(sponsorFix376,20);setTimeout(sponsorFix376,180);setTimeout(sponsorFix376,700);setTimeout(sponsorFix376,1800);setTimeout(ratingFix376,40);setTimeout(ratingFix376,240);setTimeout(ratingFix376,900);setTimeout(ratingFix376,2200);setTimeout(shareFix382,40);setTimeout(shareFix382,180);setTimeout(shareFix382,700);setTimeout(shareFix382,1800);setTimeout(chevronFix383,20);setTimeout(chevronFix383,180);setTimeout(chevronFix383,700);setTimeout(chevronFix383,1800);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){homeAmbient386();badgeFix();dotFix();packFix();compareStock380();legacyCompare387();heartFix387();stockActionFix387();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();},100);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();compareStock380();legacyCompare387();heartFix387();stockActionFix387();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();},20);}).observe(document.documentElement,"
