...
static NSString *ADDarkReaderBootstrapBuild(void){
    ...
    NSString *adBody = [NSString stringWithFormat:
        @"(function(){try{"
         ...
         // v5.399: final stock-symbol authority. Keep Amazon's real glyph/state;
         // normalize only the existing host chrome. No replacement SVG/path/checkmark is drawn.
         "try{if(document&&!document.getElementById('adstock399')){var __s399=document.createElement('style');__s399.id='adstock399';"
           "__s399.textContent='"
             "html body [data-ad-stockhost399]{position:relative !important;width:32px !important;height:32px !important;min-width:32px !important;min-height:32px !important;max-width:32px !important;max-height:32px !important;box-sizing:border-box !important;background-color:#181a1b !important;border:1.5px solid #9aa0a3 !important;box-shadow:none !important;}"
             "html body [data-ad-stockhost399]:not([data-ad-stockhost399=\"checkbox\"]){border-radius:50%% !important;}"
             "html body [data-ad-stockhost399=\"checkbox\"]{border-radius:4px !important;}"
             "html body [data-ad-stockhost399][data-ad-stockglyph399],html body [data-ad-stockhost399] [data-ad-stockglyph399],html body [data-ad-stockhost399] > [data-ad-stockglyph399]{visibility:visible !important;opacity:1 !important;}"
             "html body [data-ad-stockhost399]:not([data-ad-stockhost399=\"checkbox\"]) [data-ad-stockraster399]{filter:brightness(0) invert(1) !important;}"

             "html body [data-ad-stockhost399]:not([data-ad-stockhost399=\"checkbox\"]) [data-ad-stockvector399],html body [data-ad-stockhost399]:not([data-ad-stockhost399=\"checkbox\"]) [data-ad-stockvector399] *{color:#fff !important;fill:#fff !important;stroke:#fff !important;}"
             "html body [data-ad-stockhost399]:not([data-ad-stockhost399=\"checkbox\"])[data-ad-stockpseudo399]::before,html body [data-ad-stockhost399]:not([data-ad-stockhost399=\"checkbox\"])[data-ad-stockpseudo399]::after,html body [data-ad-stockhost399]:not([data-ad-stockhost399=\"checkbox\"]) [data-ad-stockpseudo399]::before,html body [data-ad-stockhost399]:not([data-ad-stockhost399=\"checkbox\"]) [data-ad-stockpseudo399]::after{color:#fff !important;border-color:#fff !important;filter:brightness(0) invert(1) !important;}"
             "html body [data-ad-actioncanonical376]{display:none !important;visibility:hidden !important;opacity:0 !important;}"
             "html body [data-ad-actionorig376]{visibility:visible !important;opacity:1 !important;}"
             "html body [data-ad-stockhost399=\"checkbox\"]::before,html body [data-ad-stockhost399=\"checkbox\"]::after,"
             "html body [data-ad-stockhost399=\"checkbox\"][data-ad-compare379]::before,html body [data-ad-stockhost399=\"checkbox\"][data-ad-compare379]::after,"
             "html body [data-ad-stockhost399=\"checkbox\"][data-ad-compare380]::before,html body [data-ad-stockhost399=\"checkbox\"][data-ad-compare380]::after,"
             "html body [data-ad-stockhost399=\"checkbox\"][data-ad-comparelegacy387]::before,html body [data-ad-stockhost399=\"checkbox\"][data-ad-comparelegacy387]::after,"
             "html body [data-ad-stockhost399=\"checkbox\"][data-ad-product391=\"checkbox\"]::before,html body [data-ad-stockhost399=\"checkbox\"][data-ad-product391=\"checkbox\"]::after,"
             "html body [data-ad-stockhost399=\"checkbox\"] [data-ad-compare379]::before,html body [data-ad-stockhost399=\"checkbox\"] [data-ad-compare379]::after,"
             "html body [data-ad-stockhost399=\"checkbox\"] [data-ad-compare380]::before,html body [data-ad-stockhost399=\"checkbox\"] [data-ad-compare380]::after,"
             "html body [data-ad-stockhost399=\"checkbox\"] [data-ad-comparelegacy387]::before,html body [data-ad-stockhost399=\"checkbox\"] [data-ad-comparelegacy387]::after{content:none !important;display:none !important;background:transparent !important;border:0 !important;box-shadow:none !important;}"
             "html body [data-ad-stockhost399=\"checkbox\"] [data-ad-stockglyph399=\"checkbox\"],html body [data-ad-stockhost399=\"checkbox\"] [data-ad-compareorig379][data-ad-stockglyph399],html body [data-ad-stockhost399=\"checkbox\"] [data-ad-compareorig380][data-ad-stockglyph399],html body [data-ad-stockhost399=\"checkbox\"] [data-ad-comparelegacyorig387][data-ad-stockglyph399]{visibility:visible !important;opacity:1 !important;}"
           "';(document.head||document.documentElement).appendChild(__s399);}}catch(e){}"
         // v5.399 Home bleed experiment: preserve the v5.397 Home colors exactly and
         // clip/contain the live ambient compositor layer instead of recoloring it.
         "try{if(document&&!document.getElementById('adbleed399')){var __b399=document.createElement('style');__b399.id='adbleed399';"
           "__b399.textContent='[data-ad-main396] [class*=theming-card-background],[data-ad-bleed399]{contain:paint !important;overflow:hidden !important;isolation:isolate !important;clip-path:inset(0) !important;}[data-ad-bleedhost399]{contain:paint !important;overflow:hidden !important;isolation:isolate !important;}';"
           "(document.head||document.documentElement).appendChild(__b399);}}catch(e){}"
...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         // v5.399: keep the stock Amazon symbol itself. This pass runs AFTER the
         // v5.397/v5.333 recovery and owns final host chrome only. It never creates a glyph.
         "window.__AD_STOCKCTRL399__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           "var st399=document.getElementById('adstock399');if(st399&&st399.parentNode)st399.parentNode.appendChild(st399);"
           "function cn399(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}"
           "function rr399(e){try{return e&&e.getBoundingClientRect?e.getBoundingClientRect():null;}catch(x){return null;}}"
           "function sq399(e,lo,hi){var r=rr399(e);return !!(r&&r.width>=lo&&r.width<=hi&&r.height>=lo&&r.height<=hi&&Math.abs(r.width-r.height)<=8);}"
           "function structural399(e){return !!(e&&e.nodeType===1&&!/^(IMG|I|INPUT|SVG|PATH|USE|POLYGON)$/.test(String(e.tagName||'').toUpperCase()));}"
           "function product399(e){return e&&e.closest&&e.closest('[class*=puis-card],[class*=s-result-item],[data-asin],[class*=s-product-image],[class*=product-image]');}"
           "function bad399(e){var z=String((e&&e.currentSrc)||e&&e.src||'')+' '+cn399(e);return /placehold|spacer|grey[-_]?pixel|gray[-_]?pixel|transparent[-_]?pixel|(?:^|[/_-])blank(?:[._-]|$)/i.test(z)||!!(e&&e.hasAttribute&&e.hasAttribute('data-ad-actioncanonical376'));}"
           "function nearest399(g,stop){var p=g,b=null,bd=999,u=0;while(p&&u++<8){if(structural399(p)&&sq399(p,22,52)){var r=rr399(p),d=Math.abs(Math.max(r.width,r.height)-32);if(d<bd){bd=d;b=p;}}if(p===stop)break;p=p.parentElement;}if(!b&&sq399(stop,22,52))b=stop;return b;}"
           "function pseudo399(e){try{var b=getComputedStyle(e,'::before'),a=getComputedStyle(e,'::after'),z=String((b&&b.backgroundImage)||'none')+String((b&&b.maskImage)||'none')+String((a&&a.backgroundImage)||'none')+String((a&&a.maskImage)||'none')+String((b&&b.content)||'')+String((a&&a.content)||'');return z!=='nonenonenonenonenonenone'&&z.replace(/none|normal|\\\"\\\"/g,'').length>0;}catch(x){return false;}}"
           "function pick399(root,kind){if(!root||!root.querySelectorAll)return null;var Q=root.querySelectorAll('[class*=lists-framework-unfill],[class*=lists-framework-fill],[class*=a-icon-checkbox],[class*=a-icon],[class*=heart],[class*=wish],[class*=favor],img,i,svg,path,use,polygon,button,[role=button],span'),best=null,bs=-1;for(var i=0;i<Q.length&&i<150;i++){var e=Q[i],r=rr399(e);if(!r||r.width<3||r.height<3||r.width>48||r.height>48||bad399(e))continue;var t=String(e.tagName||'').toUpperCase(),c=cn399(e),cs=getComputedStyle(e),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none'),real=(/^(IMG|I|SVG|PATH|USE|POLYGON)$/.test(t)||bi!=='none'||mi!=='none'||pseudo399(e));if(!real)continue;var sc=0;if(kind==='checkbox'&&/checkbox|checkmark|checked/i.test(c+' '+String(e.currentSrc||e.src||'')))sc+=80;if(kind==='heart'&&/heart|wish|favor|lists-treatment/i.test(c))sc+=60;if(kind==='cards'&&/lists-framework-(?:unfill|fill)|lists-framework-action/i.test(c))sc+=60;if(kind==='arrow'&&/dropdown|extender|chevron|caret|arrow/i.test(c))sc+=60;if(kind==='share'&&/share/i.test(c+' '+String(e.getAttribute&&e.getAttribute('aria-label')||'')))sc+=60;if(/^(IMG|I|SVG)$/.test(t))sc+=12;if(bi!=='none'||mi!=='none'||pseudo399(e))sc+=10;sc+=Math.max(0,10-Math.abs(Math.max(r.width,r.height)-20));if(sc>bs){bs=sc;best=e;}}return best;}"
           "function glyph399(g,type,h){if(!g)return 0;g.setAttribute('data-ad-stockglyph399',type);g.style.setProperty('visibility','visible','important');g.style.setProperty('opacity','1','important');var t=String(g.tagName||'').toUpperCase(),cs=getComputedStyle(g),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none'),same399=(g===h);if(t==='SVG'||t==='PATH'||t==='USE'||t==='POLYGON'){g.setAttribute('data-ad-stockvector399','1');}else if(!same399&&(t==='IMG'||t==='I'||bi!=='none'||mi!=='none')){g.setAttribute('data-ad-stockraster399','1');}if(pseudo399(g))g.setAttribute('data-ad-stockpseudo399','1');g.__adBy='stock399';return 1;}"
           "function clear399(root,keep){if(!root||!keep)return;var kr=rr399(keep);if(!kr)return;var kx=kr.left+kr.width/2,ky=kr.top+kr.height/2;function z399(e){if(!e||e===keep||!structural399(e))return;var r=rr399(e);if(!r||r.width<18||r.width>54||r.height<18||r.height>54||Math.abs(r.width-r.height)>10)return;var ex=r.left+r.width/2,ey=r.top+r.height/2;if(Math.abs(ex-kx)>5||Math.abs(ey-ky)>5)return;e.style.setProperty('border','0','important');e.style.setProperty('box-shadow','none','important');e.style.setProperty('background-color','transparent','important');}z399(root);if(root.querySelectorAll){var Q=root.querySelectorAll('button,[role=button],a,span,div,[class*=lists-framework-action-button],[data-ad-stockaction379],[data-ad-stockaction380],[data-ad-actionhost376],[data-ad-product391]');for(var i=0;i<Q.length;i++)z399(Q[i]);}var p=keep.parentElement,u=0;while(p&&u++<5){z399(p);if(p===root)break;p=p.parentElement;}}"
           "function host399(h,type,root){if(!h)return 0;h.setAttribute('data-ad-stockhost399',type);h.style.setProperty('width','32px','important');h.style.setProperty('height','32px','important');h.style.setProperty('min-width','32px','important');h.style.setProperty('min-height','32px','important');h.style.setProperty('max-width','32px','important');h.style.setProperty('max-height','32px','important');h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('border','1.5px solid #9aa0a3','important');h.style.setProperty('box-shadow','none','important');h.style.setProperty('box-sizing','border-box','important');h.style.setProperty('border-radius',type==='checkbox'?'4px':'50%%','important');clear399(root||h,h);return 1;}"
           "var heart399=0,cards399=0,arrow399=0,check399=0,share399=0,miss399=0,H399=document.querySelectorAll('[class*=puis-heart-position]');for(var hi399=0;hi399<H399.length&&hi399<180;hi399++){var hr399=H399[hi399],hg399=pick399(hr399,'heart'),hh399=hg399&&nearest399(hg399,hr399);if(!hg399||!hh399){miss399++;continue;}host399(hh399,'heart',hr399);glyph399(hg399,'heart',hh399);hr399.style.setProperty('visibility','visible','important');heart399++;}"
           "var A399=document.querySelectorAll('[class*=lists-framework-action-button]');for(var ai399=0;ai399<A399.length&&ai399<200;ai399++){var ar399=A399[ai399];if(ar399.closest&&ar399.closest('[class*=puis-heart-position],[class*=mlt-icon-container],[role=checkbox]'))continue;var ag399=pick399(ar399,'cards');if(!ag399){miss399++;continue;}var ah399=nearest399(ag399,ar399)|| (sq399(ar399,22,52)?ar399:null);if(!ah399){miss399++;continue;}host399(ah399,'cards',ar399);glyph399(ag399,'cards',ah399);cards399++;}"
           "var E399=document.querySelectorAll('[class*=a-icon-dropdown],[class*=a-icon-extender],[class*=chevron],[class*=caret],[class*=arrow]'),seenA399=[];for(var ei399=0;ei399<E399.length&&ei399<500;ei399++){var eg399=E399[ei399],ec399=product399(eg399);if(!ec399)continue;var cl399=cn399(eg399);if(/carousel|next|previous|prev/i.test(cl399))continue;if(eg399.closest&&eg399.closest('[class*=puis-heart-position],[class*=lists-framework-action-button],[class*=mlt-icon-container],[role=checkbox]'))continue;var eh399=nearest399(eg399,ec399);if(!eh399||seenA399.indexOf(eh399)>=0)continue;seenA399.push(eh399);host399(eh399,'arrow',eh399);glyph399(eg399,'arrow',eh399);arrow399++;}"
           "var C399=document.querySelectorAll('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],i.a-icon-checkbox,[class*=a-icon-checkbox]'),seenC399=[];for(var ci399=0;ci399<C399.length&&ci399<450;ci399++){var ce399=C399[ci399],pc399=product399(ce399),ch399=nearest399(ce399,pc399||null);if(!ch399&&sq399(ce399,22,52)&&structural399(ce399))ch399=ce399;if(!ch399||seenC399.indexOf(ch399)>=0)continue;if(!pc399&&!/mlt-icon-container/i.test(cn399(ch399)))continue;seenC399.push(ch399);var cg399=pick399(ch399,'checkbox');if(!cg399&&ce399.nodeType===1&&!structural399(ce399)&&!bad399(ce399))cg399=ce399;if(!cg399){miss399++;continue;}host399(ch399,'checkbox',ch399);glyph399(cg399,'checkbox',ch399);cg399.removeAttribute('data-ad-actioncanonical376');check399++;}"
           "var S399=document.querySelectorAll('.ssf-share-trigger,[data-ad-share377=\"1\"]'),seenS399=[];for(var si399=0;si399<S399.length&&si399<80;si399++){var sr399=S399[si399],sg399=pick399(sr399,'share'),sh399=sg399&&nearest399(sg399,sr399);if(!sh399&&sq399(sr399,22,52))sh399=sr399;if(!sg399||!sh399||seenS399.indexOf(sh399)>=0)continue;seenS399.push(sh399);host399(sh399,'share',sr399);glyph399(sg399,'share',sh399);share399++;}"
           "window.__AD_STOCKCTRL399_STATE__='heart='+heart399+' cards='+cards399+' arrow='+arrow399+' checkbox='+check399+' share='+share399+' miss='+miss399;return heart399+cards399+arrow399+check399+share399;"
         "}catch(e){window.__AD_STOCKCTRL399_STATE__='err '+(e&&e.message||e);return -1;}};"
         "try{window.__AD_PRODUCTCTRL391_ORIG399__=window.__AD_PRODUCTCTRL391RUN__;window.__AD_PRODUCTCTRL391RUN__=function(){var r399=window.__AD_PRODUCTCTRL391_ORIG399__?window.__AD_PRODUCTCTRL391_ORIG399__():0;try{window.__AD_STOCKCTRL399__();}catch(c399){}return r399;};}catch(e){}"
         "try{window.__AD_STOCKCTRL399__();setTimeout(window.__AD_STOCKCTRL399__,55);setTimeout(window.__AD_STOCKCTRL399__,240);setTimeout(window.__AD_STOCKCTRL399__,940);setTimeout(window.__AD_STOCKCTRL399__,1840);addEventListener('scroll',function(){clearTimeout(window.__adStock399T);window.__adStock399T=setTimeout(function(){try{window.__AD_STOCKCTRL399__();}catch(x){}},80);},{passive:true,capture:true});}catch(e){}"
         // v5.399 Home bleed: no color/background/filter writes. Find the nearest card-like
         // geometry around each live ambient layer and clip BOTH the layer and its host.
         "window.__AD_BLEED399__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;if(document.querySelector('#search,.s-search-results,[data-component-type=\"s-search-result\"],#productTitle,#dp-container,#ppd')){window.__AD_BLEED399_STATE__='home=0';return 0;}var B399=document.querySelectorAll('[class*=theming-card-background]'),n399=0,h399=0,miss399=0;for(var bi399=0;bi399<B399.length&&bi399<120;bi399++){var b399=B399[bi399],r399=null;try{r399=b399.getBoundingClientRect();}catch(x399){}if(!r399||r399.width<80||r399.height<60)continue;b399.setAttribute('data-ad-bleed399','1');b399.style.setProperty('contain','paint','important');b399.style.setProperty('overflow','hidden','important');b399.style.setProperty('isolation','isolate','important');b399.style.setProperty('clip-path','inset(0)','important');var p399=b399.parentElement,best399=null,score399=999,u399=0;while(p399&&u399++<8&&p399!==document.body&&p399!==document.documentElement){var pr399=p399.getBoundingClientRect();if(pr399&&pr399.width>=r399.width-12&&pr399.width<=r399.width+80&&pr399.height>=r399.height-12&&pr399.height<=r399.height+120){var d399=Math.abs(pr399.width-r399.width)+Math.abs(pr399.height-r399.height);if(d399<score399){score399=d399;best399=p399;}}p399=p399.parentElement;}if(best399){best399.setAttribute('data-ad-bleedhost399','1');best399.style.setProperty('contain','paint','important');best399.style.setProperty('overflow','hidden','important');best399.style.setProperty('isolation','isolate','important');h399++;}else miss399++;n399++;}window.__AD_BLEED399_STATE__='home=1 n='+n399+' hosted='+h399+' miss='+miss399;return n399;}catch(e){window.__AD_BLEED399_STATE__='err '+(e&&e.message||e);return -1;}};"
         "try{window.__AD_BLEED399__();setTimeout(window.__AD_BLEED399__,20);setTimeout(window.__AD_BLEED399__,120);setTimeout(window.__AD_BLEED399__,500);setTimeout(window.__AD_BLEED399__,1400);addEventListener('scroll',function(){clearTimeout(window.__adBleed399T);window.__adBleed399T=setTimeout(function(){try{window.__AD_BLEED399__();}catch(x){}},25);},{passive:true,capture:true});if(window.MutationObserver)new MutationObserver(function(){clearTimeout(window.__adBleed399M);window.__adBleed399M=setTimeout(function(){try{window.__AD_BLEED399__();}catch(x){}},20);}).observe(document.documentElement,{subtree:true,childList:true});}catch(e){}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // P63STOCK399: final stock-glyph/chrome authority. No synthetic symbol may be visible.
       "try{var H63=document.querySelectorAll('[data-ad-stockhost399]'),badSize63=0,badRing63=0,badShape63=0,extra63=0,stockMissing63=0,heart63=0,cards63=0,arrow63=0,checkbox63=0,share63=0,Q63=[];for(var i63=0;i63<H63.length&&i63<240;i63++){var e63=H63[i63],r63=e63.getBoundingClientRect(),s63=getComputedStyle(e63),t63=String(e63.getAttribute('data-ad-stockhost399')||'-');if(t63==='heart')heart63++;else if(t63==='cards')cards63++;else if(t63==='arrow')arrow63++;else if(t63==='checkbox')checkbox63++;else if(t63==='share')share63++;if(Math.abs(r63.width-32)>1.5||Math.abs(r63.height-32)>1.5)badSize63++;var bw63=parseFloat(s63.borderTopWidth||'0'),bc63=String(s63.borderTopColor||'').replace(/\\s+/g,'');if(Math.abs(bw63-1.5)>.6||bc63.indexOf('154,160,163')<0)badRing63++;var br63=parseFloat(s63.borderTopLeftRadius||'0');if((t63==='checkbox'&&(br63<3||br63>6))||(t63!=='checkbox'&&br63<12))badShape63++;var g63=e63.hasAttribute('data-ad-stockglyph399')?e63:e63.querySelector('[data-ad-stockglyph399]');if(!g63)stockMissing63++;var R63=e63.querySelectorAll('[class*=lists-framework-action-button],[data-ad-stockaction379],[data-ad-stockaction380],[data-ad-actionhost376],[data-ad-product391]');for(var j63=0;j63<R63.length;j63++){var x63=R63[j63];if(x63===e63)continue;var xr63=x63.getBoundingClientRect();if(xr63.width<18||xr63.width>54||xr63.height<18||xr63.height>54)continue;var xs63=getComputedStyle(x63),xb63=parseFloat(xs63.borderTopWidth||'0'),xsh63=String(xs63.boxShadow||'none');if(xb63>=1||xsh63!=='none')extra63++;}var ep63=e63.parentElement,eu63=0,ecx63=r63.left+r63.width/2,ecy63=r63.top+r63.height/2;while(ep63&&eu63++<4){var er63=ep63.getBoundingClientRect();if(er63.width>=18&&er63.width<=54&&er63.height>=18&&er63.height<=54&&Math.abs((er63.left+er63.width/2)-ecx63)<=5&&Math.abs((er63.top+er63.height/2)-ecy63)<=5){var es63=getComputedStyle(ep63),eb63=parseFloat(es63.borderTopWidth||'0'),esh63=String(es63.boxShadow||'none');if(eb63>=1||esh63!=='none')extra63++;}ep63=ep63.parentElement;}if(Q63.length<10)Q63.push(t63+'@'+Math.round(r63.width)+'x'+Math.round(r63.height)+'|bw='+bw63.toFixed(1));}var Y63=document.querySelectorAll('[data-ad-actioncanonical376],[data-ad-productdisc390],[data-ad-checkboxglyph390]'),redrawn63=0;for(var y63=0;y63<Y63.length;y63++){var ys63=getComputedStyle(Y63[y63]),yr63=Y63[y63].getBoundingClientRect();if(ys63.display!=='none'&&ys63.visibility!=='hidden'&&parseFloat(ys63.opacity||'1')>.05&&yr63.width>1&&yr63.height>1)redrawn63++;}out.push('P63STOCK399[n='+H63.length+' heart='+heart63+' cards='+cards63+' arrow='+arrow63+' checkbox='+checkbox63+' share='+share63+' badSize='+badSize63+' badRing='+badRing63+' badShape='+badShape63+' extraRing='+extra63+' redrawn='+redrawn63+' stockMissing='+stockMissing63+' state='+String(window.__AD_STOCKCTRL399_STATE__||'-')+(Q63.length?' '+Q63.join(' ~~ '):'')+']');}catch(e63){out.push('P63STOCK399[err '+(e63&&e63.message||e63)+']');}"
       // P64BLEED399: containment is the success condition; original card colors are allowed.
       "try{var B64=document.querySelectorAll('[data-ad-bleed399]'),hosted64=0,containMiss64=0,hostMiss64=0,Q64=[];for(var i64=0;i64<B64.length&&i64<120;i64++){var e64=B64[i64],r64=e64.getBoundingClientRect(),s64=getComputedStyle(e64),h64=e64.closest&&e64.closest('[data-ad-bleedhost399]');if(h64)hosted64++;else hostMiss64++;if(String(s64.contain||'').indexOf('paint')<0||String(s64.overflow||'')==='visible')containMiss64++;if(Q64.length<8)Q64.push(Math.round(r64.width)+'x'+Math.round(r64.height)+'|'+String(s64.backgroundColor||'').replace(/\\s+/g,'')+'|h='+(h64?1:0));}out.push('P64BLEED399[seen='+B64.length+' hosted='+hosted64+' containMiss='+containMiss64+' hostMiss='+hostMiss64+' legacy398='+(document.getElementById('adbleed398')?1:0)+' state='+String(window.__AD_BLEED399_STATE__||'-')+(Q64.length?' '+Q64.join(' ~~ '):'')+']');}catch(e64){out.push('P64BLEED399[err '+(e64&&e64.message||e64)+']');}"
