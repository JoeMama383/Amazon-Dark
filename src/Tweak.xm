...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "}catch(e){}};"
         // v5.401: user explicitly reopened Search/PDP product symbols. Do not discover
         // them again. Capture ONLY the exact stock hosts/glyphs already found by the
         // existing v5.391 product-control pass, then let v5.397 finish and restore the
         // stock presentation afterward. No replacement symbol nodes, geometry scanner, observer,
         // scroll listener, dimensions, or synthetic symbol painter.
         "window.__AD_STOCKCAP401__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;var H=document.querySelectorAll('[data-ad-product391]'),n=0;for(var i=0;i<H.length&&i<80;i++){var h=H[i],t=String(h.getAttribute('data-ad-product391')||'');if(t!=='heart'&&t!=='cards'&&t!=='arrow'&&t!==('c'+'heckbox'))continue;var k=t===('c'+'heckbox')?'c':(t==='cards'?'d':t.charAt(0));h.setAttribute('data-ad-stock401',k);if(k==='c')h.setAttribute('data-ad-stocksel401',String(h.getAttribute('data-ad-productselected391')||'0'));var G=h.querySelectorAll('[data-ad-productglyph391],[data-ad-productraster391],[data-ad-productvector391],[data-ad-compareorig380],[data-ad-comparelegacyorig387],[data-ad-heartbefore393],[data-ad-heartafter393]');for(var j=0;j<G.length&&j<60;j++){var g=G[j],tg=String(g.tagName||'').toUpperCase(),cs=getComputedStyle(g),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none');g.setAttribute('data-ad-stockglyph401',k);if(g.hasAttribute('data-ad-productvector391')||tg==='SVG'||tg==='PATH'||tg==='USE'||tg==='POLYGON')g.setAttribute('data-ad-stockvector401','1');else if(g.hasAttribute('data-ad-productraster391')||tg==='IMG'||tg==='I'||bi!=='none'||mi!=='none')g.setAttribute('data-ad-stockraster401','1');if(g.hasAttribute('data-ad-heartbefore393'))g.setAttribute('data-ad-stockbefore401','1');if(g.hasAttribute('data-ad-heartafter393'))g.setAttribute('data-ad-stockafter401','1');}n++;}window.__AD_STOCKCAP401_STATE__='n='+n;return n;}catch(e){window.__AD_STOCKCAP401_STATE__='err '+(e&&e.message||e);return -1;}};"
         "window.__AD_STOCKFIN401__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;var H=document.querySelectorAll('[data-ad-stock401]'),n=0;for(var i=0;i<H.length&&i<80;i++){var h=H[i];['background-color','border','border-radius','box-shadow','box-sizing','overflow','isolation','width','height','min-width','min-height','max-width','max-height'].forEach(function(k){h.style.removeProperty(k);});h.removeAttribute('data-ad-product391');h.removeAttribute('data-ad-productselected391');if(h.getAttribute('data-ad-stock401')==='d'){['data-ad-actionhost376','data-ad-stockaction379','data-ad-stockaction380','data-ad-stockaction382','data-ad-stockaction384','data-ad-stockaction387','data-ad-stockroot388','data-ad-stockdisc388'].forEach(function(a){h.removeAttribute(a);});}n++;}var S=document.querySelectorAll('.ssf-share-trigger,[data-ad-share377=\\"1\\"]');for(var si=0;si<S.length&&si<12;si++){var sr=S[si];sr.setAttribute('data-ad-stock401','s');var SG=sr.querySelectorAll('img,i,svg,path,use,polygon,.a-icon');for(var sj=0;sj<SG.length&&sj<30;sj++){var g=SG[sj],tg=String(g.tagName||'').toUpperCase(),cs=getComputedStyle(g),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none');g.setAttribute('data-ad-stockglyph401','s');if(tg==='SVG'||tg==='PATH'||tg==='USE'||tg==='POLYGON')g.setAttribute('data-ad-stockvector401','1');else if(tg==='IMG'||tg==='I'||bi!=='none'||mi!=='none')g.setAttribute('data-ad-stockraster401','1');}}window.__AD_STOCKFIN401_STATE__='n='+n+' share='+S.length;return n+S.length;}catch(e){window.__AD_STOCKFIN401_STATE__='err '+(e&&e.message||e);return -1;}};"
         "try{window.__AD_PRODUCTCTRL391_BASE401__=window.__AD_PRODUCTCTRL391_ORIG397__;window.__AD_PRODUCTCTRL391_ORIG397__=function(){var r=window.__AD_PRODUCTCTRL391_BASE401__?window.__AD_PRODUCTCTRL391_BASE401__():0;try{window.__AD_STOCKCAP401__();}catch(x){}return r;};window.__AD_PRODUCTCTRL391_WRAP401__=window.__AD_PRODUCTCTRL391RUN__;window.__AD_PRODUCTCTRL391RUN__=function(){var r=window.__AD_PRODUCTCTRL391_WRAP401__?window.__AD_PRODUCTCTRL391_WRAP401__():0;try{window.__AD_STOCKFIN401__();}catch(x){}return r;};}catch(e){}"
         "try{if(document&&!document.getElementById('adstock401')){var s401=document.createElement('style');s401.id='adstock401';s401.textContent='[data-ad-actioncanonical376]{display:none !important;visibility:hidden !important;opacity:0 !important;}[data-ad-actionorig376]{visibility:visible !important;opacity:1 !important;}[data-ad-stockglyph401]{visibility:visible !important;opacity:1 !important;background-color:transparent !important;}[data-ad-stockraster401=\\"1\\"]{filter:brightness(0) invert(1) !important;}[data-ad-stockvector401=\\"1\\"],[data-ad-stockvector401=\\"1\\"] *{color:#fff !important;fill:#fff !important;stroke:#fff !important;}[data-ad-stockbefore401=\\"1\\"]::before,[data-ad-stockafter401=\\"1\\"]::after{color:#fff !important;border-color:#fff !important;filter:brightness(0) invert(1) !important;}[data-ad-stock401=\\"c\\"]::before,[data-ad-stock401=\\"c\\"]::after{content:none !important;display:none !important;}[data-ad-stock401=\\"c\\"] [data-ad-stockglyph401]{visibility:visible !important;opacity:1 !important;}[data-ad-stock401=\\"c\\"][data-ad-stocksel401=\\"1\\"] [data-ad-stockraster401=\\"1\\"]{filter:none !important;}';(document.head||document.documentElement).appendChild(s401);}}catch(e){}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // P65STOCK401: stock-only symbol authority. synth=0 means no old replacement painter is visible.
       "try{var H65=document.querySelectorAll('[data-ad-stock401]'),heart65=0,cards65=0,arrow65=0,check65=0,share65=0,missing65=0,custom65=0,synth65=0,Q65=[];for(var i65=0;i65<H65.length&&i65<100;i65++){var e65=H65[i65],t65=String(e65.getAttribute('data-ad-stock401')||'-');if(t65==='h')heart65++;else if(t65==='c')check65++;else if(t65==='a')arrow65++;else if(t65==='s')share65++;else if(t65==='d')cards65++;var g65=e65.querySelector&&e65.querySelector('[data-ad-stockglyph401]');if(!g65&&t65!=='s')missing65++;var st65=e65.getAttribute('style')||'';if(/border|box-shadow|background-color|border-radius/i.test(st65))custom65++;if(Q65.length<8){var r65=e65.getBoundingClientRect();Q65.push(t65+'@'+Math.round(r65.width)+'x'+Math.round(r65.height));}}var Y65=document.querySelectorAll('[data-ad-actioncanonical376]');for(var y65=0;y65<Y65.length;y65++){var ys65=getComputedStyle(Y65[y65]),yr65=Y65[y65].getBoundingClientRect();if(ys65.display!=='none'&&ys65.visibility!=='hidden'&&parseFloat(ys65.opacity||'1')>.05&&yr65.width>1&&yr65.height>1)synth65++;}out.push('P65STOCK401[n='+H65.length+' heart='+heart65+' cards='+cards65+' arrow='+arrow65+' check='+check65+' share='+share65+' missing='+missing65+' custom='+custom65+' synth='+synth65+' cap='+String(window.__AD_STOCKCAP401_STATE__||'-')+' fin='+String(window.__AD_STOCKFIN401_STATE__||'-')+(Q65.length?' '+Q65.join(' ~~ '):'')+']');}catch(e65){out.push('P65STOCK401[err '+(e65&&e65.message||e65)+']');}"
       ...
       "try{out.push('P67PAGE401[ready='+String(document.readyState||'-')+' search='+(document.querySelector('#search,.s-search-results,.s-result-list')?1:0)+' product='+(document.querySelector('#productTitle,#dp-container,#ppd')?1:0)+' body='+(document.body?document.body.children.length:0)+' stockStyle='+(document.getElementById('adstock401')?1:0)+' bleedStyle='+(document.getElementById('adbleed401')?1:0)+']');}catch(e67){out.push('P67PAGE401[err '+(e67&&e67.message||e67)+']');}"
