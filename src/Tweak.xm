...
#define AD_VERSION "v7.0.21-home-floor-bottomnav-probe"
...
static NSString *ADFloorJS(void){
    ...
    [js appendString:@"(function(){try{var id='ad7-static-theme',s=document.getElementById(id);if(!s){s=document.createElement('style');s.id=id;(document.head||document.documentElement||document).appendChild(s);}s.textContent='html,body,#a-page,#gwm-PageContent,#dp,main,[role=main],#search,#cart-page,#sc-active-cart,#sc-saved-cart{background:#000!important;background-color:#000!important;color:#e8e6e3!important;}.s-result-item,[data-component-type=s-search-result],.s-card-container,.s-main-slot,#sc-active-cart .sc-list-item,#sc-saved-cart .sc-list-item,[class*=sc-][class*=content],[class*=sc-][class*=container],#dp [class*=a-box],#dp [class*=a-expander],#dp [class*=celwidget]:not([class*=image]):not([class*=media]),.s-suggestion,.s-suggestion-container,[class*=recentSearch],[class*=search-suggestion],#authportal-main-section,#auth-footer,.auth-footer,[id*=auth-footer],[class*=variation],[class*=swatch-container],[class*=status-shell],[class*=badge-message],[class*=puis-card]:not([class*=creative]):not([class*=image]),[class*=product-card]:not([class*=image]){background-color:#181a1b!important;color:#e8e6e3!important;}.s-suggestion-container,.s-suggestion,.autocomplete-results-container,[class*=autocomplete],[class*=suggestion]{background:#181a1b!important;color:#e8e6e3!important;}.a-color-base,.a-text-normal,.a-size-base,.a-size-base-plus,.a-size-medium,.a-price,.a-price-whole,.a-price-symbol,.a-price-fraction,.a-offscreen,"];
    ...
    [js appendString:@".s-suggestion-container [class*=icon-past-search-sugge],.s-suggestion-container .icon-close.s-suggestion-icon-left{background-color:#e8e6e3!important;filter:none!important;opacity:1!important;}.puis-mab-overlay-row-share .puis-mab-overlay-icon-share{background-color:#e8e6e3!important;color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;filter:none!important;}#gwm-PageContent [class*=hp-mosaic-container],#gwm-PageContent [class*=_mosaic-container_style_widgetContainer]{background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;border-color:#494d4d!important;mix-blend-mode:normal!important;isolation:isolate!important;}#gwm-PageContent [class*=hp-mosaic-container] :is(div,section,article,ul,ol,li,a),#gwm-PageContent [class*=_mosaic-container_style_widgetContainer] :is(div,section,article,ul,ol,li,a){background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;border-color:#494d4d!important;mix-blend-mode:normal!important;}#gwm-PageContent [class*=hp-mosaic-container] :is(img,video,canvas,picture,svg),#gwm-PageContent [class*=_mosaic-container_style_widgetContainer] :is(img,video,canvas,picture,svg){background-color:transparent!important;}#gwm-PageContent [class*=hp-mosaic-container] [class*=badgeMessage],#gwm-PageContent [class*=_mosaic-container_style_widgetContainer] [class*=badgeMessage]"];
    [js appendString:@"{background-color:transparent!important;background-image:none!important;box-shadow:none!important;border-color:transparent!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#gwm-PageContent [class*=hp-mosaic-container] [class*=badgeLabel],#gwm-PageContent [class*=_mosaic-container_style_widgetContainer] [class*=badgeLabel]{background-color:#cc0c39!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}#gwm-PageContent [class*=hp-mosaic-container] [class*=next],#gwm-PageContent [class*=hp-mosaic-container] [class*=prev],#gwm-PageContent [class*=hp-mosaic-container] [class*=chevron],#gwm-PageContent [class*=hp-mosaic-container] [class*=arrow],#gwm-PageContent [class*=_mosaic-container_style_widgetContainer] [class*=next],#gwm-PageContent [class*=_mosaic-container_style_widgetContainer] [class*=prev],#gwm-PageContent [class*=_mosaic-container_style_widgetContainer] [class*=chevron],#gwm-PageContent [class*=_mosaic-container_style_widgetContainer] [class*=arrow]{color:#e8e6e3!important;fill:#e8e6e3!important;stroke:#e8e6e3!important;}#gwm-PageContent [class*=a-cardui]:not([class*=creative]):not([class*=ad-card]),#gwm-PageContent [class*=npack-asin-card],#gwm-PageContent [class*=gwm-asin-tile],#gwm-PageContent [class*=puis-card],#gwm-PageContent [class*=cXVhZ][class*=asin-container],#gwm-PageContent [class*=cXVhZ][class*=container_]:not([class*=image]):not([class*=creative])"];
    [js appendString:@"{background-color:#181a1b!important;}#gwm-PageContent [class*=npack-asin-card] :is(div,section,article,li,ul,ol,a,p,span):not([class*=image]):not([class*=img]):not([class*=picture]):not([class*=video]):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=button]):not([class*=swatch]):not([class*=creative]):not([class*=theming]):not([class*=poster]),#gwm-PageContent [class*=gwm-asin-tile] :is(div,section,article,li,ul,ol,a,p,span):not([class*=image]):not([class*=img]):not([class*=picture]):not([class*=video]):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=button]):not([class*=swatch]):not([class*=creative]):not([class*=theming]):not([class*=poster]),#gwm-PageContent [class*=puis-card] :is(div,section,article,li,ul,ol,a,p,span):not([class*=image]):not([class*=img]):not([class*=picture]):not([class*=video]):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=button]):not([class*=swatch]):not([class*=creative]):not([class*=theming]):not([class*=poster]){background-color:#181a1b!important;}picture,img,video,canvas,svg,#imgTagWrapperId,.s-product-image-container,[data-component-type=s-product-image],[class*=image-wrapper],[class*=img-wrapper],[class*=image-container],[class*=product-image],[class*=asin-image],[class*=single-creative],[class*=single-video],[class*=theming-card-background],[class*=vjs-poster],[class*=media-wrapper],"];
