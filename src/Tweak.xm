...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           "window.__AD_PRODUCTTEXT370__=function(){try{if(!document.body)return 0;var E=document.querySelectorAll('*'),n=0;for(var i=0;i<E.length&&i<1100;i++){var e=E[i],tg=e.tagName;if(tg==='IMG'||tg==='PICTURE'||tg==='VIDEO'||tg==='CANVAS'||tg==='SVG'||tg==='svg'||tg==='USE'||tg==='PATH'||tg==='SCRIPT'||tg==='STYLE'||tg==='INPUT'||tg==='TEXTAREA'||tg==='SELECT'||tg==='OPTION')continue;var own='';try{for(var q=0;q<e.childNodes.length&&q<12;q++){var nd=e.childNodes[q];if(nd.nodeType===3)own+=String(nd.nodeValue||'');}}catch(et){}var txt=own.replace(/\\s+/g,' ').trim();try{if(!txt&&e.childElementCount<=2&&!e.querySelector('img,svg,picture,video,canvas,input,select,textarea')){var tx=String(e.textContent||'').replace(/\\s+/g,' ').trim();if(tx.length>0&&tx.length<180)txt=tx;}}catch(ex){}if(!txt)continue;var cs=getComputedStyle(e),fg=AF.p(cs.color),ff=AF.p(cs.webkitTextFillColor||cs.getPropertyValue('-webkit-text-fill-color')),bad=((fg&&AF.l(fg)<0.62&&AF.s(fg)<0.22)||(ff&&AF.l(ff)<0.62&&AF.s(ff)<0.22));if(!bad)continue;e.style.setProperty('color','#e8e6e3','important');e.style.setProperty('-webkit-text-fill-color','#e8e6e3','important');e.setAttribute('data-ad-producttext370','1');e.__adBy='productText370';n++;}window.__AD_PRODUCTTEXT370_N__=n;return n;}catch(e){return 0;}};"
 ...
 // imposed, so the creative renders exactly as Amazon shipped it.
         ...
         "try{window._adProductAds367=_adProductAds367;window._adBorderFast367=_adBorderFast367;window._adExactBorder370=_adExactBorder370;_adProductAds367(document.documentElement);_adBorderFast367(document.documentElement);_adExactBorder370(document.documentElement);setTimeout(function(){try{_adExactBorder370(document.documentElement);}catch(e){}},120);setTimeout(function(){try{_adExactBorder370(document.documentElement);}catch(e){}},650);setTimeout(function(){try{_adExactBorder370(document.documentElement);}catch(e){}},1800);}catch(e){}"
         ...
         "try{var _t=null;new MutationObserver(function(muts){var structural=0;"
           "try{for(var m2=0;m2<muts.length&&m2<40;m2++){var mm2=muts[m2];if(mm2.type==='attributes'){if(mm2.target){_adTameFast362(mm2.target);_adBorderFast367(mm2.target);_adExactBorder370(mm2.target);if(mm2.target.hasAttribute&&mm2.target.hasAttribute('data-ad-sponsored-light363'))_adSponsorPin366(mm2.target);if(mm2.target.hasAttribute&&mm2.target.hasAttribute('data-ad-reviewink367')){mm2.target.style.setProperty('color','#e8e6e3','important');mm2.target.style.setProperty('-webkit-text-fill-color','#e8e6e3','important');}}continue;}structural=1;var ad=mm2.addedNodes;for(var a2=0;a2<ad.length&&a2<20;a2++){_adPin(ad[a2]);_adTameFast362(ad[a2]);_adTextPins363(ad[a2]);if(ad[a2]&&ad[a2].nodeType===1){var tx367=String(ad[a2].textContent||'');if(tx367.length<7000&&/sponsored/i.test(tx367))_adProductAds367(ad[a2]);_adBorderFast367(ad[a2]);_adExactBorder370(ad[a2]);}}try{_adVideoCtlMain362();}catch(e){}}}catch(e){}"
...
"/*V5317FIX*/"
       ...
       "try{var pa31=document.querySelectorAll('[data-ad-productad367]').length,ri31=document.querySelectorAll('[data-ad-reviewink367]').length,bf31=document.querySelectorAll('[data-ad-border-section=\"fast367\"],[data-ad-border-section=\"fast368\"]').length,be31=document.querySelectorAll('[data-ad-border-section=\"exact370\"]').length,pf31=document.querySelectorAll('iframe[data-ad-frame-mode362=\"productad\"]').length;out.push('P31FIX[productAd='+pa31+' productFrame='+pf31+' reviewInk='+ri31+' borderFast='+bf31+' borderExact='+be31+']');}catch(e31){out.push('P31FIX[err '+(e31&&e31.message||e31)+']');}"
       "try{var P32=document.querySelectorAll('iframe[data-ad-frame-mode362=\"productad\"]'),R32=[];for(var i32=0;i32<P32.length&&i32<8;i32++){var f32=P32[i32],r32=f32.getBoundingClientRect();R32.push(String(f32.getAttribute('data-ad-frame-why369')||'-')+'@'+Math.round(r32.left)+','+Math.round(r32.top)+'/'+Math.round(r32.width)+'x'+Math.round(r32.height));}out.push('P32V370[productDoc='+String(window.__AD_PRODUCTDOC369__||0)+' productFrame='+P32.length+(R32.length?' '+R32.join(' ~~ '):'')+']');}catch(e32){out.push('P32V370[err '+(e32&&e32.message||e32)+']');}"
       "try{var A33=document.querySelectorAll('[class*=_hp-mosaic-container_style_widgetContainer],[class*=_mosaic-container_style_widgetContainer]'),Q33=[];for(var i33=0;i33<A33.length&&i33<10;i33++){var e33=A33[i33],r33=e33.getBoundingClientRect(),s33=getComputedStyle(e33);if(r33.width<100||r33.height<50)continue;Q33.push(e33.tagName+'.'+cls(e33)+'@'+Math.round(r33.top)+'/'+Math.round(r33.width)+'x'+Math.round(r33.height)+'|t='+String(s33.borderTopColor||'-').replace(/ /g,'')+'|sec='+String(e33.getAttribute('data-ad-border-section')||'-')+'|by='+(e33.__adBy||'-'));}out.push('P33V370[n='+Q33.length+(Q33.length?' '+Q33.join(' ~~ '):'')+']');}catch(e33){out.push('P33V370[err '+(e33&&e33.message||e33)+']');}"
