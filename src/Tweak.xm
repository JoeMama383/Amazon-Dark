...
static BOOL ADWTGridPeer386(UIView *v){
    @try {
        ...
        if(ADMenuRole382(v)!=0||ADWTNoTameGlyph367(v)||ADWTInHighlightsCarousel368(v)) return NO;
                ...
                for(NSUInteger qi=0;qi<q.count&&qi<90;qi++){
                    ...
                    if([x isKindOfClass:[UIImageView class]]){
                        ...
                        if(xc&&strstr(xc,"RCTUIImageView")&&xw>=88&&xw<=155&&xh>=78&&xh<=175&&
                           !ADWTNoTameGlyph367(x)&&!ADWTInHighlightsCarousel368(x)) peers++;
                    }
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         "}catch(e){}}""homeAmbient386();badgeFix();dotFix();packFix();heartBezel386();stockActionFix384();compareStock380();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(homeAmbient386,300);setTimeout(homeAmbient386,1200);setTimeout(homeAmbient386,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(heartBezel386,20);setTimeout(heartBezel386,120);setTimeout(heartBezel386,500);setTimeout(heartBezel386,1600);setTimeout(stockActionFix384,20);setTimeout(stockActionFix384,120);setTimeout(stockActionFix384,500);setTimeout(stockActionFix384,1600);setTimeout(compareStock380,20);setTimeout(compareStock380,120);setTimeout(compareStock380,500);setTimeout(compareStock380,1500);setTimeout(cartChrome382,20);setTimeout(cartChrome382,180);setTimeout(cartChrome382,700);setTimeout(cartChrome382,1800);setTimeout(sponsorFix376,20);setTimeout(sponsorFix376,180);setTimeout(sponsorFix376,700);setTimeout(sponsorFix376,1800);setTimeout(ratingFix376,40);setTimeout(ratingFix376,240);setTimeout(ratingFix376,900);setTimeout(ratingFix376,2200);setTimeout(shareFix382,40);setTimeout(shareFix382,180);setTimeout(shareFix382,700);setTimeout(shareFix382,1800);setTimeout(chevronFix383,20);setTimeout(chevronFix383,180);setTimeout(chevronFix383,700);setTimeout(chevronFix383,1800);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){homeAmbient386();badgeFix();dotFix();packFix();heartBezel386();stockActionFix384();compareStock380();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();},100);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();heartBezel386();stockActionFix384();compareStock380();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();},20);}).observe(document.documentElement,"
       ...
       "})();}catch(e){}"
       "/*V5314FIX*//*V5315FIX*/"
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*/"
