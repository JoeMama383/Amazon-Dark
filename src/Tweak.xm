/*
 * AmazonDark v7.355 — Cart Same-Day + Search carousel title-strip correction on v7.354
 *
 * Architecture:
...
#define AD_VERSION "v7.355-cart-same-day-search-strip-fix"
