...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           "window.__AD_ADTEXT371__=function(){try{if(!document.body)return 0;var mode=String(window.__ADFRAME_MODE__||''),sticky=!!window.__AD_STRIPCONF375__,compact=(mode==='standalone'&&(innerWidth||0)>=240&&(innerHeight||999)<=190);if(mode!=='productad'&&!compact&&!sticky){window.__AD_ADTEXT371_N__=0;window.__AD_ADTEXT371_LEFT__=0;window.__AD_ADTEXT371_ROOTS__=1;window.__AD_ADVIS375_N__=0;window.__AD_COMPACT371__=0;return 0;}var roots=[document],ri=0;while(ri<roots.length&&roots.length<24){var rt=roots[ri++],H=[];try{H=rt.querySelectorAll?rt.querySelectorAll('*'):[];}catch(er){H=[];}for(var hi=0;hi<H.length&&hi<1000&&roots.length<24;hi++){var sr=H[hi].shadowRoot;if(sr&&roots.indexOf(sr)<0)roots.push(sr);}}var n=0,left=0,vis=0,budget=0;for(var rr=0;rr<roots.length&&budget<2600;rr++){var R=roots[rr],E=[];try{E=R.querySelectorAll?R.querySelectorAll('*'):[];}catch(eq){E=[];}for(var i=0;i<E.length&&budget++<2600;i++){var e=E[i],tg=String(e.tagName||'').toUpperCase();if(tg==='IMG'||tg==='PICTURE'||tg==='VIDEO'||tg==='CANVAS'||tg==='SVG'||tg==='USE'||tg==='PATH'||tg==='SCRIPT'||tg==='STYLE'||tg==='INPUT'||tg==='TEXTAREA'||tg==='SELECT'||tg==='OPTION')continue;var own='';try{for(var q=0;q<e.childNodes.length&&q<12;q++){var nd=e.childNodes[q];if(nd.nodeType===3)own+=String(nd.nodeValue||'');}}catch(et){}var txt=own.replace(/\\s+/g,' ').trim();try{if(!txt&&e.childElementCount<=2&&!e.querySelector('img,svg,picture,video,canvas,input,select,textarea')){var tx=String(e.textContent||'').replace(/\\s+/g,' ').trim();if(tx.length>0&&tx.length<220)txt=tx;}}catch(ex){}if(!txt)continue;if(sticky){try{var vr=e.getBoundingClientRect();if(vr.width>1&&vr.height>1){var vc=getComputedStyle(e),changed=false;if(parseFloat(vc.opacity||'1')<0.20){e.style.setProperty('opacity','1','important');changed=true;}if(vc.visibility==='hidden'||vc.visibility==='collapse'){e.style.setProperty('visibility','visible','important');changed=true;}var up=e.parentElement,ud=0;while(up&&up!==document.body&&ud++<3){var uc=getComputedStyle(up),ur=up.getBoundingClientRect();if(ur.width<1||ur.height<1)break;if(parseFloat(uc.opacity||'1')<0.20){up.style.setProperty('opacity','1','important');changed=true;}if(uc.visibility==='hidden'||uc.visibility==='collapse'){up.style.setProperty('visibility','visible','important');changed=true;}up=up.parentElement;}if(changed)vis++;}}catch(ev){}}var cs=getComputedStyle(e),fg=AF.p(cs.color),ff=AF.p(cs.webkitTextFillColor||cs.getPropertyValue('-webkit-text-fill-color')),fl=AF.p(cs.fill),bad=((fg&&((fg.a!==undefined&&fg.a<0.20)||(AF.l(fg)<0.72&&AF.s(fg)<0.26)))||(ff&&((ff.a!==undefined&&ff.a<0.20)||(AF.l(ff)<0.72&&AF.s(ff)<0.26)))||((tg==='TEXT'||tg==='TSPAN')&&fl&&AF.l(fl)<0.72&&AF.s(fl)<0.26));if(!bad)continue;e.style.setProperty('color','#e8e6e3','important');e.style.setProperty('-webkit-text-fill-color','#e8e6e3','important');e.style.setProperty('opacity','1','important');e.style.setProperty('visibility','visible','important');if(tg==='TEXT'||tg==='TSPAN')e.style.setProperty('fill','#e8e6e3','important');e.setAttribute('data-ad-adtext371','1');e.__adBy='adText375';n++;try{var cs2=getComputedStyle(e),fg2=AF.p(cs2.color),ff2=AF.p(cs2.webkitTextFillColor||cs2.getPropertyValue('-webkit-text-fill-color'));if((fg2&&AF.l(fg2)<0.60&&AF.s(fg2)<0.26)||(ff2&&AF.l(ff2)<0.60&&AF.s(ff2)<0.26))left++;}catch(ec){}}}window.__AD_ADTEXT371_N__=n;window.__AD_ADTEXT371_LEFT__=left;window.__AD_ADTEXT371_ROOTS__=roots.length;window.__AD_ADVIS375_N__=vis;window.__AD_COMPACT371__=compact?1:0;return n;}catch(e){window.__AD_ADTEXT371_N__=-1;return 0;}};"
           ...
           "window.__AMZDARK_ADTHEME__=function(){try{"
             ...
             "var strip375=window.__AD_PRODUCTSTRIP375__?window.__AD_PRODUCTSTRIP375__():0;if(strip375){var cl375=window.__AD_CLEARSTRIP374__?window.__AD_CLEARSTRIP374__():0;var in375=window.__AD_ADTEXT371__?window.__AD_ADTEXT371__():0;var tm375=window.__AD_STRIPMEDIA374__?window.__AD_STRIPMEDIA374__():0;var sp375=window.__AD_SPON365__?window.__AD_SPON365__():0;window.__AD_STANDALONE__='strip-stock375';window.__AD_ADTHEME__='mode='+mode+' strip375=1 sticky375='+String(window.__AD_STRIPCONF375__?1:0)+' first='+String(window.__AD_STRIP375_FIRSTMODE__||'-')+' clean375='+cl375+' chrome375='+String(window.__AD_STRIPCHROME374_LEFT__||0)+' ink375='+in375+' left='+String(window.__AD_ADTEXT371_LEFT__||0)+' vis375='+String(window.__AD_ADVIS375_N__||0)+' roots='+String(window.__AD_ADTEXT371_ROOTS__||1)+' media375='+String(window.__AD_STRIPMEDIA374_N__||0)+' fullSkip375='+String(window.__AD_STRIPFULL374_N__||0)+' spon='+sp375;return cl375+in375+tm375+sp375;}"
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         "function actionFix375(){try{var H=document.querySelectorAll('[class*=lists-framework-action-button],[class*=mlt-icon-container]'),hosts=0,canon=0,hidden=0,skip=0;"
         "for(var i=0;i<H.length&&i<120;i++){var h=H[i],hr=h.getBoundingClientRect();if(hr.width<18||hr.width>64||hr.height<18||hr.height>64||Math.abs(hr.width-hr.height)>14)continue;"
         "var hc=h.className;hc=String(hc&&hc.baseVal!==undefined?hc.baseVal:(hc||''));var lab=String(h.getAttribute&&h.getAttribute('aria-label')||h.getAttribute&&h.getAttribute('title')||'').toLowerCase();"
         "if(/heart|wish|favorite|favourite|save for later|like/.test(lab)){skip++;continue;}var im=h.querySelector('img'),isList=/lists-framework-action-button/i.test(hc),imageBacked=!!im;if(!isList&&!imageBacked){skip++;continue;}"
         "hosts++;h.setAttribute('data-ad-actionhost375','1');var pos=getComputedStyle(h).position;if(pos==='static')h.style.setProperty('position','relative','important');"
         "var olds=h.querySelectorAll('[data-ad-actionfallback374]');for(var oi=0;oi<olds.length;oi++)if(olds[oi].parentNode)olds[oi].parentNode.removeChild(olds[oi]);"
         "var v=h.querySelector(':scope > [data-ad-actioncanonical375]');if(!v){var ns='http://www.w3.org/2000/svg';v=document.createElementNS(ns,'svg');v.setAttribute('viewBox','0 0 24 24');v.setAttribute('data-ad-actioncanonical375','1');v.setAttribute('aria-hidden','true');"
         "var r1=document.createElementNS(ns,'rect');r1.setAttribute('x','4');r1.setAttribute('y','7');r1.setAttribute('width','12');r1.setAttribute('height','12');r1.setAttribute('rx','1.6');"
         "var r2=document.createElementNS(ns,'rect');r2.setAttribute('x','8');r2.setAttribute('y','4');r2.setAttribute('width','12');r2.setAttribute('height','12');r2.setAttribute('rx','1.6');"
         "var pp=document.createElementNS(ns,'path');pp.setAttribute('d','M14 7v6M11 10h6');v.appendChild(r1);v.appendChild(r2);v.appendChild(pp);h.appendChild(v);}v.__adGlyph=1;v.__adBy='actionCanonical375';"
         "var O=h.querySelectorAll('img,picture,svg,i,[class*=icon]');for(var k=0;k<O.length&&k<40;k++){var a=O[k];if(a===v||a.hasAttribute&&a.hasAttribute('data-ad-actioncanonical375')||a.closest&&a.closest('[data-ad-actioncanonical375]'))continue;a.setAttribute('data-ad-actionorig375','1');a.style.setProperty('visibility','hidden','important');a.style.setProperty('opacity','0','important');hidden++;}"
         "v.style.setProperty('visibility','visible','important');v.style.setProperty('opacity','1','important');canon++;}"
         "window.__AD_ACTION375__='hosts='+hosts+' canonical='+canon+' hidden='+hidden+' skip='+skip;}catch(e){window.__AD_ACTION375__='err '+e;}}"
         "function shareFix375(){try{var S=document.querySelectorAll('.ssf-share-trigger'),hosts=0,leaves=0;"
         "for(var i=0;i<S.length&&i<20;i++){var h=S[i],r=h.getBoundingClientRect();if(r.width<8||r.height<8)continue;hosts++;h.setAttribute('data-ad-share375','1');h.style.setProperty('color','#ffffff','important');h.style.setProperty('-webkit-text-fill-color','#ffffff','important');"
         "var A=h.querySelectorAll('svg,path,i,img,[class*=icon]');for(var j=0;j<A.length&&j<40;j++){var a=A[j],ar=a.getBoundingClientRect();if(ar.width>90||ar.height>90)continue;var tg=String(a.tagName||'').toUpperCase(),cn=a.className;cn=String(cn&&cn.baseVal!==undefined?cn.baseVal:(cn||''));a.style.setProperty('opacity','1','important');a.style.setProperty('color','#ffffff','important');"
         "if(tg==='SVG'||tg==='PATH'){var ac=getComputedStyle(a),af=String(ac.fill||'none'),asx=String(ac.stroke||'none');if(af!=='none'&&af!=='transparent'&&af!=='rgba(0, 0, 0, 0)')a.style.setProperty('fill','#ffffff','important');if(asx!=='none'&&asx!=='transparent'&&asx!=='rgba(0, 0, 0, 0)')a.style.setProperty('stroke','#ffffff','important');}"
         "else if(tg==='IMG'||tg==='I'||/icon|share/i.test(cn)||String(getComputedStyle(a).backgroundImage||'').indexOf('url(')>=0){"
         "a.style.setProperty('background-color','transparent','important');"
         "a.__adGlyph=1;a.__adBy='share375';"
         "}a.setAttribute('data-ad-shareleaf375','1');leaves++;}}window.__AD_SHARE375__='hosts='+hosts+' leaves='+leaves;}catch(e){window.__AD_SHARE375__='err '+e;}}"
         ...
         "}catch(e){}}""badgeFix();dotFix();packFix();actionFix375();shareFix375();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(actionFix375,60);setTimeout(actionFix375,240);setTimeout(actionFix375,800);setTimeout(actionFix375,1800);setTimeout(shareFix375,80);setTimeout(shareFix375,360);setTimeout(shareFix375,1200);setTimeout(shareFix375,2600);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){badgeFix();dotFix();packFix();actionFix375();shareFix375();},120);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();actionFix375();shareFix375();},50);}).observe(document.documentElement,"
...
"/*V5317FIX*/"
       ...
       // P39V375: image-backed search action controls use one canonical white cards+ vector.
       "try{var H39=document.querySelectorAll('[data-ad-actionhost375]'),Q39=[];for(var h39=0;h39<H39.length&&Q39.length<12;h39++){var x39=H39[h39],r39=x39.getBoundingClientRect(),v39=x39.querySelector(':scope > [data-ad-actioncanonical375]'),vs39=v39?getComputedStyle(v39):null,paint39=v39?v39.querySelector('rect,path'):null,ps39=paint39?getComputedStyle(paint39):null,orig39=x39.querySelector('[data-ad-actionorig375]'),os39=orig39?getComputedStyle(orig39):null;Q39.push(Math.round(r39.left)+','+Math.round(r39.top)+'/'+Math.round(r39.width)+'x'+Math.round(r39.height)+'|canon='+(v39?1:0)+'|vis='+(vs39?String(vs39.visibility||'-'):'-')+'|op='+(vs39?String(vs39.opacity||'-'):'-')+'|stroke='+(ps39?String(ps39.stroke||'-').replace(/ /g,''):'-')+'|origVis='+(os39?String(os39.visibility||'-'):'-'));}out.push('P39V375[n='+Q39.length+(Q39.length?' '+Q39.join(' ~~ '):'')+' state='+String(window.__AD_ACTION375__||'-')+']');}catch(e39){out.push('P39V375[err '+(e39&&e39.message||e39)+']');}"
       // P40V375: unified Sponsored product-strip iframe + wrapper state.
       "try{var F40=document.querySelectorAll('iframe[data-ad-stripframe374]'),W40=document.querySelectorAll('[data-ad-stripwrap374]'),Q40=[];for(var i40=0;i40<F40.length&&i40<10;i40++){var f40=F40[i40],r40=f40.getBoundingClientRect();if(r40.width<250||r40.height>230)continue;var s40=getComputedStyle(f40),p40=f40.parentElement,ps40=p40?getComputedStyle(p40):null;Q40.push(String(f40.getAttribute('data-ad-frame-mode362')||'-')+'@'+Math.round(r40.left)+','+Math.round(r40.top)+'/'+Math.round(r40.width)+'x'+Math.round(r40.height)+'|conf='+(f40.hasAttribute('data-ad-stripconfirmed374')?1:0)+'|bg='+String(s40.backgroundColor||'-').replace(/ /g,'')+'|fil='+String(s40.filter||'-').replace(/ /g,'')+'|pbg='+(ps40?String(ps40.backgroundColor||'-').replace(/ /g,''):'-'));}out.push('P40V375[frames='+F40.length+' wraps='+W40.length+(Q40.length?' '+Q40.join(' ~~ '):'')+']');}catch(e40){out.push('P40V375[err '+(e40&&e40.message||e40)+']');}"
       // P41V375: PDP share glyph must stay white across recycled product templates.
       "try{var S41=document.querySelectorAll('.ssf-share-trigger'),Q41=[];for(var i41=0;i41<S41.length&&i41<8;i41++){var h41=S41[i41],r41=h41.getBoundingClientRect();if(r41.width<8||r41.height<8)continue;var a41=h41.querySelector('[data-ad-shareleaf375],svg,path,i,img,[class*=icon]'),s41=a41?getComputedStyle(a41):getComputedStyle(h41),b41=getComputedStyle(h41,'::before'),z41=getComputedStyle(h41,'::after');Q41.push(Math.round(r41.left)+','+Math.round(r41.top)+'/'+Math.round(r41.width)+'x'+Math.round(r41.height)+'|mk='+(h41.hasAttribute('data-ad-share375')?1:0)+'|c='+String(s41.color||'-').replace(/ /g,'')+'|fill='+String(s41.fill||'-').replace(/ /g,'')+'|flt='+String(s41.filter||'-').slice(0,22)+'|bef='+String(b41.color||'-').replace(/ /g,'')+'/'+String(b41.filter||'-').slice(0,12)+'|aft='+String(z41.color||'-').replace(/ /g,'')+'/'+String(z41.filter||'-').slice(0,12));}out.push('P41V375[n='+Q41.length+(Q41.length?' '+Q41.join(' ~~ '):'')+' state='+String(window.__AD_SHARE375__||'-')+']');}catch(e41){out.push('P41V375[err '+(e41&&e41.message||e41)+']');}"
