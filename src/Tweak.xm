...
static NSString *ADFixesLiteral(void){
    ...
    return [NSString stringWithFormat:
            @"{css:'"
             ...
             // v5.385: search/shopping heart chrome is deterministic instead of
             // inheriting an occasionally-missing Amazon border state. Runtime marks
             // ONLY a true square host inside the known puis-heart-position family.
             "[data-ad-heartchrome385=\"1\"]{background:#181a1b !important;background-color:#181a1b !important;"
             "background-image:none !important;border:1.5px solid rgba(255,255,255,.65) !important;border-radius:50%% !important;"
             "box-shadow:none !important;box-sizing:border-box !important;overflow:hidden !important;}"
             "[data-ad-heartglyph385=\"1\"]{color:#fff !important;fill:#fff !important;stroke:#fff !important;opacity:1 !important;}"
             "[data-ad-heartraster385=\"1\"]{filter:brightness(0) invert(1) !important;background-color:transparent !important;}"
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         "function heartChrome385(){try{var R=document.querySelectorAll('[class*=puis-heart-position]'),n=0,ringless=0,leaf=0;function cls(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}function sq(e){if(!e||!e.getBoundingClientRect)return false;var r=e.getBoundingClientRect();return r.width>=26&&r.width<=58&&r.height>=26&&r.height<=58&&Math.abs(r.width-r.height)<=10;}function score(e){if(!sq(e))return -1;var tg=String(e.tagName||'').toUpperCase(),ro=String(e.getAttribute&&e.getAttribute('role')||'').toLowerCase(),sc=0;if(tg==='BUTTON'||ro==='button')sc+=12;else if(tg==='A')sc+=8;if(/heart|wish|favor/i.test(cls(e)))sc+=5;if(e.querySelector&&e.querySelector('img,i,svg,path,[class*=icon]'))sc+=5;var r=e.getBoundingClientRect();sc+=Math.max(0,5-Math.abs(r.width-36)/4);return sc;}for(var i=0;i<R.length&&i<160;i++){var root=R[i],A=[root],Q=root.querySelectorAll('button,[role=button],a,span,div');for(var q=0;q<Q.length&&q<55;q++)A.push(Q[q]);var best=null,bs=-1;for(var j=0;j<A.length;j++){var z=score(A[j]);if(z>bs){bs=z;best=A[j];}}if(!best||bs<0)continue;best.setAttribute('data-ad-heartchrome385','1');best.style.setProperty('background-color','#181a1b','important');best.style.setProperty('background-image','none','important');best.style.setProperty('border','1.5px solid rgba(255,255,255,.65)','important');best.style.setProperty('border-radius','50%','important');best.style.setProperty('box-shadow','none','important');best.style.setProperty('box-sizing','border-box','important');best.style.setProperty('overflow','hidden','important');n++;var L=best.querySelectorAll('img,i,svg,path,[class*=icon]');for(var k=0;k<L.length&&k<30;k++){var a=L[k],ar=a.getBoundingClientRect();if(ar.width<4||ar.height<4||ar.width>42||ar.height>42||/placehold/i.test(cls(a)))continue;var tg=String(a.tagName||'').toUpperCase(),cs=getComputedStyle(a),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none');a.setAttribute('data-ad-heartglyph385','1');if(tg==='IMG'||tg==='I'||bi!=='none'||mi!=='none')a.setAttribute('data-ad-heartraster385','1');if(tg==='SVG'||tg==='PATH'){a.style.setProperty('color','#fff','important');a.style.setProperty('fill','#fff','important');a.style.setProperty('stroke','#fff','important');}a.style.setProperty('opacity','1','important');leaf++;}var cc=getComputedStyle(best),bw=parseFloat(cc.borderWidth||'0'),bg=String(cc.backgroundColor||'');if(bw<1||bg==='transparent'||bg==='rgba(0, 0, 0, 0)')ringless++;}window.__AD_HEART385__='hosts='+n+' leaf='+leaf+' ringless='+ringless;}catch(e){window.__AD_HEART385__='err '+e;}}"
         ...
         "}catch(e){}}""badgeFix();dotFix();packFix();heartChrome385();stockActionFix384();compareStock380();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(heartChrome385,20);setTimeout(heartChrome385,120);setTimeout(heartChrome385,500);setTimeout(heartChrome385,1600);setTimeout(stockActionFix384,20);setTimeout(stockActionFix384,120);setTimeout(stockActionFix384,500);setTimeout(stockActionFix384,1600);setTimeout(compareStock380,20);setTimeout(compareStock380,120);setTimeout(compareStock380,500);setTimeout(compareStock380,1500);setTimeout(cartChrome382,20);setTimeout(cartChrome382,180);setTimeout(cartChrome382,700);setTimeout(cartChrome382,1800);setTimeout(sponsorFix376,20);setTimeout(sponsorFix376,180);setTimeout(sponsorFix376,700);setTimeout(sponsorFix376,1800);setTimeout(ratingFix376,40);setTimeout(ratingFix376,240);setTimeout(ratingFix376,900);setTimeout(ratingFix376,2200);setTimeout(shareFix382,40);setTimeout(shareFix382,180);setTimeout(shareFix382,700);setTimeout(shareFix382,1800);setTimeout(chevronFix383,20);setTimeout(chevronFix383,180);setTimeout(chevronFix383,700);setTimeout(chevronFix383,1800);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){badgeFix();dotFix();packFix();heartChrome385();stockActionFix384();compareStock380();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();},80);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();heartChrome385();stockActionFix384();compareStock380();cartChrome382();shareFix382();chevronFix383();sponsorFix376();ratingFix376();},20);}).observe(document.documentElement,"
       ...
       "})();}catch(e){}"
       "/*V5314FIX*//*V5315FIX*/"
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*/"
       ...
       "try{var H385=document.querySelectorAll('[data-ad-heartchrome385]'),HL385=document.querySelectorAll('[data-ad-heartglyph385]'),rl385=0,HQ385=[];for(var h385=0;h385<H385.length&&h385<12;h385++){var he385=H385[h385],hr385=he385.getBoundingClientRect(),hc385=getComputedStyle(he385),hb385=parseFloat(hc385.borderWidth||'0'),hg385=String(hc385.backgroundColor||'');if(hb385<1||hg385==='transparent'||hg385==='rgba(0, 0, 0, 0)')rl385++;HQ385.push(Math.round(hr385.left)+','+Math.round(hr385.top)+'/'+Math.round(hr385.width)+'x'+Math.round(hr385.height)+'|b='+hb385.toFixed(1));}out.push('P48HEART385[hosts='+H385.length+' leaf='+HL385.length+' ringless='+rl385+(HQ385.length?' '+HQ385.join(' ~~ '):'')+' state='+String(window.__AD_HEART385__||'-')+']');}catch(e385){out.push('P48HEART385[err '+(e385&&e385.message||e385)+']');}"
