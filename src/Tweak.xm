...
#define AD_VERSION "v7.0.21-home-floor-bottomnav-fix"
...
static NSString *ADFloorJS(void){
    ...
    return @"(function(){try{var id='ad7-static-theme',s=document.getElementById(id);"
            ...
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container],"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer]"
            ...
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container] :is(div,section,article,ul,ol,li,a),"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer] :is(div,section,article,ul,ol,li,a)"
            ...
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container] :is(img,video,canvas,picture,svg),"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer] :is(img,video,canvas,picture,svg)"
            "{background-color:transparent!important;}"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container] [class*=badgeMessage],"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer] [class*=badgeMessage]"
            ...
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container] [class*=badgeLabel],"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer] [class*=badgeLabel]"
            "{background-color:#cc0c39!important;color:#fff!important;-webkit-text-fill-color:#fff!important;}"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container] [class*=next],:is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container] [class*=prev],:is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container] [class*=chevron],:is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=hp-mosaic-container] [class*=arrow],"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer] [class*=next],:is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer] [class*=prev],:is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer] [class*=chevron],:is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=_mosaic-container_style_widgetContainer] [class*=arrow]"
            ...
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=a-cardui]:not([class*=creative]):not([class*=ad-card]),"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=npack-asin-card],"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=gwm-asin-tile],"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=puis-card],"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=cXVhZ][class*=asin-container],"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=cXVhZ][class*=container_]:not([class*=image]):not([class*=creative])"
            "{background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=npack-asin-card] :is(div,section,article,li,ul,ol,a,p,span):not([class*=image]):not([class*=img]):not([class*=picture]):not([class*=video]):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=button]):not([class*=swatch]):not([class*=creative]):not([class*=theming]):not([class*=poster]),"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=gwm-asin-tile] :is(div,section,article,li,ul,ol,a,p,span):not([class*=image]):not([class*=img]):not([class*=picture]):not([class*=video]):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=button]):not([class*=swatch]):not([class*=creative]):not([class*=theming]):not([class*=poster]),"
            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) [class*=puis-card] :is(div,section,article,li,ul,ol,a,p,span):not([class*=image]):not([class*=img]):not([class*=picture]):not([class*=video]):not([class*=badge]):not([class*=deal]):not([class*=coupon]):not([class*=button]):not([class*=swatch]):not([class*=creative]):not([class*=theming]):not([class*=poster])"
            "{background-color:#000!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}"
                        /* v7.0.21 probe-proven cXVhZ product images ship with mix-blend-mode:multiply.\n             * Normalize only those actual Home product-media leaves before placing them on OLED black. */\n            ":is(#gwm-PageContent,#gwm-Deck,#gwm-Deck-btf) img.a-amazon-image[class*=cXVhZ][class*=asin-image]"\n            "{mix-blend-mode:normal!important;background-color:transparent!important;}"\n/* Creative/media protection: protect actual art/media, not entire NPACK/GWM/cXVhZ product-card families. */
...
// v7.0.21: probe-proven visible bottom-nav fill.
// Background only: do not alter ANXTabBarButton images, tint, renderingMode,
// selected state, labels, or accessibility/symbology.
%hook ANXTabBarView
- (void)didMoveToWindow {
    %orig;
    ADOwnBottomBar708((UIView *)self);
