...
static NSString *ADFixesLiteral(void){
    ...
    return [NSString stringWithFormat:
            @"{css:'"
             ...
             "{mix-blend-mode:normal !important;isolation:auto !important;}"
             "',invert:[],ignoreInlineStyle:['[class*=puis-heart-position]','[class*=puis-heart-position] *','[class*=lists-framework-action-button]','[class*=lists-framework-action-button] *','[class*=mlt-icon-'+'container]','[class*=mlt-icon-'+'container] *','[class*=a-check'+'box]','[class*=a-check'+'box] *',"
...
"if(!(function(x){try{return x.closest&&x.closest('[class*=a-cardui-header],[class*=sponsored-products],[class*=hybrid-widget-sponsored],[class*=adFeedbackMainComponent]');}catch(e){return false;}})(e2)){"
         ...
         "if(window.top!==window){try{"
           ...
           "window.__AMZDARK_ADTAME__=function(){try{"
             ...
             "for(var i=0;i<M.length&&i<220;i++){var e=M[i],r=e.getBoundingClientRect();"
               ...
               "if(String(e.tagName||'').toUpperCase()!=='VIDEO')e.style.setProperty('filter','brightness('+bb+') saturate(1.08)','important');"
         ...
         "function sym414(){window.__AD_SYM414__='css418';}"  // v5.418: CSS owns the controls now
         "try{var _sp414=window.__AMZDARK_ADTHEME__;"
           "window.__AMZDARK_ADTHEME__=function(){"
             "var r=_sp414?_sp414.apply(this,arguments):undefined;try{sym414();}catch(x){}return r;};"
         "}catch(e){}"
         ...
         "}catch(e){}"
             ...
             "var DB=document.querySelectorAll(SEL),ndisc=0,dskip=0;"
             "var SAMP=[];"
             "for(var db=0;db<DB.length&&db<160;db++){var de=DB[db];"
               "try{if(SAMP.length<6){var sr=de.getBoundingClientRect();"
                 "SAMP.push(String(de.className||'').replace(/\\s+/g,'.').slice(0,18)+'@'+Math.round(sr.width)+'x'+Math.round(sr.height));}}catch(_){}"
               "var dc=String(de.className||'');"
               "if(/glyph/.test(dc)){dskip++;continue;}"
               ...
               "var sq=/a-check/.test(dc)&&!/a-icon-check/.test(dc);"
               // v5.427: Amazon mounts the Heart's lists-framework root at 32x0
               // inside a square wrapper which can also carry a-checkbox.  That
               // wrapper is structural, not the Compare control.  Never paint it
               // as a square: doing so creates the box behind the real round Heart.
               "var hs=de.querySelector&&de.querySelector('[class*=lists-framework-action-'+'button],[class*=puis-heart-position]');"
               "var rc=!!(de.querySelector&&de.querySelector('input[type=check'+'box],[class*=a-icon-check'+'box]'));"
               "if(hs&&!rc&&!/mlt-icon-container/.test(dc)){de.setAttribute('data-ad-heart-shell427','1');"
                 "['data-ad-disc420','data-ad-sym413','data-ad-stock403','data-ad-stocksel403','data-ad-v333403','data-ad-product391','data-ad-productselected391'].forEach(function(a){de.removeAttribute(a);});"
                 "de.style.setProperty('background-color','transparent','important');"
                 "de.style.setProperty('border','0','important');"
                 "de.style.setProperty('border-radius','0','important');"
                 "de.style.setProperty('box-shadow','none','important');"
                 "de.style.setProperty('outline','none','important');dskip++;continue;}"
               "if(sq){dskip++;continue;}"
               "de.setAttribute('data-ad-disc420',sq?'checkbox':'disc');"
               "de.style.setProperty('background-color','#181a1b','important');"
               "de.style.setProperty('border-radius',(sq?'4px':'50%%'),'important');"
               ...
               "var GG=de.querySelectorAll('*');"
               "for(var gi=0;gi<GG.length&&gi<16;gi++){var ge=GG[gi];"
                 "if(ge.matches&&ge.matches(SEL)){continue;}"
                 "ge.style.setProperty('background-color','transparent','important');"
                 "ge.style.setProperty('border','0','important');"
                 "ge.style.setProperty('box-shadow','none','important');"
                 "var gr=ge.getBoundingClientRect();"
                 "if(gr.width>48||gr.height>48)continue;"
                 "var gt=String(ge.tagName||'').toUpperCase();"
                 "if(gt==='IMG'||gt==='I'||gt==='P')"
                   "ge.style.setProperty('filter','brightness(0) invert(1)','important');"
                 "ge.__adBy='disc420';"
                 "ge.style.setProperty('color','#ffffff','important');"
                 "ge.style.setProperty('fill','#ffffff','important');}"
               "ndisc++;}"
             "window.__AD_DISC419__='on='+ndisc+' skipped='+dskip+' cand='+DB.length;"
             "window.__AD_DISC420SEEN__=SAMP.slice(0,6).join(' ');"
           "}catch(e){window.__AD_DISC419__='err '+e;}}"
           "try{var _pv419=window.__AMZDARK_ADTHEME__;"
             "window.__AMZDARK_ADTHEME__=function(){"
               "var r=_pv419?_pv419.apply(this,arguments):undefined;try{disc419();}catch(x){}return r;};"
           "}catch(e){}"
...
"+(window.__AD_DISC419__?(' DISC420['+window.__AD_DISC419__+']'):' DISC420[never-ran]')"
"+(window.__AD_DISC420SEEN__?(' D420SEEN['+window.__AD_DISC420SEEN__+']'):'')"
         ...
         "window.__AD_PRODUCTCTRL391RUN__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           ...
           "window.__AD_CARDS391_DISABLED408__=1;var A=[];/* cards are owned only by the historical clr() ACTION-BUTTON DISC */"
           ...
           // v5.434 Compare: this product-control painter has no checkbox branch.
           // Amazon owns the host, dimensions, interaction, blue sprite and checkmark.
         ...
         "window.__AD_SYMBOL333397__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           ...
           // v5.408: cards host paint is owned solely by the literal historical clr() ACTION-BUTTON DISC above.
           "var ndisc397=0,dskip397=0;"
         ...
         // v5.433: keep the passive v5.333 family attribution for the non-checkbox
         // icons, but permanently retire the stock403 checkbox capture/finalizer.
         "window.__AD_STOCKCAP403__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;var H=document.querySelectorAll('[data-ad-product391]'),n=0;for(var i=0;i<H.length&&i<96;i++){var h=H[i],t=String(h.getAttribute('data-ad-product391')||''),k='';if(t==='heart')k='h';else if(t==='cards')k='d';else if(t==='arrow')k='a';else continue;h.setAttribute('data-ad-v333403',k);n++;}window.__AD_STOCKCAP403_STATE__='n='+n+' checkbox=retired433';return n;}catch(e){window.__AD_STOCKCAP403_STATE__='err '+(e&&e.message||e);return -1;}};"
         ...
         "try{var s403=document&&document.getElementById('adstock403');if(s403&&s403.parentNode)s403.parentNode.removeChild(s403);}catch(e){}"
         // v5.427 HEART SHELL: the on-device attribution
         ...
         "window.__AD_HEARTSHELL427__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           ...
           "function own427(e){return e.hasAttribute('data-ad-stock403')||e.hasAttribute('data-ad-stocksel403')||e.getAttribute('data-ad-v333403')==='c'||e.getAttribute('data-ad-product391')==='checkbox'||e.hasAttribute('data-ad-compare380')||e.hasAttribute('data-ad-comparelegacy387')||e.getAttribute('data-ad-disc420')==='checkbox'||e.getAttribute('data-ad-sym413')==='checkbox';}"
           "function flat427(e){e.setAttribute('data-ad-heart-shell427','1');e.__adBy='heartShell427';"
             "['data-ad-stock403','data-ad-stocksel403','data-ad-v333403','data-ad-product391','data-ad-productselected391','data-ad-compare378','data-ad-compare379','data-ad-compare380','data-ad-comparelegacy387','data-ad-disc420','data-ad-sym413','data-ad-v333404'].forEach(function(a){e.removeAttribute(a);});/*heart427*/"
           ...
           "var R=document.querySelectorAll('[class*=lists-framework-action-button],[class*=puis-heart-position]'),seen=[],n=0;"
           "for(var i=0;i<R.length&&i<180;i++){var p=R[i].parentElement,d=0;while(p&&d++<4){"
             ...
             "if(geom&&(own427(p)||p.hasAttribute('data-ad-heart-shell427'))){"
               "var s=getComputedStyle(p),clean=(String(s.backgroundColor||'').replace(/\\s+/g,'')==='rgba(0,0,0,0)'||String(s.backgroundColor||'')==='transparent')&&parseFloat(s.borderTopWidth||0)<.1&&String(s.boxShadow||'none')==='none';"
               "if(!clean||own427(p)||!p.hasAttribute('data-ad-heart-shell427'))flat427(p);n++;}"
             "p=p.parentElement;}}"
         ...
         // preserved v5.397/v5.333 action-button path is its sole final owner. Checkbox is
         // intentionally untouched.
         "window.__AD_V333FIX404__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;var seen=[],hc=0,dc=0,ac=0,gc=0;function rr(e){try{return e&&e.getBoundingClientRect?e.getBoundingClientRect():null;}catch(x){return null;}}function sq(e,lo,hi){var r=rr(e);return !!(r&&r.width>=lo&&r.width<=hi&&r.height>=lo&&r.height<=hi&&Math.abs(r.width-r.height)<=8);}function structural(e){return !!(e&&e.nodeType===1&&!/^(IMG|I|INPUT|SVG|PATH|USE|POLYGON)$/.test(String(e.tagName||'').toUpperCase()));}function cleanmarks(e){['data-ad-product391','data-ad-productselected391','data-ad-stockaction378','data-ad-stockaction379','data-ad-stockaction380','data-ad-stockaction382','data-ad-stockaction384','data-ad-stockaction387','data-ad-stockroot388','data-ad-stockdisc388','data-ad-actionhost375','data-ad-actionhost376','data-ad-heartready394'].forEach(function(a){e.removeAttribute(a);});}function paint(h){var G=h.querySelectorAll('img,i,svg,path,use,polygon,span[class*=icon],div[class*=icon],[class*=unfill],[class*=fill],[class*=a-icon]');for(var j=0;j<G.length&&j<96;j++){var g=G[j],r=rr(g);if(r&&(r.width<3||r.height<3||r.width>52||r.height>52))continue;['data-ad-productglyph391','data-ad-productraster391','data-ad-productvector391','data-ad-stockglyph379','data-ad-stockglyph380','data-ad-stockglyph382','data-ad-stockglyph384','data-ad-stockglyph387','data-ad-heartbefore393','data-ad-heartafter393','data-ad-heartbeforemask393','data-ad-heartaftermask393','data-ad-heartbeforeraster393','data-ad-heartafterraster393'].forEach(function(a){g.removeAttribute(a);});var tg=String(g.tagName||'').toUpperCase(),cs=getComputedStyle(g),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none');g.style.setProperty('background-color','transparent','important');if(tg==='SVG'||tg==='PATH'||tg==='USE'||tg==='POLYGON'){g.style.setProperty('color','#ffffff','important');g.style.setProperty('fill','#ffffff','important');g.style.setProperty('stroke','#ffffff','important');g.setAttribute('data-ad-v333vector404','1');gc++;}else if(tg==='IMG'||tg==='I'||bi!=='none'||mi!=='none'){g.setAttribute('data-ad-v333raster404','1');g.__adGlyph=1;g.__adBy='v333404';gc++;}}}function own(h,k){if(!h||seen.indexOf(h)>=0||!sq(h,18,52))return 0;seen.push(h);h.setAttribute('data-ad-v333404',k);cleanmarks(h);['background','background-color','border','border-color','border-width','border-style','border-radius','box-shadow','box-sizing','filter','width','height','min-width','min-height','max-width','max-height'].forEach(function(q){h.style.removeProperty(q);});h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('border-radius','50%%','important');h.style.setProperty('border','1.5px solid rgba(255,255,255,0.65)','important');h.style.setProperty('box-shadow','none','important');h.style.setProperty('box-sizing','border-box','important');paint(h);var p=h.parentElement,d=0;while(p&&d++<2){var pr=rr(p);if(pr&&pr.width<=64&&pr.height<=64){p.style.setProperty('background-color','transparent','important');p.style.setProperty('border','0','important');p.style.setProperty('box-shadow','none','important');}p=p.parentElement;}return 1;}var HR=document.querySelectorAll('[class*=puis-heart-position]');for(var hi=0;hi<HR.length&&hi<180;hi++){var root=HR[hi],Q=root.querySelectorAll('button,[role=button],a,span,div'),best=null,bd=999;for(var qi=0;qi<Q.length&&qi<120;qi++){var q=Q[qi];if(!sq(q,24,48)||!structural(q))continue;var r=rr(q),art=q.querySelector&&q.querySelector('img,i,svg,[class*=a-icon],[class*=heart],[class*=wish],[class*=favor]'),cs=getComputedStyle(q),self=String(cs.backgroundImage||'none')!=='none'||String(cs.maskImage||cs.webkitMaskImage||'none')!=='none';if(!art&&!self)continue;var d=Math.abs(Math.max(r.width,r.height)-34);if(d<bd){bd=d;best=q;}}if(!best&&sq(root,24,48))best=root;if(best&&own(best,'h')){root.style.setProperty('background-color','transparent','important');root.style.setProperty('border','0','important');root.style.setProperty('box-shadow','none','important');hc++;}}var E=document.querySelectorAll('[class*=a-icon-dropdown],[class*=a-icon-extender],[class*=chevron],[class*=caret],[class*=arrow]');for(var ai=0;ai<E.length&&ai<600;ai++){var eg=E[ai];if(eg.closest&&eg.closest('[class*=puis-heart-position],[class*=lists-framework-action-button]'))continue;var card=eg.closest&&eg.closest('[class*=puis-card],[class*=s-result-item],[data-asin],[class*=s-product-image],[class*=product-image]');if(!card)continue;var cl=String(eg.className&&eg.className.baseVal!==undefined?eg.className.baseVal:(eg.className||''));if(/carousel|next|previous|prev/i.test(cl))continue;var p=eg,best=null,bd=999,u=0;while(p&&u++<7){if(structural(p)&&sq(p,22,48)){var r=rr(p),d=Math.abs(Math.max(r.width,r.height)-34);if(d<bd){bd=d;best=p;}}if(p===card)break;p=p.parentElement;}if(best&&own(best,'a'))ac++;}window.__AD_V333FIX404_STATE__='heart='+hc+' cards='+dc+' arrow='+ac+' glyph='+gc;return hc+dc+ac;}catch(e){window.__AD_V333FIX404_STATE__='err '+(e&&e.message||e);return -1;}};"
         "try{window.__AD_PRODUCTCTRL391_PRE404__=window.__AD_PRODUCTCTRL391RUN__;window.__AD_PRODUCTCTRL391RUN__=function(){var r=window.__AD_PRODUCTCTRL391_PRE404__?window.__AD_PRODUCTCTRL391_PRE404__():0;try{window.__AD_V333FIX404__();}catch(x){}return r;};}catch(e){}"
         "try{if(document&&!document.getElementById('adv333404')){var s404=document.createElement('style');s404.id='adv333404';s404.textContent='[data-ad-v333404]{background-color:#181a1b !important;border-radius:50%% !important;border:1.5px solid rgba(255,255,255,.65) !important;box-shadow:none !important;box-sizing:border-box !important;}[data-ad-v333404]::before,[data-ad-v333404]::after{border-color:#fff !important;color:#fff !important;}[data-ad-v333404] img,[data-ad-v333404] i,[data-ad-v333404] svg,[data-ad-v333404] path,[data-ad-v333404] use,[data-ad-v333404] polygon{background-color:transparent !important;}[data-ad-v333vector404],[data-ad-v333vector404] *{color:#fff !important;fill:#fff !important;stroke:#fff !important;}[data-ad-v333raster404]{filter:brightness(0) invert(1) !important;}';(document.head||document.documentElement).appendChild(s404);}}catch(e){}"
         // v5.410 TWO-CARDS: P77 proved the literal v5.333 root-only disc sees
         // 14 mounted lists roots but zero icon-sized roots. Keep the stock Amazon glyph,
         // resolve its actual current-DOM paint leaf, but never use that paint leaf as
         // the disc host. Use a square ancestor or the proven 36px backdrop-only disc.
         // Force the real stock glyph white inline-important so product-photo shielding
         // cannot turn it black. Strong cards seeds
         // that collide with Compare are suppressed so they can never paint inside it.
         "window.__AD_CARDS410__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;function cn(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}function rr(e){try{return e&&e.getBoundingClientRect?e.getBoundingClientRect():null;}catch(x){return null;}}function cb(e){try{return !!(e&&e.closest&&e.closest('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[class*=a-icon-checkbox],[data-ad-compare380],[data-ad-comparelegacy387],[data-ad-product391=\"checkbox\"]'));}catch(x){return false;}}function pseudo(e,w){try{var c=getComputedStyle(e,w),bi=String(c.backgroundImage||'none'),mi=String(c.maskImage||c.webkitMaskImage||'none'),ct=String("
         "c.content||'none');if(mi!=='none')return 'mask';if(bi!=='none')return 'raster';if(ct&&ct!=='none'&&ct!=='normal'&&ct!='\"\"')return 'ink';}catch(x){}return '';}var C=document.querySelectorAll('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[class*=a-icon-checkbox],[data-ad-compare380],[data-ad-comparelegacy387],[data-ad-product391=\"checkbox\"]'),CR=[];for(var cx=0;cx<C.length&&cx<320;cx++){try{var Z=C[cx].querySelectorAll('[data-ad-cards410-disc],[data-ad-cards410-host],[data-ad-cards410-glyph]');for(var cz=0;cz<Z.length;cz++){var z=Z[cz];if(z.hasAttribute('data-ad-cards410-disc')){if(z.parentNode)z.parentNode.removeChild(z);continue;}if(z.hasAttribute('data-ad-cards410-host')){['background-color','background-image','border','border-radius','box-shadow','box-sizing'].forEach(function(k){z.style.removeProperty(k);});}if(z.hasAttribute('data-ad-cards410-glyph')){['filter','color','fill','stroke','background-color','visibility','opacity','z-index','position'].forEach(function(k){z.style.removeProperty(k);});}['data-ad-cards410-host','data-ad-cards410-glyph','data-ad-cards410-raster','data-ad-cards410-mask','data-ad-cards410-vector','data-ad-cards410-before','data-ad-cards410-after','data-ad-cards410-suppressed'].forEach(function(a){z.removeAttribute(a);});}}catch(x){}}for(var ci=0;ci<C.length&&ci<320;ci++){var q=rr(C[ci]);if(q&&q.width>=8&&q.width<=64&&q.height>=8&&q.height<=64)CR.push(q);}function ovxy(x,y){for(var i=0;i<CR.length;i++){var q=CR[i],qx=q.left+q.width/2,qy=q.top+q.height/2;if(Math.abs(x-qx)<19&&Math.abs(y-qy)<19)return 1;}return 0;}function ovr(e){var r=rr(e);if(!r)return 0;"
         "var x=r.left+r.width/2,y=r.top+r.height/2;if(ovxy(x,y))return 1;for(var i=0;i<CR.length;i++){var q=CR[i],ix=Math.max(0,Math.min(r.right,q.right)-Math.max(r.left,q.left)),iy=Math.max(0,Math.min(r.bottom,q.bottom)-Math.max(r.top,q.top));if(ix*iy>Math.min(r.width*r.height,q.width*q.height)*.22)return 1;}return 0;}function strong(e){if(!e||cb(e))return -1;var r=rr(e);if(!r||r.width<4||r.height<4||r.width>48||r.height>48)return -1;var tg=String(e.tagName||'').toUpperCase(),c=cn(e),src=String(e.currentSrc||e.src||''),cs=getComputedStyle(e),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none'),pb=pseudo(e,'::before'),pa=pseudo(e,'::after'),sc=0;if(/lists-framewo"
         "rk-(?:unfill|fill)/i.test(c))sc+=100;if(/01rrzVoKd5L|01rrz/i.test(src))sc+=100;if(/lists-framework/i.test(c)&&/(icon|image|add|list|action|button)/i.test(c))sc+=55;else if(/cards|two-card|list|add|plus|action/i.test(c))sc+=34;if(/^(IMG|I|SVG|PATH|USE|POLYGON)$/.test(tg))sc+=10;if(bi!=='none'||mi!=='none')sc+=12;if(pb||pa)sc+=10;if(/checkbox|heart|wish|favorite|chevron|arrow|caret/i.test(c+' '+src))sc-=100;return sc;}function squareHost(root,g){var p=g&&g.parentElement,b=null,bd=1e9,u=0;while(p&&u++<7){if(!cb(p)){var r=rr(p),tg=String(p.tagName||'').toUpperCase();if(r&&!/^(IMG|I|INPUT|SVG|PATH|USE|POLYGON)$/.test(tg)&&r.width>=24&&r.width<=56&&r.height>=24&&r.height<=56&&Math.abs(r.width-r.height)<=10&&!ovr("
         "p)){var d=Math.abs(Math.max(r.width,r.height)-36);if(d<bd){bd=d;b=p;}}}if(p===root)break;p=p.parentElement;}return b;}function markGlyph(g){if(!g||cb(g))return 0;var tg=String(g.tagName||'').toUpperCase(),cs=getComputedStyle(g),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none'),pb=pseudo(g,'::before'),pa=pseudo(g,'::after'),n=0;g.setAttribute('data-ad-cards410-glyph','1');g.style.setProperty('position','relative','important');g.style.setProperty('z-index','2','important');g.style.setProperty('visibility','visible','important');g.style.setProperty('opacity','1','important');if(/^(SVG|PATH|USE|POLYGON)$/.test(tg)){g.style.setProperty('color','#fff','important');g.style.setProperty('fill','#fff','important');g.style.setProperty('stroke','#fff','important');g.style.setProperty('filter','none','important');g.setAttribute('data-ad-cards410-vector'"
         ",'1');n++;}else if(mi!=='none'){g.style.setProperty('background-color','#fff','important');g.style.setProperty('color','#fff','important');g.style.setProperty('filter','none','important');g.setAttribute('data-ad-cards410-mask','1');n++;}else if(tg==='IMG'||tg==='I'||bi!=='none'){g.style.setProperty('filter','brightness(0) invert(1)','important');g.__adBy='cards410';g.style.setProperty('background-color','transparent','important');g.setAttribute('data-ad-cards410-raster','1');n++;}if(pb){g.setAttribute('data-ad-cards410-before',pb);n++;}if(pa){g.setAttribute('data-ad-cards410-after',pa);n++;}return n;}function suppress(g){if(!g)return;g.setAttribute('data-ad-cards410-suppressed','1');}function unsuppress(g){if(g)g.removeAttribute('data-ad-cards410-suppressed');}var R=document.querySelectorAll('[class*=lists-framework-action-button]'),roots=0,seeds=0,hosts=0,discs=0,glyphs=0,miss=0,cbskip=0,ovskip=0,hidden=0,live=[];for(var ri=0;ri<R.length&&ri<140;ri++){var root=R[ri];if(cb(root)){cbskip++;co"
         "ntinue;}var A=[root],Q=root.querySelectorAll('*');for(var qi=0;qi<Q.length&&qi<180;qi++)A.push(Q[qi]);var best=null,bs=-1;for(var ai=0;ai<A.length&&ai<181;ai++){var sc=strong(A[ai]);if(sc>bs){bs=sc;best=A[ai];}}if(!best||bs<30){miss++;continue;}seeds++;var gr=rr(best);if(!gr){miss++;continue;}var gx=gr.left+gr.width/2,gy=gr.top+gr.height/2;if(ovxy(gx,gy)||ovr(best)){if(bs>=80){suppress(best);hidden++;}ovskip++;continue;}unsuppress(best);roots++;live.push(root);var h=squareHost(root,best);if(h){h.setAttribute('data-ad-cards410-host','1');h.style.setProperty('background-color','#181a1b','important');h.style.setProperty('background-image','none','important');h.style.setProperty('border-radius',"
         "'50%%','important');h.style.setProperty('border','1.5px solid rgba(255,255,255,.65)','important');h.style.setProperty('box-shadow','none','important');h.style.setProperty('box-sizing','border-box','important');hosts++;}else{var rr0=rr(root);if(!rr0){miss++;continue;}root.setAttribute('data-ad-cards410-root','1');root.style.setProperty('position','relative','important');root.style.setProperty('overflow','visible','important');var d=root.querySelector(':scope > [data-ad-cards410-disc]');if(!d){d=document.createElement('span');d.setAttribute('data-ad-cards410-disc','1');d.setAttribute('aria-hidden','true');root.insertBefore(d,root.firstChild);}var relx=gx-rr0.left,rely=gy-rr0.top;d.style.setProp"
         "erty('left',(relx-18)+'px','important');d.style.setProperty('top',(rely-18)+'px','important');discs++;}glyphs+=markGlyph(best);}var OD=document.querySelectorAll('[data-ad-cards410-disc]');for(var oi=0;oi<OD.length;oi++){var pr=OD[oi].parentElement;if(!pr||live.indexOf(pr)<0){if(OD[oi].parentNode)OD[oi].parentNode.removeChild(OD[oi]);}}window.__AD_CARDS410_STATE__='roots='+R.length+' seeds='+seeds+' owned='+roots+' hosts='+hosts+' discs='+discs+' glyph='+glyphs+' hiddenOverlap='+hidden+' miss='+miss+' cbskip='+cbskip+' ovskip='+ovskip;return roots;}catch(e){window.__AD_CARDS410_STATE__='err '+(e&&e.message||e);return -1;}};try{if(document&&!document.getElementById('adcards410')){var c=doc"
         "ument.createElement('style');c.id='adcards410';c.textContent='[data-ad-cards410-host]{background-color:#181a1b !important;background-image:none !important;border-radius:50%% !important;border:1.5px solid rgba(255,255,255,.65) !important;box-shadow:none !important;box-sizing:border-box !important;}[data-ad-cards410-disc]{position:absolute !important;width:36px !important;height:36px !important;border-radius:50%% !important;background:#181a1b !important;border:1.5px solid rgba(255,255,255,.65) !important;box-shadow:none !important;box-sizing:border-box !important;pointer-events:none !important;z-index:1 !important;}[data-ad-cards410-glyph]{background-color:transparent !important;}[data-ad-cards4"
         "10-raster]{filter:brightness(0) invert(1) !important;background-color:transparent !important;opacity:1 !important;visibility:visible !important;}[data-ad-cards410-mask]{background-color:#fff !important;color:#fff !important;opacity:1 !important;visibility:visible !important;}[data-ad-cards410-vector],[data-ad-cards410-vector] *{color:#fff !important;fill:#fff !important;stroke:#fff !important;opacity:1 !important;visibility:visible !important;}[data-ad-cards410-before=\"raster\"]::before,[data-ad-cards410-after=\"raster\"]::after{filter:brightness(0) invert(1) !important;}[data-ad-cards410-before=\"mask\"]::before,[data-ad-cards410-after=\"mask\"]::after{background-color:#fff !important;color:#fff !"
         "important;}[data-ad-cards410-before=\"ink\"]::before,[data-ad-cards410-after=\"ink\"]::after{color:#fff !important;border-color:#fff !important;}[data-ad-cards410-suppressed]{visibility:hidden !important;opacity:0 !important;}[data-ad-cards410-suppressed]::before,[data-ad-cards410-suppressed]::after{visibility:hidden !important;opacity:0 !important;}';(document.head||document.documentElement).appendChild(c);}}catch(e){}try{window.__AD_PRODUCTCTRL391_PRE410__=window.__AD_PRODUCTCTRL391RUN__;window.__AD_PRODUCTCTRL391RUN__=function(){var r=window.__AD_PRODUCTCTRL391_PRE410__?window.__AD_PRODUCTCTRL391_PRE410__():0;try{window.__AD_CARDS410__();}catch(x){}return r;};}catch(e){}try{window.__AD_CARD"
         "S410__();setTimeout(window.__AD_CARDS410__,60);setTimeout(window.__AD_CARDS410__,300);setTimeout(window.__AD_CARDS410__,1200);}catch(e){}"
         ...
         // Heart, checkbox and arrow remain on their already-confirmed current paths.
         // v5.404: COLLEGE PANE -- heading-derived owner, not the previously measured
         // descendant. Find the exact Off to College heading, walk upward to the smallest
         // full-width pane that actually contains its carousel imagery, then neutralize
         // only structural paint on that pane. This fixes the visible darker slab while
         // leaving product imagery/text untouched.
         "window.__AD_COLLEGE404__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;function appbg(){var A=[document.body,document.documentElement];for(var z=0;z<A.length;z++){if(!A[z])continue;var c=String(getComputedStyle(A[z]).backgroundColor||'').replace(/\\s+/g,'');if(c&&c!=='transparent'&&c!=='rgba(0,0,0,0)')return c;}return 'rgb(24,26,27)';}var Q=document.querySelectorAll('h1,h2,h3,h4,span,div'),H=null;for(var q=0;q<Q.length&&q<3500;q++){var e=Q[q];if(e.children&&e.children.length>6)continue;var t=String(e.textContent||'').replace(/\\s+/g,' ').trim().toLowerCase();if(t==='off to college'){H=e;break;}}if(!H){window.__AD_COLLEGE404_STATE__='heading=0';return 0;}var vw=innerWidth||390,bg=appbg(),P=H.parentElement,pane=null,d=0;while(P&&d++<9){var r=P.getBoundingClientRect(),imgs=P.querySelectorAll?P.querySelectorAll('img,picture'):[];if(r.width>=vw*.88&&r.height>=150&&r.height<=760&&imgs.length>=2){pane=P;break;}P=P.parentElement;}if(!pane){window.__AD_COLLEGE404_STATE__='heading=1 pane=0';return 0;}pane.setAttribute('data-ad-college404','1');pane.style.setProperty('--ad-college404-bg',bg);var R=pane.getBoundingClientRect(),K=pane.querySelectorAll('div,section,article,ul,ol'),struct=0;for(var i=0;i<K.length&&i<260;i++){var k=K[i],kr=k.getBoundingClientRect();if(kr.width<R.width*.90||kr.height<R.height*.55)continue;var cs=getComputedStyle(k),bi=String(cs.backgroundImage||'none');if(bi.indexOf('url(')>=0)continue;k.setAttribute('data-ad-college404-struct','1');k.style.setProperty('--ad-college404-bg',bg);struct++;}window.__AD_COLLEGE404_STATE__='heading=1 pane=1 struct='+struct+' '+Math.round(R.width)+'x'+Math.round(R.height)+' bg='+bg;return 1+struct;}catch(e){window.__AD_COLLEGE404_STATE__='err '+(e&&e.message||e);return -1;}};"
         "try{if(document&&!document.getElementById('adcollege404')){var c404=document.createElement('style');c404.id='adcollege404';c404.textContent='[data-ad-college404],[data-ad-college404-struct]{background-color:var(--ad-college404-bg,#181a1b) !important;background-image:none !important;filter:none !important;mix-blend-mode:normal !important;opacity:1 !important;}[data-ad-college404]::before,[data-ad-college404]::after,[data-ad-college404-struct]::before,[data-ad-college404-struct]::after{background-color:var(--ad-college404-bg,#181a1b) !important;background-image:none !important;filter:none !important;mix-blend-mode:normal !important;}';(document.head||document.documentElement).appendChild(c404);}}catch(e){}"
         // v5.404: BLEED -- P66=seen=0 proved the old descendant selector never owned
         // the live painter. Query the actual theming-card-background leaves directly,
         // geometry-gate to the observed 299x478 / 325x466 Home cards, and contain PAINT
    ...
    return
       ...
       "try{(function(){"
         ...
         "function sym413(){try{"
           ...
           "function cn(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}"
           "function sq(e){var r=e.getBoundingClientRect();"
         ...
         // v5.434 STOCK CHECKBOX: Amazon still owns state, hit testing, geometry,
         // and the checked blue/checkmark sprite.  v5.433 recognized only the classic
         // a-checkbox > a-icon-checkbox shape, which covered Cart but missed recycled
         // search-result rows that expose a native input/role/background-art variant.
         // One stock art node per control is inverted only while unchecked.  Cart's
         // separate square tap shell is merely neutralized so it cannot draw the gray
         // box visible in the device screenshots; no width/height/position is changed.
         "function stockCheckbox434(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           ...
           "function group434(e){if(!e||!scope434(e)||foreign434(e))return null;var t0=String(e.tagName||'').toUpperCase(),explicit0=t0==='INPUT'||(e.matches&&e.matches('div.a-checkbox,[class~=a-checkbox],[role=checkbox]'));if(!explicit0&&e.querySelector){var d0=e.querySelector('div.a-checkbox,[class~=a-checkbox],input[type=checkbox],[role=checkbox]');if(d0)e=d0;}var p=e,best=null,u=0;while(p&&u++<7){if(foreign434(p))return null;var tg=String(p.tagName||'').toUpperCase();if(p.matches&&p.matches('div.a-checkbox,[class~=a-checkbox],[role=checkbox]'))return p;if(!best&&!/^(IMG|I|INPUT|SVG|PATH|USE|POLYGON)$/.test(tg)&&sq434(p,16,72))best=p;if(p.matches&&p.matches(scopeSel434))break;p=p.parentElement;}return best||((String(e.tagName||'').toUpperCase()==='INPUT')?e:(e.parentElement||e));}"
           "function selected434(h){try{var q=(h.matches&&h.matches('input[type=checkbox]'))?h:h.querySelector('input[type=checkbox]');if(q)return !!q.checked;var A=[h],Z=h.querySelectorAll?h.querySelectorAll('[role=checkbox],[aria-checked],[data-checked],[data-selected]'):[];for(var i=0;i<Z.length&&i<24;i++)A.push(Z[i]);for(var j=0;j<A.length;j++){var e=A[j],a=String(e.getAttribute('aria-checked')||e.getAttribute('data-checked')||e.getAttribute('data-selected')||'').toLowerCase(),c=cn434(e).toLowerCase();if(a==='true'||/(^|[ _-])(checked|selected|active)([ _-]|$)/.test(c))return true;if(a==='false')return false;}var im=h.querySelector&&h.querySelector('img[src],img[data-src]'),src=im?String(im.currentSrc||im.src||im.getAttribute('data-src')||'').toLowerCase():'';return /checkbox[_-]?(?:on|checked)|checkmark|selected/.test(src);}catch(x){return false;}}"
           "function art434(h,seed){try{var Q=[h],D=h.querySelectorAll?h.querySelectorAll('*'):[];for(var q=0;q<D.length&&q<80;q++)Q.push(D[q]);if(Q.indexOf(seed)<0)Q.push(seed);var best=null,bs=9999;for(var i=0;i<Q.length;i++){var e=Q[i];if(!e||foreign434(e))continue;var r=rr434(e);if(!r||r.width<8||r.height<8||r.width>76||r.height>76)continue;var tg=String(e.tagName||'').toUpperCase();if(/^(PATH|USE|POLYGON)$/.test(tg))continue;var c=cn434(e).toLowerCase(),src=String((e.currentSrc||e.src||(e.getAttribute&&e.getAttribute('data-src'))||'')).toLowerCase(),cs=getComputedStyle(e),bf=getComputedStyle(e,'::before'),af=getComputedStyle(e,'::after'),bi=String(cs.backgroundImage||'none'),mi=String(cs.maskImage||cs.webkitMaskImage||'none'),pbi=String((bf&&bf.backgroundImage)||'none')+' '+String((af&&af.backgroundImage)||'none'),pmi=String((bf&&(bf.maskImage||bf.webkitMaskImage))||'none')+' '+String((af&&(af.maskImage||af.webkitMaskImage))||'none'),op=parseFloat(cs.opacity||'1'),exact=/a-icon-checkbox|checkbox[-_ ]?(?:icon|sprite|image)|checkmark|check-mark|tick/.test(c+' '+src),painted=bi!=='none'||mi!=='none'||pbi!=='none none'||pmi!=='none none',role=e.getAttribute&&e.getAttribute('role')==='checkbox',score=999;if(exact)score=0;else if(painted)score=20;else if(/^(I|IMG|SVG)$/.test(tg))score=35;else if(tg==='INPUT'&&String(e.type||'').toLowerCase()==='checkbox')score=op<.15?80:45;else if(role)score=60;else if(e===seed)score=90;else continue;if(e===h)score+=30;score+=(r.width*r.height)/100000;if(score<bs){bs=score;best=e;}}return best||(sq434(seed,8,76)?seed:(sq434(h,8,76)?h:null));}catch(x){return null;}}"
           "var live434=[],shells434=[],hosts434=[],unchecked434=0,checked434=0,cleaned434=0,skip434=0,cartShell434=0;"
           "function shell434(h,art){if(!cart434||!h||!art)return;var p=(h===art?h.parentElement:h),u=0;while(p&&u++<3){if(p!==art&&p.contains&&p.contains(art)&&sq434(p,18,76)&&!/^(IMG|I|INPUT|SVG|PATH|USE)$/.test(String(p.tagName||'').toUpperCase())){p.setAttribute('data-ad-checkbox434-shell','cart');shells434.push(p);cartShell434++;}p=p.parentElement;}}"
           "var C=document.querySelectorAll('input[type=checkbox],[role=checkbox],[aria-checked],[class*=a-checkbox],[class*=a-icon-checkbox],[class*=checkbox],img[src*=checkbox],img[data-src*=checkbox]');"
           "for(var i=0;i<C.length&&i<900;i++){var seed=C[i],h=group434(seed);if(!h||hosts434.indexOf(h)>=0){skip434++;continue;}var art=art434(h,seed);if(!art){skip434++;continue;}hosts434.push(h);var syn=h.querySelectorAll?h.querySelectorAll('[data-ad-comparebox377],[data-ad-comparecheck377]'):[];for(var sy=0;sy<syn.length;sy++){if(syn[sy].parentNode)syn[sy].parentNode.removeChild(syn[sy]);cleaned434++;}var Q=[h],D=h.querySelectorAll?h.querySelectorAll('*'):[];for(var q=0;q<D.length&&q<120;q++)Q.push(D[q]);for(var z=0;z<Q.length;z++){cleaned434+=scrub434(Q[z]);Q[z].removeAttribute('data-ad-checkbox433-art');}var on=selected434(h);art.setAttribute('data-ad-checkbox434-art',on?'checked':'unchecked');live434.push(art);shell434(h,art);if(on)checked434++;else unchecked434++;}"
           "var old434=document.querySelectorAll('[data-ad-checkbox434-art]');for(var o=0;o<old434.length;o++)if(live434.indexOf(old434[o])<0)old434[o].removeAttribute('data-ad-checkbox434-art');var oldShell434=document.querySelectorAll('[data-ad-checkbox434-shell]');for(var os=0;os<oldShell434.length;os++)if(shells434.indexOf(oldShell434[os])<0)oldShell434[os].removeAttribute('data-ad-checkbox434-shell');var old433=document.querySelectorAll('[data-ad-checkbox433-art]');for(var x433=0;x433<old433.length;x433++)old433[x433].removeAttribute('data-ad-checkbox433-art');"
           "window.__AD_CHECKBOX434_STATE__='hosts='+hosts434.length+' unchecked='+unchecked434+' checked='+checked434+' cart='+(cart434?1:0)+' shells='+cartShell434+' cleaned='+cleaned434+' skip='+skip434;return hosts434.length;"
         "}catch(e){window.__AD_CHECKBOX434_STATE__='err '+(e&&e.message||e);return -1;}}"
         "try{window.__AD_CHECKBOX434__=stockCheckbox434;if(!window.__AD_CHECKBOX434_WRAP__){window.__AD_CHECKBOX434_WRAP__=1;"
           ...
           "var t434=0;new MutationObserver(function(){clearTimeout(t434);t434=setTimeout(function(){try{window.__AD_CHECKBOX434__();}catch(x){}},25);}).observe(document.documentElement,{childList:true,subtree:true,attributes:true,attributeFilter:['class','style','aria-checked','data-checked','data-selected','checked','src','data-src']});"
           "function event434(e){try{return !!(e&&e.target&&e.target.closest&&e.target.closest('input[type=checkbox],[role=checkbox],[class*=a-checkbox],[class*=a-icon-checkbox],[class*=checkbox]'));}catch(x){return false;}}"
           "document.addEventListener('change',function(e){if(event434(e)){setTimeout(window.__AD_CHECKBOX434__,0);setTimeout(window.__AD_CHECKBOX434__,100);}},true);"
           "document.addEventListener('click',function(e){if(event434(e)){setTimeout(window.__AD_CHECKBOX434__,0);setTimeout(window.__AD_CHECKBOX434__,80);setTimeout(window.__AD_CHECKBOX434__,260);}},true);"
           "addEventListener('scroll',function(){clearTimeout(window.__adCheckboxScroll434);window.__adCheckboxScroll434=setTimeout(window.__AD_CHECKBOX434__,60);},{passive:true,capture:true});}"
         ...
         "/* v5.434: no checkbox state emulation; stockCheckbox434 only observes native state. */"
       "})();}catch(e){}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // P9SYM (v5.412): supersedes the previous MLT probe. Two fixes -- (1)
       // DISCOVERY: finds the four on-image controls by geometry (small,
       // square-ish, over a product image) and reports their REAL class chain,
       // instead of assuming a class name that returned n=0 on device; (2)
       // PERSISTENCE: keeps a session high-water mark in window.__AD_SYM_BEST__
       // and always emits it, so a run while the app is backgrounded or on a
       // page with no controls cannot erase a good earlier observation.
       "try{"
       "  var VS=window.innerHeight||900;"
       "  function cs(e){var c=e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||'')).replace(/\\s+/g,'.').slice(0,30)||e.tagName;}"
       "  function bg(s){var m=/rgba?\\(([0-9.]+),\\s*([0-9.]+),\\s*([0-9.]+)(?:,\\s*([0-9.]+))?\\)/.exec(String(s||''));"
       "    if(!m)return 'none';if(m[4]!==undefined&&+m[4]<0.1)return '0';return m[1]+','+m[2]+','+m[3];}"
       "  function kind(e){"
       "    var c=cs(e).toLowerCase();"
       "    if(/heart|wish|favorite/.test(c))return 'heart';"
       "    if(/checkbox|mlt/.test(c))return 'cbx?';"
       "    if(/chevron|caret|arrow|dropdown|extender/.test(c))return 'chev';"
       "    if(/card|list|plus|add/.test(c))return 'cards?';"
       "    return '?';}"
       "  var seen=[],got=[],H=[];"
       "  var Q=document.querySelectorAll('[class*=product-image] *,[class*=s-product-image] *,[class*=image-container] *,[class*=heart],[class*=wish],[class*=mlt],[class*=checkbox],[class*=lists-framework]');"
       "  for(var i=0;i<Q.length&&H.length<8;i++){var e=Q[i];"
       "    var r=e.getBoundingClientRect();"
       "    if(r.width<14||r.width>60||r.height<14||r.height>60)continue;"
       "    if(Math.abs(r.width-r.height)>10)continue;"
       "    if(r.bottom<0||r.top>VS*2)continue;"
       "    var key=Math.round(r.left)+','+Math.round(r.top);"
       "    if(seen.indexOf(key)>=0)continue;"
       "    var anc=0,pn=e.parentElement,pd=0;"
       "    while(pn&&pd++<4){if(got.indexOf(pn)>=0){anc=1;break;}pn=pn.parentElement;}"
       "    if(anc)continue;"
       "    seen.push(key);got.push(e);"
       "    var s=getComputedStyle(e);"
       "    var inp=e.querySelector('input[type=checkbox]')?1:0;"
       "    var rc=(e.getAttribute('role')==='checkbox'||e.querySelector('[role=checkbox]'))?1:0;"
       "    var svg=e.querySelector('svg,path')?1:0;"
       "    var img=e.querySelector('img')?1:0;"
       "    var par=e.parentElement?cs(e.parentElement):'-';"
       "    var pa=[];['data-ad-'+'compare380','data-ad-'+'comparelegacy387','data-ad-cards410-host','data-ad-cards410-root','data-ad-'+'product391'].forEach(function(a){if(e.hasAttribute(a))pa.push(a.slice(8,20));});"
       "    H.push(kind(e)+'['+Math.round(r.width)+']'+cs(e)+'>'+par+'|inp='+inp+'|role='+rc+'|svg='+svg+'|img='+img+'|bg='+bg(s.backgroundColor)+'|bw='+parseFloat(s.borderTopWidth||0).toFixed(1)+'|by='+(pa.join('+')||'-'));}"
       "  var cur='n='+H.length+(H.length?' '+H.join(' ~~ '):'');"
       "  try{var prev=window.__AD_SYM_BEST__||'';var pn=+(String(prev).match(/^n=(\\d+)/)||[0,0])[1];"
       "    if(H.length>=pn)window.__AD_SYM_BEST__=cur;"
       "    window.__AD_SYM_RUNS__=(window.__AD_SYM_RUNS__||0)+1;}catch(z){}"
       ...
       "function repaint425(){"
       "try{"
         "var SELD='[class*=mlt-icon-'+'container],[class*=lists-framework-action-'+'button],[class*=a-check'+'box],[class*=puis-mab-chevron]';"
       ...
       "}catch(e425){}"
       "try{"
         "var VIEW87=/cart/i.test(location.pathname)?'cart':(/\\/s\\b|\\/s\\?/.test(location.pathname+location.search)?'shop':'other');"
         "var CB87=document.querySelectorAll('[class*=a-check'+'box],[role=check'+'box]'),R87=[];"
         "for(var i87=0;i87<CB87.length&&R87.length<2;i87++){var h87=CB87[i87];"
           "var r87=h87.getBoundingClientRect();if(r87.width<10||r87.height<10)continue;"
           "var inp87=h87.querySelector('input[type=check'+'box]');"
           "var art87=h87.querySelector('i[class*=a-icon-check],[class*=a-icon-check]')||h87;"
           "var cs87=getComputedStyle(art87);"
           "var bi87=String(cs87.backgroundImage||'none');"
           "bi87=bi87==='none'?'none':bi87.slice(-30);"
           "function cl87(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||'')).replace(/\\s+/g,'.').slice(0,30);}"
           "R87.push(VIEW87+'|host='+cl87(h87)+'|art='+String(art87.tagName)+'.'+cl87(art87)"
             "+'|f='+String(cs87.filter||'-').slice(0,22)+'|bgi='+bi87"
             "+'|inp='+(inp87?1:0)+'|chk='+(inp87&&inp87.checked?1:0)"
             "+'|aria='+String(h87.getAttribute('aria-checked')||'-')"
             "+'|bg='+String(getComputedStyle(h87).backgroundColor||'').replace(/\\s+/g,''));}"
         "if(R87.length){var prev87='';try{prev87=localStorage.getItem('__ad87')||'';}catch(_){}"
           "var keep87=prev87&&prev87.indexOf(VIEW87)!==0?prev87.split(' || ')[0]:'';"
           "var out87=R87.join(' ~ ')+(keep87?' || '+keep87:'');"
           "try{localStorage.setItem('__ad87',out87);}catch(_){}}"
       "}catch(e87){try{localStorage.setItem('__ad87','err '+e87);}catch(_){}}"
       ...
       "var sz4=Math.round(e4.getBoundingClientRect().width)+'x'+Math.round(e4.getBoundingClientRect().height);"
       "if(bc!=='rgb(24,26,27)')b4++;if(Math.abs(bw-1.5)>0.3)r4++;"
       "if(Q4.length<6)Q4.push(e4.getAttribute('data-ad-sym413')+'|bg='+bc+'|bw='+bw.toFixed(1)+'|sz='+sz4);}"
       "out.push('P80SYM413{n='+Z4.length+' badBg='+b4+' badRing='+r4+' '+Q4.join(' ~ ')+' state='+String(window.__AD_SYM413__||'-')+' d422='+String(window.__AD_DISC422__||'never-ran')+' L426='+(function(){try{return localStorage.getItem('__ad426')||'none';}catch(e){return 'ls-blocked';}})()+' CB87='+(function(){try{return localStorage.getItem('__ad87')||'none';}catch(e){return 'ls-blocked';}})()+' ATTR='+(function(){try{var h=document.querySelector('[data-ad-sym413=\\'cards\\']');if(!h)return 'no-cards';var cs=getComputedStyle(h),g=h.querySelector('img'),gs=g?getComputedStyle(g):null;var at=[];for(var i=0;i<h.attributes.length;i++){var an=h.attributes[i].name;if(an.indexOf('data-ad')===0)at.push(an.replace('data-ad-',''));}return 'bg='+String(cs.backgroundColor).replace(/\\s+/g,'')+'|r='+String(cs.borderRadius).slice(0,6)+'|bw='+parseFloat(cs.borderTopWidth||0).toFixed(1)+'|glyphf='+(gs?String(gs.filter).slice(0,26):'-')+'|by='+(at.join('+')||'-');}catch(e){return 'err';}})()+'}');"
       "}catch(e4x){out.push('P80SYM413{err '+(e4x&&e4x.message||e4x)+'}');}"

       // P82HEART427: the former square wrapper must remain paint-free and
       // must never retain any of the stale checkbox ownership markers.
       "try{var H82=document.querySelectorAll('[data-ad-heart-shell427]'),dirty82=0,stale82=0,Q82=[];"
       "for(var i82=0;i82<H82.length&&i82<40;i82++){var h82=H82[i82],s82=getComputedStyle(h82),r82=h82.getBoundingClientRect();"
       "var bg82=String(s82.backgroundColor||'').replace(/\\s+/g,''),bd82=parseFloat(s82.borderTopWidth||0),sh82=String(s82.boxShadow||'none');"
       "if((bg82!=='transparent'&&bg82!=='rgba(0,0,0,0)')||bd82>.1||sh82!=='none')dirty82++;"
       "if(h82.hasAttribute('data-ad-stock403')||h82.hasAttribute('data-ad-stocksel403')||h82.getAttribute('data-ad-product391')==='checkbox'||h82.getAttribute('data-ad-sym413')==='checkbox')stale82++;"
       "if(Q82.length<6)Q82.push(Math.round(r82.width)+'x'+Math.round(r82.height)+'|bg='+bg82+'|bw='+bd82.toFixed(1));}"
       "out.push('P82HEART427[shells='+H82.length+' dirty='+dirty82+' stale='+stale82+' state='+String(window.__AD_HEARTSHELL427_STATE__||'-')+(Q82.length?' '+Q82.join(' ~~ '):'')+']');"
       "}catch(e82){out.push('P82HEART427[err '+(e82&&e82.message||e82)+']');}"

       // P85CHECKBOX434: covers both classic Cart art and recycled search-result
       // input/role/background art.  miss=0 proves every scoped native control found
       // an art owner; cartShell reports the neutralized wrapper population.
       "try{var A85=document.querySelectorAll('[data-ad-checkbox434-art]'),S85=document.querySelectorAll('[data-ad-checkbox434-shell=\"cart\"]'),unchecked85=0,checked85=0,badFilter85=0,legacy85=0,foreign85=0,miss85=0,Q85=[];"
       "for(var i85=0;i85<A85.length&&i85<120;i85++){var a85=A85[i85],st85=String(a85.getAttribute('data-ad-checkbox434-art')||''),f85=String(getComputedStyle(a85).filter||'none');if(st85==='checked'){checked85++;if(f85!=='none')badFilter85++;}else{unchecked85++;if(f85.indexOf('invert')<0)badFilter85++;}if(a85.closest&&a85.closest('[class*=mlt-icon-container],[class*=lists-framework-action-button],[class*=puis-heart-position],[class*=puis-mab-chevron]'))foreign85++;if(Q85.length<10){var r85=a85.getBoundingClientRect(),c85=a85.className;c85=String(c85&&c85.baseVal!==undefined?c85.baseVal:(c85||''));Q85.push(st85+'|'+a85.tagName+'.'+c85.slice(0,28)+'@'+Math.round(r85.width)+'x'+Math.round(r85.height)+'|f='+f85.slice(0,30));}}"
       "var old85=document.querySelectorAll('[data-ad-comparehost377],[data-ad-compare378],[data-ad-compare379],[data-ad-compare380],[data-ad-comparelegacy387],[data-ad-stock403=\"c\"],[data-ad-product391=\"checkbox\"],[data-ad-sym413=\"checkbox\"],[data-ad-comparefunc428],[data-ad-checkbox433-art]').length;legacy85+=old85;"
       "var cartPage85=/proceed to checkout/i.test(String((document.body&&document.body.innerText)||'')),C85=document.querySelectorAll('input[type=checkbox],[role=checkbox],[class*=a-checkbox],[class*=checkbox]');for(var c85i=0;c85i<C85.length&&c85i<500;c85i++){var e85=C85[c85i];if(e85.closest&&e85.closest('[class*=mlt-icon-container],[class*=lists-framework-action-button],[class*=puis-heart-position],[class*=puis-mab-chevron]'))continue;var scoped85=cartPage85||(e85.closest&&e85.closest('[class*=puis-card],[class*=s-result-item],[data-component-type=\"s-search-result\"],[data-asin],[class*=s-product-image],[class*=product-image],[class*=sc-list-item],[class*=sc-item]'));if(!scoped85)continue;var g85=(e85.closest&&e85.closest('[class*=a-checkbox],[role=checkbox],[class*=checkbox]'))||e85.parentElement||e85;if(!(g85.hasAttribute&&g85.hasAttribute('data-ad-checkbox434-art'))&&!(g85.querySelector&&g85.querySelector('[data-ad-checkbox434-art]')))miss85++;}"
       "var css85=document.getElementById('adcheckbox434'),ct85=css85?String(css85.textContent||''):'',artBad85=/data-ad-checkbox434-art[^}]*\\{[^}]*(?:background|border|radius|shadow|width|height|position|transform|opacity|visibility|content|display|pointer-events)\\s*:/i.test(ct85)?1:0,shellGeom85=/data-ad-checkbox434-shell[^}]*\\{[^}]*(?:width|height|position|inset|transform|margin|padding|border-radius|display|pointer-events)\\s*:/i.test(ct85)?1:0;"
       "var pane85=/compare with similar|keep selecting/i.test(String((document.body&&document.body.innerText)||''))?1:0;"
       "out.push('P85CHECKBOX434[art='+A85.length+' unchecked='+unchecked85+' checked='+checked85+' badFilter='+badFilter85+' legacy='+legacy85+' foreign='+foreign85+' miss='+miss85+' cartShell='+S85.length+' artBad='+artBad85+' shellGeom='+shellGeom85+' pane='+pane85+' state='+String(window.__AD_CHECKBOX434_STATE__||'-')+(Q85.length?' '+Q85.join(' ~~ '):'')+']');"
       "}catch(e85){out.push('P85CHECKBOX434[err '+(e85&&e85.message||e85)+']');}"
       ...
       "try{"
       "  function c8(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||'')).replace(/\\s+/g,'.').slice(0,22)||e.tagName;}"
       "  function px(v){return Math.round(parseFloat(v||0));}"
       "  function rgb8(v){var m=/rgba?\\(([0-9.]+),\\s*([0-9.]+),\\s*([0-9.]+)(?:,\\s*([0-9.]+))?\\)/.exec(String(v||''));"
       "    if(!m)return '-';if(m[4]!==undefined&&+m[4]<0.08)return '0';return m[1]+','+m[2]+','+m[3];}"
       "  function paint8(e){var s=getComputedStyle(e),o=[];"
       "    var bg=rgb8(s.backgroundColor);if(bg!=='-'&&bg!=='0')o.push('bg='+bg);"
       "    var bw=parseFloat(s.borderTopWidth||0);if(bw>0.2)o.push('bd='+bw.toFixed(1)+':'+rgb8(s.borderTopColor));"
       "    if(s.boxShadow&&s.boxShadow!=='none')o.push('shadow');"
       "    var br=String(s.borderRadius||'');if(br&&br!=='0px')o.push('r='+br.slice(0,7));"
       "    var bi=s.backgroundImage;if(bi&&bi!=='none')o.push('bgimg');"
       "    return o.length?o.join(','):'clean';}"
       "  var H8=document.querySelectorAll('[data-ad-sym413]'),R8=[];"
       "  for(var i=0;i<H8.length&&R8.length<4;i++){var h=H8[i],r=h.getBoundingClientRect();"
       "    var line=h.getAttribute('data-ad-sym413')+' ['+Math.round(r.width)+'x'+Math.round(r.height)+'] '+c8(h)+' {'+paint8(h)+'}';"
       "    var up=[],a=h.parentElement,d=0;"
       "    while(a&&d++<2){var p=paint8(a);if(p!=='clean')up.push('^'+c8(a)+'{'+p+'}');a=a.parentElement;}"
       "    if(up.length)line+=' UP:'+up.join(' ');"
       "    var dn=[],D=h.querySelectorAll('*');"
       "    for(var j=0;j<D.length&&j<6&&dn.length<4;j++){var p2=paint8(D[j]);"
       "      if(p2!=='clean')dn.push('>'+c8(D[j])+'{'+p2+'}');}"
       "    if(dn.length)line+=' DOWN:'+dn.join(' ');"
       "    R8.push(line);}"
       "  var miss=[],SELM='[class*=puis-heart-position],[class*=lists-framework-action-button],[class*=mlt-icon-'+'container],[class*=a-check'+'box]';"
       "  var C8=document.querySelectorAll(SELM);"
       "  for(var k=0;k<C8.length&&miss.length<3;k++){var m=C8[k];"
       "    if(m.hasAttribute('data-ad-sym413'))continue;"
       "    if(m.querySelector('[data-ad-sym413]'))continue;"
       ...
       // P71V333404: final visible owner, not a passive marker. All three should be
       // dark circular hosts with the literal v5.333 1.5px chrome and a white stock glyph.
       "try{var V71=document.querySelectorAll('[data-ad-v333404]'),h71=0,d71=0,a71=0,bg71=0,ring71=0,shape71=0,glyph71=0,Q71=[];for(var i71=0;i71<V71.length&&i71<96;i71++){var e71=V71[i71],k71=String(e71.getAttribute('data-ad-v333404')||'-'),s71=getComputedStyle(e71),r71=e71.getBoundingClientRect();if(k71==='h')h71++;else if(k71==='d')d71++;else if(k71==='a')a71++;var bc71=String(s71.backgroundColor||'').replace(/\\s+/g,''),bw71=parseFloat(s71.borderTopWidth||'0'),br71=parseFloat(s71.borderTopLeftRadius||'0');if(bc71!=='rgb(24,26,27)'&&bc71!=='rgba(24,26,27,1)')bg71++;if(Math.abs(bw71-1.5)>.26)ring71++;if(br71<Math.min(r71.width,r71.height)*.40)shape71++;var G71=e71.querySelectorAll('[data-ad-v333raster404],[data-ad-v333vector404]'),good71=0;for(var j71=0;j71<G71.length;j71++){var g71=G71[j71],gs71=getComputedStyle(g71);if(g71.hasAttribute('data-ad-v333raster404')&&String(gs71.filter||'').indexOf('invert')>=0)good71=1;if(g71.hasAttribute('data-ad-v333vector404')&&/255/.test(String(gs71.fill||'')+String(gs71.stroke||'')+String(gs71.color||'')))good71=1;}if(!good71)glyph71++;if(Q71.length<8)Q71.push(k71+'@'+Math.round(r71.width)+'x'+Math.round(r71.height)+'|bg='+bc71+'|bw='+bw71+'|br='+br71);}out.push('P71V333404[h='+h71+' cards='+d71+' arrow='+a71+' badBg='+bg71+' badRing='+ring71+' badShape='+shape71+' badGlyph='+glyph71+' state='+String(window.__AD_V333FIX404_STATE__||'-')+(Q71.length?' '+Q71.join(' ~~ '):'')+']');}catch(e71){out.push('P71V333404[err '+(e71&&e71.message||e71)+']');}"
       // P72COLLEGE404: heading-derived pane and structural painter, not the old child marker.
       "try{var C72=document.querySelectorAll('[data-ad-college404]'),S72=document.querySelectorAll('[data-ad-college404-struct]'),app72=String(getComputedStyle(document.body||document.documentElement).backgroundColor||'').replace(/\\s+/g,''),mis72=0,Q72=[];for(var i72=0;i72<C72.length;i72++){var e72=C72[i72],cs72=getComputedStyle(e72),b72=String(cs72.backgroundColor||'').replace(/\\s+/g,'');if(app72&&b72!==app72)mis72++;var r72=e72.getBoundingClientRect();Q72.push(Math.round(r72.width)+'x'+Math.round(r72.height)+'|bg='+b72+'|img='+String(cs72.backgroundImage||'none').slice(0,18)+'|f='+String(cs72.filter||'none'));}out.push('P72COLLEGE404[pane='+C72.length+' struct='+S72.length+' mismatch='+mis72+' app='+app72+' state='+String(window.__AD_COLLEGE404_STATE__||'-')+(Q72.length?' '+Q72.join(' ~~ '):'')+']');}catch(e72){out.push('P72COLLEGE404[err '+(e72&&e72.message||e72)+']');}"
       // P73BLEED404: the real theming-card-background leaf family that P66 missed.
       "try{var B73=document.querySelectorAll('[data-ad-bleed404]'),miss73=0,Q73=[];for(var i73=0;i73<B73.length&&i73<40;i73++){var e73=B73[i73],r73=e73.getBoundingClientRect(),s73=getComputedStyle(e73),cp73=String(s73.clipPath||s73.webkitClipPath||'none'),ct73=String(s73.contain||'none');if(cp73==='none'||ct73.indexOf('paint')<0)miss73++;if(Q73.length<8)Q73.push(Math.round(r73.width)+'x'+Math.round(r73.height)+'|clip='+cp73+'|contain='+ct73+'|bg='+String(s73.backgroundColor||'').replace(/\\s+/g,''));}out.push('P73BLEED404[seen='+B73.length+' miss='+miss73+' style='+(document.getElementById('adbleed404')?1:0)+' old401='+(document.getElementById('adbleed401')?1:0)+' state='+String(window.__AD_BLEED404_STATE__||'-')+(Q73.length?' '+Q73.join(' ~~ '):'')+']');}catch(e73){out.push('P73BLEED404[err '+(e73&&e73.message||e73)+']');}"
       // P79CARDS410: current-DOM stock glyph plus existing-host/backdrop-only ownership.
       "try{var H=document.querySelectorAll('[data-ad-cards410-host],[data-ad-cards410-disc]'),n=H.length,bg=0,ring=0,shape=0,glyph=0,cb=0,ov=0,Q=[],X=document.querySelectorAll('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[class*=a-icon-checkbox],[data-ad-compare380],[data-ad-comparelegacy387]');function c(e){var r=e.getBoundingClientRect();return [r.left+r.width/2,r.top+r.height/2,r.width,r.height];}for(var i=0;i<H.length&&i<80;i++){var e=H[i],r=e.getBoundingClientRect(),s=getComputedStyle(e),bc=String(s.backgroundColor||'').replace(/\\s+/g,''),bw=parseFloat(s.borderTopWidth||'0'),br=parseFloat(s.borderTopLeftRadius||'0');if(e.closest&&e.closest('[class*=mlt-icon-container],[role=checkbox],input[type=checkbox],[class*=a-icon-checkbox],[data-ad-compare380],[data-ad-comparelegacy387]'))cb++;if(bc!=='rgb(24,26,27)'&&bc!=='rgba(24,26,27,1)')bg++;if(Math.abs(bw-1.5)>.26)ring++;if(br<Math.min(r.width,r.height)*.40)shape++;var cc=c(e);for(var x=0;x<X.length&&x<300;x++){var xc=c(X"
       "[x]);if(xc[2]<8||xc[3]<8||xc[2]>64||xc[3]>64)continue;if(Math.abs(cc[0]-xc[0])<18&&Math.abs(cc[1]-xc[1])<18){ov++;break;}}if(Q.length<8)Q.push((e.hasAttribute('data-ad-cards410-disc')?'D':'H')+'@'+Math.round(r.width)+'x'+Math.round(r.height)+'|bg='+bc+'|bw='+bw);}var G=document.querySelectorAll('[data-ad-cards410-glyph]'),good=0;for(var g=0;g<G.length;g++){var z=G[g],zs=getComputedStyle(z),f=String(zs.filter||''),ink=String(zs.color||'')+'|'+String(zs.fill||'')+'|'+String(zs.backgroundColor||'');if(f.indexOf('invert')>=0||/rgb\\(255,\\s*255,\\s*255\\)|#fff/i.test(ink))good++;}glyph=Math.max(0,G.length-good);out.push('P79CARDS410[n='+n+' badBg='+bg+' badRing='+ring+' badShape='+shape+' badGlyph='+glyph+' inCheckbox='+cb+' overlap='+ov+' glyphs='+G.length+' suppressed='+document.querySelectorAll('[data-ad-cards410-suppressed]').length+' disabled391='+String(window.__AD_CARDS391_DISABLED408__||0)+' state='+String(window.__AD_CARDS410_STATE__||'-')+(Q.length?' '+Q.join(' ~~ '):'')+']');}catch("
       "e){out.push('P79CARDS410[err '+(e&&e.message||e)+']');}"
