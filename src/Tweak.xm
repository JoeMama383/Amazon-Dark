...
static void ADRestoreCategoryArtwork379(UIImageView *iv){
    @try {
        ...
        if(cat379log<18){ cat379log++; ADLog(@"P44CAT379[%s %.0fx%.0f changed=%d mode=%ld]",object_getClassName(iv),iv.bounds.size.width,iv.bounds.size.height,changed?1:0,(long)iv.image.renderingMode); }
    } @catch(...) {}
}
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         "}catch(e){}}""badgeFix();dotFix();packFix();stockActionFix379();compareStock379();cartChrome379();shareFix377();sponsorFix376();ratingFix376();""clr();setTimeout(clr,300);setTimeout(clr,1200);setTimeout(clr,2500);""setTimeout(badgeFix,300);setTimeout(badgeFix,1200);setTimeout(badgeFix,2500);""setTimeout(dotFix,120);setTimeout(dotFix,500);setTimeout(dotFix,1400);setTimeout(dotFix,2800);""setTimeout(packFix,120);setTimeout(packFix,500);setTimeout(packFix,1400);setTimeout(packFix,2800);setTimeout(stockActionFix379,60);setTimeout(stockActionFix379,240);setTimeout(stockActionFix379,800);setTimeout(stockActionFix379,1800);setTimeout(compareStock379,20);setTimeout(compareStock379,120);setTimeout(compareStock379,500);setTimeout(compareStock379,1500);setTimeout(cartChrome379,40);setTimeout(cartChrome379,350);setTimeout(cartChrome379,1400);setTimeout(sponsorFix376,20);setTimeout(sponsorFix376,180);setTimeout(sponsorFix376,700);setTimeout(sponsorFix376,1800);setTimeout(ratingFix376,40);setTimeout(ratingFix376,240);setTimeout(ratingFix376,900);setTimeout(ratingFix376,2200);setTimeout(shareFix377,40);setTimeout(shareFix377,180);setTimeout(shareFix377,700);setTimeout(shareFix377,1800);addEventListener('scroll',function(){clearTimeout(window.__bgT);window.__bgT=setTimeout(function(){badgeFix();dotFix();packFix();stockActionFix379();compareStock379();cartChrome379();shareFix377();sponsorFix376();ratingFix376();},80);},{passive:true,capture:true});""addEventListener('scroll',function(){clearTimeout(window.__bxS);window.__bxS=setTimeout(clr,120);},{passive:true,capture:true});"
         "new MutationObserver(function(){clearTimeout(window.__bxT);"
           "window.__bxT=setTimeout(function(){clr();dotFix();packFix();stockActionFix379();compareStock379();cartChrome379();shareFix377();sponsorFix376();ratingFix376();},20);}).observe(document.documentElement,"
         ...
         "try{document.addEventListener('change',function(e){try{if(e&&e.target&&(String(e.target.type||'').toLowerCase()==='checkbox'||(e.target.closest&&e.target.closest('[class*=mlt-icon-container]')) ))compareStock379();}catch(x){}},true);document.addEventListener('click',function(e){try{if(e&&e.target&&e.target.closest){var h=e.target.closest('[class*=mlt-icon-container]');if(h){var hp=h.parentElement&&h.parentElement.closest?h.parentElement.closest('[class*=mlt-icon-container]'):null;while(hp){h=hp;hp=h.parentElement&&h.parentElement.closest?h.parentElement.closest('[class*=mlt-icon-container]'):null;}var cur=String(h.getAttribute('data-ad-compare379')||'0')==='1';h.__adManual379=cur?0:1;h.__adManualUntil379=Date.now()+5000;h.setAttribute('data-ad-compare379',cur?'0':'1');setTimeout(compareStock379,0);setTimeout(compareStock379,120);setTimeout(compareStock379,5200);}}}catch(x){}},true);}catch(e){}"
       "})();}catch(e){}"
       "/*V5314FIX*//*V5315FIX*/"
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*/"
       ...
       // P39V379: stock list-action chrome + one real clickable Compare host.
       "try{var A39=document.querySelectorAll('[data-ad-stockaction379]'),C39=document.querySelectorAll('[data-ad-compare379]'),Q39=[];for(var i39=0;i39<A39.length&&Q39.length<6;i39++){var h39=A39[i39],r39=h39.getBoundingClientRect(),s39=getComputedStyle(h39);Q39.push('A@'+Math.round(r39.left)+','+Math.round(r39.top)+'/'+Math.round(r39.width)+'x'+Math.round(r39.height)+'|bg='+String(s39.backgroundColor||'-').replace(/ /g,'')+'|sh='+String(s39.boxShadow||'none').slice(0,28));}for(var j39=0;j39<C39.length&&Q39.length<12;j39++){var c39=C39[j39],rr39=c39.getBoundingClientRect(),s=c39.getAttribute('data-ad-compare379'),inp=c39.querySelector('input[type=checkbox]');Q39.push('C@'+Math.round(rr39.left)+','+Math.round(rr39.top)+'/'+Math.round(rr39.width)+'x'+Math.round(rr39.height)+'|sel='+s+'|inp='+(inp?1:0)+'|chk='+(inp&&inp.checked?1:0)+'|bg='+String(getComputedStyle(c39).backgroundColor||'-').replace(/ /g,''));}out.push('P39V379[action='+A39.length+' compare='+C39.length+(Q39.length?' '+Q39.join(' ~~ '):'')+' state='+String(window.__AD_STOCKACTION379__||'-')+' cmp='+String(window.__AD_COMPARE379__||'-')+']');}catch(e39){out.push('P39V379[err '+(e39&&e39.message||e39)+']');}"
       ...
       // P43V379: Cart direct sibling fix + tame regression counters.
       "try{var C43=document.querySelectorAll('[data-ad-cartchrome379]'),D43=document.querySelectorAll('[data-ad-cartdirect379]'),K43=document.querySelectorAll('[data-ad-tame-fast362],[data-ad-tame-bgfast364]');out.push('P43V379[cart='+C43.length+' direct='+D43.length+' tame='+K43.length+' cartState='+String(window.__AD_CART379__||'-')+' parent='+String(window.__AD_PARENTSTRIP379__||'-')+']');}catch(e43){out.push('P43V379[err '+(e43&&e43.message||e43)+']');}"
