...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // P76CARDS407: passive read of the actual v5.333 action-button host. No paint.
       "try{var C76=document.querySelectorAll('[class*=lists-framework-action-button]'),raw76=C76.length,n76=0,bg76=0,ring76=0,shape76=0,glyph76=0,Q76=[];for(var i76=0;i76<C76.length&&i76<80;i76++){var e76=C76[i76],r76=e76.getBoundingClientRect();if(r76.width<18||r76.width>52||r76.height<18||r76.height>52||Math.abs(r76.width-r76.height)>10)continue;n76++;var s76=getComputedStyle(e76),bc76=String(s76.backgroundColor||'').replace(/\\s+/g,''),bw76=parseFloat(s76.borderTopWidth||'0'),br76=parseFloat(s76.borderTopLeftRadius||'0');if(bc76!=='rgb(24,26,27)'&&bc76!=='rgba(24,26,27,1)')bg76++;if(Math.abs(bw76-1.5)>.26)ring76++;if(br76<Math.min(r76.width,r76.height)*.40)shape76++;var G76=e76.querySelectorAll('img,i,svg,path,use,polygon,[class*=lists-framework-unfill],[class*=lists-framework-fill]'),light76=0;for(var j76=0;j76<G76.length;j76++){var gs76=getComputedStyle(G76[j76]),f76=String(gs76.filter||''),ink76=String(gs76.color||'')+'|'+String(gs76.fill||'')+'|'+String(gs76.stroke||'');if(f76.indexOf('invert')>=0||/rgb\\(255,\\s*255,\\s*255\\)|#fff/i.test(ink76)){light76=1;break;}}if(!light76)glyph76++;if(Q76.length<8)Q76.push(Math.round(r76.width)+'x'+Math.round(r76.height)+'|bg='+bc76+'|bw='+bw76+'|br='+br76+'|g='+G76.length+'|light='+light76);}out.push('P76CARDS407[raw='+raw76+' n='+n76+' badBg='+bg76+' badRing='+ring76+' badShape='+shape76+' badGlyph='+glyph76+' state='+String(window.__AD_SYMBOL333397_STATE__||'-')+(Q76.length?' '+Q76.join(' ~~ '):'')+']');}catch(e76){out.push('P76CARDS407[err '+(e76&&e76.message||e76)+']');}"
