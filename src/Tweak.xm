...
static NSString *ADFixesLiteral(void){
    ...
    return [NSString stringWithFormat:
            @"{css:'"
             ...
             "background-color:transparent !important;}"
             // v5.433: Compare is stock Amazon artwork and geometry.  No checkbox
...
"+(window.__AD_DISC420SEEN__?(' D420SEEN['+window.__AD_DISC420SEEN__+']'):'')"
         ...
         "window.__AD_PRODUCTCTRL391RUN__=function(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           ...
           // v5.433 Compare: this product-control painter has no checkbox branch.
...
static NSString *ADProbeWebJS(void){
    return
       ...
       "try{(function(){"
         ...
         // v5.433 STOCK COMPARE: Amazon owns the complete checkbox control -- host,
         // geometry, hit target, background, border, blue checked sprite and checkmark.
         // This layer removes every retired tweak-owned checkbox mutation and applies
         // exactly one visual operation: invert the stock artwork while it is unchecked.
         // MLT/two-cards, list/cards, Heart and product-chevron families are hard exclusions.
         "function stockCheckbox433(){try{if(window.__ADFRAME_MODE__||!document.body)return 0;"
           "var retired433=['adstock403','adcomparenative428'];for(var ri433=0;ri433<retired433.length;ri433++){var rs433=document.getElementById(retired433[ri433]);if(rs433&&rs433.parentNode)rs433.parentNode.removeChild(rs433);}"
           "if(!document.getElementById('adcheckbox433')){var s433=document.createElement('style');s433.id='adcheckbox433';"
             "s433.textContent='[data-ad-checkbox433-art=\"unchecked\"]{filter:invert(1) !important;}[data-ad-checkbox433-art=\"checked\"]{filter:none !important;}';"
             "(document.head||document.documentElement).appendChild(s433);}"
           "function cn433(e){var c=e&&e.className;return String(c&&c.baseVal!==undefined?c.baseVal:(c||''));}"
           "function product433(e){return e&&e.closest&&e.closest('[class*=puis-card],[class*=s-result-item],[data-asin],[class*=s-product-image],[class*=product-image]');}"
           "function foreign433(e){try{return !!(e&&e.closest&&e.closest('[class*=mlt-icon-container],[class*=lists-framework-action-button],[data-ad-cards410-root],[data-ad-cards410-host],[data-ad-cards410-disc],[data-ad-cards410-glyph],[data-ad-heart-shell427],[class*=puis-heart-position],[class*=lists-treatment-hear],[class*=puis-mab-chevron]'));}catch(x){return true;}}"
           "function owned433(e){if(!e||e.nodeType!==1)return false;var p=String(e.getAttribute('data-ad-product391')||''),v=String(e.getAttribute('data-ad-v333403')||''),d=String(e.getAttribute('data-ad-disc420')||''),s=String(e.getAttribute('data-ad-sym413')||''),v4=String(e.getAttribute('data-ad-v333404')||'');if(p==='checkbox'||v==='c'||d==='checkbox'||s==='checkbox'||v4==='c'||v4==='checkbox')return true;var A=['data-ad-comparehost377','data-ad-comparechecked377','data-ad-compareinput377','data-ad-compare378','data-ad-compareleaf378','data-ad-compare-raster378','data-ad-compare379','data-ad-compareinput379','data-ad-compareorig379','data-ad-compare380','data-ad-compareinput380','data-ad-compareorig380','data-ad-comparelegacy387','data-ad-comparelegacyorig387','data-ad-productselected391','data-ad-productglyph391','data-ad-productraster391','data-ad-productvector391','data-ad-stock403','data-ad-stocksel403','data-ad-stockglyph403','data-ad-stockraster403','data-ad-stockvector403','data-ad-sym413glyph','data-ad-comparefunc428','data-ad-compareselected428','data-ad-comparehit428'];for(var i=0;i<A.length;i++)if(e.hasAttribute(A[i]))return true;return /^(?:product391|sym413|sym413glyph|disc420|disc422)$/.test(String(e.__adBy||''));}"
           "var marks433=['data-ad-comparehost377','data-ad-comparechecked377','data-ad-compareinput377','data-ad-compare378','data-ad-compareleaf378','data-ad-compare-raster378','data-ad-compare379','data-ad-compareinput379','data-ad-compareorig379','data-ad-compare380','data-ad-compareinput380','data-ad-compareorig380','data-ad-comparelegacy387','data-ad-comparelegacyorig387','data-ad-product391','data-ad-productselected391','data-ad-productglyph391','data-ad-productraster391','data-ad-productvector391','data-ad-stock403','data-ad-stocksel403','data-ad-stockglyph403','data-ad-stockraster403','data-ad-stockvector403','data-ad-v333403','data-ad-v333404','data-ad-disc420','data-ad-sym413','data-ad-sym413glyph','data-ad-comparefunc428','data-ad-compareselected428','data-ad-comparehit428'];"
           "var props433=['background','background-color','background-image','border','border-color','border-width','border-style','border-radius','box-shadow','box-sizing','filter','width','height','min-width','min-height','max-width','max-height','position','inset','top','right','bottom','left','transform','overflow','isolation','outline','z-index','margin','pointer-events','opacity','visibility','color','fill','stroke','transition','display','cursor'];"
           "function scrub433(e){if(!owned433(e))return 0;for(var p=0;p<props433.length;p++)e.style.removeProperty(props433[p]);for(var a=0;a<marks433.length;a++)e.removeAttribute(marks433[a]);delete e.__adBy;delete e.__adGlyph;delete e.__adManual380;delete e.__adManualSig380;delete e.__adCompareBlue428;return 1;}"
           "function selected433(h){try{var q=h.querySelector('input[type=checkbox]');if(q)return !!q.checked;var A=[h],Z=h.querySelectorAll('[role=checkbox],[aria-checked],[data-checked],[data-selected]');for(var i=0;i<Z.length&&i<20;i++)A.push(Z[i]);for(var j=0;j<A.length;j++){var e=A[j],a=String(e.getAttribute('aria-checked')||e.getAttribute('data-checked')||e.getAttribute('data-selected')||'').toLowerCase(),c=cn433(e).toLowerCase();if(a==='true'||/(^|[ _-])(checked|selected|active)([ _-]|$)/.test(c))return true;if(a==='false')return false;}var im=h.querySelector('img[src],img[data-src]'),src=im?String(im.currentSrc||im.src||im.getAttribute('data-src')||'').toLowerCase():'';return /checkbox[_-]?(?:on|checked)|checkmark|selected/.test(src);}catch(x){return false;}}"
           "var C=document.querySelectorAll('div.a-checkbox,[class~=\"a-checkbox\"]'),live=[],hosts=0,unchecked=0,checked=0,cleaned=0,skip=0;"
           "for(var i=0;i<C.length&&i<320;i++){var h=C[i];if(/a-icon-checkbox/.test(cn433(h))||foreign433(h)||!product433(h)){skip++;continue;}var A=h.querySelectorAll('i.a-icon-checkbox,[class~=\"a-icon-checkbox\"]');if(!A.length)A=h.querySelectorAll('[class*=a-icon-checkbox]');if(!A.length){skip++;continue;}var syn=h.querySelectorAll('[data-ad-comparebox377],[data-ad-comparecheck377]');for(var sy=0;sy<syn.length;sy++){if(syn[sy].parentNode)syn[sy].parentNode.removeChild(syn[sy]);cleaned++;}var Q=[h],D=h.querySelectorAll('*');for(var q=0;q<D.length&&q<100;q++)Q.push(D[q]);for(var z=0;z<Q.length;z++)cleaned+=scrub433(Q[z]);var on=selected433(h),marked=0;for(var j=0;j<A.length&&j<8;j++){var art=A[j];if(foreign433(art))continue;art.setAttribute('data-ad-checkbox433-art',on?'checked':'unchecked');live.push(art);marked++;}if(!marked){skip++;continue;}hosts++;if(on)checked++;else unchecked++;}"
           "var old433=document.querySelectorAll('[data-ad-checkbox433-art]');for(var o=0;o<old433.length;o++)if(live.indexOf(old433[o])<0)old433[o].removeAttribute('data-ad-checkbox433-art');"
           "window.__AD_CHECKBOX433_STATE__='hosts='+hosts+' unchecked='+unchecked+' checked='+checked+' cleaned='+cleaned+' skip='+skip;return hosts;"
         "}catch(e){window.__AD_CHECKBOX433_STATE__='err '+(e&&e.message||e);return -1;}}"
         "try{window.__AD_CHECKBOX433__=stockCheckbox433;if(!window.__AD_CHECKBOX433_WRAP__){window.__AD_CHECKBOX433_WRAP__=1;"
           "window.__AD_PRODUCTCTRL391_PRE433__=window.__AD_PRODUCTCTRL391RUN__;window.__AD_PRODUCTCTRL391RUN__=function(){var r=window.__AD_PRODUCTCTRL391_PRE433__?window.__AD_PRODUCTCTRL391_PRE433__():0;try{window.__AD_CHECKBOX433__();}catch(x){}return r;};"
           "var t433=0;new MutationObserver(function(){clearTimeout(t433);t433=setTimeout(function(){try{window.__AD_CHECKBOX433__();}catch(x){}},25);}).observe(document.documentElement,{childList:true,subtree:true,attributes:true,attributeFilter:['class','aria-checked','data-checked','data-selected','checked','src','data-src']});"
           "document.addEventListener('change',function(e){try{if(e&&e.target&&(String(e.target.type||'').toLowerCase()==='checkbox'||(e.target.closest&&e.target.closest('div.a-checkbox,[class~=\"a-checkbox\"]')))){setTimeout(window.__AD_CHECKBOX433__,0);setTimeout(window.__AD_CHECKBOX433__,100);}}catch(x){}},true);"
           "document.addEventListener('click',function(e){try{if(e&&e.target&&e.target.closest&&e.target.closest('div.a-checkbox,[class~=\"a-checkbox\"]')){setTimeout(window.__AD_CHECKBOX433__,0);setTimeout(window.__AD_CHECKBOX433__,80);setTimeout(window.__AD_CHECKBOX433__,260);}}catch(x){}},true);"
           "addEventListener('scroll',function(){clearTimeout(window.__adCheckboxScroll433);window.__adCheckboxScroll433=setTimeout(window.__AD_CHECKBOX433__,90);},{passive:true,capture:true});}"
           "stockCheckbox433();setTimeout(stockCheckbox433,40);setTimeout(stockCheckbox433,180);setTimeout(stockCheckbox433,700);setTimeout(stockCheckbox433,1800);"
         "}catch(e){}"
         ...
         "/* v5.433: no checkbox state emulation; stockCheckbox433 only observes native state. */"
       "})();}catch(e){}"
...
"/*V5317FIX*//*V5376FIX*//*V5377FIX*//*V5378FIX*//*V5379FIX*//*V5380FIX*//*V5381FIX*//*V5382FIX*//*V5383FIX*//*V5384FIX*//*V5385FIX*//*V5386FIX*//*V5387FIX*//*V5388FIX*//*V5391FIX*//*V5393FIX*/"
       ...
       // P84CHECKBOX433: stock Compare artwork probe. badFilter=0 means only the
       // unchecked stock icon is inverted; checked artwork is completely unfiltered
       // so Amazon's native blue sprite/checkmark renders. legacy/foreign must stay 0.
       "try{var A84=document.querySelectorAll('[data-ad-checkbox433-art]'),unchecked84=0,checked84=0,badFilter84=0,legacy84=0,foreign84=0,Q84=[];"
       "for(var i84=0;i84<A84.length&&i84<80;i84++){var a84=A84[i84],st84=String(a84.getAttribute('data-ad-checkbox433-art')||''),f84=String(getComputedStyle(a84).filter||'none'),h84=a84.closest&&a84.closest('div.a-checkbox,[class~=\"a-checkbox\"]');if(st84==='checked'){checked84++;if(f84!=='none')badFilter84++;}else{unchecked84++;if(f84.indexOf('invert')<0)badFilter84++;}if(a84.closest&&a84.closest('[class*=mlt-icon-container],[class*=lists-framework-action-button],[class*=puis-heart-position],[class*=puis-mab-chevron]'))foreign84++;if(h84&&(h84.hasAttribute('data-ad-compare380')||h84.hasAttribute('data-ad-comparelegacy387')||h84.hasAttribute('data-ad-stock403')||h84.getAttribute('data-ad-product391')==='checkbox'||h84.getAttribute('data-ad-sym413')==='checkbox'))legacy84++;if(Q84.length<8)Q84.push(st84+'|f='+f84.slice(0,34));}"
       "var old84=document.querySelectorAll('[data-ad-comparehost377],[data-ad-compare378],[data-ad-compare379],[data-ad-compare380],[data-ad-comparelegacy387],[data-ad-stock403=\"c\"],[data-ad-product391=\"checkbox\"],[data-ad-sym413=\"checkbox\"],[data-ad-comparefunc428]').length;legacy84+=old84;"
       "var css84=document.getElementById('adcheckbox433'),ct84=css84?String(css84.textContent||''):'',cssBad84=/(?:background|border|radius|shadow|width|height|position|transform|opacity|visibility|content|display|pointer-events)\\s*:/i.test(ct84)?1:0;"
       "var pane84=/compare with similar|keep selecting/i.test(String((document.body&&document.body.innerText)||''))?1:0;"
       "out.push('P84CHECKBOX433[art='+A84.length+' unchecked='+unchecked84+' checked='+checked84+' badFilter='+badFilter84+' legacy='+legacy84+' foreign='+foreign84+' cssBad='+cssBad84+' pane='+pane84+' state='+String(window.__AD_CHECKBOX433_STATE__||'-')+(Q84.length?' '+Q84.join(' ~~ '):'')+']');"
       "}catch(e84){out.push('P84CHECKBOX433[err '+(e84&&e84.message||e84)+']');}"
