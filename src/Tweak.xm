/*
 * AmazonDark v7.368 — probe-backed checkout BYG + Place Order theming on v7.367
 *
 * Architecture:
...
#define AD_VERSION "v7.368-checkout-byg-order-theme"
...
static NSString *ADFloorJS(void){
    ...
    return
        ...
        // v7.368 probe-backed checkout theming. The first FULL sweep identifies the before-you-go
        // recommendations as checkout-byg-mobile-container with dense-grid faceouts; the second identifies
        // the Place Order page as checkoutDisplayPage / checkout-experience-container. Keep authored
        // link/success/price/Prime colors; own only neutral copy, structural floors and exact controls.
        @"#checkoutDisplayPage.checkout-display-page{background:#000!important;background-color:#000!important;color:#e8e6e3!important;}#checkoutDisplayPage .checkout-byg-mobile-container,#checkoutDisplayPage .checkout-byg-mobile-container :is(.a-cardui,.a-section,.a-row,.a-carousel-container,.a-carousel-viewport,.a-carousel-card,[class*=_mobileDenseGridLayoutContainer_],[class*=_mobileDenseGridAsinFaceout_],[class*=_imageAndAtcContainer_],.productDetailsContainer,.checkout-byg-continue-button-shadow-mobile,.checkout-byg-continue-button-shadow-mobile>.a-box-inner){background:#000!important;background-color:#000!important;background-image:none!important;box-shadow:none!important;}#checkoutDisplayPage .checkout-byg-mobile-container :is(h1,h2,h3,h4,h5,h6,p,span,div,strong,b):not(.a-color-price):not(.a-color-success):not(.a-color-link):not([class*=_badgeMessage_]):not(:where(.a-color-price *)):not(:where(.a-color-success *)):not(:where(.a-color-link *)):not(:where([class*=_badgeMessage_] *)):not(:where(a *)){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#checkoutDisplayPage .checkout-byg-mobile-container i.a-icon-prime{filter:none!important;-webkit-filter:none!important;}#checkoutDisplayPage #checkout-byg-ptc-button.a-button-primary{background:#000!important;background-color:#000!important;background-image:none!important;border:1px solid #747a7c!important;border-color:#747a7c!important;box-shadow:none!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#checkoutDisplayPage #checkout-byg-ptc-button .a-button-inner{background:transparent!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;}#checkoutDisplayPage #checkout-byg-ptc-button .a-button-text{color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#checkoutDisplayPage .checkout-byg-mobile-container [class*=_denseGridAxSpotAtcButton_] button[name=\"submit.addToCart\"]{background:#303335!important;background-color:#303335!important;background-image:none!important;border:1px solid #747a7c!important;border-color:#747a7c!important;box-shadow:none!important;color:#e8e6e3!important;}#checkoutDisplayPage .checkout-byg-mobile-container [class*=_denseGridAxSpotAtcButton_] .a-icon-small-add{filter:brightness(0) invert(1)!important;-webkit-filter:brightness(0) invert(1)!important;}"
        @"#checkoutDisplayPage #checkout-experience-container,#checkoutDisplayPage .checkout-experience-panel,#checkoutDisplayPage .checkout-experience-block,#checkoutDisplayPage .rcx-checkout-custom-card,#checkoutDisplayPage .checkout-card-color,#checkoutDisplayPage .lineitem-container,#checkoutDisplayPage .checkout-card-color>.a-box-inner,#checkoutDisplayPage .checkout-experience-block>.a-box-inner{background:#000!important;background-color:#000!important;background-image:none!important;box-shadow:none!important;border-color:#494d4d!important;}#checkoutDisplayPage .rcx-checkout-custom-card,#checkoutDisplayPage .lineitem-container.checkout-card-color{border-color:#494d4d!important;outline-color:#494d4d!important;}#checkoutDisplayPage :is(h1,h2,h3,h4,h5,h6,p,span,div,label,strong,b,li):not(.a-color-price):not(.a-color-success):not(.a-color-link):not(.a-link-normal):not(:where(.a-color-price *)):not(:where(.a-color-success *)):not(:where(.a-color-link *)):not(:where(a *)):not(:where(.a-icon-prime *)){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#checkoutDisplayPage :is(a,.a-link-normal,.a-link-legal,.pipeline-link),#checkoutDisplayPage :is(a,.a-link-normal,.a-link-legal,.pipeline-link) *{color:rgb(33,98,161)!important;-webkit-text-fill-color:rgb(33,98,161)!important;}#checkoutDisplayPage .a-color-success,#checkoutDisplayPage .a-color-success *{color:rgb(11,123,60)!important;-webkit-text-fill-color:rgb(11,123,60)!important;}#checkoutDisplayPage i.a-icon-prime{filter:none!important;-webkit-filter:none!important;}#checkoutDisplayPage img.sustainability-green-leaf-alignment-updated{filter:none!important;-webkit-filter:none!important;background-color:transparent!important;}#checkoutDisplayPage :is(#placeOrder,#placeYourOrder,#placeYourOrderSecondary,.place-order-button-link,.place-your-order-button,.continue-button.a-button-primary){background:#000!important;background-color:#000!important;background-image:none!important;border:1px solid #747a7c!important;border-color:#747a7c!important;box-shadow:none!important;color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#checkoutDisplayPage :is(#placeOrder,#placeYourOrder,#placeYourOrderSecondary,.place-order-button-link,.place-your-order-button,.continue-button.a-button-primary) .a-button-inner{background:transparent!important;background-color:transparent!important;background-image:none!important;border-color:transparent!important;box-shadow:none!important;}#checkoutDisplayPage :is(#placeOrder,#placeYourOrder,#placeYourOrderSecondary,.place-order-button-link,.place-your-order-button,.continue-button.a-button-primary) :is(.a-button-text,span){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#checkoutDisplayPage fieldset[name=\"checkout-quantity-stepper\"] .a-stepper-inner-container{background:#303335!important;background-color:#303335!important;background-image:none!important;border:1px solid #747a7c!important;border-color:#747a7c!important;box-shadow:none!important;}#checkoutDisplayPage fieldset[name=\"checkout-quantity-stepper\"] .a-stepper-controls,#checkoutDisplayPage fieldset[name=\"checkout-quantity-stepper\"] .a-stepper-controls :is(button,div,span){color:#e8e6e3!important;-webkit-text-fill-color:#e8e6e3!important;}#checkoutDisplayPage fieldset[name=\"checkout-quantity-stepper\"] :is(.a-icon-small-trash,.a-icon-small-add){filter:brightness(0) invert(1)!important;-webkit-filter:brightness(0) invert(1)!important;}"
        @"\");}if(document.rea"
...
static const void *kADCheckoutNavImage7368=&kADCheckoutNavImage7368;
static BOOL ADInCheckoutModal7368(UIView *v){
    @try {
        UIResponder *r=v;
        for(int i=0;r&&i<16;i++,r=r.nextResponder){
            NSString *cn=NSStringFromClass(r.class)?:@"";
            if([cn rangeOfString:@"AMSModalLayoutFullScreenViewController" options:NSCaseInsensitiveSearch].location!=NSNotFound||
               [cn rangeOfString:@"AMIWebViewController" options:NSCaseInsensitiveSearch].location!=NSNotFound)return YES;
        }
    } @catch(...) {}
    return NO;
}
static void ADOwnCheckoutNav7368(_UIBarBackground *bar){
    if(!gP.enabled||!bar||!bar.window)return;
    BOOL checkout=ADInCheckoutModal7368((UIView *)bar);
    @try {
        if(checkout){
            ...
            if([n isKindOfClass:[UINavigationBar class]])((UINavigationBar *)n).tintColor=ADLightText706();
        }
        for(UIView *x in ((UIView *)bar).subviews){
            if(![x isKindOfClass:[UIImageView class]])continue;
            if(checkout){
                objc_setAssociatedObject(x,kADCheckoutNavImage7368,@YES,OBJC_ASSOCIATION_RETAIN_NONATOMIC);
                x.hidden=YES;
                ADSetViewBackground7226(x,ADOLED(),YES);
            }else if([objc_getAssociatedObject(x,kADCheckoutNavImage7368) boolValue]){
                x.hidden=NO;
                objc_setAssociatedObject(x,kADCheckoutNavImage7368,nil,OBJC_ASSOCIATION_RETAIN_NONATOMIC);
            }
        }
    } @catch(...) {}
}
