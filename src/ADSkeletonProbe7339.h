...
// v7.492 transition expansion: capture the exact AMIWebViewController/root lifecycle
...
static void ADSkelInstall7339(void){
    ...
    @try {
        ...
        ADSkelArmPath7339=[docs stringByAppendingPathComponent:@"AmazonDark-v7.492-probe.arm"];
        ADSkelStatusPath7339=[docs stringByAppendingPathComponent:@"AmazonDark-v7.492-probe-status.json"];
        NSError *error=nil;
        ...
        ADSkelPath7339=[docs stringByAppendingPathComponent:[NSString stringWithFormat:@"AmazonDark-v7.492-skeleton-%@.jsonl",ADSkelSession7339]];
