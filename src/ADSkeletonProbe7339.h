...
static void ADSkelInstall7339(void){
    ...
    @try {
        ...
        ADSkelArmPath7339=[docs stringByAppendingPathComponent:@"AmazonDark-v7.423-probe.arm"];
        ADSkelStatusPath7339=[docs stringByAppendingPathComponent:@"AmazonDark-v7.423-probe-status.json"];
        NSError *error=nil;
        ...
        ADSkelPath7339=[docs stringByAppendingPathComponent:[NSString stringWithFormat:@"AmazonDark-v7.423-skeleton-%@.jsonl",ADSkelSession7339]];
