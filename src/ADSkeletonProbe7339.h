...
// v7.381 transition mode is intentionally multi-cycle: it survives one or more
...
// v7.381 teal trace: take a synchronous, read-only census at lifecycle boundaries.
...
static void ADSkelInstall7339(void){
    ...
    @try {
        ...
        ADSkelArmPath7339=[docs stringByAppendingPathComponent:@"AmazonDark-v7.381-probe.arm"];
        ADSkelStatusPath7339=[docs stringByAppendingPathComponent:@"AmazonDark-v7.381-probe-status.json"];
        NSError *error=nil;
        ...
        ADSkelPath7339=[docs stringByAppendingPathComponent:[NSString stringWithFormat:@"AmazonDark-v7.381-skeleton-%@.jsonl",ADSkelSession7339]];
