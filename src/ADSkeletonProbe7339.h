...
// v7.388 transition mode is intentionally multi-cycle: it survives one or more
...
// v7.388 teal trace: take a synchronous, read-only census at lifecycle boundaries.
...
// v7.510 transition expansion: capture the exact AMIWebViewController/root lifecycle
...
static void ADSkelInstall7339(void){
    ...
    @try {
        ...
        ADSkelArmPath7339=[docs stringByAppendingPathComponent:@"AmazonDark-v7.510-probe.arm"];
        ADSkelStatusPath7339=[docs stringByAppendingPathComponent:@"AmazonDark-v7.510-probe-status.json"];
        NSError *error=nil;
        ...
        ADSkelPath7339=[docs stringByAppendingPathComponent:[NSString stringWithFormat:@"AmazonDark-v7.510-skeleton-%@.jsonl",ADSkelSession7339]];
