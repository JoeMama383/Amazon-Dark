...
rm -rf /var/mobile/t7399 && mkdir -p /var/mobile/t7399
unzip -q "$D/AmazonDark-v7.399-add-address-form-completion-source.zip" -d /var/mobile/t7399
find . -mindepth 1 -maxdepth 1 ! -name .git -exec rm -rf {} +
cp -a /var/mobile/t7399/AmazonDark-v7.399-add-address-form-completion-source/. .
chmod 755 layout/DEBIAN/postinst
AD_STRICT_VALIDATE=1 sh scripts/validate.sh
git add -A
git commit -m "v7.399: complete Add-address form theming"
