...
AD_STAGE=$(mktemp -d /var/mobile/ad7482.XXXXXX) &&
unzip -q "$AD_DOCS/AmazonDark-v7.482-pdp-immersive-review-profile-theme-source.zip" -d "$AD_STAGE" &&
...
git add -A &&
if ! git diff --cached --quiet; then git commit -m "v7.482: theme PDP immersive review and profile picker menus"; fi &&
