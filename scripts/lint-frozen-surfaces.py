...
_version_ok = ('#define AD_VERSION "v5.465.1"' in src
               and "Version: 5.465.1" in _control
               and "AmazonDark-TESTA-no-web-engine-rootless-deb" in _workflow)
...
for _need in ['__AD_CARDS391_DISABLED408__=1;var A=[]','window.__AD_CARDS410__=function()','data-ad-cards410-disc','data-ad-cards410-glyph','P79CARDS410[','Version: 5.465.1']:
