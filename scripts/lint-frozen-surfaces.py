...
_version_ok = ('#define AD_VERSION "v5.470.0"' in src
               and "Version: 5.470.0" in _control
               and "AmazonDark-v5.470-buildfix-scan-budgets-rootless-deb" in _workflow)
print(("PASS" if _version_ok else "FAIL") + ": v5.470 runtime/package/artifact identifiers agree")
if not _version_ok:
    sys.exit(1)
...
for _need in ['__AD_CARDS391_DISABLED408__=1;var A=[]','window.__AD_CARDS410__=function()','data-ad-cards410-disc','data-ad-cards410-glyph','P79CARDS410[','Version: 5.470.0']:
